...
/**
 * Class representing ContainedPrimaryResourceType
 *
 * A Composite containing details of a primary Resource contained in a Release.
 * XSD Type: ContainedPrimaryResource
 */
class ContainedPrimaryResourceType
{
    /**
     * A Composite containing details of ResourceIds.
     *
     * @var \DDEX\CT\CT_100\ResourceIdType $resourceId
     */
    private $resourceId = null;

    /**
     * A Composite containing details of a Title of the Resource as the MessageSender suggests it should be shown to the Consumer. In many instances this is the only Title to be communicated for any given Creation. Multiple instances can be supplied with an ApplicableTerritoryCode and/or LanguageAndScriptCode.
     *
     ...
     * A Composite containing details of ResourceIds.
     *
     * @return \DDEX\CT\CT_100\ResourceIdType
     */
     ...
     * A Composite containing details of ResourceIds.
     *
     * @param \DDEX\CT\CT_100\ResourceIdType $resourceId
     * @return self
     */
    public function setResourceId(\DDEX\CT\CT_100\ResourceIdType $resourceId)
    {
