...
class ResourceIdType
{
     ...
     *
     * @var \DDEX\CT\CT_100\CatalogNumberType $catalogNumber
     */
     ...
     *
     * @var \DDEX\CT\CT_100\ProprietaryIdType[] $proprietaryId
     */
     ...
     * A Composite containing details of the CatalogNumber of the Resource.
     *
     * @return \DDEX\CT\CT_100\CatalogNumberType
     */
     ...
     * A Composite containing details of the CatalogNumber of the Resource.
     *
     * @param \DDEX\CT\CT_100\CatalogNumberType $catalogNumber
     * @return self
     */
    public function setCatalogNumber(?\DDEX\CT\CT_100\CatalogNumberType $catalogNumber = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\CT\CT_100\ProprietaryIdType $proprietaryId
     */
    public function addToProprietaryId(\DDEX\CT\CT_100\ProprietaryIdType $proprietaryId)
    {
