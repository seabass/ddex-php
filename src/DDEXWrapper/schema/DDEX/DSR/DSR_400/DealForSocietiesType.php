...
class DealForSocietiesType
{
     ...
     *
     * @var \DDEX\DSR\DSR_400\SummaryDealType $summaryDeal
     */
     ...
     * @return self
     */
    public function setDetailedDeal(?\DDEX\DSR\DSR_400\DetailedDealType $detailedDeal = null)
    {
     ...
     * A ddex:Composite containing a summary of the terms and conditions of the ddex:Deal. Either this ddex:Element or the DetailedDeal are required, but not both.
     *
     * @return \DDEX\DSR\DSR_400\SummaryDealType
     */
     ...
     * A ddex:Composite containing a summary of the terms and conditions of the ddex:Deal. Either this ddex:Element or the DetailedDeal are required, but not both.
     *
     * @param \DDEX\DSR\DSR_400\SummaryDealType $summaryDeal
     * @return self
     */
    public function setSummaryDeal(?\DDEX\DSR\DSR_400\SummaryDealType $summaryDeal = null)
    {
