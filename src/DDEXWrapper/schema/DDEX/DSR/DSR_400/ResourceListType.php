 ...
 *
 * A ddex:Composite containing details of one or more ddex:Resources. ResourceList provides a simple means of aggregating ddex:Resources without any explicit sequencing or grouping: if it is needed, that is provided by the ddex:ResourceGroup ddex:Composite.
 * XSD Type: ResourceList
 */
class ResourceListType
{
    /**
     * The ddex:Language and script for the ddex:Elements of the dsr:ResourceList as defined in IETF RfC 4646. The default is the same as indicated for the containing composite. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
     ...
     *
     * @var \DDEX\DSR\DSR_400\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DDEX\DSR\DSR_400\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *
     * @var \DDEX\DSR\DSR_400\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DDEX\DSR\DSR_400\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DDEX\DSR\DSR_400\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DDEX\DSR\DSR_400\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DDEX\DSR\DSR_400\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @var \DDEX\DSR\DSR_400\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\DSR\DSR_400\SoundRecordingType $soundRecording)
    {
     ...
     * A ddex:Composite containing details of a ddex:SoundRecording.
     *
     * @return \DDEX\DSR\DSR_400\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\MIDIType $mIDI
     */
    public function addToMIDI(\DDEX\DSR\DSR_400\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:MIDI.
     *
     * @return \DDEX\DSR\DSR_400\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\VideoType $video
     */
    public function addToVideo(\DDEX\DSR\DSR_400\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Video.
     *
     * @return \DDEX\DSR\DSR_400\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\ImageType $image
     */
    public function addToImage(\DDEX\DSR\DSR_400\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A ddex:Composite containing details of an ddex:Image.
     *
     * @return \DDEX\DSR\DSR_400\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\TextType $text
     */
    public function addToText(\DDEX\DSR\DSR_400\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Text.
     *
     * @return \DDEX\DSR\DSR_400\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\DSR\DSR_400\SheetMusicType $sheetMusic)
    {
     ...
     * A ddex:Composite containing details of a ddex:SheetMusic.
     *
     * @return \DDEX\DSR\DSR_400\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\SoftwareType $software
     */
    public function addToSoftware(\DDEX\DSR\DSR_400\SoftwareType $software)
    {
     ...
     * A ddex:Composite containing details of an item of ddex:Software.
     *
     * @return \DDEX\DSR\DSR_400\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DDEX\DSR\DSR_400\UserDefinedResourceType $userDefinedResource)
    {
     ...
     * A ddex:Composite containing details of a ddex:UserDefinedResource.
     *
     * @return \DDEX\DSR\DSR_400\UserDefinedResourceType[]
     */
