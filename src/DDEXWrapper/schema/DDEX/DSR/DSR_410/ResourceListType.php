...
class ResourceListType
{
     ...
     *
     * @var \DDEX\DSR\DSR_410\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DDEX\DSR\DSR_410\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *
     * @var \DDEX\DSR\DSR_410\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DDEX\DSR\DSR_410\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DDEX\DSR\DSR_410\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DDEX\DSR\DSR_410\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DDEX\DSR\DSR_410\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @var \DDEX\DSR\DSR_410\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\DSR\DSR_410\SoundRecordingType $soundRecording)
    {
     ...
     * A ddex:Composite containing details of a ddex:SoundRecording.
     *
     * @return \DDEX\DSR\DSR_410\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\MIDIType $mIDI
     */
    public function addToMIDI(\DDEX\DSR\DSR_410\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:MIDI.
     *
     * @return \DDEX\DSR\DSR_410\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\VideoType $video
     */
    public function addToVideo(\DDEX\DSR\DSR_410\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Video.
     *
     * @return \DDEX\DSR\DSR_410\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\ImageType $image
     */
    public function addToImage(\DDEX\DSR\DSR_410\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A ddex:Composite containing details of an ddex:Image.
     *
     * @return \DDEX\DSR\DSR_410\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\TextType $text
     */
    public function addToText(\DDEX\DSR\DSR_410\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Text.
     *
     * @return \DDEX\DSR\DSR_410\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\DSR\DSR_410\SheetMusicType $sheetMusic)
    {
     ...
     * A ddex:Composite containing details of a ddex:SheetMusic.
     *
     * @return \DDEX\DSR\DSR_410\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\SoftwareType $software
     */
    public function addToSoftware(\DDEX\DSR\DSR_410\SoftwareType $software)
    {
     ...
     * A ddex:Composite containing details of an item of ddex:Software.
     *
     * @return \DDEX\DSR\DSR_410\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DDEX\DSR\DSR_410\UserDefinedResourceType $userDefinedResource)
    {
     ...
     * A ddex:Composite containing details of a ddex:UserDefinedResource.
     *
     * @return \DDEX\DSR\DSR_410\UserDefinedResourceType[]
     */
