 ...
 *
 * A ddex:Composite containing details of ddex:SalesTransactions reported by a ddex:DSP to a record company for a specific ddex:CommercialModelType.
...
class SalesToRecordCompanyByCommercialModelType
{
    ...
    /**
     * A ddex:Composite containing details of ddex:SalesTransactions reported by the ddex:DSP to the record company for a specific ddex:Territory.
     *
     * @var \DDEX\DSR\DSR_410\SalesToRecordCompanyByTerritoryType[] $salesByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\SalesToRecordCompanyByTerritoryType $salesByTerritory
     */
    public function addToSalesByTerritory(\DDEX\DSR\DSR_410\SalesToRecordCompanyByTerritoryType $salesByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:SalesTransactions reported by the ddex:DSP to the record company for a specific ddex:Territory.
     *
     * @return \DDEX\DSR\DSR_410\SalesToRecordCompanyByTerritoryType[]
     */
