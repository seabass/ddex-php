...
class CueSheetType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\ProprietaryIdType[] $cueSheetId
     */
    private $cueSheetId = [
     ...
     *
     * @var \DDEX\DSR\DSR_420\CueSheetTypeType $cueSheetType
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\ProprietaryIdType $cueSheetId
     */
    public function addToCueSheetId(\DDEX\DSR\DSR_420\ProprietaryIdType $cueSheetId)
    {
     ...
     * A Composite containing details of a Type of the CueSheet.
     *
     * @return \DDEX\DSR\DSR_420\CueSheetTypeType
     */
     ...
     * A Composite containing details of a Type of the CueSheet.
     *
     * @param \DDEX\DSR\DSR_420\CueSheetTypeType $cueSheetType
     * @return self
     */
    public function setCueSheetType(\DDEX\DSR\DSR_420\CueSheetTypeType $cueSheetType)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\CueType $cue
     */
    public function addToCue(\DDEX\DSR\DSR_420\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     * A Composite containing details of a Cue.
     *
     * @return \DDEX\DSR\DSR_420\CueType[]
     */
