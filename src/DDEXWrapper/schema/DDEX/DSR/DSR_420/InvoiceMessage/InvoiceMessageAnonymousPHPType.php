...
namespace DDEX\DSR\DSR_420\InvoiceMessage;
...
class InvoiceMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\ProprietaryIdType $invoiceId
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\InvoiceItemType[] $invoiceItem
     */
    private $invoiceItem = [
     ...
     *
     * @var \DDEX\DSR\DSR_420\TotalRoyaltyAmountType[] $totalRoyaltyAmount
     */
     ...
     * A Composite containing details of an Identifier of the Invoice.
     *
     * @param \DDEX\DSR\DSR_420\ProprietaryIdType $invoiceId
     * @return self
     */
    public function setInvoiceId(\DDEX\DSR\DSR_420\ProprietaryIdType $invoiceId)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\InvoiceItemType $invoiceItem
     */
    public function addToInvoiceItem(\DDEX\DSR\DSR_420\InvoiceItemType $invoiceItem)
    {
     ...
     * A Composite containing details of an InvoiceItem.
     *
     * @return \DDEX\DSR\DSR_420\InvoiceItemType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\TotalRoyaltyAmountType $totalRoyaltyAmount
     */
    public function addToTotalRoyaltyAmount(\DDEX\DSR\DSR_420\TotalRoyaltyAmountType $totalRoyaltyAmount)
    {
     ...
     * A Composite containing details of a total RoyaltyAmount.
     *
     * @return \DDEX\DSR\DSR_420\TotalRoyaltyAmountType[]
     */
