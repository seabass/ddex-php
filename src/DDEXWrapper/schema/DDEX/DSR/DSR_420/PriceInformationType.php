...
class PriceInformationType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\PriceRangeTypeType $priceRangeType
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\PriceTypeType $priceType
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\PriceType $wholesalePricePerUnit
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\PriceType $wholesalePricePerUnitInCurrencyOfAccounting
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\PriceType $bulkOrderWholesalePricePerUnit
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\PriceType $bulkOrderWholesalePricePerUnitInCurrencyOfAccounting
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\PriceType $suggestedRetailPrice
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\PriceType $suggestedRetailPriceInCurrencyOfAccounting
     */
     ...
     * A Composite containing a Type of Price according to its value range. Typical examples include 'budget' and 'front line'.
     *
     * @return \DDEX\DSR\DSR_420\PriceRangeTypeType
     */
     ...
     * A Composite containing a Type of Price according to its value range. Typical examples include 'budget' and 'front line'.
     *
     * @param \DDEX\DSR\DSR_420\PriceRangeTypeType $priceRangeType
     * @return self
     */
    public function setPriceRangeType(?\DDEX\DSR\DSR_420\PriceRangeTypeType $priceRangeType = null)
    {
     ...
     * A Composite containing further details of the Price. Often used to refine the PriceRangeType.
     *
     * @return \DDEX\DSR\DSR_420\PriceTypeType
     */
     ...
     * A Composite containing further details of the Price. Often used to refine the PriceRangeType.
     *
     * @param \DDEX\DSR\DSR_420\PriceTypeType $priceType
     * @return self
     */
    public function setPriceType(?\DDEX\DSR\DSR_420\PriceTypeType $priceType = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage. Note that this Price applies to all UseTypes referenced in a DealTerm Composite.
     *
     * @param \DDEX\DSR\DSR_420\PriceType $wholesalePricePerUnit
     * @return self
     */
    public function setWholesalePricePerUnit(?\DDEX\DSR\DSR_420\PriceType $wholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, using the CurrencyOfAccounting. Note that this Price applies to all UseTypes referenced in a DealTerm Composite.
     *
     * @param \DDEX\DSR\DSR_420\PriceType $wholesalePricePerUnitInCurrencyOfAccounting
     * @return self
     */
    public function setWholesalePricePerUnitInCurrencyOfAccounting(?\DDEX\DSR\DSR_420\PriceType $wholesalePricePerUnitInCurrencyOfAccounting = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit. Note that the size of a bulk order is defined in the contract between MessageSender and the MessageRecipient.
     *
     * @param \DDEX\DSR\DSR_420\PriceType $bulkOrderWholesalePricePerUnit
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnit(?\DDEX\DSR\DSR_420\PriceType $bulkOrderWholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit, using the CurrencyOfAccounting. Note that the size of a bulk order is defined in the contract between MessageSender and the MessageRecipient.
     *
     * @param \DDEX\DSR\DSR_420\PriceType $bulkOrderWholesalePricePerUnitInCurrencyOfAccounting
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnitInCurrencyOfAccounting(?\DDEX\DSR\DSR_420\PriceType $bulkOrderWholesalePricePerUnitInCurrencyOfAccounting = null)
    {
     ...
     * A Composite containing details of a suggested retail Price.
     *
     * @param \DDEX\DSR\DSR_420\PriceType $suggestedRetailPrice
     * @return self
     */
    public function setSuggestedRetailPrice(?\DDEX\DSR\DSR_420\PriceType $suggestedRetailPrice = null)
    {
     ...
     * A Composite containing details of a suggested retail Price, using the CurrencyOfAccounting.
     *
     * @param \DDEX\DSR\DSR_420\PriceType $suggestedRetailPriceInCurrencyOfAccounting
     * @return self
     */
    public function setSuggestedRetailPriceInCurrencyOfAccounting(?\DDEX\DSR\DSR_420\PriceType $suggestedRetailPriceInCurrencyOfAccounting = null)
    {
