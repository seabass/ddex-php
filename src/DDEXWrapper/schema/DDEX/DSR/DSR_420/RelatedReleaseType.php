...
class RelatedReleaseType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\ReleaseSummaryDetailsByTerritoryType[] $releaseSummaryDetailsByTerritory
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\ReleaseRelationshipTypeType $releaseRelationshipType
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\EventDateType $releaseDate
     */
     ...
     * @return self
     */
    public function setReferenceTitle(?\DDEX\DSR\DSR_420\ReferenceTitleType $referenceTitle = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory
     */
    public function addToReleaseSummaryDetailsByTerritory(\DDEX\DSR\DSR_420\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory)
    {
     ...
     * A Composite containing summary details of Descriptors and other attributes of the Release which may vary according to Territory of Release. Territory of Release may be the world.
     *
     * @return \DDEX\DSR\DSR_420\ReleaseSummaryDetailsByTerritoryType[]
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @return \DDEX\DSR\DSR_420\ReleaseRelationshipTypeType
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @param \DDEX\DSR\DSR_420\ReleaseRelationshipTypeType $releaseRelationshipType
     * @return self
     */
    public function setReleaseRelationshipType(\DDEX\DSR\DSR_420\ReleaseRelationshipTypeType $releaseRelationshipType)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the related Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DDEX\DSR\DSR_420\EventDateType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DDEX\DSR\DSR_420\EventDateType $releaseDate = null)
    {
