...
class ReleaseType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\ReleaseCollectionReferenceType[] $releaseCollectionReference
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\ReleaseDetailsByTerritoryType[] $releaseDetailsByTerritory
     */
     ...
     */
    public function addToReleaseResourceReferenceList(\DDEX\DSR\DSR_420\ReleaseResourceReferenceType $releaseResourceReference)
    {
     ...
     * A Composite containing details of one or more Resources contained in the Release.
     *
     * @param \DDEX\DSR\DSR_420\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\ReleaseCollectionReferenceType $releaseCollectionReference
     */
    public function addToReleaseCollectionReference(\DDEX\DSR\DSR_420\ReleaseCollectionReferenceType $releaseCollectionReference)
    {
     ...
     * A Composite containing a Reference for a Collection (specific to this Message). The LocalAnchorReference in this Composite is a xs:string starting with the letter X.
     *
     * @return \DDEX\DSR\DSR_420\ReleaseCollectionReferenceType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory
     */
    public function addToReleaseDetailsByTerritory(\DDEX\DSR\DSR_420\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the Release which may vary according to Territory of release.
     *
     * @return \DDEX\DSR\DSR_420\ReleaseDetailsByTerritoryType[]
     */
