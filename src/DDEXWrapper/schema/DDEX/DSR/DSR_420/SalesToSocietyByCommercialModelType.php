...
class SalesToSocietyByCommercialModelType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\SalesToSocietyByTerritoryType[] $salesByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\SalesToSocietyByTerritoryType $salesByTerritory
     */
    public function addToSalesByTerritory(\DDEX\DSR\DSR_420\SalesToSocietyByTerritoryType $salesByTerritory)
    {
     ...
     * A Composite containing details of SalesTransactions reported by the DSP to the MusicalWork Licensor for a specific Territory.
     *
     * @return \DDEX\DSR\DSR_420\SalesToSocietyByTerritoryType[]
     */
