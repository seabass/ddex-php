...
class SalesTransactionToRecordCompanyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\SalesDataToRecordCompanyType[] $salesData
     */
    private $salesData = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\SalesDataToRecordCompanyType $salesData
     */
    public function addToSalesData(\DDEX\DSR\DSR_420\SalesDataToRecordCompanyType $salesData)
    {
     ...
     * A Composite containing details of SalesTransactions of the Release governed by the Deal.
     *
     * @return \DDEX\DSR\DSR_420\SalesDataToRecordCompanyType[]
     */
