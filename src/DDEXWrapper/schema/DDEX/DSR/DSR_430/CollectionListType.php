...
class CollectionListType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\CollectionType[] $collection
     */
    private $collection = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\CollectionType $collection
     */
    public function addToCollection(\DDEX\DSR\DSR_430\CollectionType $collection)
    {
     ...
     * A Composite containing details of a Collection contained in a Resource.
     *
     * @return \DDEX\DSR\DSR_430\CollectionType[]
     */
