...
class CollectionType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\CollectionIdType[] $collectionId
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ResourceContributorType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @var \DDEX\DSR\DSR_430\CollectionCollectionReferenceListType $collectionCollectionReferenceList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\EventDateType $releaseDate
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\CollectionDetailsByTerritoryType[] $collectionDetailsByTerritory
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\CollectionWorkReferenceType[] $collectionWorkReferenceList
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\CollectionIdType $collectionId
     */
    public function addToCollectionId(\DDEX\DSR\DSR_430\CollectionIdType $collectionId)
    {
     ...
     * A Composite containing details of an Identifier of the Collection.
     *
     * @return \DDEX\DSR\DSR_430\CollectionIdType[]
     */
     ...
     */
    public function addToCollectionType(\DDEX\DSR\DSR_430\CollectionTypeType $collectionType)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\ResourceContributorType $contributor
     */
    public function addToContributor(\DDEX\DSR\DSR_430\ResourceContributorType $contributor)
    {
     ...
     * A Composite containing a list of CollectionCollectionReferences for a Collection (specific to this Message).
     *
     * @return \DDEX\DSR\DSR_430\CollectionCollectionReferenceListType
     */
     ...
     * A Composite containing a list of CollectionCollectionReferences for a Collection (specific to this Message).
     *
     * @param \DDEX\DSR\DSR_430\CollectionCollectionReferenceListType $collectionCollectionReferenceList
     * @return self
     */
    public function setCollectionCollectionReferenceList(?\DDEX\DSR\DSR_430\CollectionCollectionReferenceListType $collectionCollectionReferenceList = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Collection was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DDEX\DSR\DSR_430\EventDateType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DDEX\DSR\DSR_430\EventDateType $releaseDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\CollectionDetailsByTerritoryType $collectionDetailsByTerritory
     */
    public function addToCollectionDetailsByTerritory(\DDEX\DSR\DSR_430\CollectionDetailsByTerritoryType $collectionDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the Collection which may vary according to Territory of release.
     *
     * @return \DDEX\DSR\DSR_430\CollectionDetailsByTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\CollectionWorkReferenceType $collectionWorkReference
     */
    public function addToCollectionWorkReferenceList(\DDEX\DSR\DSR_430\CollectionWorkReferenceType $collectionWorkReference)
    {
     ...
     * A Composite containing a list of CollectionWorkReferences for a Work (specific to this Message).
     *
     * @return \DDEX\DSR\DSR_430\CollectionWorkReferenceType[]
     */
     ...
     * A Composite containing a list of CollectionWorkReferences for a Work (specific to this Message).
     *
     * @param \DDEX\DSR\DSR_430\CollectionWorkReferenceType[] $collectionWorkReferenceList
     * @return self
     */
