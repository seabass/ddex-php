...
class DetailedDealType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\PriceInformationType $priceInformation
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\PromotionalCodeType $promotionalCode
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\DealReferenceType $dealReference
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\TaxRateType[] $taxRate
     */
    private $taxRate = [
     ...
     *
     * @var \DDEX\DSR\DSR_430\CalculationTypeType[] $calculationType
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\DeductionRateType[] $deductionRate
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\DeductionRateType[] $deductionRateInCurrencyOfAccounting
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ProprietaryFinancialDataType[] $proprietaryFinancialData
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ProprietaryFinancialDataType[] $proprietaryFinancialDataInCurrencyOfAccounting
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\TechnicalInstantiationType $technicalInstantiation
     */
     ...
     * A Composite containing details of the Price applicable to the SalesTransaction.
     *
     * @return \DDEX\DSR\DSR_430\PriceInformationType
     */
     ...
     * A Composite containing details of the Price applicable to the SalesTransaction.
     *
     * @param \DDEX\DSR\DSR_430\PriceInformationType $priceInformation
     * @return self
     */
    public function setPriceInformation(?\DDEX\DSR\DSR_430\PriceInformationType $priceInformation = null)
    {
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @return \DDEX\DSR\DSR_430\PromotionalCodeType
     */
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @param \DDEX\DSR\DSR_430\PromotionalCodeType $promotionalCode
     * @return self
     */
    public function setPromotionalCode(?\DDEX\DSR\DSR_430\PromotionalCodeType $promotionalCode = null)
    {
     ...
     * A Composite containing the Reference (in the form of an Identifier, Name or Description) to a TextDocument containing details of the Deal governing the SalesTransaction.
     *
     * @return \DDEX\DSR\DSR_430\DealReferenceType
     */
     ...
     * A Composite containing the Reference (in the form of an Identifier, Name or Description) to a TextDocument containing details of the Deal governing the SalesTransaction.
     *
     * @param \DDEX\DSR\DSR_430\DealReferenceType $dealReference
     * @return self
     */
    public function setDealReference(?\DDEX\DSR\DSR_430\DealReferenceType $dealReference = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\TaxRateType $taxRate
     */
    public function addToTaxRate(\DDEX\DSR\DSR_430\TaxRateType $taxRate)
    {
     ...
     * A Composite containing details of a TaxRate applicable to the total Amount to be paid. Within the DSR Message, only one of the two TaxRate Elements (here and in the SalesByTerritory or in the SalesByTerritory Composite) may be filled.
     *
     * @return \DDEX\DSR\DSR_430\TaxRateType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\CalculationTypeType $calculationType
     */
    public function addToCalculationType(\DDEX\DSR\DSR_430\CalculationTypeType $calculationType)
    {
     ...
     * A Composite containing details of a Type of Calculation method used by which the royalties are to be determined. This is a text string with no prescribed allowed values.
     *
     * @return \DDEX\DSR\DSR_430\CalculationTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\DeductionRateType $deductionRate
     */
    public function addToDeductionRate(\DDEX\DSR\DSR_430\DeductionRateType $deductionRate)
    {
     ...
     * A Composite containing details of an applicable DeductionRate (if any).
     *
     * @return \DDEX\DSR\DSR_430\DeductionRateType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\DeductionRateType $deductionRateInCurrencyOfAccounting
     */
    public function addToDeductionRateInCurrencyOfAccounting(\DDEX\DSR\DSR_430\DeductionRateType $deductionRateInCurrencyOfAccounting)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\ProprietaryFinancialDataType $proprietaryFinancialData
     */
    public function addToProprietaryFinancialData(\DDEX\DSR\DSR_430\ProprietaryFinancialDataType $proprietaryFinancialData)
    {
     ...
     * A Composite containing proprietary financial Elements.
     *
     * @return \DDEX\DSR\DSR_430\ProprietaryFinancialDataType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\ProprietaryFinancialDataType $proprietaryFinancialDataInCurrencyOfAccounting
     */
    public function addToProprietaryFinancialDataInCurrencyOfAccounting(\DDEX\DSR\DSR_430\ProprietaryFinancialDataType $proprietaryFinancialDataInCurrencyOfAccounting)
    {
     ...
     * A Composite containing technical details of the Release.
     *
     * @return \DDEX\DSR\DSR_430\TechnicalInstantiationType
     */
     ...
     * A Composite containing technical details of the Release.
     *
     * @param \DDEX\DSR\DSR_430\TechnicalInstantiationType $technicalInstantiation
     * @return self
     */
    public function setTechnicalInstantiation(?\DDEX\DSR\DSR_430\TechnicalInstantiationType $technicalInstantiation = null)
    {
