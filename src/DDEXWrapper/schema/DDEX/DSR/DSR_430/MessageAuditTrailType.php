...
class MessageAuditTrailType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\MessageAuditTrailEventType[] $messageAuditTrailEvent
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrailEvent(\DDEX\DSR\DSR_430\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing details of a Party handling the Message and the Time at which the handling took place.
     *
     * @return \DDEX\DSR\DSR_430\MessageAuditTrailEventType[]
     */
