...
class MusicalWorkDetailsByTerritoryType
{
    ...
    /**
     * A Flag indicating whether some rights in the MusicalWork are in dispute (=True) or not (=False). This element is set to true if the sum of all Claims for the MusicalWork (for the given country) is more than 100% for a (not specified) Right within (at least part of) the time period covered by the sales report. Absence of this element is synonymous with false.
     *
