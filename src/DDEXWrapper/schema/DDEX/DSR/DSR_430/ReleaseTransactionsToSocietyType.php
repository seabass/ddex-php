...
{
    /**
     * The Language and script for the Elements of the ReleaseTransactions as defined in IETF RfC 5646. The default is the same as indicated for the containing composite. Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
     ...
     *
     * @var \DDEX\DSR\DSR_430\DetailedDealType $deal
     */
    private $deal = null;
     ...
     *
     * @var \DDEX\DSR\DSR_430\SalesTransactionToSocietyType[] $salesTransaction
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\CommentType $comment
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\DurationByUseTypeType[] $durationUsed
     */
     ...
     * @return self
     */
    public function setResourceType(?\DDEX\DSR\DSR_430\ResourceTypeType $resourceType = null)
    {
     ...
     * A Composite containing details of the terms and conditions of the Deal under which sales were transacted. (Note: The Amount reported in this Composite is an estimate based on best knowledge on the side of the MessageSender with respect to the intellectual property rights controlled by the MessageRecipient. The default is that 100% ownership is assumed).
     *
     * @param \DDEX\DSR\DSR_430\DetailedDealType $deal
     * @return self
     */
    public function setDeal(?\DDEX\DSR\DSR_430\DetailedDealType $deal = null)
    {
        $this->deal = $deal;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\SalesTransactionToSocietyType $salesTransaction
     */
    public function addToSalesTransaction(\DDEX\DSR\DSR_430\SalesTransactionToSocietyType $salesTransaction)
    {
     ...
     * A Composite containing details of a SalesTransaction for specified Usages of the Release or Resource.
     *
     * @return \DDEX\DSR\DSR_430\SalesTransactionToSocietyType[]
     */
     ...
     * A Composite containing the Comment about the ReleaseTransactions Composite.
     *
     * @return \DDEX\DSR\DSR_430\CommentType
     */
     ...
     * A Composite containing the Comment about the ReleaseTransactions Composite.
     *
     * @param \DDEX\DSR\DSR_430\CommentType $comment
     * @return self
     */
    public function setComment(?\DDEX\DSR\DSR_430\CommentType $comment = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\DurationByUseTypeType $durationUsed
     */
    public function addToDurationUsed(\DDEX\DSR\DSR_430\DurationByUseTypeType $durationUsed)
    {
     ...
     * A Composite containing details of the total Duration of the Release or Resource that has been used (this may be less than the total Duration), specified for a UseType (using the ISO 8601:2004 PT[[hhH]mmM]ssS format, where lower case characters indicate variables, upper case characters are part of the xs:string, e.g. one hour, two minutes and three seconds would be PT1H2M3S). This applies only to Release which are single-Resource Creations.
     *
     * @return \DDEX\DSR\DSR_430\DurationByUseTypeType[]
     */
