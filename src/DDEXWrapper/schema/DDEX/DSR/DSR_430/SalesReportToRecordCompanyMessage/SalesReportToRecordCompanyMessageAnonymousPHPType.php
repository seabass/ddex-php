...
namespace DDEX\DSR\DSR_430\SalesReportToRecordCompanyMessage;
...
class SalesReportToRecordCompanyMessageAnonymousPHPType
{
    ...
    /**
     * The Language and script for the Elements of the SalesReportToRecordCompanyMessage as defined in IETF RfC 5646. Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
     ...
     *
     * @var \DDEX\DSR\DSR_430\SalesReportToRecordCompanyType[] $salesReport
     */
    private $salesReport = [
     ...
     *
     * @var \DDEX\DSR\DSR_430\TotalSalesByReleaseTypeType[] $totalSalesByReleaseType
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\SalesReportToRecordCompanyType $salesReport
     */
    public function addToSalesReport(\DDEX\DSR\DSR_430\SalesReportToRecordCompanyType $salesReport)
    {
     ...
     * A Composite containing details of SalesTransactions by a distribution partner reported to a record company.
     *
     * @return \DDEX\DSR\DSR_430\SalesReportToRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\TotalSalesByReleaseTypeType $totalSalesByReleaseType
     */
    public function addToTotalSalesByReleaseType(\DDEX\DSR\DSR_430\TotalSalesByReleaseTypeType $totalSalesByReleaseType)
    {
     ...
     * A Composite containing details of total sales of Releases of a specific Type.
     *
     * @return \DDEX\DSR\DSR_430\TotalSalesByReleaseTypeType[]
     */
