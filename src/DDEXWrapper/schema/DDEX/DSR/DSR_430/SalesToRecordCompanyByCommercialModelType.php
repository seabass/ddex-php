...
class SalesToRecordCompanyByCommercialModelType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\SalesToRecordCompanyByTerritoryType[] $salesByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\SalesToRecordCompanyByTerritoryType $salesByTerritory
     */
    public function addToSalesByTerritory(\DDEX\DSR\DSR_430\SalesToRecordCompanyByTerritoryType $salesByTerritory)
    {
     ...
     * A Composite containing details of SalesTransactions reported by the DSP to the record company for a specific Territory.
     *
     * @return \DDEX\DSR\DSR_430\SalesToRecordCompanyByTerritoryType[]
     */
