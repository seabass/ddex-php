 ...
 *
 * A Composite containing details of SalesTransactions reported by a DSP to a WorkLicensor for a specific CommercialModelType.
 * XSD Type: SalesToSocietyByCommercialModel
 */
class SalesToSocietyByCommercialModelType
{
    /**
     * The Language and script for the Elements of the SalesByCommercialModel as defined in IETF RfC 5646. The default is the same as indicated for the containing composite. Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A Composite containing details of SalesTransactions reported by the DSP to the MusicalWork Licensor for a specific Territory.
     *
     * @var \DDEX\DSR\DSR_430\SalesToSocietyByTerritoryType[] $salesByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\SalesToSocietyByTerritoryType $salesByTerritory
     */
    public function addToSalesByTerritory(\DDEX\DSR\DSR_430\SalesToSocietyByTerritoryType $salesByTerritory)
    {
     ...
     * A Composite containing details of SalesTransactions reported by the DSP to the MusicalWork Licensor for a specific Territory.
     *
     * @return \DDEX\DSR\DSR_430\SalesToSocietyByTerritoryType[]
     */
