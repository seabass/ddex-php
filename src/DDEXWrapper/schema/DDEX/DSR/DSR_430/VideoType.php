...
class VideoType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\VideoTypeType $videoType
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\VideoIdType[] $videoId
     */
    private $videoId = [
     ...
     *
     * @var \DDEX\DSR\DSR_430\MusicalWorkIdType[] $indirectVideoId
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\VideoCueSheetReferenceType[] $videoCueSheetReference
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ReasonType $reasonForCueSheetAbsence
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\DescriptionType $instrumentationDescription
     */
    ...
    /**
     * A Composite containing details of the Date and Place of the Event in which the Video was originally mastered (either in analogue or digital form). This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @var \DDEX\DSR\DSR_430\EventDateType $masteredDate
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\VideoDetailsByTerritoryType[] $videoDetailsByTerritory
     */
    ...
    /**
     * A Composite containing details of the Date and Place of the Event in which the Resource was or will be first made available for Usage, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD). This element is deprecated. DDEX advises that it may be removed at a future date and therefore recommends against using it.
     *
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @return \DDEX\DSR\DSR_430\VideoTypeType
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @param \DDEX\DSR\DSR_430\VideoTypeType $videoType
     * @return self
     */
    public function setVideoType(?\DDEX\DSR\DSR_430\VideoTypeType $videoType = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\VideoIdType $videoId
     */
    public function addToVideoId(\DDEX\DSR\DSR_430\VideoIdType $videoId)
    {
     ...
     * A Composite containing details of an Identifier of the Video.
     *
     * @return \DDEX\DSR\DSR_430\VideoIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\MusicalWorkIdType $indirectVideoId
     */
    public function addToIndirectVideoId(\DDEX\DSR\DSR_430\MusicalWorkIdType $indirectVideoId)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\VideoCueSheetReferenceType $videoCueSheetReference
     */
    public function addToVideoCueSheetReference(\DDEX\DSR\DSR_430\VideoCueSheetReferenceType $videoCueSheetReference)
    {
     ...
     * A Composite containing a VideoCueSheetReference for a CueSheet (specific to this Message).
     *
     * @return \DDEX\DSR\DSR_430\VideoCueSheetReferenceType[]
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @return \DDEX\DSR\DSR_430\ReasonType
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @param \DDEX\DSR\DSR_430\ReasonType $reasonForCueSheetAbsence
     * @return self
     */
    public function setReasonForCueSheetAbsence(?\DDEX\DSR\DSR_430\ReasonType $reasonForCueSheetAbsence = null)
    {
     ...
     * A Composite containing a Description of the Type of instrumentation of the MusicalWork(s) in the Video.
     *
     * @param \DDEX\DSR\DSR_430\DescriptionType $instrumentationDescription
     * @return self
     */
    public function setInstrumentationDescription(?\DDEX\DSR\DSR_430\DescriptionType $instrumentationDescription = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Video was originally mastered (either in analogue or digital form). This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\DSR\DSR_430\EventDateType $masteredDate
     * @return self
     */
    public function setMasteredDate(?\DDEX\DSR\DSR_430\EventDateType $masteredDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\VideoDetailsByTerritoryType $videoDetailsByTerritory
     */
    public function addToVideoDetailsByTerritory(\DDEX\DSR\DSR_430\VideoDetailsByTerritoryType $videoDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the Video which may vary according to Territory of release.
     *
     * @return \DDEX\DSR\DSR_430\VideoDetailsByTerritoryType[]
     */
