...
class SalesReportToRecordCompanyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\DSPType $dSP
     */
    private $dSP = null;
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\SalesToRecordCompanyByCommercialModelType[] $salesByCommercialModel
     */
     ...
     * A Composite containing details of the DSP whose SalesTransactions are being reported.
     *
     * @return \DDEX\DSR\DSR_43D1\DSPType
     */
     ...
     * A Composite containing details of the DSP whose SalesTransactions are being reported.
     *
     * @param \DDEX\DSR\DSR_43D1\DSPType $dSP
     * @return self
     */
    public function setDSP(\DDEX\DSR\DSR_43D1\DSPType $dSP)
    {
        $this->dSP = $dSP;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\SalesToRecordCompanyByCommercialModelType $salesByCommercialModel
     */
    public function addToSalesByCommercialModel(\DDEX\DSR\DSR_43D1\SalesToRecordCompanyByCommercialModelType $salesByCommercialModel)
    {
     ...
     * A Composite containing details of SalesTransactions reported by the DSP to the record company for a specific CommercialModelType.
     *
     * @return \DDEX\DSR\DSR_43D1\SalesToRecordCompanyByCommercialModelType[]
     */
