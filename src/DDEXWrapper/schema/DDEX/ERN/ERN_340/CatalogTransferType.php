...
class CatalogTransferType
{
     ...
     *
     * @var \DDEX\ddexC\EventDateType $effectiveTransferDate
     */
     ...
     *
     * @var \DDEX\ddexC\PartyDescriptorType $transferringFrom
     */
     ...
     *
     * @var \DDEX\ddexC\PartyDescriptorType $transferringTo
     */
     ...
     * A ddex:Composite containing details of the Date and ddex:Place of the ddex:Event in which the catalog is or was transferred.
     *
     * @param \DDEX\ddexC\EventDateType $effectiveTransferDate
     * @return self
     */
    public function setEffectiveTransferDate(?\DDEX\ddexC\EventDateType $effectiveTransferDate = null)
    {
     ...
     * A ddex:Composite containing details of the old ddex:RightsController.
     *
     * @param \DDEX\ddexC\PartyDescriptorType $transferringFrom
     * @return self
     */
    public function setTransferringFrom(\DDEX\ddexC\PartyDescriptorType $transferringFrom)
    {
     ...
     * A ddex:Composite containing details of the new ddex:RightsController.
     *
     * @param \DDEX\ddexC\PartyDescriptorType $transferringTo
     * @return self
     */
    public function setTransferringTo(\DDEX\ddexC\PartyDescriptorType $transferringTo)
    {
