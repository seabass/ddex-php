...
class CollectionType
{
     ...
     *
     * @var \DDEX\ddexC\ResourceContributorType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @var \DDEX\ddexC\CharacterType[] $character
     */
    private $character = [
     ...
     *
     * @var \DDEX\ERN\ERN_340\CollectionDetailsByTerritoryType[] $collectionDetailsByTerritory
     */
     ...
     *
     * @var \DDEX\ERN\ERN_340\CollectionResourceReferenceType[] $collectionResourceReferenceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_340\CollectionWorkReferenceType[] $collectionWorkReferenceList
     */
     ...
     *
     * @return self
     * @param \DDEX\ddexC\ResourceContributorType $contributor
     */
    public function addToContributor(\DDEX\ddexC\ResourceContributorType $contributor)
    {
     ...
     *
     * @return self
     * @param \DDEX\ddexC\CharacterType $character
     */
    public function addToCharacter(\DDEX\ddexC\CharacterType $character)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_340\CollectionDetailsByTerritoryType $collectionDetailsByTerritory
     */
    public function addToCollectionDetailsByTerritory(\DDEX\ERN\ERN_340\CollectionDetailsByTerritoryType $collectionDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ddex:Collection which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\ERN\ERN_340\CollectionDetailsByTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_340\CollectionResourceReferenceType $collectionResourceReference
     */
    public function addToCollectionResourceReferenceList(\DDEX\ERN\ERN_340\CollectionResourceReferenceType $collectionResourceReference)
    {
     ...
     * A ddex:Composite containing a list of ddex:CollectionResourceReferences for a ddex:Resource (specific to this ddex:Message).
     *
     * @return \DDEX\ERN\ERN_340\CollectionResourceReferenceType[]
     */
     ...
     * A ddex:Composite containing a list of ddex:CollectionResourceReferences for a ddex:Resource (specific to this ddex:Message).
     *
     * @param \DDEX\ERN\ERN_340\CollectionResourceReferenceType[] $collectionResourceReferenceList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_340\CollectionWorkReferenceType $collectionWorkReference
     */
    public function addToCollectionWorkReferenceList(\DDEX\ERN\ERN_340\CollectionWorkReferenceType $collectionWorkReference)
    {
     ...
     * A ddex:Composite containing a list of ddex:CollectionWorkReferences for a ddex:Work (specific to this ddex:Message).
     *
     * @return \DDEX\ERN\ERN_340\CollectionWorkReferenceType[]
     */
     ...
     * A ddex:Composite containing a list of ddex:CollectionWorkReferences for a ddex:Work (specific to this ddex:Message).
     *
     * @param \DDEX\ERN\ERN_340\CollectionWorkReferenceType[] $collectionWorkReferenceList
     * @return self
     */
