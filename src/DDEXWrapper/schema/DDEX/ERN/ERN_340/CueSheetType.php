...
class CueSheetType
{
     ...
     *
     * @var \DDEX\ERN\ERN_340\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_340\CueType $cue
     */
    public function addToCue(\DDEX\ERN\ERN_340\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Cue.
     *
     * @return \DDEX\ERN\ERN_340\CueType[]
     */
