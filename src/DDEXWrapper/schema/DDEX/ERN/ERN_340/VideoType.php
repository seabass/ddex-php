...
class VideoType
{
     ...
     *
     * @var \DDEX\ERN\ERN_340\VideoDetailsByTerritoryType[] $videoDetailsByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_340\VideoDetailsByTerritoryType $videoDetailsByTerritory
     */
    public function addToVideoDetailsByTerritory(\DDEX\ERN\ERN_340\VideoDetailsByTerritoryType $videoDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ern:Video which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\ERN\ERN_340\VideoDetailsByTerritoryType[]
     */
