...
class CueSheetType
{
     ...
     *
     * @var \DDEX\ddexC\ProprietaryIdType[] $cueSheetId
     */
    private $cueSheetId = [
     ...
     *
     * @var \DDEX\ddexC\CueSheetTypeType $cueSheetType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_341\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DDEX\ddexC\ProprietaryIdType $cueSheetId
     */
    public function addToCueSheetId(\DDEX\ddexC\ProprietaryIdType $cueSheetId)
    {
     ...
     * A ddex:Composite containing details of a ddex:Type of the ddexC:CueSheet.
     *
     * @return \DDEX\ddexC\CueSheetTypeType
     */
     ...
     * A ddex:Composite containing details of a ddex:Type of the ddexC:CueSheet.
     *
     * @param \DDEX\ddexC\CueSheetTypeType $cueSheetType
     * @return self
     */
    public function setCueSheetType(\DDEX\ddexC\CueSheetTypeType $cueSheetType)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_341\CueType $cue
     */
    public function addToCue(\DDEX\ERN\ERN_341\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Cue.
     *
     * @return \DDEX\ERN\ERN_341\CueType[]
     */
