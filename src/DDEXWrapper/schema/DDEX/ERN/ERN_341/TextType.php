...
class TextType
{
     ...
     *
     * @var \DDEX\ERN\ERN_341\TextDetailsByTerritoryType[] $textDetailsByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_341\TextDetailsByTerritoryType $textDetailsByTerritory
     */
    public function addToTextDetailsByTerritory(\DDEX\ERN\ERN_341\TextDetailsByTerritoryType $textDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of the ern:Text which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\ERN\ERN_341\TextDetailsByTerritoryType[]
     */
