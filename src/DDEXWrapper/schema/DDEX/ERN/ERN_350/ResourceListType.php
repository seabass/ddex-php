...
class ResourceListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_350\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DDEX\ERN\ERN_350\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *
     * @var \DDEX\ERN\ERN_350\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DDEX\ERN\ERN_350\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DDEX\ERN\ERN_350\TextType[] $text
     */
    private $text = [
     ...
     * A ddex:Composite containing details of a ddex:Text.
     *
     * @var \DDEX\ERN\ERN_350\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DDEX\ERN\ERN_350\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @var \DDEX\ERN\ERN_350\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\ERN\ERN_350\SoundRecordingType $soundRecording)
    {
     ...
     * A ddex:Composite containing details of a ddex:SoundRecording.
     *
     * @return \DDEX\ERN\ERN_350\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\MIDIType $mIDI
     */
    public function addToMIDI(\DDEX\ERN\ERN_350\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:MIDI.
     *
     * @return \DDEX\ERN\ERN_350\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\VideoType $video
     */
    public function addToVideo(\DDEX\ERN\ERN_350\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Video.
     *
     * @return \DDEX\ERN\ERN_350\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\ImageType $image
     */
    public function addToImage(\DDEX\ERN\ERN_350\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A ddex:Composite containing details of an ddex:Image.
     *
     * @return \DDEX\ERN\ERN_350\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\TextType $text
     */
    public function addToText(\DDEX\ERN\ERN_350\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Text.
     *
     * @return \DDEX\ERN\ERN_350\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\ERN\ERN_350\SheetMusicType $sheetMusic)
    {
     ...
     * A ddex:Composite containing details of a ddex:Text.
     *
     * @return \DDEX\ERN\ERN_350\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\SoftwareType $software
     */
    public function addToSoftware(\DDEX\ERN\ERN_350\SoftwareType $software)
    {
     ...
     * A ddex:Composite containing details of an item of ddex:Software.
     *
     * @return \DDEX\ERN\ERN_350\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DDEX\ERN\ERN_350\UserDefinedResourceType $userDefinedResource)
    {
     ...
     * A ddex:Composite containing details of a ddex:UserDefinedResource.
     *
     * @return \DDEX\ERN\ERN_350\UserDefinedResourceType[]
     */
