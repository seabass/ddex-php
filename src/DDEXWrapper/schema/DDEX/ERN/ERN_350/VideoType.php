...
class VideoType
{
    ...
    /**
     * The ddex:Flag indicating whether the ern:Video is remastered (=True) or not (=False).
     *
     ...
     *
     * @var \DDEX\ERN\ERN_350\VideoDetailsByTerritoryType[] $videoDetailsByTerritory
     */
    ...
    /**
     * The country of commissioning (represented by an ISO 3166-1 iso3166a2:TerritoryCode).
     *
    ...
    /**
     * The number of ddex:FeaturedArtists associated with the ddex:Video.
     *
    ...
    /**
     * The number of ddex:NonFeaturedArtists associated with the ddex:Video.
     *
    ...
    /**
     * The number of ddex:ContractedArtists associated with the ddex:Video.
     *
    ...
    /**
     * The number of ddex:NonContractedArtists associated with the ddex:Video.
     *
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\VideoDetailsByTerritoryType $videoDetailsByTerritory
     */
    public function addToVideoDetailsByTerritory(\DDEX\ERN\ERN_350\VideoDetailsByTerritoryType $videoDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ern:Video which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\ERN\ERN_350\VideoDetailsByTerritoryType[]
     */
