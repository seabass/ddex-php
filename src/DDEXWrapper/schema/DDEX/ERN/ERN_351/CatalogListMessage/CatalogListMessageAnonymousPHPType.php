...
namespace DDEX\ERN\ERN_351\CatalogListMessage;
...
class CatalogListMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_351\CatalogItemType[] $catalogItem
     */
    private $catalogItem = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_351\CatalogItemType $catalogItem
     */
    public function addToCatalogItem(\DDEX\ERN\ERN_351\CatalogItemType $catalogItem)
    {
     ...
     * A ddex:Composite containing details of a ddex:Release which is an item of the catalog.
     *
     * @return \DDEX\ERN\ERN_351\CatalogItemType[]
     */
