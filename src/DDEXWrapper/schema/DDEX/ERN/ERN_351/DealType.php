...
class DealType
{
     ...
     *
     * @var \DDEX\ERN\ERN_351\DealTermsType $dealTerms
     */
     ...
     *
     * @var \DDEX\ERN\ERN_351\ResourceUsageType $resourceUsage
     */
     ...
     * A ddex:Composite containing details of the terms of the ern:Deal.
     *
     * @return \DDEX\ERN\ERN_351\DealTermsType
     */
     ...
     * A ddex:Composite containing details of the terms of the ern:Deal.
     *
     * @param \DDEX\ERN\ERN_351\DealTermsType $dealTerms
     * @return self
     */
    public function setDealTerms(?\DDEX\ERN\ERN_351\DealTermsType $dealTerms = null)
    {
     ...
     * A ddex:Composite containing details of one or more Usages that govern a ddex:Resource in the ern:Deal where the Usage of the ddex:Resource differs from the Usage of the other ddex:Resources in the same ddex:Release.
     *
     * @return \DDEX\ERN\ERN_351\ResourceUsageType
     */
     ...
     * A ddex:Composite containing details of one or more Usages that govern a ddex:Resource in the ern:Deal where the Usage of the ddex:Resource differs from the Usage of the other ddex:Resources in the same ddex:Release.
     *
     * @param \DDEX\ERN\ERN_351\ResourceUsageType $resourceUsage
     * @return self
     */
    public function setResourceUsage(?\DDEX\ERN\ERN_351\ResourceUsageType $resourceUsage = null)
    {
