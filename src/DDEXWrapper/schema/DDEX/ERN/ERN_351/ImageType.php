...
class ImageType
{
     ...
     *
     * @var \DDEX\ERN\ERN_351\ImageDetailsByTerritoryType[] $imageDetailsByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_351\ImageDetailsByTerritoryType $imageDetailsByTerritory
     */
    public function addToImageDetailsByTerritory(\DDEX\ERN\ERN_351\ImageDetailsByTerritoryType $imageDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of the ern:Image which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\ERN\ERN_351\ImageDetailsByTerritoryType[]
     */
