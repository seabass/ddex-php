...
class ReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_351\ReleaseDetailsByTerritoryType[] $releaseDetailsByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_351\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory
     */
    public function addToReleaseDetailsByTerritory(\DDEX\ERN\ERN_351\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ern:Release which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\ERN\ERN_351\ReleaseDetailsByTerritoryType[]
     */
