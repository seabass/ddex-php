...
class AvRatingType
{
     ...
     *
     * @var \DDEX\ERN\ERN_360\RatingAgencyType $ratingAgency
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\DescriptionType[] $ratingSchemeDescription
     */
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @return \DDEX\ERN\ERN_360\RatingAgencyType
     */
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @param \DDEX\ERN\ERN_360\RatingAgencyType $ratingAgency
     * @return self
     */
    public function setRatingAgency(\DDEX\ERN\ERN_360\RatingAgencyType $ratingAgency)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\DescriptionType $ratingSchemeDescription
     */
    public function addToRatingSchemeDescription(\DDEX\ERN\ERN_360\DescriptionType $ratingSchemeDescription)
    {
