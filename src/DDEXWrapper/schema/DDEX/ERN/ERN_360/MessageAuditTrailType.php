...
class MessageAuditTrailType
{
     ...
     *
     * @var \DDEX\ERN\ERN_360\MessageAuditTrailEventType[] $messageAuditTrailEvent
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrailEvent(\DDEX\ERN\ERN_360\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing details of a Party handling the Message and the Time at which the handling took place.
     *
     * @return \DDEX\ERN\ERN_360\MessageAuditTrailEventType[]
     */
