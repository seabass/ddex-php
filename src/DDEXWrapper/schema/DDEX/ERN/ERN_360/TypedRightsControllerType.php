...
class TypedRightsControllerType
{
    ...
    /**
     * The share of the licensed Rights owned by the RightsController. RightShare information is given as a xs:decimal value (e.g. '0.125' represents 12.5%). If no information is given, 100% is assumed.
     *
    ...
    /**
     * The country of registration (represented by an ISO 3166-1 TerritoryCode).
     *
