...
class CueSheetType
{
     ...
     *
     * @var \DDEX\ERN\ERN_370\ProprietaryIdType[] $cueSheetId
     */
    private $cueSheetId = [
     ...
     *  of the CueSheet.
     *
     * @var \DDEX\ERN\ERN_370\CueSheetTypeType $cueSheetType
     */
     ...
     *  Cue.
     *
     * @var \DDEX\ERN\ERN_370\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_370\ProprietaryIdType $cueSheetId
     */
    public function addToCueSheetId(\DDEX\ERN\ERN_370\ProprietaryIdType $cueSheetId)
    {
     ...
     *  of the CueSheet.
     *
     * @return \DDEX\ERN\ERN_370\CueSheetTypeType
     */
     ...
     *  of the CueSheet.
     *
     * @param \DDEX\ERN\ERN_370\CueSheetTypeType $cueSheetType
     * @return self
     */
    public function setCueSheetType(\DDEX\ERN\ERN_370\CueSheetTypeType $cueSheetType)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_370\CueType $cue
     */
    public function addToCue(\DDEX\ERN\ERN_370\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     *  Cue.
     *
     * @return \DDEX\ERN\ERN_370\CueType[]
     */
