...
class CollectionIdType
{
     ...
     *
     * @var \DDEX\ERN\ERN_37D1\ICPNType $iCPN
     */
    private $iCPN = null;
     ...
     *
     * @var \DDEX\ERN\ERN_37D1\CatalogNumberType $catalogNumber
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D1\ProprietaryIdType[] $proprietaryId
     */
     ...
     * A Composite containing details of the ICPN used as proxy for identification of the Collection. Only applicable when the Collection is an abstraction of a complete PhysicalProduct. An ICPN comprises 12 or 13 digits, depending whether it is an EAN (13) or a UPC (12).
     *
     * @return \DDEX\ERN\ERN_37D1\ICPNType
     */
     ...
     * A Composite containing details of the ICPN used as proxy for identification of the Collection. Only applicable when the Collection is an abstraction of a complete PhysicalProduct. An ICPN comprises 12 or 13 digits, depending whether it is an EAN (13) or a UPC (12).
     *
     * @param \DDEX\ERN\ERN_37D1\ICPNType $iCPN
     * @return self
     */
    public function setICPN(?\DDEX\ERN\ERN_37D1\ICPNType $iCPN = null)
    {
        $this->iCPN = $iCPN;
        return $this;
    }
     ...
     * A Composite containing details of the CatalogNumber of the Collection.
     *
     * @return \DDEX\ERN\ERN_37D1\CatalogNumberType
     */
     ...
     * A Composite containing details of the CatalogNumber of the Collection.
     *
     * @param \DDEX\ERN\ERN_37D1\CatalogNumberType $catalogNumber
     * @return self
     */
    public function setCatalogNumber(?\DDEX\ERN\ERN_37D1\CatalogNumberType $catalogNumber = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D1\ProprietaryIdType $proprietaryId
     */
    public function addToProprietaryId(\DDEX\ERN\ERN_37D1\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of a ProprietaryIdentifier of the Collection (usually one per society involved in the messaging).
     *
     * @return \DDEX\ERN\ERN_37D1\ProprietaryIdType[]
     */
