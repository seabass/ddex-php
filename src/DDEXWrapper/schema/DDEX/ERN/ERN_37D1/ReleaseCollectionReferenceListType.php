...
class ReleaseCollectionReferenceListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_37D1\ReleaseCollectionReferenceType[] $releaseCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D1\ReleaseCollectionReferenceType $releaseCollectionReference
     */
    public function addToReleaseCollectionReference(\DDEX\ERN\ERN_37D1\ReleaseCollectionReferenceType $releaseCollectionReference)
    {
     ...
     * A Composite containing a ReleaseCollectionReference for a Collection (specific to this Message). The referenced Collection has to be of CollectionType Series, Season or Episode.
     *
     * @return \DDEX\ERN\ERN_37D1\ReleaseCollectionReferenceType[]
     */
