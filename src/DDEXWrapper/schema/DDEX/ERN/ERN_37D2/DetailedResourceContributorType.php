...
class DetailedResourceContributorType
{
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\ResourceContributorRoleType[] $resourceContributorRole
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\EventDateType $dateAndPlaceOfBirth
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\EventDateType $dateAndPlaceOfDeath
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\ArtistRoleType $primaryRole
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\GoverningAgreementTypeType $governingAgreementType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\ContactIdType $contactInformation
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\AllTerritoryCodeType $territoryOfResidency
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\CurrentTerritoryCodeType $citizenship
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\ArtistRoleType[] $additionalRoles
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\MembershipType[] $membership
     */
    private $membership = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\ERN\ERN_37D2\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, Producers or other Creators.
     *
     * @return \DDEX\ERN\ERN_37D2\PartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\PartyNameType $partyName
     */
    public function addToPartyName(\DDEX\ERN\ERN_37D2\PartyNameType $partyName)
    {
     ...
     * A Composite containing details of the PartyName(s).
     *
     * @return \DDEX\ERN\ERN_37D2\PartyNameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\ResourceContributorRoleType $resourceContributorRole
     */
    public function addToResourceContributorRole(\DDEX\ERN\ERN_37D2\ResourceContributorRoleType $resourceContributorRole)
    {
     ...
     * A Composite containing details of a role played by the Contributor.
     *
     * @return \DDEX\ERN\ERN_37D2\ResourceContributorRoleType[]
     */
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated by the Artist.
     *
     * @return \DDEX\ERN\ERN_37D2\ArtistDelegatedUsageRightsType
     */
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated by the Artist.
     *
     * @param \DDEX\ERN\ERN_37D2\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     * @return self
     */
    public function setArtistDelegatedUsageRights(?\DDEX\ERN\ERN_37D2\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights = null)
    {
     ...
     * A Composite containing details of the Date and Place of birth.
     *
     * @param \DDEX\ERN\ERN_37D2\EventDateType $dateAndPlaceOfBirth
     * @return self
     */
    public function setDateAndPlaceOfBirth(?\DDEX\ERN\ERN_37D2\EventDateType $dateAndPlaceOfBirth = null)
    {
     ...
     * A Composite containing details of the Date and Place of death.
     *
     * @param \DDEX\ERN\ERN_37D2\EventDateType $dateAndPlaceOfDeath
     * @return self
     */
    public function setDateAndPlaceOfDeath(?\DDEX\ERN\ERN_37D2\EventDateType $dateAndPlaceOfDeath = null)
    {
     ...
     * A Composite containing details of the primary role played by the Artist in relation to other Artists.
     *
     * @return \DDEX\ERN\ERN_37D2\ArtistRoleType
     */
     ...
     * A Composite containing details of the primary role played by the Artist in relation to other Artists.
     *
     * @param \DDEX\ERN\ERN_37D2\ArtistRoleType $primaryRole
     * @return self
     */
    public function setPrimaryRole(?\DDEX\ERN\ERN_37D2\ArtistRoleType $primaryRole = null)
    {
     ...
     * A Composite containing details of a Type of an agreement that covers the Artist's participation in making a SoundRecording.
     *
     * @return \DDEX\ERN\ERN_37D2\GoverningAgreementTypeType
     */
     ...
     * A Composite containing details of a Type of an agreement that covers the Artist's participation in making a SoundRecording.
     *
     * @param \DDEX\ERN\ERN_37D2\GoverningAgreementTypeType $governingAgreementType
     * @return self
     */
    public function setGoverningAgreementType(?\DDEX\ERN\ERN_37D2\GoverningAgreementTypeType $governingAgreementType = null)
    {
     ...
     * A Composite containing details of contact Identifiers of the Artist.
     *
     * @return \DDEX\ERN\ERN_37D2\ContactIdType
     */
     ...
     * A Composite containing details of contact Identifiers of the Artist.
     *
     * @param \DDEX\ERN\ERN_37D2\ContactIdType $contactInformation
     * @return self
     */
    public function setContactInformation(?\DDEX\ERN\ERN_37D2\ContactIdType $contactInformation = null)
    {
     ...
     * The country of main residency of the Artist.
     *
     * @param \DDEX\ERN\ERN_37D2\AllTerritoryCodeType $territoryOfResidency
     * @return self
     */
    public function setTerritoryOfResidency(?\DDEX\ERN\ERN_37D2\AllTerritoryCodeType $territoryOfResidency = null)
    {
     ...
     * The country of whose citizenship the Artist has.
     *
     * @param \DDEX\ERN\ERN_37D2\CurrentTerritoryCodeType $citizenship
     * @return self
     */
    public function setCitizenship(?\DDEX\ERN\ERN_37D2\CurrentTerritoryCodeType $citizenship = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\ArtistRoleType $additionalRoles
     */
    public function addToAdditionalRoles(\DDEX\ERN\ERN_37D2\ArtistRoleType $additionalRoles)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\MembershipType $membership
     */
    public function addToMembership(\DDEX\ERN\ERN_37D2\MembershipType $membership)
    {
     ...
     * A Composite containing details of a membership in a collective rights management organization.
     *
     * @return \DDEX\ERN\ERN_37D2\MembershipType[]
     */
