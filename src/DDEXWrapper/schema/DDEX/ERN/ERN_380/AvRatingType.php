...
class AvRatingType
{
     ...
     *
     * @var \DDEX\ERN\ERN_380\RatingAgencyType $ratingAgency
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\DescriptionType[] $ratingSchemeDescription
     */
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @return \DDEX\ERN\ERN_380\RatingAgencyType
     */
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @param \DDEX\ERN\ERN_380\RatingAgencyType $ratingAgency
     * @return self
     */
    public function setRatingAgency(\DDEX\ERN\ERN_380\RatingAgencyType $ratingAgency)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\DescriptionType $ratingSchemeDescription
     */
    public function addToRatingSchemeDescription(\DDEX\ERN\ERN_380\DescriptionType $ratingSchemeDescription)
    {
