...
class DealListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_380\ReleaseDealType[] $releaseDeal
     */
    private $releaseDeal = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\ReleaseDealType $releaseDeal
     */
    public function addToReleaseDeal(\DDEX\ERN\ERN_380\ReleaseDealType $releaseDeal)
    {
     ...
     * A Composite containing details of one or more Deals pertaining to one or more Releases.
     *
     * @return \DDEX\ERN\ERN_380\ReleaseDealType[]
     */
