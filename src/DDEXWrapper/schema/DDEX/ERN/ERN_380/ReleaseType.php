...
class ReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_380\ExternalResourceLinkType[] $externalResourceLink
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\SalesReportingProxyReleaseIdType[] $salesReportingProxyReleaseId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\ResourceOmissionReasonType $resourceOmissionReason
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\ReleaseCollectionReferenceListType $releaseCollectionReferenceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\ReleaseDetailsByTerritoryType[] $releaseDetailsByTerritory
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\WebPageType[] $artistProfilePage
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\EventDateType $globalReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\EventDateType $globalOriginalReleaseDate
     */
     ...
     */
    public function addToReleaseId(\DDEX\ERN\ERN_380\ReleaseIdType $releaseId)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\ExternalResourceLinkType $externalResourceLink
     */
    public function addToExternalResourceLink(\DDEX\ERN\ERN_380\ExternalResourceLinkType $externalResourceLink)
    {
     ...
     * A Composite containing details of promotional or other material related to the Release.
     *
     * @return \DDEX\ERN\ERN_380\ExternalResourceLinkType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\SalesReportingProxyReleaseIdType $salesReportingProxyReleaseId
     */
    public function addToSalesReportingProxyReleaseId(\DDEX\ERN\ERN_380\SalesReportingProxyReleaseIdType $salesReportingProxyReleaseId)
    {
     ...
     * A Composite containing details of the A Composite containing details of the SalesReportingProxyReleaseId.
     *
     * @return \DDEX\ERN\ERN_380\SalesReportingProxyReleaseIdType[]
     */
     ...
     * @return self
     */
    public function setReferenceTitle(\DDEX\ERN\ERN_380\ReferenceTitleType $referenceTitle)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\ReleaseResourceReferenceType $releaseResourceReference
     */
    public function addToReleaseResourceReferenceList(\DDEX\ERN\ERN_380\ReleaseResourceReferenceType $releaseResourceReference)
    {
     ...
     * A Composite containing details of one or more Resources contained in the Release.
     *
     * @return \DDEX\ERN\ERN_380\ReleaseResourceReferenceType[]
     */
     ...
     * A Composite containing details of one or more Resources contained in the Release.
     *
     * @param \DDEX\ERN\ERN_380\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     * @return self
     */
     ...
     * A Composite containing details of a ResourceOmissionReason.
     *
     * @return \DDEX\ERN\ERN_380\ResourceOmissionReasonType
     */
     ...
     * A Composite containing details of a ResourceOmissionReason.
     *
     * @param \DDEX\ERN\ERN_380\ResourceOmissionReasonType $resourceOmissionReason
     * @return self
     */
    public function setResourceOmissionReason(?\DDEX\ERN\ERN_380\ResourceOmissionReasonType $resourceOmissionReason = null)
    {
     ...
     * A Composite containing details of one or more Collections contained in the Release.
     *
     * @return \DDEX\ERN\ERN_380\ReleaseCollectionReferenceListType
     */
     ...
     * A Composite containing details of one or more Collections contained in the Release.
     *
     * @param \DDEX\ERN\ERN_380\ReleaseCollectionReferenceListType $releaseCollectionReferenceList
     * @return self
     */
    public function setReleaseCollectionReferenceList(?\DDEX\ERN\ERN_380\ReleaseCollectionReferenceListType $releaseCollectionReferenceList = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory
     */
    public function addToReleaseDetailsByTerritory(\DDEX\ERN\ERN_380\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the Release which may vary according to Territory of release.
     *
     * @return \DDEX\ERN\ERN_380\ReleaseDetailsByTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\WebPageType $artistProfilePage
     */
    public function addToArtistProfilePage(\DDEX\ERN\ERN_380\WebPageType $artistProfilePage)
    {
     ...
     * A Composite containing details of a WebPage for the Artist.
     *
     * @return \DDEX\ERN\ERN_380\WebPageType[]
     */
     ...
     * A Composite containing details of the Date of the Event in which the Release was or will be first made globally available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD). This element is deprecated. DDEX advises that it may be removed at a future date and therefore recommends against using it.
     *
     * @param \DDEX\ERN\ERN_380\EventDateType $globalReleaseDate
     * @return self
     */
    public function setGlobalReleaseDate(?\DDEX\ERN\ERN_380\EventDateType $globalReleaseDate = null)
    {
     ...
     * A Composite containing details of the Date of the Event in which the collection of tracks for the Release (e.g. the equivalent physical album on vinyl) was or will be first made globally available for Usage, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD). This element is deprecated. DDEX advises that it may be removed at a future date and therefore recommends against using it.
     *
     * @param \DDEX\ERN\ERN_380\EventDateType $globalOriginalReleaseDate
     * @return self
     */
    public function setGlobalOriginalReleaseDate(?\DDEX\ERN\ERN_380\EventDateType $globalOriginalReleaseDate = null)
    {
