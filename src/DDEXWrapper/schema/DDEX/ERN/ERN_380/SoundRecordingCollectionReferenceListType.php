...
class SoundRecordingCollectionReferenceListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_380\SoundRecordingCollectionReferenceType[] $soundRecordingCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference
     */
    public function addToSoundRecordingCollectionReference(\DDEX\ERN\ERN_380\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference)
    {
     ...
     * A Composite containing a SoundRecordingCollectionReference for a Collection (specific to this Message).
     *
     * @return \DDEX\ERN\ERN_380\SoundRecordingCollectionReferenceType[]
     */
