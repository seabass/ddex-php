...
class TitleType
{
     ...
     *
     * @var \DDEX\ERN\ERN_380\TitleTextType $titleText
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\TypedSubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     * A Composite containing the text of the Title.
     *
     * @return \DDEX\ERN\ERN_380\TitleTextType
     */
     ...
     * A Composite containing the text of the Title.
     *
     * @param \DDEX\ERN\ERN_380\TitleTextType $titleText
     * @return self
     */
    public function setTitleText(\DDEX\ERN\ERN_380\TitleTextType $titleText)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\TypedSubTitleType $subTitle
     */
    public function addToSubTitle(\DDEX\ERN\ERN_380\TypedSubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DDEX\ERN\ERN_380\TypedSubTitleType[]
     */
