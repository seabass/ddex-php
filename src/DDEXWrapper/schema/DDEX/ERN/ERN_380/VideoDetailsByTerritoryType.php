...
class VideoDetailsByTerritoryType
{
     ...
     *
     * @var \DDEX\ERN\ERN_380\CurrentTerritoryCodeType[] $territoryCode
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\CurrentTerritoryCodeType[] $excludedTerritoryCode
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\ArtistType[] $displayArtist
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\ArtistType[] $displayConductor
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\IndirectResourceContributorType[] $indirectResourceContributor
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\RightsAgreementIdType $rightsAgreementId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\NameType[] $displayArtistName
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\LabelNameType[] $labelName
     */
    private $labelName = [
     ...
     *
     * @var \DDEX\ERN\ERN_380\TypedRightsControllerType[] $rightsController
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\EventDateType $remasteredDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\EventDateType $resourceReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\EventDateType $originalResourceReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\PLineType[] $pLine
     */
    private $pLine = [
     ...
     *
     * @var \DDEX\ERN\ERN_380\CourtesyLineType $courtesyLine
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\HostSoundCarrierType[] $hostSoundCarrier
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\CommentType $marketingComment
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\GenreType[] $genre
     */
    private $genre = [
     ...
     *
     * @var \DDEX\ERN\ERN_380\ParentalWarningTypeType[] $parentalWarningType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\AvRatingType[] $avRating
     */
    private $avRating = [
     ...
     *
     * @var \DDEX\ERN\ERN_380\FulfillmentDateType $fulfillmentDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\KeywordsType[] $keywords
     */
    private $keywords = [
     ...
     *
     * @var \DDEX\ERN\ERN_380\SynopsisType $synopsis
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\CLineType[] $cLine
     */
    private $cLine = [
     ...
     *
     * @var \DDEX\ERN\ERN_380\TechnicalVideoDetailsType[] $technicalVideoDetails
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\CharacterType[] $character
     */
    private $character = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\CurrentTerritoryCodeType $territoryCode
     */
    public function addToTerritoryCode(\DDEX\ERN\ERN_380\CurrentTerritoryCodeType $territoryCode)
    {
     ...
     * A Territory to which the SoundRecording details apply. Either this Element or ExcludedTerritory shall be present, but not both. The use of ISO TerritoryCodes (or the term 'Worldwide”) is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
     * @return \DDEX\ERN\ERN_380\CurrentTerritoryCodeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\CurrentTerritoryCodeType $excludedTerritoryCode
     */
    public function addToExcludedTerritoryCode(\DDEX\ERN\ERN_380\CurrentTerritoryCodeType $excludedTerritoryCode)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\ArtistType $displayArtist
     */
    public function addToDisplayArtist(\DDEX\ERN\ERN_380\ArtistType $displayArtist)
    {
     ...
     * A Composite containing details of the DisplayArtist for the SoundRecording. The DisplayArtist may be described through Name, Identifier and Roles.
     *
     * @return \DDEX\ERN\ERN_380\ArtistType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\ArtistType $displayConductor
     */
    public function addToDisplayConductor(\DDEX\ERN\ERN_380\ArtistType $displayConductor)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\IndirectResourceContributorType $indirectResourceContributor
     */
    public function addToIndirectResourceContributor(\DDEX\ERN\ERN_380\IndirectResourceContributorType $indirectResourceContributor)
    {
     ...
     * A Composite containing details of an indirect Contributor to the SoundRecording.
     *
     * @return \DDEX\ERN\ERN_380\IndirectResourceContributorType[]
     */
     ...
     * A Composite containing details of Identifiers of a License, Claim, RightShare or contract for the MusicalWork(s) used in the SoundRecording.
     *
     * @return \DDEX\ERN\ERN_380\RightsAgreementIdType
     */
     ...
     * A Composite containing details of Identifiers of a License, Claim, RightShare or contract for the MusicalWork(s) used in the SoundRecording.
     *
     * @param \DDEX\ERN\ERN_380\RightsAgreementIdType $rightsAgreementId
     * @return self
     */
    public function setRightsAgreementId(?\DDEX\ERN\ERN_380\RightsAgreementIdType $rightsAgreementId = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\NameType $displayArtistName
     */
    public function addToDisplayArtistName(\DDEX\ERN\ERN_380\NameType $displayArtistName)
    {
     ...
     * A Composite containing the Name to be used by a DSP when presenting Artist details of the Resource to a Consumer. A Resource-level DisplayArtistName shall only be provided if it differs from the DisplayArtistName for a Release that contains the Resource and is communicated in the same XML message.
     *
     * @return \DDEX\ERN\ERN_380\NameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\LabelNameType $labelName
     */
    public function addToLabelName(\DDEX\ERN\ERN_380\LabelNameType $labelName)
    {
     ...
     * A Composite containing the Name of the Label under which the Release is to be marketed. The use of multiple LabelNames is discouraged unless used to communicate label names in different languages and/or scripts.
     *
     * @return \DDEX\ERN\ERN_380\LabelNameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\TypedRightsControllerType $rightsController
     */
    public function addToRightsController(\DDEX\ERN\ERN_380\TypedRightsControllerType $rightsController)
    {
     ...
     * A Composite containing details of RightsController of Rights in the Video.
     *
     * @return \DDEX\ERN\ERN_380\TypedRightsControllerType[]
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the SoundRecording was re-mastered (usually digitally). This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @return \DDEX\ERN\ERN_380\EventDateType
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the SoundRecording was re-mastered (usually digitally). This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_380\EventDateType $remasteredDate
     * @return self
     */
    public function setRemasteredDate(?\DDEX\ERN\ERN_380\EventDateType $remasteredDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the SoundRecording was published, whether for physical or electronic/online distribution. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_380\EventDateType $resourceReleaseDate
     * @return self
     */
    public function setResourceReleaseDate(?\DDEX\ERN\ERN_380\EventDateType $resourceReleaseDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the SoundRecording was originally published, whether for physical or electronic/online distribution. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_380\EventDateType $originalResourceReleaseDate
     * @return self
     */
    public function setOriginalResourceReleaseDate(?\DDEX\ERN\ERN_380\EventDateType $originalResourceReleaseDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\PLineType $pLine
     */
    public function addToPLine(\DDEX\ERN\ERN_380\PLineType $pLine)
    {
        $this->pLine[] = $pLine;
        return $this;
    }
     ...
     * A Composite containing details of the PLine for the SoundRecording.
     *
     * @return \DDEX\ERN\ERN_380\PLineType[]
     */
     ...
     * A Composite containing an Annotation Annotation which acknowledges record companies and/or other Parties giving permission for guests Artists or others featured on the Video.
     *
     * @return \DDEX\ERN\ERN_380\CourtesyLineType
     */
     ...
     * A Composite containing an Annotation Annotation which acknowledges record companies and/or other Parties giving permission for guests Artists or others featured on the Video.
     *
     * @param \DDEX\ERN\ERN_380\CourtesyLineType $courtesyLine
     * @return self
     */
    public function setCourtesyLine(?\DDEX\ERN\ERN_380\CourtesyLineType $courtesyLine = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\HostSoundCarrierType $hostSoundCarrier
     */
    public function addToHostSoundCarrier(\DDEX\ERN\ERN_380\HostSoundCarrierType $hostSoundCarrier)
    {
     ...
     * A Composite containing details of a HostSoundCarrier on which the Video appears (e.g., the CD on which it was originally released). This Composite exists in the Release Notification Message Suite Standard, to support the identification and matching of Video information.
     *
     * @return \DDEX\ERN\ERN_380\HostSoundCarrierType[]
     */
     ...
     * A Composite containing a Comment about the promotion and marketing of the Video.
     *
     * @return \DDEX\ERN\ERN_380\CommentType
     */
     ...
     * A Composite containing a Comment about the promotion and marketing of the Video.
     *
     * @param \DDEX\ERN\ERN_380\CommentType $marketingComment
     * @return self
     */
    public function setMarketingComment(?\DDEX\ERN\ERN_380\CommentType $marketingComment = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\GenreType $genre
     */
    public function addToGenre(\DDEX\ERN\ERN_380\GenreType $genre)
    {
        $this->genre[] = $genre;
        return $this;
    }
     ...
     * A Composite containing details of a Genre to which the Video belongs.
     *
     * @return \DDEX\ERN\ERN_380\GenreType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\ParentalWarningTypeType $parentalWarningType
     */
    public function addToParentalWarningType(\DDEX\ERN\ERN_380\ParentalWarningTypeType $parentalWarningType)
    {
     ...
     * A Composite containing details of the classification of the Video according to advice which it carries about the level of explicitness or offensiveness of its content.
     *
     * @return \DDEX\ERN\ERN_380\ParentalWarningTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\AvRatingType $avRating
     */
    public function addToAvRating(\DDEX\ERN\ERN_380\AvRatingType $avRating)
    {
     ...
     * A Composite containing details of a rating for the Video.
     *
     * @return \DDEX\ERN\ERN_380\AvRatingType[]
     */
     ...
     * A Composite containing details of a FulfillmentDate.
     *
     * @return \DDEX\ERN\ERN_380\FulfillmentDateType
     */
     ...
     * A Composite containing details of a FulfillmentDate.
     *
     * @param \DDEX\ERN\ERN_380\FulfillmentDateType $fulfillmentDate
     * @return self
     */
    public function setFulfillmentDate(?\DDEX\ERN\ERN_380\FulfillmentDateType $fulfillmentDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\KeywordsType $keywords
     */
    public function addToKeywords(\DDEX\ERN\ERN_380\KeywordsType $keywords)
    {
     ...
     * A Composite containing details of a Description of the Video containing Keywords.
     *
     * @return \DDEX\ERN\ERN_380\KeywordsType[]
     */
     ...
     * A Composite containing details of a Synopsis of the Video.
     *
     * @return \DDEX\ERN\ERN_380\SynopsisType
     */
     ...
     * A Composite containing details of a Synopsis of the Video.
     *
     * @param \DDEX\ERN\ERN_380\SynopsisType $synopsis
     * @return self
     */
    public function setSynopsis(?\DDEX\ERN\ERN_380\SynopsisType $synopsis = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\CLineType $cLine
     */
    public function addToCLine(\DDEX\ERN\ERN_380\CLineType $cLine)
    {
        $this->cLine[] = $cLine;
        return $this;
    }
     ...
     * A Composite containing details of the CLine for the Video.
     *
     * @return \DDEX\ERN\ERN_380\CLineType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\TechnicalVideoDetailsType $technicalVideoDetails
     */
    public function addToTechnicalVideoDetails(\DDEX\ERN\ERN_380\TechnicalVideoDetailsType $technicalVideoDetails)
    {
     ...
     * A Composite containing technical details of the Video.
     *
     * @return \DDEX\ERN\ERN_380\TechnicalVideoDetailsType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\CharacterType $character
     */
    public function addToCharacter(\DDEX\ERN\ERN_380\CharacterType $character)
    {
     ...
     * A Composite containing details of a Character in the Video. A Character may be described through Name, Identifier and Roles.
     *
     * @return \DDEX\ERN\ERN_380\CharacterType[]
     */
