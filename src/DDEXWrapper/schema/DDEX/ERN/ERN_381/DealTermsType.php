...
class DealTermsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_381\CommercialModelTypeType[] $commercialModelType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\UsageType[] $usage
     */
    private $usage = [
     ...
     *
     * @var \DDEX\ERN\ERN_381\DSPType[] $distributionChannel
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\DSPType[] $excludedDistributionChannel
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\PriceInformationType[] $priceInformation
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\PromotionalCodeType $promotionalCode
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\PeriodType[] $validityPeriod
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\ConsumerRentalPeriodType $consumerRentalPeriod
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\EventDateType $preOrderReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\EventDateType $preOrderPreviewDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\DealResourceReferenceListType $preOrderIncentiveResourceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\DealResourceReferenceListType $instantGratificationResourceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\RelatedReleaseOfferSetType[] $relatedReleaseOfferSet
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\PhysicalReturnsType $physicalReturns
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\RightsClaimPolicyType[] $rightsClaimPolicy
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\WebPolicyType[] $webPolicy
     */
    private $webPolicy = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\CommercialModelTypeType $commercialModelType
     */
    public function addToCommercialModelType(\DDEX\ERN\ERN_381\CommercialModelTypeType $commercialModelType)
    {
     ...
     * A Composite containing details of the fundamental business model which applies to the Deal (e.g. SubscriptionModel and PayAsYouGoModel). The CommercialModelType indicates how the Consumer pays for the Service or Release.
     *
     * @return \DDEX\ERN\ERN_381\CommercialModelTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\UsageType $usage
     */
    public function addToUsage(\DDEX\ERN\ERN_381\UsageType $usage)
    {
        $this->usage[] = $usage;
        return $this;
    }
     ...
     * A Composite containing the Types and number of Usages applicable to a Release to which the Deal applies.
     *
     * @return \DDEX\ERN\ERN_381\UsageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\DSPType $distributionChannel
     */
    public function addToDistributionChannel(\DDEX\ERN\ERN_381\DSPType $distributionChannel)
    {
     ...
     * A Composite containing details of the DSP through whose DistributionChannel the sales are permitted. If none are provided no limitations on the DistributionChannels are given.
     *
     * @return \DDEX\ERN\ERN_381\DSPType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\DSPType $excludedDistributionChannel
     */
    public function addToExcludedDistributionChannel(\DDEX\ERN\ERN_381\DSPType $excludedDistributionChannel)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\PriceInformationType $priceInformation
     */
    public function addToPriceInformation(\DDEX\ERN\ERN_381\PriceInformationType $priceInformation)
    {
     ...
     * A Composite containing details of a Price. Note that this Price applies to all UseTypes referenced in this Composite.
     *
     * @return \DDEX\ERN\ERN_381\PriceInformationType[]
     */
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @return \DDEX\ERN\ERN_381\PromotionalCodeType
     */
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @param \DDEX\ERN\ERN_381\PromotionalCodeType $promotionalCode
     * @return self
     */
    public function setPromotionalCode(?\DDEX\ERN\ERN_381\PromotionalCodeType $promotionalCode = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\PeriodType $validityPeriod
     */
    public function addToValidityPeriod(\DDEX\ERN\ERN_381\PeriodType $validityPeriod)
    {
     ...
     * A Composite containing details about a Period of Time during which the Deal is valid. No StartDate in this Composite means that the Deal is valid as per contractual relationship between MessageSender and MessageRecipient. No EndDate in this Composite means that the Deal is valid until further notice.
     *
     * @return \DDEX\ERN\ERN_381\PeriodType[]
     */
     ...
     * A Composite containing details of a Period the DSP may rent something to a Customer.
     *
     * @return \DDEX\ERN\ERN_381\ConsumerRentalPeriodType
     */
     ...
     * A Composite containing details of a Period the DSP may rent something to a Customer.
     *
     * @param \DDEX\ERN\ERN_381\ConsumerRentalPeriodType $consumerRentalPeriod
     * @return self
     */
    public function setConsumerRentalPeriod(?\DDEX\ERN\ERN_381\ConsumerRentalPeriodType $consumerRentalPeriod = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the related Release is made available for pre-ordering. This element is not applicable on Track Releases. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_381\EventDateType $preOrderReleaseDate
     * @return self
     */
    public function setPreOrderReleaseDate(?\DDEX\ERN\ERN_381\EventDateType $preOrderReleaseDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the pre-ordered Release is made first available for previewing (it overrides the generic ReleaseDisplayStartDate if supplied). If no PreOrderPreviewDate is provided, the StartDate for the Deal is used instead. The PreOrderPreviewDate may not be later than the StartDate for the Deal. This element has been deprecated and may be deleted in a future version of this message. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_381\EventDateType $preOrderPreviewDate
     * @return self
     */
    public function setPreOrderPreviewDate(?\DDEX\ERN\ERN_381\EventDateType $preOrderPreviewDate = null)
    {
     ...
     * A Composite containing details of one or more Resources that are only available when the Release is purchased during a pre-order period (delivery is typically at ReleaseDate).
     *
     * @return \DDEX\ERN\ERN_381\DealResourceReferenceListType
     */
     ...
     * A Composite containing details of one or more Resources that are only available when the Release is purchased during a pre-order period (delivery is typically at ReleaseDate).
     *
     * @param \DDEX\ERN\ERN_381\DealResourceReferenceListType $preOrderIncentiveResourceList
     * @return self
     */
    public function setPreOrderIncentiveResourceList(?\DDEX\ERN\ERN_381\DealResourceReferenceListType $preOrderIncentiveResourceList = null)
    {
     ...
     * A Composite containing details of one or more Resources that are only available for download as soon as the Release is purchased (i.e. before the ReleaseDate).
     *
     * @param \DDEX\ERN\ERN_381\DealResourceReferenceListType $instantGratificationResourceList
     * @return self
     */
    public function setInstantGratificationResourceList(?\DDEX\ERN\ERN_381\DealResourceReferenceListType $instantGratificationResourceList = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\RelatedReleaseOfferSetType $relatedReleaseOfferSet
     */
    public function addToRelatedReleaseOfferSet(\DDEX\ERN\ERN_381\RelatedReleaseOfferSetType $relatedReleaseOfferSet)
    {
     ...
     * A Composite containing details of one or more offers related to the Release.
     *
     * @return \DDEX\ERN\ERN_381\RelatedReleaseOfferSetType[]
     */
     ...
     * A Composite containing details of physical returns.
     *
     * @return \DDEX\ERN\ERN_381\PhysicalReturnsType
     */
     ...
     * A Composite containing details of physical returns.
     *
     * @param \DDEX\ERN\ERN_381\PhysicalReturnsType $physicalReturns
     * @return self
     */
    public function setPhysicalReturns(?\DDEX\ERN\ERN_381\PhysicalReturnsType $physicalReturns = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\RightsClaimPolicyType $rightsClaimPolicy
     */
    public function addToRightsClaimPolicy(\DDEX\ERN\ERN_381\RightsClaimPolicyType $rightsClaimPolicy)
    {
     ...
     * A Composite containing details of a rights claim policy.
     *
     * @return \DDEX\ERN\ERN_381\RightsClaimPolicyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\WebPolicyType $webPolicy
     */
    public function addToWebPolicy(\DDEX\ERN\ERN_381\WebPolicyType $webPolicy)
    {
     ...
     * A Composite containing details of UserGeneratedContent permissions.
     *
     * @return \DDEX\ERN\ERN_381\WebPolicyType[]
     */
