...
class PerformanceType
{
     ...
     *
     * @var \DDEX\ERN\ERN_381\AllTerritoryCodeType $territory
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\EventDateType $date
     */
    private $date = null;
     ...
     * The territory of the Performance.
     *
     * @param \DDEX\ERN\ERN_381\AllTerritoryCodeType $territory
     * @return self
     */
    public function setTerritory(?\DDEX\ERN\ERN_381\AllTerritoryCodeType $territory = null)
    {
     ...
     * A Composite containing details of the Date of the Performance. This is a string with the syntax YYYY[-MM[-DD]]. The Place of the Performance should not be specified in the TerritoryCode and LocationDescription attributes. Instead, the sibling Territory element should be used.
     *
     * @param \DDEX\ERN\ERN_381\EventDateType $date
     * @return self
     */
    public function setDate(?\DDEX\ERN\ERN_381\EventDateType $date = null)
    {
        $this->date = $date;
        return $this;
    }
