...
class ReleaseDetailsByTerritoryType
{
     ...
     *
     * @var \DDEX\ERN\ERN_381\AdministratingRecordCompanyType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\ReleaseTypeType[] $releaseType
     */
    private $releaseType = [
     ...
     *
     * @var \DDEX\ERN\ERN_381\RelatedReleaseType[] $relatedRelease
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\ResourceGroupType[] $resourceGroup
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\EventDateType $releaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\EventDateType $originalReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\EventDateType $originalDigitalReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\DescriptionType[] $fileAvailabilityDescription
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\FileType[] $file
     */
    private $file = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\AdministratingRecordCompanyType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DDEX\ERN\ERN_381\AdministratingRecordCompanyType $administratingRecordCompany)
    {
     ...
     * A Composite containing details of the AdministratingRecordCompany for the Release.
     *
     * @return \DDEX\ERN\ERN_381\AdministratingRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\ReleaseTypeType $releaseType
     */
    public function addToReleaseType(\DDEX\ERN\ERN_381\ReleaseTypeType $releaseType)
    {
     ...
     * A Composite containing details of the form in which a ReleaseCreator anticipates offering the Release to Consumers. This overrides the ReleaseType specified globally for the Release.
     *
     * @return \DDEX\ERN\ERN_381\ReleaseTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DDEX\ERN\ERN_381\RelatedReleaseType $relatedRelease)
    {
     ...
     * A Composite containing details of a Release (or a PhysicalProduct or a DigitalProduct derived from such a Release) which is related to this Release.
     *
     * @return \DDEX\ERN\ERN_381\RelatedReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\ResourceGroupType $resourceGroup
     */
    public function addToResourceGroup(\DDEX\ERN\ERN_381\ResourceGroupType $resourceGroup)
    {
     ...
     * A Composite containing details of a group of some or all of the Resources in the Release. ResourceGroups are used to signal groupings or sequences of Resources within a Release. Examples include individual carriers in a multi-carrier Release or classical Work groupings as well as the default order of Resources within a Release.
     *
     * @return \DDEX\ERN\ERN_381\ResourceGroupType[]
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY[-MM[-DD]]).
     *
     * @param \DDEX\ERN\ERN_381\EventDateType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DDEX\ERN\ERN_381\EventDateType $releaseDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the collection of tracks for the Release (e.g. the equivalent physical album on vinyl) was or will be first made available for Usage, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY[-MM[-DD]]).
     *
     * @param \DDEX\ERN\ERN_381\EventDateType $originalReleaseDate
     * @return self
     */
    public function setOriginalReleaseDate(?\DDEX\ERN\ERN_381\EventDateType $originalReleaseDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available in electronic/online format for Usage (in ISO 8601:2004 format: YYYY-MM-DD). This element is deprecated. DDEX advises that it may be removed at a future date and therefore recommends against using it.
     *
     * @param \DDEX\ERN\ERN_381\EventDateType $originalDigitalReleaseDate
     * @return self
     */
    public function setOriginalDigitalReleaseDate(?\DDEX\ERN\ERN_381\EventDateType $originalDigitalReleaseDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\DescriptionType $fileAvailabilityDescription
     */
    public function addToFileAvailabilityDescription(\DDEX\ERN\ERN_381\DescriptionType $fileAvailabilityDescription)
    {
     ...
     * A Composite containing a Description providing details of how a DSP can obtain any related Release File.
     *
     * @return \DDEX\ERN\ERN_381\DescriptionType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\FileType $file
     */
    public function addToFile(\DDEX\ERN\ERN_381\FileType $file)
    {
        $this->file[] = $file;
        return $this;
    }
     ...
     * A Composite containing details of a related Release File that a DSP can obtain.
     *
     * @return \DDEX\ERN\ERN_381\FileType[]
     */
