...
class ResourceListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_381\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *
     * @var \DDEX\ERN\ERN_381\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DDEX\ERN\ERN_381\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DDEX\ERN\ERN_381\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DDEX\ERN\ERN_381\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DDEX\ERN\ERN_381\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @var \DDEX\ERN\ERN_381\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\ERN\ERN_381\SoundRecordingType $soundRecording)
    {
     ...
     * A Composite containing details of a SoundRecording.
     *
     * @return \DDEX\ERN\ERN_381\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\MIDIType $mIDI
     */
    public function addToMIDI(\DDEX\ERN\ERN_381\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     * A Composite containing details of a MIDI.
     *
     * @return \DDEX\ERN\ERN_381\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\VideoType $video
     */
    public function addToVideo(\DDEX\ERN\ERN_381\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A Composite containing details of a Video.
     *
     * @return \DDEX\ERN\ERN_381\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\ImageType $image
     */
    public function addToImage(\DDEX\ERN\ERN_381\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A Composite containing details of an Image.
     *
     * @return \DDEX\ERN\ERN_381\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\TextType $text
     */
    public function addToText(\DDEX\ERN\ERN_381\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A Composite containing details of a Text.
     *
     * @return \DDEX\ERN\ERN_381\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\ERN\ERN_381\SheetMusicType $sheetMusic)
    {
     ...
     * A Composite containing details of a SheetMusic.
     *
     * @return \DDEX\ERN\ERN_381\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\SoftwareType $software
     */
    public function addToSoftware(\DDEX\ERN\ERN_381\SoftwareType $software)
    {
     ...
     * A Composite containing details of an item of Software.
     *
     * @return \DDEX\ERN\ERN_381\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DDEX\ERN\ERN_381\UserDefinedResourceType $userDefinedResource)
    {
     ...
     * A Composite containing details of a UserDefinedResource.
     *
     * @return \DDEX\ERN\ERN_381\UserDefinedResourceType[]
     */
