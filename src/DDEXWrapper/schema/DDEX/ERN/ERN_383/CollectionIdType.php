...
class CollectionIdType
{
     ...
     *
     * @var \DDEX\ERN\ERN_383\ICPNType $iCPN
     */
    private $iCPN = null;
     ...
     *
     * @var \DDEX\ERN\ERN_383\CatalogNumberType $catalogNumber
     */
     ...
     *  messaging).
     *
     * @var \DDEX\ERN\ERN_383\ProprietaryIdType[] $proprietaryId
     */
     ...
     *  the syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @return \DDEX\ERN\ERN_383\ICPNType
     */
     ...
     *  the syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @param \DDEX\ERN\ERN_383\ICPNType $iCPN
     * @return self
     */
    public function setICPN(?\DDEX\ERN\ERN_383\ICPNType $iCPN = null)
    {
        $this->iCPN = $iCPN;
        return $this;
    }
     ...
     *  CatalogNumber of the Collection.
     *
     * @return \DDEX\ERN\ERN_383\CatalogNumberType
     */
     ...
     *  CatalogNumber of the Collection.
     *
     * @param \DDEX\ERN\ERN_383\CatalogNumberType $catalogNumber
     * @return self
     */
    public function setCatalogNumber(?\DDEX\ERN\ERN_383\CatalogNumberType $catalogNumber = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\ProprietaryIdType $proprietaryId
     */
    public function addToProprietaryId(\DDEX\ERN\ERN_383\ProprietaryIdType $proprietaryId)
    {
     ...
     *  messaging).
     *
     * @return \DDEX\ERN\ERN_383\ProprietaryIdType[]
     */
