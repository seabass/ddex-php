...
class CollectionListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_383\CollectionType[] $collection
     */
    private $collection = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\CollectionType $collection
     */
    public function addToCollection(\DDEX\ERN\ERN_383\CollectionType $collection)
    {
     ...
     *  Collection contained in a Resource.
     *
     * @return \DDEX\ERN\ERN_383\CollectionType[]
     */
