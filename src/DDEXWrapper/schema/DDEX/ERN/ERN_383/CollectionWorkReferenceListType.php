...
class CollectionWorkReferenceListType
{
     ...
     *  Message).
     *
     * @var \DDEX\ERN\ERN_383\CollectionWorkReferenceType[] $collectionWorkReference
     */
     ...
     */
    public function addToCollectionWorkReference(\DDEX\ERN\ERN_383\CollectionWorkReferenceType $collectionWorkReference)
    {
