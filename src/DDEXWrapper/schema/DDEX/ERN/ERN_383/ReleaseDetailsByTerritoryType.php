...
class ReleaseDetailsByTerritoryType
{
     ...
     *
     * @var \DDEX\ERN\ERN_383\AdministratingRecordCompanyType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DDEX\ERN\ERN_383\ReleaseTypeType[] $releaseType
     */
    private $releaseType = [
     ...
     *
     * @var \DDEX\ERN\ERN_383\RelatedReleaseType[] $relatedRelease
     */
     ...
     *
     * @var \DDEX\ERN\ERN_383\ResourceGroupType[] $resourceGroup
     */
     ...
     *
     * @var \DDEX\ERN\ERN_383\EventDateType $releaseDate
     */
     ...
     *  YYYY[-MM[-DD]]).
     *
     * @var \DDEX\ERN\ERN_383\EventDateType $originalReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_383\EventDateType $originalDigitalReleaseDate
     */
     ...
     *  File.
     *
     * @var \DDEX\ERN\ERN_383\DescriptionType[] $fileAvailabilityDescription
     */
     ...
     *
     * @var \DDEX\ERN\ERN_383\FileType[] $file
     */
    private $file = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\AdministratingRecordCompanyType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DDEX\ERN\ERN_383\AdministratingRecordCompanyType $administratingRecordCompany)
    {
     ...
     *  AdministratingRecordCompany for the Release.
     *
     * @return \DDEX\ERN\ERN_383\AdministratingRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\ReleaseTypeType $releaseType
     */
    public function addToReleaseType(\DDEX\ERN\ERN_383\ReleaseTypeType $releaseType)
    {
     ...
     *  overrides the ReleaseType specified globally for the Release.
     *
     * @return \DDEX\ERN\ERN_383\ReleaseTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DDEX\ERN\ERN_383\RelatedReleaseType $relatedRelease)
    {
     ...
     *  which is related to this Release.
     *
     * @return \DDEX\ERN\ERN_383\RelatedReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\ResourceGroupType $resourceGroup
     */
    public function addToResourceGroup(\DDEX\ERN\ERN_383\ResourceGroupType $resourceGroup)
    {
     ...
     *  default order of Resources within a Release.
     *
     * @return \DDEX\ERN\ERN_383\ResourceGroupType[]
     */
     ...
     *  distribution (in ISO 8601:2004 format: YYYY[-MM[-DD]]).
     *
     * @param \DDEX\ERN\ERN_383\EventDateType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DDEX\ERN\ERN_383\EventDateType $releaseDate = null)
    {
     ...
     *  YYYY[-MM[-DD]]).
     *
     * @param \DDEX\ERN\ERN_383\EventDateType $originalReleaseDate
     * @return self
     */
    public function setOriginalReleaseDate(?\DDEX\ERN\ERN_383\EventDateType $originalReleaseDate = null)
    {
     ...
     *  therefore recommends against using it.
     *
     * @param \DDEX\ERN\ERN_383\EventDateType $originalDigitalReleaseDate
     * @return self
     */
    public function setOriginalDigitalReleaseDate(?\DDEX\ERN\ERN_383\EventDateType $originalDigitalReleaseDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\DescriptionType $fileAvailabilityDescription
     */
    public function addToFileAvailabilityDescription(\DDEX\ERN\ERN_383\DescriptionType $fileAvailabilityDescription)
    {
     ...
     *  File.
     *
     * @return \DDEX\ERN\ERN_383\DescriptionType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\FileType $file
     */
    public function addToFile(\DDEX\ERN\ERN_383\FileType $file)
    {
        $this->file[] = $file;
        return $this;
    }
     ...
     *  related Release File that a DSP can obtain.
     *
     * @return \DDEX\ERN\ERN_383\FileType[]
     */
