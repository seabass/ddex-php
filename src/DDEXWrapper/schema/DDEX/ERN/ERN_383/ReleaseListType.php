...
class ReleaseListType
{
     ...
     *  Release.
     *
     * @var \DDEX\ERN\ERN_383\ReleaseType[] $release
     */
    private $release = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\ReleaseType $release
     */
    public function addToRelease(\DDEX\ERN\ERN_383\ReleaseType $release)
    {
     ...
     *  Release.
     *
     * @return \DDEX\ERN\ERN_383\ReleaseType[]
     */
