...
class SoundRecordingCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DDEX\ERN\ERN_383\SoundRecordingCollectionReferenceType[] $soundRecordingCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference
     */
    public function addToSoundRecordingCollectionReference(\DDEX\ERN\ERN_383\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DDEX\ERN\ERN_383\SoundRecordingCollectionReferenceType[]
     */
