...
class ChapterType
{
     ...
     *
     * @var \DDEX\ERN\ERN_400\ProprietaryIdType[] $chapterId
     */
    private $chapterId = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\ProprietaryIdType $chapterId
     */
    public function addToChapterId(\DDEX\ERN\ERN_400\ProprietaryIdType $chapterId)
    {
