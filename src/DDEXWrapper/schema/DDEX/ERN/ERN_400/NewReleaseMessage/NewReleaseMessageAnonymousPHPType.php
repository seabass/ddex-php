...
namespace DDEX\ERN\ERN_400\NewReleaseMessage;
...
class NewReleaseMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_400\PartyType[] $partyList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\DetailedCueSheetType[] $cueSheetList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\ResourceListType $resourceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\ChapterListType $chapterList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\ReleaseListType $releaseList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\ReleaseDealType[] $dealList
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\PartyType $party
     */
    public function addToPartyList(\DDEX\ERN\ERN_400\PartyType $party)
    {
     ...
     * A Composite containing details of one or more Parties relating to the reported MusicalWorks.
     *
     * @return \DDEX\ERN\ERN_400\PartyType[]
     */
     ...
     * A Composite containing details of one or more Parties relating to the reported MusicalWorks.
     *
     * @param \DDEX\ERN\ERN_400\PartyType[] $partyList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\DetailedCueSheetType $cueSheet
     */
    public function addToCueSheetList(\DDEX\ERN\ERN_400\DetailedCueSheetType $cueSheet)
    {
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_400\DetailedCueSheetType[]
     */
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_400\DetailedCueSheetType[] $cueSheetList
     * @return self
     */
     ...
     * A Composite containing details of one or more Resources.
     *
     * @return \DDEX\ERN\ERN_400\ResourceListType
     */
     ...
     * A Composite containing details of one or more Resources.
     *
     * @param \DDEX\ERN\ERN_400\ResourceListType $resourceList
     * @return self
     */
    public function setResourceList(\DDEX\ERN\ERN_400\ResourceListType $resourceList)
    {
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_400\ChapterListType
     */
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_400\ChapterListType $chapterList
     * @return self
     */
    public function setChapterList(?\DDEX\ERN\ERN_400\ChapterListType $chapterList = null)
    {
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_400\ReleaseListType
     */
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_400\ReleaseListType $releaseList
     * @return self
     */
    public function setReleaseList(\DDEX\ERN\ERN_400\ReleaseListType $releaseList)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\ReleaseDealType $releaseDeal
     */
    public function addToDealList(\DDEX\ERN\ERN_400\ReleaseDealType $releaseDeal)
    {
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @return \DDEX\ERN\ERN_400\ReleaseDealType[]
     */
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @param \DDEX\ERN\ERN_400\ReleaseDealType[] $dealList
     * @return self
     */
