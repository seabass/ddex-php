...
class ReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_400\ReleaseTypeForReleaseNotificationType[] $releaseType
     */
    private $releaseType = [
    ...
    /**
     * A Composite containing the Label for the Release.
     *
     * @var \DDEX\ERN\ERN_400\LabelType[] $label
     */
    private $label = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\AdministratingRecordCompanyWithReferenceType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\EventDateWithDefaultType[] $releaseDate
     */
    private $releaseDate = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\EventDateWithDefaultType[] $originalReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\ResourceGroupType $resourceGroup
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\ExternalResourceLinkType[] $externalResourceLink
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\ReleaseTypeForReleaseNotificationType $releaseType
     */
    public function addToReleaseType(\DDEX\ERN\ERN_400\ReleaseTypeForReleaseNotificationType $releaseType)
    {
     ...
     * A Composite containing details of the form in which a ReleaseCreator anticipates offering the Release to Consumers. The RelaseType is a marketing term and more than one value may be provided.
     *
     * @return \DDEX\ERN\ERN_400\ReleaseTypeForReleaseNotificationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\LabelType $label
     */
    public function addToLabel(\DDEX\ERN\ERN_400\LabelType $label)
    {
        $this->label[] = $label;
        return $this;
    }
     ...
     * A Composite containing the Label for the Release.
     *
     * @return \DDEX\ERN\ERN_400\LabelType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\AdministratingRecordCompanyWithReferenceType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DDEX\ERN\ERN_400\AdministratingRecordCompanyWithReferenceType $administratingRecordCompany)
    {
     ...
     * A Composite containing details of the AdministratingRecordCompany for the Release.
     *
     * @return \DDEX\ERN\ERN_400\AdministratingRecordCompanyWithReferenceType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\EventDateWithDefaultType $releaseDate
     */
    public function addToReleaseDate(\DDEX\ERN\ERN_400\EventDateWithDefaultType $releaseDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY[-MM[-DD]]). This Element is for display and cataloguing purposes only.
     *
     * @return \DDEX\ERN\ERN_400\EventDateWithDefaultType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\EventDateWithDefaultType $originalReleaseDate
     */
    public function addToOriginalReleaseDate(\DDEX\ERN\ERN_400\EventDateWithDefaultType $originalReleaseDate)
    {
     ...
     * A Composite containing details of a group of some or all of the Resources in the Release. ResourceGroups are used to signal groupings or sequences of Resources within a Release. Examples include individual carriers in a multi-carrier Release or classical Work groupings as well as the default order of Resources within a Release. ResourceGroups are typically not used with Releases that contain only one primary Resource such as TrackReleases.
     *
     * @return \DDEX\ERN\ERN_400\ResourceGroupType
     */
     ...
     * A Composite containing details of a group of some or all of the Resources in the Release. ResourceGroups are used to signal groupings or sequences of Resources within a Release. Examples include individual carriers in a multi-carrier Release or classical Work groupings as well as the default order of Resources within a Release. ResourceGroups are typically not used with Releases that contain only one primary Resource such as TrackReleases.
     *
     * @param \DDEX\ERN\ERN_400\ResourceGroupType $resourceGroup
     * @return self
     */
    public function setResourceGroup(\DDEX\ERN\ERN_400\ResourceGroupType $resourceGroup)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\ExternalResourceLinkType $externalResourceLink
     */
    public function addToExternalResourceLink(\DDEX\ERN\ERN_400\ExternalResourceLinkType $externalResourceLink)
    {
     ...
     * A Composite containing details of promotional or other material related to the Release.
     *
     * @return \DDEX\ERN\ERN_400\ExternalResourceLinkType[]
     */
