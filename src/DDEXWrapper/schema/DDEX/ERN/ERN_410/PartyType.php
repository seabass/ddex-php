...
class PartyType
{
     ...
     *
     * @var \DDEX\ERN\ERN_410\PartyNameWithTerritoryType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\ERN\ERN_410\AffiliationType[] $affiliation
     */
    private $affiliation = [
     ...
     *
     * @var \DDEX\ERN\ERN_410\RelatedPartyType[] $relatedParty
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_410\PartyNameWithTerritoryType $partyName
     */
    public function addToPartyName(\DDEX\ERN\ERN_410\PartyNameWithTerritoryType $partyName)
    {
     ...
     * A Composite containing details of the PartyName(s).
     *
     * @return \DDEX\ERN\ERN_410\PartyNameWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_410\AffiliationType $affiliation
     */
    public function addToAffiliation(\DDEX\ERN\ERN_410\AffiliationType $affiliation)
    {
     ...
     * A Composite containing details of an affiliation for the Party.
     *
     * @return \DDEX\ERN\ERN_410\AffiliationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_410\RelatedPartyType $relatedParty
     */
    public function addToRelatedParty(\DDEX\ERN\ERN_410\RelatedPartyType $relatedParty)
    {
     ...
     * A Composite containing details of a PartyRelatedPartyReference referring to a Party that is related to the current Party.
     *
     * @return \DDEX\ERN\ERN_410\RelatedPartyType[]
     */
