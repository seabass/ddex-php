...
class RelatedReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_410\ReleaseRelationshipTypeType $releaseRelationshipType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_410\EventDateWithoutFlagsType $releaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_410\EventDateWithoutFlagsType $originalReleaseDate
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @return \DDEX\ERN\ERN_410\ReleaseRelationshipTypeType
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @param \DDEX\ERN\ERN_410\ReleaseRelationshipTypeType $releaseRelationshipType
     * @return self
     */
    public function setReleaseRelationshipType(\DDEX\ERN\ERN_410\ReleaseRelationshipTypeType $releaseRelationshipType)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the related Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DDEX\ERN\ERN_410\EventDateWithoutFlagsType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DDEX\ERN\ERN_410\EventDateWithoutFlagsType $releaseDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the collection of tracks for the Release (e.g. the equivalent physical album on vinyl) was or will be first made available for Usage, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DDEX\ERN\ERN_410\EventDateWithoutFlagsType $originalReleaseDate
     * @return self
     */
    public function setOriginalReleaseDate(?\DDEX\ERN\ERN_410\EventDateWithoutFlagsType $originalReleaseDate = null)
    {
