...
class ResourceRightsControllerType
{
     ...
     *
     * @var \DDEX\ERN\ERN_410\PercentageType $rightSharePercentage
     */
     ...
     *
     * @var \DDEX\ERN\ERN_410\DelegatedUsageRightsType[] $delegatedUsageRights
     */
     ...
     * The share of the licensed Rights owned by the RightsController. RightShare information is given as a xs:decimal value with up to 6 digits (e.g. '12.5' represents 12.5%). If no information is given, 100% is assumed.
     *
     * @return \DDEX\ERN\ERN_410\PercentageType
     */
     ...
     * The share of the licensed Rights owned by the RightsController. RightShare information is given as a xs:decimal value with up to 6 digits (e.g. '12.5' represents 12.5%). If no information is given, 100% is assumed.
     *
     * @param \DDEX\ERN\ERN_410\PercentageType $rightSharePercentage
     * @return self
     */
    public function setRightSharePercentage(?\DDEX\ERN\ERN_410\PercentageType $rightSharePercentage = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_410\DelegatedUsageRightsType $delegatedUsageRights
     */
    public function addToDelegatedUsageRights(\DDEX\ERN\ERN_410\DelegatedUsageRightsType $delegatedUsageRights)
    {
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated.
     *
     * @return \DDEX\ERN\ERN_410\DelegatedUsageRightsType[]
     */
