...
class ChapterListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\ChapterType[] $chapter
     */
    private $chapter = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\ChapterType $chapter
     */
    public function addToChapter(\DDEX\ERN\ERN_411\ChapterType $chapter)
    {
     ...
     * A Composite containing details of a Chapter contained in a Resource.
     *
     * @return \DDEX\ERN\ERN_411\ChapterType[]
     */
