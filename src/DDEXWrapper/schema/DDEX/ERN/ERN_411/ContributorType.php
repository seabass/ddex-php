...
class ContributorType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\IsCreditedType $isCredited
     */
     ...
     * A Flag indicating whether the Contributor is credited as having played a role in creating the Recording (=true) or not (=false).
     *
     * @return \DDEX\ERN\ERN_411\IsCreditedType
     */
     ...
     * A Flag indicating whether the Contributor is credited as having played a role in creating the Recording (=true) or not (=false).
     *
     * @param \DDEX\ERN\ERN_411\IsCreditedType $isCredited
     * @return self
     */
    public function setIsCredited(?\DDEX\ERN\ERN_411\IsCreditedType $isCredited = null)
    {
