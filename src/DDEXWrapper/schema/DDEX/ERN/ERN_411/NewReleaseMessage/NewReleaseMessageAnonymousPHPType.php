...
namespace DDEX\ERN\ERN_411\NewReleaseMessage;
...
class NewReleaseMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\MessageHeaderType $messageHeader
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\PartyType[] $partyList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\DetailedCueSheetType[] $cueSheetList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\ResourceListType $resourceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\ChapterListType $chapterList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\ReleaseListType $releaseList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\ReleaseDealType[] $dealList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\FileType[] $supplementalDocumentList
     */
     ...
     * The MessageHeader for the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_411\MessageHeaderType
     */
     ...
     * The MessageHeader for the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_411\MessageHeaderType $messageHeader
     * @return self
     */
    public function setMessageHeader(\DDEX\ERN\ERN_411\MessageHeaderType $messageHeader)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\PartyType $party
     */
    public function addToPartyList(\DDEX\ERN\ERN_411\PartyType $party)
    {
     ...
     * A Composite containing details of one or more Parties relating to the reported MusicalWorks.
     *
     * @return \DDEX\ERN\ERN_411\PartyType[]
     */
     ...
     * A Composite containing details of one or more Parties relating to the reported MusicalWorks.
     *
     * @param \DDEX\ERN\ERN_411\PartyType[] $partyList
     * @return self
     */
     ...
     */
    public function addToCueSheetList(\DDEX\ERN\ERN_411\DetailedCueSheetType $cueSheet)
    {
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_411\DetailedCueSheetType[] $cueSheetList
     * @return self
     */
     ...
     * A Composite containing details of one or more Resources.
     *
     * @return \DDEX\ERN\ERN_411\ResourceListType
     */
     ...
     * A Composite containing details of one or more Resources.
     *
     * @param \DDEX\ERN\ERN_411\ResourceListType $resourceList
     * @return self
     */
    public function setResourceList(\DDEX\ERN\ERN_411\ResourceListType $resourceList)
    {
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_411\ChapterListType
     */
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_411\ChapterListType $chapterList
     * @return self
     */
    public function setChapterList(?\DDEX\ERN\ERN_411\ChapterListType $chapterList = null)
    {
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_411\ReleaseListType
     */
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_411\ReleaseListType $releaseList
     * @return self
     */
    public function setReleaseList(\DDEX\ERN\ERN_411\ReleaseListType $releaseList)
    {
     ...
     */
    public function addToDealList(\DDEX\ERN\ERN_411\ReleaseDealType $releaseDeal)
    {
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @param \DDEX\ERN\ERN_411\ReleaseDealType[] $dealList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\FileType $supplementalDocument
     */
    public function addToSupplementalDocumentList(\DDEX\ERN\ERN_411\FileType $supplementalDocument)
    {
     ...
     * A Composite containing details of one or more XML documents communicated with the Message.
     *
     * @param \DDEX\ERN\ERN_411\FileType[] $supplementalDocumentList
     * @return self
     */
