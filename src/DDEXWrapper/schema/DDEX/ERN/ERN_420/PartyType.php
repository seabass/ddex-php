...
class PartyType
{
     ...
     *
     * @var \DDEX\ERN\ERN_420\PartyNameWithTerritoryType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\AffiliationType[] $affiliation
     */
    private $affiliation = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\RelatedPartyType[] $relatedParty
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\PartyNameWithTerritoryType $partyName
     */
    public function addToPartyName(\DDEX\ERN\ERN_420\PartyNameWithTerritoryType $partyName)
    {
     ...
     * A Composite containing details of the PartyName(s).
     *
     * @return \DDEX\ERN\ERN_420\PartyNameWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\AffiliationType $affiliation
     */
    public function addToAffiliation(\DDEX\ERN\ERN_420\AffiliationType $affiliation)
    {
     ...
     * A Composite containing details of an affiliation for the Party.
     *
     * @return \DDEX\ERN\ERN_420\AffiliationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\RelatedPartyType $relatedParty
     */
    public function addToRelatedParty(\DDEX\ERN\ERN_420\RelatedPartyType $relatedParty)
    {
     ...
     * A Composite containing details of a PartyRelatedPartyReference referring to a Party that is related to the current Party. This can be used to express, for instance, relationships between a band and its members or between a label and its parent company.
     *
     * @return \DDEX\ERN\ERN_420\RelatedPartyType[]
     */
