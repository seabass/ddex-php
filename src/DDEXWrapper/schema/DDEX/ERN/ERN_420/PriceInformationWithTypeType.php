...
class PriceInformationWithTypeType
{
     ...
     *
     * @var \DDEX\ERN\ERN_420\PriceTypeType $priceCode
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\PriceType $wholesalePricePerUnit
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\PriceType $bulkOrderWholesalePricePerUnit
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\PriceType $suggestedRetailPrice
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @return \DDEX\ERN\ERN_420\PriceTypeType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @param \DDEX\ERN\ERN_420\PriceTypeType $priceCode
     * @return self
     */
    public function setPriceCode(?\DDEX\ERN\ERN_420\PriceTypeType $priceCode = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @return \DDEX\ERN\ERN_420\PriceType
     */
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @param \DDEX\ERN\ERN_420\PriceType $wholesalePricePerUnit
     * @return self
     */
    public function setWholesalePricePerUnit(?\DDEX\ERN\ERN_420\PriceType $wholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit, which informs the informs the DSP of the Price the Release should be offered at. Note that the size of a bulk order is defined in the contract between MessageSender and the MessageRecipient. This element should not be combined with PriceType.
     *
     * @param \DDEX\ERN\ERN_420\PriceType $bulkOrderWholesalePricePerUnit
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnit(?\DDEX\ERN\ERN_420\PriceType $bulkOrderWholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a suggested retail Price.
     *
     * @param \DDEX\ERN\ERN_420\PriceType $suggestedRetailPrice
     * @return self
     */
    public function setSuggestedRetailPrice(?\DDEX\ERN\ERN_420\PriceType $suggestedRetailPrice = null)
    {
