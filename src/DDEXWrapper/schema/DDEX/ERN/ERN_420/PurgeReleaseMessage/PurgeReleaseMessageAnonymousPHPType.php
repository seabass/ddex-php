...
namespace DDEX\ERN\ERN_420\PurgeReleaseMessage;
...
class PurgeReleaseMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_420\PurgedReleaseType $purgedRelease
     */
     ...
     * A Composite containing details of a DDEX Release to be purged.
     *
     * @return \DDEX\ERN\ERN_420\PurgedReleaseType
     */
     ...
     * A Composite containing details of a DDEX Release to be purged.
     *
     * @param \DDEX\ERN\ERN_420\PurgedReleaseType $purgedRelease
     * @return self
     */
    public function setPurgedRelease(\DDEX\ERN\ERN_420\PurgedReleaseType $purgedRelease)
    {
