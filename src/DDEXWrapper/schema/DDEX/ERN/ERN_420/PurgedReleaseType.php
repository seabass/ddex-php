...
class PurgedReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_420\TitleType[] $title
     */
    private $title = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\DetailedResourceContributorType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\TitleType $title
     */
    public function addToTitle(\DDEX\ERN\ERN_420\TitleType $title)
    {
        $this->title[] = $title;
        return $this;
    }
     ...
     * A Composite containing details of a Title of the Release.
     *
     * @return \DDEX\ERN\ERN_420\TitleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\DetailedResourceContributorType $contributor
     */
    public function addToContributor(\DDEX\ERN\ERN_420\DetailedResourceContributorType $contributor)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @return \DDEX\ERN\ERN_420\DetailedResourceContributorType[]
     */
