...
class RelatedResourceType
{
     ...
     *
     * @var \DDEX\ERN\ERN_420\TimingType[] $timing
     */
    private $timing = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\TimingType $timing
     */
    public function addToTiming(\DDEX\ERN\ERN_420\TimingType $timing)
    {
        $this->timing[] = $timing;
        return $this;
    }
     ...
     * A Composite containing details of a StartTime and/or a Duration of the related Resource.
     *
     * @return \DDEX\ERN\ERN_420\TimingType[]
     */
