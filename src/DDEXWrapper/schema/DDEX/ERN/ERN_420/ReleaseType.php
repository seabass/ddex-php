...
class ReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_420\ReleaseTypeForReleaseNotificationType[] $releaseType
     */
    private $releaseType = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\ReleaseIdType $releaseId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\ReleaseLabelReferenceWithPartyType[] $releaseLabelReference
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\AdministratingRecordCompanyWithReferenceType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\GenreWithTerritoryType[] $genre
     */
    private $genre = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\EventDateWithDefaultType[] $releaseDate
     */
    private $releaseDate = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\EventDateWithDefaultType[] $originalReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\ResourceGroupType $resourceGroup
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\ExternalResourceLinkType[] $externalResourceLink
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\KeywordsWithTerritoryType[] $keywords
     */
    private $keywords = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\SynopsisWithTerritoryType[] $synopsis
     */
    private $synopsis = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\MarketingCommentType[] $marketingComment
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\ReleaseTypeForReleaseNotificationType $releaseType
     */
    public function addToReleaseType(\DDEX\ERN\ERN_420\ReleaseTypeForReleaseNotificationType $releaseType)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/release-types-for-trackreleases
     *
     * @return \DDEX\ERN\ERN_420\ReleaseTypeForReleaseNotificationType[]
     */
     ...
     * A Composite containing details of ReleaseIds. If available, a GRid has to be used. If the Release is an abstraction of a complete PhysicalProduct (such as a CD Album), the ICPN of the PhysicalProduct may be used instead.
     *
     * @return \DDEX\ERN\ERN_420\ReleaseIdType
     */
     ...
     * A Composite containing details of ReleaseIds. If available, a GRid has to be used. If the Release is an abstraction of a complete PhysicalProduct (such as a CD Album), the ICPN of the PhysicalProduct may be used instead.
     *
     * @param \DDEX\ERN\ERN_420\ReleaseIdType $releaseId
     * @return self
     */
    public function setReleaseId(\DDEX\ERN\ERN_420\ReleaseIdType $releaseId)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\ReleaseLabelReferenceWithPartyType $releaseLabelReference
     */
    public function addToReleaseLabelReference(\DDEX\ERN\ERN_420\ReleaseLabelReferenceWithPartyType $releaseLabelReference)
    {
     ...
     * A Reference for a label of the Release (specific to this Message). This is a LocalPartyAnchorReference starting with the letter P.
     *
     * @return \DDEX\ERN\ERN_420\ReleaseLabelReferenceWithPartyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\AdministratingRecordCompanyWithReferenceType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DDEX\ERN\ERN_420\AdministratingRecordCompanyWithReferenceType $administratingRecordCompany)
    {
     ...
     * A Composite containing details of the AdministratingRecordCompany for the Release.
     *
     * @return \DDEX\ERN\ERN_420\AdministratingRecordCompanyWithReferenceType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\GenreWithTerritoryType $genre
     */
    public function addToGenre(\DDEX\ERN\ERN_420\GenreWithTerritoryType $genre)
    {
        $this->genre[] = $genre;
        return $this;
    }
     ...
     * A Composite containing details of a Genre to which the Release belongs.
     *
     * @return \DDEX\ERN\ERN_420\GenreWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\EventDateWithDefaultType $releaseDate
     */
    public function addToReleaseDate(\DDEX\ERN\ERN_420\EventDateWithDefaultType $releaseDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601 format: YYYY[-MM[-DD]]). This Element is for display and cataloguing purposes only.
     *
     * @return \DDEX\ERN\ERN_420\EventDateWithDefaultType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\EventDateWithDefaultType $originalReleaseDate
     */
    public function addToOriginalReleaseDate(\DDEX\ERN\ERN_420\EventDateWithDefaultType $originalReleaseDate)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @return \DDEX\ERN\ERN_420\ResourceGroupType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @param \DDEX\ERN\ERN_420\ResourceGroupType $resourceGroup
     * @return self
     */
    public function setResourceGroup(\DDEX\ERN\ERN_420\ResourceGroupType $resourceGroup)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\ExternalResourceLinkType $externalResourceLink
     */
    public function addToExternalResourceLink(\DDEX\ERN\ERN_420\ExternalResourceLinkType $externalResourceLink)
    {
     ...
     * A Composite containing details of promotional or other material related to the Release.
     *
     * @return \DDEX\ERN\ERN_420\ExternalResourceLinkType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\KeywordsWithTerritoryType $keywords
     */
    public function addToKeywords(\DDEX\ERN\ERN_420\KeywordsWithTerritoryType $keywords)
    {
     ...
     * A Composite containing details of a Description of the Release containing Keywords.
     *
     * @return \DDEX\ERN\ERN_420\KeywordsWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\SynopsisWithTerritoryType $synopsis
     */
    public function addToSynopsis(\DDEX\ERN\ERN_420\SynopsisWithTerritoryType $synopsis)
    {
     ...
     * A Composite containing details of a Synopsis of the Release.
     *
     * @return \DDEX\ERN\ERN_420\SynopsisWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\MarketingCommentType $marketingComment
     */
    public function addToMarketingComment(\DDEX\ERN\ERN_420\MarketingCommentType $marketingComment)
    {
     ...
     * A Composite containing a Comment about the promotion and marketing of the Release.
     *
     * @return \DDEX\ERN\ERN_420\MarketingCommentType[]
     */
