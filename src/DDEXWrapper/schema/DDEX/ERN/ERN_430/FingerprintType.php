...
class FingerprintType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\FingerprintAlgorithmTypeType $algorithm
     */
     ...
     * A Composite containing details of the Type of Algorithm governing the Fingerprint.
     *
     * @return \DDEX\ERN\ERN_430\FingerprintAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of Algorithm governing the Fingerprint.
     *
     * @param \DDEX\ERN\ERN_430\FingerprintAlgorithmTypeType $algorithm
     * @return self
     */
    public function setAlgorithm(\DDEX\ERN\ERN_430\FingerprintAlgorithmTypeType $algorithm)
    {
