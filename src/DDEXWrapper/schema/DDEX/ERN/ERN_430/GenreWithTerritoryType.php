...
class GenreWithTerritoryType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\GenreCategoryType[] $genreCategory
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\SubGenreCategoryValueType[] $subGenreCategory
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\GenreCategoryType $genreCategory
     */
    public function addToGenreCategory(\DDEX\ERN\ERN_430\GenreCategoryType $genreCategory)
    {
     ...
     * A Composite containing details of a Genre Category to which the Release belongs.
     *
     * @return \DDEX\ERN\ERN_430\GenreCategoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\SubGenreCategoryValueType $value
     */
    public function addToSubGenreCategory(\DDEX\ERN\ERN_430\SubGenreCategoryValueType $value)
    {
     ...
     * A Composite containing details of a sub-genre of the Release.
     *
     * @return \DDEX\ERN\ERN_430\SubGenreCategoryValueType[]
     */
     ...
     * A Composite containing details of a sub-genre of the Release.
     *
     * @param \DDEX\ERN\ERN_430\SubGenreCategoryValueType[] $subGenreCategory
     * @return self
     */
