...
class ReleaseDealType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\DealType[] $deal
     */
    private $deal = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\DealType $deal
     */
    public function addToDeal(\DDEX\ERN\ERN_430\DealType $deal)
    {
        $this->deal[] = $deal;
        return $this;
    }
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/no-takedown-in-initial-deal
     *
     * @return \DDEX\ERN\ERN_430\DealType[]
     */
