...
class ServiceExceptionType
{
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @var \DDEX\ERN\ERN_430\NameType $tradingName
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\ChannelType[] $channel
     */
    private $channel = [
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @param \DDEX\ERN\ERN_430\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\ERN\ERN_430\NameType $tradingName = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\ChannelType $channel
     */
    public function addToChannel(\DDEX\ERN\ERN_430\ChannelType $channel)
    {
     ...
     * A Composite containing details of an excluded channel provided by the Service. This channel may be specific to an Artist.
     *
     * @return \DDEX\ERN\ERN_430\ChannelType[]
     */
