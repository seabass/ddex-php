...
class TechnicalVideoDetailsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\BitRateType $overallBitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\VideoDeliveryFileType[] $deliveryFile
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\VideoClipDetailsType[] $clipDetails
     */
    private $clipDetails = [
     ...
     * A Composite containing the overall BitRate and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_430\BitRateType $overallBitRate
     * @return self
     */
    public function setOverallBitRate(?\DDEX\ERN\ERN_430\BitRateType $overallBitRate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\VideoDeliveryFileType $deliveryFile
     */
    public function addToDeliveryFile(\DDEX\ERN\ERN_430\VideoDeliveryFileType $deliveryFile)
    {
     ...
     * A Composite containing details of a delivery File.
     *
     * @return \DDEX\ERN\ERN_430\VideoDeliveryFileType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\VideoClipDetailsType $clipDetails
     */
    public function addToClipDetails(\DDEX\ERN\ERN_430\VideoClipDetailsType $clipDetails)
    {
     ...
     * A Composite containing details of a preview.
     *
     * @return \DDEX\ERN\ERN_430\VideoClipDetailsType[]
     */
