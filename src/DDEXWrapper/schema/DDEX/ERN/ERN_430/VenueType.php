...
class VenueType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\AllTerritoryCodeType $territoryCode
     */
     ...
     * A Territory of the VenueAddress. The use of ISO TerritoryCodes is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
     * @param \DDEX\ERN\ERN_430\AllTerritoryCodeType $territoryCode
     * @return self
     */
    public function setTerritoryCode(?\DDEX\ERN\ERN_430\AllTerritoryCodeType $territoryCode = null)
    {
