...
class DetailedHashSumType
{
     ...
     *
     * @var \DDEX\ERN\ERN_431\HashSumAlgorithmTypeType $algorithm
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the hash sum.
     *
     * @return \DDEX\ERN\ERN_431\HashSumAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the hash sum.
     *
     * @param \DDEX\ERN\ERN_431\HashSumAlgorithmTypeType $algorithm
     * @return self
     */
    public function setAlgorithm(\DDEX\ERN\ERN_431\HashSumAlgorithmTypeType $algorithm)
    {
