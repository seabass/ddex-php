...
namespace DDEX\ERN\ERN_431\NewReleaseMessage;
...
class NewReleaseMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_431\MessageHeaderType $messageHeader
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ReleaseAdminType[] $releaseAdmin
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\PartyListType $partyList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\CueSheetType[] $cueSheetList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ResourceListType $resourceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ChapterListType $chapterList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ReleaseListType $releaseList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\DealListType $dealList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\FileType[] $supplementalDocumentList
     */
     ...
     * The MessageHeader for the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_431\MessageHeaderType
     */
     ...
     * The MessageHeader for the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_431\MessageHeaderType $messageHeader
     * @return self
     */
    public function setMessageHeader(\DDEX\ERN\ERN_431\MessageHeaderType $messageHeader)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ReleaseAdminType $releaseAdmin
     */
    public function addToReleaseAdmin(\DDEX\ERN\ERN_431\ReleaseAdminType $releaseAdmin)
    {
     ...
     * A Composite containing details of Release administration.
     *
     * @return \DDEX\ERN\ERN_431\ReleaseAdminType[]
     */
     ...
     * A Composite containing details of one or more Parties relating to the reported Creations.
     *
     * @return \DDEX\ERN\ERN_431\PartyListType
     */
     ...
     * A Composite containing details of one or more Parties relating to the reported Creations.
     *
     * @param \DDEX\ERN\ERN_431\PartyListType $partyList
     * @return self
     */
    public function setPartyList(\DDEX\ERN\ERN_431\PartyListType $partyList)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\CueSheetType $cueSheet
     */
    public function addToCueSheetList(\DDEX\ERN\ERN_431\CueSheetType $cueSheet)
    {
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_431\CueSheetType[]
     */
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_431\CueSheetType[] $cueSheetList
     * @return self
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @return \DDEX\ERN\ERN_431\ResourceListType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @param \DDEX\ERN\ERN_431\ResourceListType $resourceList
     * @return self
     */
    public function setResourceList(\DDEX\ERN\ERN_431\ResourceListType $resourceList)
    {
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_431\ChapterListType
     */
     ...
     * A Composite containing details of one or more Chapters contained in Releases for which data is provided in the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_431\ChapterListType $chapterList
     * @return self
     */
    public function setChapterList(?\DDEX\ERN\ERN_431\ChapterListType $chapterList = null)
    {
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_431\ReleaseListType
     */
     ...
     * A Composite containing details of one or more DDEX Releases contained in the NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_431\ReleaseListType $releaseList
     * @return self
     */
    public function setReleaseList(\DDEX\ERN\ERN_431\ReleaseListType $releaseList)
    {
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @return \DDEX\ERN\ERN_431\DealListType
     */
     ...
     * A Composite containing details of one or more Deals governing the Usage of the Releases in the Message.
     *
     * @param \DDEX\ERN\ERN_431\DealListType $dealList
     * @return self
     */
    public function setDealList(?\DDEX\ERN\ERN_431\DealListType $dealList = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\FileType $supplementalDocument
     */
    public function addToSupplementalDocumentList(\DDEX\ERN\ERN_431\FileType $supplementalDocument)
    {
     ...
     * A Composite containing details of one or more XML documents communicated with the Message.
     *
     * @param \DDEX\ERN\ERN_431\FileType[] $supplementalDocumentList
     * @return self
     */
