...
class ReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_431\ReleaseTypeForReleaseNotificationType[] $releaseType
     */
    private $releaseType = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\ReleaseLabelReferenceWithPartyType[] $releaseLabelReference
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\AdministratingRecordCompanyType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\PLineType[] $pLine
     */
    private $pLine = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\CLineType[] $cLine
     */
    private $cLine = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\GenreWithTerritoryType[] $displayGenre
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\EventDateWithDefaultType[] $releaseDate
     */
    private $releaseDate = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\EventDateWithDefaultType[] $originalReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ResourceGroupType $resourceGroup
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ExternalResourceLinkType[] $externalResourceLink
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\KeywordsWithTerritoryType[] $keywords
     */
    private $keywords = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\SynopsisWithTerritoryType[] $synopsis
     */
    private $synopsis = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\MarketingCommentType[] $marketingComment
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ReleaseTypeForReleaseNotificationType $releaseType
     */
    public function addToReleaseType(\DDEX\ERN\ERN_431\ReleaseTypeForReleaseNotificationType $releaseType)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/release-types-for-trackreleases
     *
     * @return \DDEX\ERN\ERN_431\ReleaseTypeForReleaseNotificationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ReleaseLabelReferenceWithPartyType $releaseLabelReference
     */
    public function addToReleaseLabelReference(\DDEX\ERN\ERN_431\ReleaseLabelReferenceWithPartyType $releaseLabelReference)
    {
     ...
     * A Reference for a label of the Release (specific to this Message). This is a LocalPartyAnchorReference starting with the letter P.
     *
     * @return \DDEX\ERN\ERN_431\ReleaseLabelReferenceWithPartyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\AdministratingRecordCompanyType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DDEX\ERN\ERN_431\AdministratingRecordCompanyType $administratingRecordCompany)
    {
     ...
     * A Composite containing details of the AdministratingRecordCompany for the Release.
     *
     * @return \DDEX\ERN\ERN_431\AdministratingRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\PLineType $pLine
     */
    public function addToPLine(\DDEX\ERN\ERN_431\PLineType $pLine)
    {
        $this->pLine[] = $pLine;
        return $this;
    }
     ...
     * A Composite containing details of the PLine for the Release.
     *
     * @return \DDEX\ERN\ERN_431\PLineType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\CLineType $cLine
     */
    public function addToCLine(\DDEX\ERN\ERN_431\CLineType $cLine)
    {
        $this->cLine[] = $cLine;
        return $this;
    }
     ...
     * A Composite containing details of the CLine for the Release.
     *
     * @return \DDEX\ERN\ERN_431\CLineType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\GenreWithTerritoryType $displayGenre
     */
    public function addToDisplayGenre(\DDEX\ERN\ERN_431\GenreWithTerritoryType $displayGenre)
    {
     ...
     * A Composite containing details of a Genre considered appropriate for marketing the Release by the publishing record company often in conjunction with the display artist(s).
     *
     * @return \DDEX\ERN\ERN_431\GenreWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\EventDateWithDefaultType $releaseDate
     */
    public function addToReleaseDate(\DDEX\ERN\ERN_431\EventDateWithDefaultType $releaseDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601 format: YYYY[-MM[-DD]]). This Element is for display and cataloguing purposes only.
     *
     * @return \DDEX\ERN\ERN_431\EventDateWithDefaultType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\EventDateWithDefaultType $originalReleaseDate
     */
    public function addToOriginalReleaseDate(\DDEX\ERN\ERN_431\EventDateWithDefaultType $originalReleaseDate)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @return \DDEX\ERN\ERN_431\ResourceGroupType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @param \DDEX\ERN\ERN_431\ResourceGroupType $resourceGroup
     * @return self
     */
    public function setResourceGroup(\DDEX\ERN\ERN_431\ResourceGroupType $resourceGroup)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ExternalResourceLinkType $externalResourceLink
     */
    public function addToExternalResourceLink(\DDEX\ERN\ERN_431\ExternalResourceLinkType $externalResourceLink)
    {
     ...
     * A Composite containing details of promotional or other material related to the Release.
     *
     * @return \DDEX\ERN\ERN_431\ExternalResourceLinkType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\KeywordsWithTerritoryType $keywords
     */
    public function addToKeywords(\DDEX\ERN\ERN_431\KeywordsWithTerritoryType $keywords)
    {
     ...
     * A Composite containing details of a Description of the Release containing Keywords.
     *
     * @return \DDEX\ERN\ERN_431\KeywordsWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\SynopsisWithTerritoryType $synopsis
     */
    public function addToSynopsis(\DDEX\ERN\ERN_431\SynopsisWithTerritoryType $synopsis)
    {
     ...
     * A Composite containing details of a Synopsis of the Release.
     *
     * @return \DDEX\ERN\ERN_431\SynopsisWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\MarketingCommentType $marketingComment
     */
    public function addToMarketingComment(\DDEX\ERN\ERN_431\MarketingCommentType $marketingComment)
    {
     ...
     * A Composite containing a Comment about the promotion and marketing of the Release.
     *
     * @return \DDEX\ERN\ERN_431\MarketingCommentType[]
     */
