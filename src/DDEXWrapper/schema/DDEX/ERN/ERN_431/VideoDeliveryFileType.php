...
class VideoDeliveryFileType
{
     ...
     *
     * @var \DDEX\ERN\ERN_431\ContainerFormatType $containerFormat
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\VideoCodecTypeType $videoCodecType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\BitRateType $videoBitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\FrameRateType $frameRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ExtentType $imageHeight
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ExtentType $imageWidth
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\AspectRatioType[] $aspectRatio
     */
    private $aspectRatio = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\CoreAreaType $coreArea
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\VideoDefinitionTypeType $videoDefinitionType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\AudioCodecTypeType $audioCodecType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\HdrVideoDynamicMetadataTypeType $hdrVideoDynamicMetadataType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\BitRateType $audioBitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\SamplingRateType $audioSamplingRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\FileType $file
     */
    private $file = null;
     ...
     *
     * @var \DDEX\ERN\ERN_431\FingerprintType[] $fingerprint
     */
    private $fingerprint = [
     ...
     * A Composite containing details of a ContainerFormat.
     *
     * @return \DDEX\ERN\ERN_431\ContainerFormatType
     */
     ...
     * A Composite containing details of a ContainerFormat.
     *
     * @param \DDEX\ERN\ERN_431\ContainerFormatType $containerFormat
     * @return self
     */
    public function setContainerFormat(?\DDEX\ERN\ERN_431\ContainerFormatType $containerFormat = null)
    {
     ...
     * A Composite containing details of a Type of VideoCodec.
     *
     * @return \DDEX\ERN\ERN_431\VideoCodecTypeType
     */
     ...
     * A Composite containing details of a Type of VideoCodec.
     *
     * @param \DDEX\ERN\ERN_431\VideoCodecTypeType $videoCodecType
     * @return self
     */
    public function setVideoCodecType(?\DDEX\ERN\ERN_431\VideoCodecTypeType $videoCodecType = null)
    {
     ...
     * A Composite containing the BitRate for the video data and a UnitOfMeasure (the default is kbps).
     *
     * @return \DDEX\ERN\ERN_431\BitRateType
     */
     ...
     * A Composite containing the BitRate for the video data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_431\BitRateType $videoBitRate
     * @return self
     */
    public function setVideoBitRate(?\DDEX\ERN\ERN_431\BitRateType $videoBitRate = null)
    {
     ...
     * A Composite containing the Rate for a number of frames shown in the Video in a specific Period of Time and a UnitOfMeasure (the default is Hz, interlaced).
     *
     * @return \DDEX\ERN\ERN_431\FrameRateType
     */
     ...
     * A Composite containing the Rate for a number of frames shown in the Video in a specific Period of Time and a UnitOfMeasure (the default is Hz, interlaced).
     *
     * @param \DDEX\ERN\ERN_431\FrameRateType $frameRate
     * @return self
     */
    public function setFrameRate(?\DDEX\ERN\ERN_431\FrameRateType $frameRate = null)
    {
     ...
     * A Composite containing the vertical Extent of an Image of the Video and a UnitOfMeasure (the default is Pixels).
     *
     * @return \DDEX\ERN\ERN_431\ExtentType
     */
     ...
     * A Composite containing the vertical Extent of an Image of the Video and a UnitOfMeasure (the default is Pixels).
     *
     * @param \DDEX\ERN\ERN_431\ExtentType $imageHeight
     * @return self
     */
    public function setImageHeight(?\DDEX\ERN\ERN_431\ExtentType $imageHeight = null)
    {
     ...
     * A Composite containing the horizontal Extent of an Image of the Video and a UnitOfMeasure (the default is Pixels).
     *
     * @param \DDEX\ERN\ERN_431\ExtentType $imageWidth
     * @return self
     */
    public function setImageWidth(?\DDEX\ERN\ERN_431\ExtentType $imageWidth = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\AspectRatioType $aspectRatio
     */
    public function addToAspectRatio(\DDEX\ERN\ERN_431\AspectRatioType $aspectRatio)
    {
     ...
     * A Composite containing the ratio formed by dividing the ImageHeight by the ImageWidth.
     *
     * @return \DDEX\ERN\ERN_431\AspectRatioType[]
     */
     ...
     * A Composite containing details of the core part of the Video.
     *
     * @return \DDEX\ERN\ERN_431\CoreAreaType
     */
     ...
     * A Composite containing details of the core part of the Video.
     *
     * @param \DDEX\ERN\ERN_431\CoreAreaType $coreArea
     * @return self
     */
    public function setCoreArea(?\DDEX\ERN\ERN_431\CoreAreaType $coreArea = null)
    {
     ...
     * A Type of resolution (or definition) in which the Video is provided.
     *
     * @return \DDEX\ERN\ERN_431\VideoDefinitionTypeType
     */
     ...
     * A Type of resolution (or definition) in which the Video is provided.
     *
     * @param \DDEX\ERN\ERN_431\VideoDefinitionTypeType $videoDefinitionType
     * @return self
     */
    public function setVideoDefinitionType(?\DDEX\ERN\ERN_431\VideoDefinitionTypeType $videoDefinitionType = null)
    {
     ...
     * A Composite containing details of a Type of AudioCodec.
     *
     * @return \DDEX\ERN\ERN_431\AudioCodecTypeType
     */
     ...
     * A Composite containing details of a Type of AudioCodec.
     *
     * @param \DDEX\ERN\ERN_431\AudioCodecTypeType $audioCodecType
     * @return self
     */
    public function setAudioCodecType(?\DDEX\ERN\ERN_431\AudioCodecTypeType $audioCodecType = null)
    {
     ...
     * A Composite containing details of Dolby vision metadata. This element may only be used for a VisualFile or AudioVisualFile, and if it is used, an ElectroOpticalTransferFunctionType element must also be present with a value of ST2084. Also, if this Flag is set to StandAlone, there needs to be a further delivery file of type ColorInformationFile.
     *
     * @return \DDEX\ERN\ERN_431\HdrVideoDynamicMetadataTypeType
     */
     ...
     * A Composite containing details of Dolby vision metadata. This element may only be used for a VisualFile or AudioVisualFile, and if it is used, an ElectroOpticalTransferFunctionType element must also be present with a value of ST2084. Also, if this Flag is set to StandAlone, there needs to be a further delivery file of type ColorInformationFile.
     *
     * @param \DDEX\ERN\ERN_431\HdrVideoDynamicMetadataTypeType $hdrVideoDynamicMetadataType
     * @return self
     */
    public function setHdrVideoDynamicMetadataType(?\DDEX\ERN\ERN_431\HdrVideoDynamicMetadataTypeType $hdrVideoDynamicMetadataType = null)
    {
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_431\BitRateType $audioBitRate
     * @return self
     */
    public function setAudioBitRate(?\DDEX\ERN\ERN_431\BitRateType $audioBitRate = null)
    {
     ...
     * A Composite containing the SamplingRate for the audio data and a UnitOfMeasure (the default is Hz).
     *
     * @return \DDEX\ERN\ERN_431\SamplingRateType
     */
     ...
     * A Composite containing the SamplingRate for the audio data and a UnitOfMeasure (the default is Hz).
     *
     * @param \DDEX\ERN\ERN_431\SamplingRateType $audioSamplingRate
     * @return self
     */
    public function setAudioSamplingRate(?\DDEX\ERN\ERN_431\SamplingRateType $audioSamplingRate = null)
    {
     ...
     * A Composite containing details of a File containing the Video that a DSP can obtain.
     *
     * @return \DDEX\ERN\ERN_431\FileType
     */
     ...
     * A Composite containing details of a File containing the Video that a DSP can obtain.
     *
     * @param \DDEX\ERN\ERN_431\FileType $file
     * @return self
     */
    public function setFile(?\DDEX\ERN\ERN_431\FileType $file = null)
    {
        $this->file = $file;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\FingerprintType $fingerprint
     */
    public function addToFingerprint(\DDEX\ERN\ERN_431\FingerprintType $fingerprint)
    {
     ...
     * A Composite containing details of a Fingerprint and its governing algorithm.
     *
     * @return \DDEX\ERN\ERN_431\FingerprintType[]
     */
