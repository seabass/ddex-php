...
class VideoType
{
     ...
     *
     * @var \DDEX\ERN\ERN_431\VideoTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \DDEX\ERN\ERN_431\VideoEditionType[] $videoEdition
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\RecordingFormatType[] $recordingFormat
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\MusicalWorkIdType[] $workId
     */
    private $workId = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\VersionTypeType[] $versionType
     */
    private $versionType = [
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @var \DDEX\ERN\ERN_431\DisplayArtistType[] $displayArtist
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ContributorType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\CharacterType[] $character
     */
    private $character = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\ResourceRightsControllerType[] $resourceRightsController
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\WorkRightsControllerType[] $workRightsController
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\CourtesyLineType[] $courtesyLine
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\EventDateWithoutFlagsType $creationDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\EventDateWithoutFlagsType $masteredDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\EventDateWithoutFlagsType[] $remasteredDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\FulfillmentDateType[] $firstPublicationDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ParentalWarningTypeWithStandardType[] $parentalWarningType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\AvRatingType[] $avRating
     */
    private $avRating = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\RelatedReleaseType[] $relatedRelease
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\RelatedResourceType[] $relatedResource
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ReasonType $reasonForCueSheetAbsence
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\DisplayCreditsType[] $displayCredits
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\LanguageType[] $languageOfPerformance
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ResourceContainedResourceReferenceType[] $resourceContainedResourceReferenceList
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @return \DDEX\ERN\ERN_431\VideoTypeType
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @param \DDEX\ERN\ERN_431\VideoTypeType $type
     * @return self
     */
    public function setType(\DDEX\ERN\ERN_431\VideoTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\VideoEditionType $videoEdition
     */
    public function addToVideoEdition(\DDEX\ERN\ERN_431\VideoEditionType $videoEdition)
    {
     ...
     * A Composite containing details of a Video that has been created based on the same content as the 'main' Video but specifically for a different encoding for the audio such as immersive audio. It can be the same Video (in accordance with the ISRC standard) but more likely than not will be a different Video because the sound engineer/producer will be different. If an element in this Composite is not provided, the data is assumed to be the same as for the 'main' Video.
     *
     * @return \DDEX\ERN\ERN_431\VideoEditionType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\RecordingFormatType $recordingFormat
     */
    public function addToRecordingFormat(\DDEX\ERN\ERN_431\RecordingFormatType $recordingFormat)
    {
     ...
     * A Composite containing details of a Type of the Video based on its content, intended audience, format or technical characteristics.
     *
     * @return \DDEX\ERN\ERN_431\RecordingFormatType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\MusicalWorkIdType $workId
     */
    public function addToWorkId(\DDEX\ERN\ERN_431\MusicalWorkIdType $workId)
    {
        $this->workId[] = $workId;
        return $this;
    }
     ...
     * A Composite containing details of a MusicalWorkId of a MusicalWork used in the Video.
     *
     * @return \DDEX\ERN\ERN_431\MusicalWorkIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\VersionTypeType $versionType
     */
    public function addToVersionType(\DDEX\ERN\ERN_431\VersionTypeType $versionType)
    {
     ...
     * A Composite containing details of a Type of Version given by the releasing party to characterise and differentiate one Video from another with identical or similar Title metadata. VersionTypes may be used for disambiguating a Video that has been derived from another Video by using the value EditedVersion. EditedVersion value is often combined with another VersionType such as RadioVersion.
     *
     * @return \DDEX\ERN\ERN_431\VersionTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\DisplayArtistType $displayArtist
     */
    public function addToDisplayArtist(\DDEX\ERN\ERN_431\DisplayArtistType $displayArtist)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @return \DDEX\ERN\ERN_431\DisplayArtistType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ContributorType $contributor
     */
    public function addToContributor(\DDEX\ERN\ERN_431\ContributorType $contributor)
    {
     ...
     * A Composite containing details of a Contributor to the Video.
     *
     * @return \DDEX\ERN\ERN_431\ContributorType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\CharacterType $character
     */
    public function addToCharacter(\DDEX\ERN\ERN_431\CharacterType $character)
    {
     ...
     * A Composite containing details of a Character in the Video. A Character may be described through Name, Identifier and Roles.
     *
     * @return \DDEX\ERN\ERN_431\CharacterType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ResourceRightsControllerType $resourceRightsController
     */
    public function addToResourceRightsController(\DDEX\ERN\ERN_431\ResourceRightsControllerType $resourceRightsController)
    {
     ...
     * A Composite containing details of RightsController of Rights in the Video.
     *
     * @return \DDEX\ERN\ERN_431\ResourceRightsControllerType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\WorkRightsControllerType $workRightsController
     */
    public function addToWorkRightsController(\DDEX\ERN\ERN_431\WorkRightsControllerType $workRightsController)
    {
     ...
     * A Composite containing details of RightsController of Rights in the Work.
     *
     * @return \DDEX\ERN\ERN_431\WorkRightsControllerType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\CourtesyLineType $courtesyLine
     */
    public function addToCourtesyLine(\DDEX\ERN\ERN_431\CourtesyLineType $courtesyLine)
    {
     ...
     * A Composite containing an Annotation Annotation which acknowledges record companies and/or other Parties giving permission for guests Artists or others featured on the Video.
     *
     * @return \DDEX\ERN\ERN_431\CourtesyLineType[]
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the Video was created. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_431\EventDateWithoutFlagsType $creationDate
     * @return self
     */
    public function setCreationDate(?\DDEX\ERN\ERN_431\EventDateWithoutFlagsType $creationDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Video was originally mastered (in either analogue or digital form). This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_431\EventDateWithoutFlagsType $masteredDate
     * @return self
     */
    public function setMasteredDate(?\DDEX\ERN\ERN_431\EventDateWithoutFlagsType $masteredDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\EventDateWithoutFlagsType $remasteredDate
     */
    public function addToRemasteredDate(\DDEX\ERN\ERN_431\EventDateWithoutFlagsType $remasteredDate)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\FulfillmentDateType $firstPublicationDate
     */
    public function addToFirstPublicationDate(\DDEX\ERN\ERN_431\FulfillmentDateType $firstPublicationDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Video was first published, whether for physical or electronic/online distribution. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @return \DDEX\ERN\ERN_431\FulfillmentDateType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ParentalWarningTypeWithStandardType $parentalWarningType
     */
    public function addToParentalWarningType(\DDEX\ERN\ERN_431\ParentalWarningTypeWithStandardType $parentalWarningType)
    {
     ...
     * A Composite containing details of the classification of the Video according to advice which it carries about the level of explicitness or offensiveness of its content.
     *
     * @return \DDEX\ERN\ERN_431\ParentalWarningTypeWithStandardType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\AvRatingType $avRating
     */
    public function addToAvRating(\DDEX\ERN\ERN_431\AvRatingType $avRating)
    {
     ...
     * A Composite containing details of a rating for the Video.
     *
     * @return \DDEX\ERN\ERN_431\AvRatingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DDEX\ERN\ERN_431\RelatedReleaseType $relatedRelease)
    {
     ...
     * A Composite containing details of a Release (or a PhysicalProduct or a DigitalProduct derived from such a Release) which is related to current Video.
     *
     * @return \DDEX\ERN\ERN_431\RelatedReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\RelatedResourceType $relatedResource
     */
    public function addToRelatedResource(\DDEX\ERN\ERN_431\RelatedResourceType $relatedResource)
    {
     ...
     * A Composite containing details of a ResourceRelatedResourceReference referring to a Resource that is related to the current Video.
     *
     * @return \DDEX\ERN\ERN_431\RelatedResourceType[]
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @return \DDEX\ERN\ERN_431\ReasonType
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @param \DDEX\ERN\ERN_431\ReasonType $reasonForCueSheetAbsence
     * @return self
     */
    public function setReasonForCueSheetAbsence(?\DDEX\ERN\ERN_431\ReasonType $reasonForCueSheetAbsence = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\DisplayCreditsType $displayCredits
     */
    public function addToDisplayCredits(\DDEX\ERN\ERN_431\DisplayCreditsType $displayCredits)
    {
     ...
     * A Role and instrumentation for which a Party is credited.
     *
     * @return \DDEX\ERN\ERN_431\DisplayCreditsType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\LanguageType $languageOfPerformance
     */
    public function addToLanguageOfPerformance(\DDEX\ERN\ERN_431\LanguageType $languageOfPerformance)
    {
     ...
     * The original Language of the Performance as defined in IETF RfC 5646. Language and Script are provided as lang[-script][-region][-variant]. A list of common language/script combinations has been published in the Language Metadata Table (LMT) at https://www.mesaonline.org/lmt by the Media & Entertainment Services Alliance. Other language/script combinations allowed by IETF RfC 5646 are also valid.
     *
     * @return \DDEX\ERN\ERN_431\LanguageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ResourceContainedResourceReferenceType $resourceContainedResourceReference
     */
    public function addToResourceContainedResourceReferenceList(\DDEX\ERN\ERN_431\ResourceContainedResourceReferenceType $resourceContainedResourceReference)
    {
     ...
     * A Composite containing details of ResourceContainedResourceReferences referring to a Resource that is contained in the current Video.
     *
     * @return \DDEX\ERN\ERN_431\ResourceContainedResourceReferenceType[]
     */
     ...
     * A Composite containing details of ResourceContainedResourceReferences referring to a Resource that is contained in the current Video.
     *
     * @param \DDEX\ERN\ERN_431\ResourceContainedResourceReferenceType[] $resourceContainedResourceReferenceList
     * @return self
     */
