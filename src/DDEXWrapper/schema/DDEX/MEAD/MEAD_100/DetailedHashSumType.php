...
class DetailedHashSumType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\HashSumAlgorithmTypeType $algorithm
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @return \DDEX\MEAD\MEAD_100\HashSumAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @param \DDEX\MEAD\MEAD_100\HashSumAlgorithmTypeType $algorithm
     * @return self
     */
    public function setAlgorithm(\DDEX\MEAD\MEAD_100\HashSumAlgorithmTypeType $algorithm)
    {
