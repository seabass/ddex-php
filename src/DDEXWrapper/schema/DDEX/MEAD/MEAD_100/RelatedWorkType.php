...
class RelatedWorkType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\WorkRelationshipTypeType $workRelationshipType
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PartyWithNamesType[] $writer
     */
    private $writer = [
     ...
     * A Type of relationship between the two Works.
     *
     * @return \DDEX\MEAD\MEAD_100\WorkRelationshipTypeType
     */
     ...
     * A Type of relationship between the two Works.
     *
     * @param \DDEX\MEAD\MEAD_100\WorkRelationshipTypeType $workRelationshipType
     * @return self
     */
    public function setWorkRelationshipType(\DDEX\MEAD\MEAD_100\WorkRelationshipTypeType $workRelationshipType)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\PartyWithNamesType $writer
     */
    public function addToWriter(\DDEX\MEAD\MEAD_100\PartyWithNamesType $writer)
    {
        $this->writer[] = $writer;
        return $this;
    }
