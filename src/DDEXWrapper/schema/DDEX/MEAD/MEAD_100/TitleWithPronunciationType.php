...
class TitleWithPronunciationType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\TitleTextWithPronunciationType $subTitle
     */
     ...
     * A SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @param \DDEX\MEAD\MEAD_100\TitleTextWithPronunciationType $subTitle
     * @return self
     */
    public function setSubTitle(?\DDEX\MEAD\MEAD_100\TitleTextWithPronunciationType $subTitle = null)
    {
