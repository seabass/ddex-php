...
class VocalRegisterType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\VocalRegisterValueType $value
     */
    private $value = null;
     ...
     * The value of the vocal register.
     *
     * @return \DDEX\MEAD\MEAD_100\VocalRegisterValueType
     */
     ...
     * The value of the vocal register.
     *
     * @param \DDEX\MEAD\MEAD_100\VocalRegisterValueType $value
     * @return self
     */
    public function setValue(\DDEX\MEAD\MEAD_100\VocalRegisterValueType $value)
    {
        $this->value = $value;
        return $this;
    }
