...
/**
 * Class representing ChildWorkHierarchyType
 *
 * A Composite containing details of parents, children and siblings of a Work that is a child.
 * XSD Type: ChildWorkHierarchy
 */
class ChildWorkHierarchyType
{
    /**
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\MusicalWorkIdType $workId
     */
    private $workId = null;
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\ChildWorkHierarchyType[] $child
     */
    private $child = [
     ...
     * A Composite containing details of a MusicalWorkId.
     *
     * @param \DDEX\MEAD\MEAD_101\MusicalWorkIdType $workId
     * @return self
     */
    public function setWorkId(\DDEX\MEAD\MEAD_101\MusicalWorkIdType $workId)
    {
        $this->workId = $workId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_101\ChildWorkHierarchyType $child
     */
    public function addToChild(\DDEX\MEAD\MEAD_101\ChildWorkHierarchyType $child)
    {
        $this->child[] = $child;
        return $this;
    }
     ...
     * A Composite containing details of parents, children and siblings of the Work.
     *
     * @return \DDEX\MEAD\MEAD_101\ChildWorkHierarchyType[]
     */
