...
/**
 * Class representing DanceAndRhythmStyleType
 *
 * A Composite containing details of a dance and rhythm style.
 * XSD Type: DanceAndRhythmStyle
 */
class DanceAndRhythmStyleType
{
    /**
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\DanceAndRhythmStyleValueType $value
     */
    private $value = null;
     ...
     * A Composite containing details of a dance and rhythm style value.
     *
     * @return \DDEX\MEAD\MEAD_101\DanceAndRhythmStyleValueType
     */
     ...
     * A Composite containing details of a dance and rhythm style value.
     *
     * @param \DDEX\MEAD\MEAD_101\DanceAndRhythmStyleValueType $value
     * @return self
     */
    public function setValue(\DDEX\MEAD\MEAD_101\DanceAndRhythmStyleValueType $value)
    {
        $this->value = $value;
        return $this;
    }
