...
class FormType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\FormValueType $value
     */
    private $value = null;
     ...
     * A Composite containing details of a form value.
     *
     * @return \DDEX\MEAD\MEAD_101\FormValueType
     */
     ...
     * A Composite containing details of a form value.
     *
     * @param \DDEX\MEAD\MEAD_101\FormValueType $value
     * @return self
     */
    public function setValue(\DDEX\MEAD\MEAD_101\FormValueType $value)
    {
        $this->value = $value;
        return $this;
    }
