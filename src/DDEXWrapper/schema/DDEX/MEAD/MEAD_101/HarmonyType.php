...
class HarmonyType
{
     ...
     * A root chord note.
     *
     * @var \DDEX\MEAD\MEAD_101\RootChordNoteType $rootChordNote
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\RootChordQualityType $rootChordQuality
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\ModeType $mode
     */
    private $mode = null;
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\HarmonyModulationType[] $modulation
     */
    private $modulation = [
     ...
     * A root chord note.
     *
     * @return \DDEX\MEAD\MEAD_101\RootChordNoteType
     */
     ...
     * A root chord note.
     *
     * @param \DDEX\MEAD\MEAD_101\RootChordNoteType $rootChordNote
     * @return self
     */
    public function setRootChordNote(\DDEX\MEAD\MEAD_101\RootChordNoteType $rootChordNote)
    {
     ...
     * A root chord quality.
     *
     * @return \DDEX\MEAD\MEAD_101\RootChordQualityType
     */
     ...
     * A root chord quality.
     *
     * @param \DDEX\MEAD\MEAD_101\RootChordQualityType $rootChordQuality
     * @return self
     */
    public function setRootChordQuality(?\DDEX\MEAD\MEAD_101\RootChordQualityType $rootChordQuality = null)
    {
     ...
     * A mode, i.e. a type of musical scale coupled with a set of characteristic melodic behaviours.
     *
     * @return \DDEX\MEAD\MEAD_101\ModeType
     */
     ...
     * A mode, i.e. a type of musical scale coupled with a set of characteristic melodic behaviours.
     *
     * @param \DDEX\MEAD\MEAD_101\ModeType $mode
     * @return self
     */
    public function setMode(?\DDEX\MEAD\MEAD_101\ModeType $mode = null)
    {
        $this->mode = $mode;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_101\HarmonyModulationType $modulation
     */
    public function addToModulation(\DDEX\MEAD\MEAD_101\HarmonyModulationType $modulation)
    {
     ...
     * A Composite containing details of a harmony modulation.
     *
     * @return \DDEX\MEAD\MEAD_101\HarmonyModulationType[]
     */
