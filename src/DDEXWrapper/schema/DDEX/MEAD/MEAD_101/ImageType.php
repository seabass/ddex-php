...
class ImageType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\FileType $file
     */
    private $file = null;
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\ImageTypeType[] $imageType
     */
    private $imageType = [
     ...
     * A Composite containing details of a File containing the Image.
     *
     * @return \DDEX\MEAD\MEAD_101\FileType
     */
     ...
     * A Composite containing details of a File containing the Image.
     *
     * @param \DDEX\MEAD\MEAD_101\FileType $file
     * @return self
     */
    public function setFile(\DDEX\MEAD\MEAD_101\FileType $file)
    {
        $this->file = $file;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_101\ImageTypeType $imageType
     */
    public function addToImageType(\DDEX\MEAD\MEAD_101\ImageTypeType $imageType)
    {
     ...
     * A Composite containing details of the Type of the Image.
     *
     * @return \DDEX\MEAD\MEAD_101\ImageTypeType[]
     */
