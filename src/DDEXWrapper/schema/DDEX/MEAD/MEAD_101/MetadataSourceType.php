...
class MetadataSourceType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\PartyNameWithTerritoryType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\MetadataSourceTypeType $metadataSourceType
     */
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_101\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DDEX\MEAD\MEAD_101\DetailedPartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the metadata source. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\MEAD\MEAD_101\DetailedPartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_101\PartyNameWithTerritoryType $partyName
     */
    public function addToPartyName(\DDEX\MEAD\MEAD_101\PartyNameWithTerritoryType $partyName)
    {
     ...
     * The Type of the metadata source.
     *
     * @return \DDEX\MEAD\MEAD_101\MetadataSourceTypeType
     */
     ...
     * The Type of the metadata source.
     *
     * @param \DDEX\MEAD\MEAD_101\MetadataSourceTypeType $metadataSourceType
     * @return self
     */
    public function setMetadataSourceType(\DDEX\MEAD\MEAD_101\MetadataSourceTypeType $metadataSourceType)
    {
