...
class RecordingPartType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\RecordingPartTypeType $recordingPartType
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\AnnotationType[] $comment
     */
    private $comment = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\TextWithFormatType[] $usageInformation
     */
     ...
     * A Composite containing details of a part of the Recording identified by the cue point.
     *
     * @return \DDEX\MEAD\MEAD_101\RecordingPartTypeType
     */
     ...
     * A Composite containing details of a part of the Recording identified by the cue point.
     *
     * @param \DDEX\MEAD\MEAD_101\RecordingPartTypeType $recordingPartType
     * @return self
     */
    public function setRecordingPartType(?\DDEX\MEAD\MEAD_101\RecordingPartTypeType $recordingPartType = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_101\AnnotationType $comment
     */
    public function addToComment(\DDEX\MEAD\MEAD_101\AnnotationType $comment)
    {
     ...
     * A Comment on the Recording part.
     *
     * @return \DDEX\MEAD\MEAD_101\AnnotationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_101\TextWithFormatType $usageInformation
     */
    public function addToUsageInformation(\DDEX\MEAD\MEAD_101\TextWithFormatType $usageInformation)
    {
