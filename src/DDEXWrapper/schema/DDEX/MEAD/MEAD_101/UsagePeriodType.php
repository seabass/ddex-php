...
class UsagePeriodType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\EventDateWithoutFlagsType $startDate
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\EventDateWithoutFlagsType $endDate
     */
     ...
     * A Composite containing details of the Date and Place of an Event that marks the beginning of the Period (in ISO 8601:2004 format: YYYY-MM-DD). The StartDate must be no later than the EndDate if both are provided.
     *
     * @return \DDEX\MEAD\MEAD_101\EventDateWithoutFlagsType
     */
     ...
     * A Composite containing details of the Date and Place of an Event that marks the beginning of the Period (in ISO 8601:2004 format: YYYY-MM-DD). The StartDate must be no later than the EndDate if both are provided.
     *
     * @param \DDEX\MEAD\MEAD_101\EventDateWithoutFlagsType $startDate
     * @return self
     */
    public function setStartDate(?\DDEX\MEAD\MEAD_101\EventDateWithoutFlagsType $startDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of an Event that marks the end of the Period (in ISO 8601:2004 format: YYYY-MM-DD). The EndDate must not be earlier than the StartDate if both are provided.
     *
     * @param \DDEX\MEAD\MEAD_101\EventDateWithoutFlagsType $endDate
     * @return self
     */
    public function setEndDate(?\DDEX\MEAD\MEAD_101\EventDateWithoutFlagsType $endDate = null)
    {
