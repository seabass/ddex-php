...
class ChildWorkHierarchyType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\ChildWorkHierarchyType[] $child
     */
    private $child = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_110\ChildWorkHierarchyType $child
     */
    public function addToChild(\DDEX\MEAD\MEAD_110\ChildWorkHierarchyType $child)
    {
        $this->child[] = $child;
        return $this;
    }
     ...
     * A Composite containing details of parents, children and siblings of the Work.
     *
     * @return \DDEX\MEAD\MEAD_110\ChildWorkHierarchyType[]
     */
