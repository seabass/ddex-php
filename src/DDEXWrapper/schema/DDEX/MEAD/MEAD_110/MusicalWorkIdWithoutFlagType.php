...
/**
 * Class representing MusicalWorkIdWithoutFlagType
 *
 * A Composite containing details of a MusicalWorkId.
 * Explanatory Note: This Composite is named MusicalWorkIdWithoutFlag to disambiguate it from the basic MusicalWorkId Composite.
 * XSD Type: MusicalWorkIdWithoutFlag
 */
class MusicalWorkIdWithoutFlagType
{
    /**
