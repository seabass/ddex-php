...
/**
 * Class representing ResourceIdWithoutFlagType
 *
 * A Composite containing details of ResourceIds.
 * Explanatory Note: This Composite is named ResourceIdWithoutFlag to disambiguate it from the basic ResourceId Composite.
 * XSD Type: ResourceIdWithoutFlag
 */
class ResourceIdWithoutFlagType
{
    /**
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\CatalogNumberType $catalogNumber
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\ProprietaryIdType[] $proprietaryId
     */
     ...
     * A Composite containing details of the CatalogNumber of the Resource.
     *
     * @return \DDEX\MEAD\MEAD_110\CatalogNumberType
     */
     ...
     * A Composite containing details of the CatalogNumber of the Resource.
     *
     * @param \DDEX\MEAD\MEAD_110\CatalogNumberType $catalogNumber
     * @return self
     */
    public function setCatalogNumber(?\DDEX\MEAD\MEAD_110\CatalogNumberType $catalogNumber = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_110\ProprietaryIdType $proprietaryId
     */
    public function addToProprietaryId(\DDEX\MEAD\MEAD_110\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of a ProprietaryIdentifier of the Resource.
     *
     * @return \DDEX\MEAD\MEAD_110\ProprietaryIdType[]
     */
