...
class SubGenreCategoryType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\SubGenreCategoryValueType[] $value
     */
    private $value = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_110\SubGenreCategoryValueType $value
     */
    public function addToValue(\DDEX\MEAD\MEAD_110\SubGenreCategoryValueType $value)
    {
        $this->value[] = $value;
        return $this;
    }
     ...
     * The text of the sub-genre.
     *
     * @return \DDEX\MEAD\MEAD_110\SubGenreCategoryValueType[]
     */
