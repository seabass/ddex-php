...
class TimeSignatureType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\MeterType $meter
     */
    private $meter = null;
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\TimeSignatureModulationType[] $modulation
     */
    private $modulation = [
     ...
     * A Composite containing details of a meter.
     *
     * @return \DDEX\MEAD\MEAD_110\MeterType
     */
     ...
     * A Composite containing details of a meter.
     *
     * @param \DDEX\MEAD\MEAD_110\MeterType $meter
     * @return self
     */
    public function setMeter(?\DDEX\MEAD\MEAD_110\MeterType $meter = null)
    {
        $this->meter = $meter;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_110\TimeSignatureModulationType $modulation
     */
    public function addToModulation(\DDEX\MEAD\MEAD_110\TimeSignatureModulationType $modulation)
    {
     ...
     * A Composite containing details of a time signature modulation.
     *
     * @return \DDEX\MEAD\MEAD_110\TimeSignatureModulationType[]
     */
