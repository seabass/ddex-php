...
class WorkSummaryType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\TitleWithPronunciationType[] $workTitle
     */
    private $workTitle = [
     ...
     * @return self
     */
    public function setMusicalWorkId(\DDEX\MEAD\MEAD_110\MusicalWorkIdWithoutFlagType $musicalWorkId)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_110\TitleWithPronunciationType $workTitle
     */
    public function addToWorkTitle(\DDEX\MEAD\MEAD_110\TitleWithPronunciationType $workTitle)
    {
