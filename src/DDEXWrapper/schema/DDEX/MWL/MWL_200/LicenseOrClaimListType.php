 ...
 *
 * A ddex:Composite containing details of ddex:Licenses or ddex:Claims.
 * XSD Type: LicenseOrClaimList
 */
class LicenseOrClaimListType
{
    /**
     * A ddex:Composite containing details of the ddex:License or ddex:Claim.
     *
     * @var \DDEX\MWL\MWL_200\LicenseOrClaimType[] $licenseOrClaim
     */
     ...
     */
    public function addToLicenseOrClaim(\DDEX\MWL\MWL_200\LicenseOrClaimType $licenseOrClaim)
    {
