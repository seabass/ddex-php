...
namespace DDEX\MWL\MWL_200\LicensingInformationRequestMessage;
...
class LicensingInformationRequestMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\MWL\MWL_200\LicensingInformationRequestItemType[] $licensingInformationRequestItem
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\LicensingInformationRequestItemType $licensingInformationRequestItem
     */
    public function addToLicensingInformationRequestItem(\DDEX\MWL\MWL_200\LicensingInformationRequestItemType $licensingInformationRequestItem)
    {
     ...
     * A ddex:Composite containing details of a request for additional information not previously contained in a mwl:LicenseOrClaimRequestMessage.
     *
     * @return \DDEX\MWL\MWL_200\LicensingInformationRequestItemType[]
     */
