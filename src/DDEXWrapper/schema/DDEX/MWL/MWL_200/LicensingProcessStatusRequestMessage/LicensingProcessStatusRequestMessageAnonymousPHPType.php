...
namespace DDEX\MWL\MWL_200\LicensingProcessStatusRequestMessage;

/**
 * Class representing LicensingProcessStatusRequestMessageAnonymousPHPType
 */
class LicensingProcessStatusRequestMessageAnonymousPHPType
{
    /**
    ...
    /**
     * The ddex:Language and script for the ddex:Elements of the mwl:LicensingProcessStatusRequestMessage as defined in IETF RfC 4646. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
    ...
    /**
     * The MessageHeader for the mwl:LicensingProcessStatusRequestMessage.
     *
    ...
    /**
     * A ddex:Composite containing details of an ddex:Identifier of the ddex:License or ddex:Claim request whose licensing process status is requested.
     *
