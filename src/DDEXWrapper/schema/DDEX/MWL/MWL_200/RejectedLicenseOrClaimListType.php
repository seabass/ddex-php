...
class RejectedLicenseOrClaimListType
{
     ...
     *
     * @var \DDEX\MWL\MWL_200\RejectedLicenseOrClaimType[] $rejectedLicenseOrClaim
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\RejectedLicenseOrClaimType $rejectedLicenseOrClaim
     */
    public function addToRejectedLicenseOrClaim(\DDEX\MWL\MWL_200\RejectedLicenseOrClaimType $rejectedLicenseOrClaim)
    {
     ...
     * A ddex:Composite containing details of the ddex:License or ddex:Claim that is rejected.
     *
     * @return \DDEX\MWL\MWL_200\RejectedLicenseOrClaimType[]
     */
