 ...
 *
 * A ddex:Composite containing details of a ddex:License or ddex:Claim that is rejected.
 * XSD Type: RejectedLicenseOrClaim
 */
class RejectedLicenseOrClaimType
{
    /**
     * A ddex:Composite containing details of an ddex:Identifier of the rejected ddex:License or ddex:Claim.
     *
    ...
    /**
     * A ddex:Composite containing a reason for a rejecting a ddex:License.
     *
    ...
    /**
     * A ddex:Flag indicating that all ddex:MusicalWorks subject to the rejected ddex:License or ddex:Claim are in the ddex:PublicDomain (=Yes) or not (=No).
     *
