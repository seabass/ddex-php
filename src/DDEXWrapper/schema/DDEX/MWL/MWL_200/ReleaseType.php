...
{
    /**
     * The ddex:Language and script for the ddex:Elements of the ddexC:Release as defined in IETF RfC 4646. The default is the same as indicated for the containing composite. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
    ...
    /**
     * The ddex:Flag indicating whether the ddex:Release ddex:Element was updated (=True) or not (=False). The ddex:Flag may only be used when the ddex:UpdateIndicator is set to ddex:UpdateMessage. When this ddex:Boolean ddex:Flag is set to true, the ddex:MessageRecipient is expected to replace any previously provided ddex:Release data with the now provided data.
     *
     * @var bool $isUpdated
     */
    ...
    /**
     * A ddex:Composite containing details of ddex:ReleaseIds. If available, a ddex:GRid shall always to be used. If the ddexC:Release contains only one ddex:SoundRecording, the ddex:ISRC of the ddex:SoundRecording may be used instead. If the ddexC:Release is an abstraction of a complete ddex:PhysicalProduct (such as a CD ddex:Album), the ddex:ICPN of the ddex:PhysicalProduct may be used instead. More than one of these identifiers may be provided.
     *
    ...
    /**
     * A ddex:Composite containing details of the ddex:ReferenceTitle of the ddexC:Release.
     *
    ...
    /**
     * A ddex:Composite containing details of one or more ddex:Resources contained in the ddexC:Release.
     *
    ...
    /**
     * A ddex:Composite containing details of one or more ddex:Collections contained in the ddexC:Release.
     *
    ...
    /**
     * A ddex:Composite containing details of the form in which a ddex:ReleaseCreator anticipates offering the ddexC:Release to ddex:Consumers. This may be overridden by the ddex:ReleaseType for specific Territories as specified in the ReleaseDetailsByTerritory ddex:Composite.
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ddexC:Release which may vary according to ddex:Territory of release.
     *
     * @var \DDEX\MWL\MWL_200\ReleaseDetailsByTerritoryType[] $releaseDetailsByTerritory
     */
    ...
    /**
     * The sum of the ddex:Durations of all ddex:Resources contained in the ddexC:Release (using the ISO 8601:2004 PT[[hhH]mmM]ssS format, where lower case characters indicate variables, upper case characters are part of the xs:string, e.g. one hour, two minutes and three seconds would be PT1H2M3S).
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:Identifiers of a ddex:License, ddex:Claim, ddex:RightShare or contract for the MusicalWork(s) used in the ddexC:Release.
     *
    ...
    /**
     * A ddex:Composite containing details of the ddex:PLine for the ddexC:Release.
     *
    ...
    /**
     * A ddex:Composite containing details of the ddex:CLine for the ddexC:Release.
     *
    ...
    /**
     * The ddex:Identifier (specific to the ddex:Message) of the ddex:Release. Used to link the ddex:Release to one or more Deal(s). This is a ddex:LocalReleaseAnchor starting with the letter R.
     *
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory
     */
    public function addToReleaseDetailsByTerritory(\DDEX\MWL\MWL_200\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ddexC:Release which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\MWL\MWL_200\ReleaseDetailsByTerritoryType[]
     */
