...
{
    /**
     * The ddex:Language and script for the ddex:Elements of the ddexC:SheetMusic as defined in IETF RfC 4646. The default is the same as indicated for the containing composite. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
    ...
    /**
     * The ddex:Flag indicating whether the mwl:SheetMusic ddex:Element was updated (=True) or not (=False). The ddex:Flag may only be used when the ddex:UpdateIndicator is set to ddex:UpdateMessage. When this ddex:Boolean ddex:Flag is set to true, the ddex:MessageRecipient is expected to replace any previously provided mwl:SheetMusic data with the now provided data.
     *
     * @var bool $isUpdated
     */
    ...
    /**
     * A ddex:Composite containing details of the ddex:Type of the ddexC:SheetMusic.
     *
    ...
    /**
     * The ddex:Flag indicating whether the ddexC:SheetMusic is related to an ddex:Artist (=True) or not (=False).
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:Identifiers of the ddexC:SheetMusic.
     *
    ...
    /**
     * A ddex:Composite containing details of a ddex:MusicalWorkId of a ddex:MusicalWork used in the ddexC:SheetMusic.
     *
    ...
    /**
     * The ddex:Language of the lyrics of the ddexC:SheetMusic (represented by an ISO 639-2 iso639a2:LanguageCode).
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:Identifiers of a ddex:License, ddex:Claim, ddex:RightShare or contract for the MusicalWork(s) related to the ddexC:SheetMusic.
     *
    ...
    /**
     * A ddex:Composite containing details of one or more ddex:MusicalWorks contained in the ddexC:SheetMusic.
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:ResourceContainedResourceReferences referring to a ddex:Resource that is contained in the current ddexC:SheetMusic.
     *
    ...
    /**
     * A ddex:Composite containing details of the ddex:ReferenceTitle of the ddexC:SheetMusic.
     *
    ...
    /**
     * A ddex:Composite containing details of the Date and ddex:Place of the ddex:Event in which the ddexC:SheetMusic was created.
     *
    ...
    /**
     * A ddex:Composite containing details of the ddexC:SheetMusic which may vary according to ddex:Territory of release.
     *
     * @var \DDEX\ddexC\SheetMusicDetailsByTerritoryType[] $sheetMusicDetailsByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\ddexC\SheetMusicDetailsByTerritoryType $sheetMusicDetailsByTerritory
     */
    public function addToSheetMusicDetailsByTerritory(\DDEX\ddexC\SheetMusicDetailsByTerritoryType $sheetMusicDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of the ddexC:SheetMusic which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\ddexC\SheetMusicDetailsByTerritoryType[]
     */
