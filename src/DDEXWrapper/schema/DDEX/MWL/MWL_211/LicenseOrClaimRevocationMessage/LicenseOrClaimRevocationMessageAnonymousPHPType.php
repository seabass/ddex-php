...
namespace DDEX\MWL\MWL_211\LicenseOrClaimRevocationMessage;
...
class LicenseOrClaimRevocationMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\MWL\MWL_211\LicenseOrClaimRevocationItemType[] $licenseOrClaimRevocationItem
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\LicenseOrClaimRevocationItemType $licenseOrClaimRevocationItem
     */
    public function addToLicenseOrClaimRevocationItem(\DDEX\MWL\MWL_211\LicenseOrClaimRevocationItemType $licenseOrClaimRevocationItem)
    {
     ...
     * A ddex:Composite containing details of the ddex:License or ddex:Claim that is being revoked.
     *
     * @return \DDEX\MWL\MWL_211\LicenseOrClaimRevocationItemType[]
     */
