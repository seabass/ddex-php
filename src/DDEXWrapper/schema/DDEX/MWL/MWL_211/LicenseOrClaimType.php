 ...
 *
 * A ddex:Composite containing details of a ddex:License or ddex:Claim.
...
class LicenseOrClaimType
{
    ...
    /**
     * The ddex:Identifier (specific to the ddex:Message) of the LicenseOrClaim within the ddex:Release or ddex:Creation which contains it. This is a ddex:LocalLicenseOrClaimAnchor starting with the letter L.
     *
