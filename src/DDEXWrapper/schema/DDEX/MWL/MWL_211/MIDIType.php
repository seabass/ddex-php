 ...
 *
 * A ddex:Composite containing details of a ddex:Set of computer instructions which enables a sound processor to generate generate sound (using the Musical Instrument Digital Interface as defined by the ddex:MIDI Manufacturers Association (MMA)).
 * XSD Type: MIDI
 */
class MIDIType
{
    /**
     * The ddex:Language and script for the ddex:Elements of the ddexC:MIDI as defined in IETF RfC 4646. The default is the same as indicated for the containing composite. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
    ...
    /**
     * The ddex:Flag indicating whether the mwl:MIDI ddex:Element was updated (=True) or not (=False). The ddex:Flag may only be used when the ddex:UpdateIndicator is set to ddex:UpdateMessage. When this ddex:Boolean ddex:Flag is set to true, the ddex:MessageRecipient is expected to replace any previously provided mwl:MIDI data with the now provided data.
     *
     * @var bool $isUpdated
     */
    ...
    /**
     * A ddex:Composite containing details of the ddex:Type of the ddexC:MIDI.
     *
     * @var \DDEX\ddexC\MidiTypeType $midiType
     */
    private $midiType = null;

    /**
     * The ddex:Flag indicating whether the ddexC:MIDI is related to an ddex:Artist (=True) or not (=False).
     *
     ...
     *
     * @var \DDEX\ddexC\MidiIdType[] $midiId
     */
    private $midiId = [
    ...
    /**
     * A ddex:Composite containing details of a ddex:MusicalWorkId of a ddex:MusicalWork used in the ddexC:MIDI.
     *
     * @var \DDEX\ddexC\MusicalWorkIdType[] $indirectMidiId
     */
    ...
    /**
     * The ddex:Identifier (specific to the ddex:Message) of the ddexC:MIDI within the ddex:Release which contains it. This is a ddex:LocalResourceAnchor starting with the letter A.
     *
    ...
    /**
     * A ddex:Composite containing details of the ddex:ReferenceTitle of the ddexC:MIDI.
     *
    ...
    /**
     * A ddex:Composite containing a ddex:Description of the ddex:Type of instrumentation of the MusicalWork(s) in the ddexC:MIDI.
     *
    ...
    /**
     * The ddex:Flag indicating whether the ddexC:MIDI is a ddex:Medley (=True) or not (=False).
     *
     * @var bool $isMedley
     */
    ...
    /**
     * The ddex:Flag indicating whether the ddexC:MIDI is a ddex:Potpourri (=True) or not (=False).
     *
    ...
    /**
     * The ddex:Flag indicating whether the ddexC:MIDI is instrumental (=True) or not (=False).
     *
    ...
    /**
     * The ddex:Flag indicating whether the ddexC:MIDI is used as background to other audio or audiovisual material (=True) or not (=False).
     *
    ...
    /**
     * The ddex:Flag indicating whether the ddexC:MIDI is hidden in some way from the ddex:Consumer (=True) or not (=False).
     *
    ...
    /**
     * The ddex:Flag indicating whether the ddexC:MIDI is additional to those on the original ddex:Release of which this is a ddex:Version (=True) or not (=False).
     *
    ...
    /**
     * The ddex:Flag indicating whether the ddexC:MIDI is generated by a computer (=True) or not (=False).
     *
    ...
    /**
     * A ddex:Flag indicating whether performer information is required (=True) or not (=False) when communicating details of the ddexC:MIDI.
     *
    ...
    /**
     * The ddex:Language of the ddex:Performance recorded in the ddexC:MIDI (represented by an ISO 639-2 iso639a2:LanguageCode).
     *
    ...
    /**
     * The ddex:Duration of the ddexC:MIDI (using the ISO 8601:2004 PT[[hhH]mmM]ssS format, where lower case characters indicate variables, upper case characters are part of the xs:string, e.g. one hour, two minutes and three seconds would be PT1H2M3S).
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:Identifiers of a ddex:License, ddex:Claim, ddex:RightShare or contract for the MusicalWork(s) used in the ddexC:MIDI.
     *
    ...
    /**
     * A ddex:Composite containing details of one or more ddex:MusicalWorks contained in the ddexC:MIDI.
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:ResourceContainedResourceReferences referring to a ddex:Resource that is contained in the current ddexC:MIDI.
     *
    ...
    /**
     * A ddex:Composite containing details of the Date and ddex:Place of the ddex:Event in which the ddexC:MIDI was created.
     *
    ...
    /**
     * A ddex:Composite containing details of the Date and ddex:Place of the ddex:Event in which the ddexC:MIDI was originally mastered (either in analogue or digital form).
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ddexC:MIDI which may vary according to ddex:Territory of release.
     *
     * @var \DDEX\ddexC\MidiDetailsByTerritoryType[] $midiDetailsByTerritory
     */
     ...
     * A ddex:Composite containing details of the ddex:Type of the ddexC:MIDI.
     *
     * @return \DDEX\ddexC\MidiTypeType
     */
     ...
     * A ddex:Composite containing details of the ddex:Type of the ddexC:MIDI.
     *
     * @param \DDEX\ddexC\MidiTypeType $midiType
     * @return self
     */
    public function setMidiType(?\DDEX\ddexC\MidiTypeType $midiType = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ddexC\MidiIdType $midiId
     */
    public function addToMidiId(\DDEX\ddexC\MidiIdType $midiId)
    {
        $this->midiId[] = $midiId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ddexC\MusicalWorkIdType $indirectMidiId
     */
    public function addToIndirectMidiId(\DDEX\ddexC\MusicalWorkIdType $indirectMidiId)
    {
     ...
     *
     * @return self
     * @param \DDEX\ddexC\MidiDetailsByTerritoryType $midiDetailsByTerritory
     */
    public function addToMidiDetailsByTerritory(\DDEX\ddexC\MidiDetailsByTerritoryType $midiDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ddexC:MIDI which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\ddexC\MidiDetailsByTerritoryType[]
     */
