...
class ReleaseType
{
     ...
     *
     * @var \DDEX\MWL\MWL_211\ReleaseDetailsByTerritoryType[] $releaseDetailsByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory
     */
    public function addToReleaseDetailsByTerritory(\DDEX\MWL\MWL_211\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ddexC:Release which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\MWL\MWL_211\ReleaseDetailsByTerritoryType[]
     */
