...
class ResourceListType
{
     ...
     *
     * @var \DDEX\MWL\MWL_211\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DDEX\MWL\MWL_211\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *
     * @var \DDEX\MWL\MWL_211\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DDEX\MWL\MWL_211\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DDEX\MWL\MWL_211\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DDEX\MWL\MWL_211\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DDEX\MWL\MWL_211\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @var \DDEX\MWL\MWL_211\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\MWL\MWL_211\SoundRecordingType $soundRecording)
    {
     ...
     * A ddex:Composite containing details of a ddex:SoundRecording.
     *
     * @return \DDEX\MWL\MWL_211\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\MIDIType $mIDI
     */
    public function addToMIDI(\DDEX\MWL\MWL_211\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:MIDI.
     *
     * @return \DDEX\MWL\MWL_211\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\VideoType $video
     */
    public function addToVideo(\DDEX\MWL\MWL_211\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Video.
     *
     * @return \DDEX\MWL\MWL_211\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\ImageType $image
     */
    public function addToImage(\DDEX\MWL\MWL_211\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A ddex:Composite containing details of an ddex:Image.
     *
     * @return \DDEX\MWL\MWL_211\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\TextType $text
     */
    public function addToText(\DDEX\MWL\MWL_211\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Text.
     *
     * @return \DDEX\MWL\MWL_211\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\MWL\MWL_211\SheetMusicType $sheetMusic)
    {
     ...
     * A ddex:Composite containing details of a ddex:SheetMusic.
     *
     * @return \DDEX\MWL\MWL_211\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\SoftwareType $software
     */
    public function addToSoftware(\DDEX\MWL\MWL_211\SoftwareType $software)
    {
     ...
     * A ddex:Composite containing details of an item of ddex:Software.
     *
     * @return \DDEX\MWL\MWL_211\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DDEX\MWL\MWL_211\UserDefinedResourceType $userDefinedResource)
    {
     ...
     * A ddex:Composite containing details of a ddex:UserDefinedResource.
     *
     * @return \DDEX\MWL\MWL_211\UserDefinedResourceType[]
     */
