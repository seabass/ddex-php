 ...
 *
 * A ddex:Composite containing details of a list of
...
class LicenseOrClaimConditionListType
{
     ...
     *  ddex:Elements of the mwl:LicenseOrClaimConditionList as defined in IETF RfC 4646. The
     ...
     *  conditions and/or limitations for Usages.
     *
     * @var \DDEX\MWL\MWL_212\LicenseOrClaimConditionType[] $licenseOrClaimCondition
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\LicenseOrClaimConditionType $licenseOrClaimCondition
     */
    public function addToLicenseOrClaimCondition(\DDEX\MWL\MWL_212\LicenseOrClaimConditionType $licenseOrClaimCondition)
    {
     ...
     *  conditions and/or limitations for Usages.
     *
     * @return \DDEX\MWL\MWL_212\LicenseOrClaimConditionType[]
     */
