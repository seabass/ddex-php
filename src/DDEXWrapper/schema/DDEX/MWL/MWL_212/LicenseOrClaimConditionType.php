 ...
 *  conditions and/or limitations for Usages.
...
class LicenseOrClaimConditionType
{
     ...
     *  LicenseOrClaimCondition ddex:Element was updated (=True) or not (=False). The
     *  ddex:Flag may only be used when the ddex:UpdateIndicator is set to
     *  ddex:UpdateMessage. When this ddex:Boolean ddex:Flag is set to true, the
     *  ddex:MessageRecipient is expected to replace any previously provided
     *  LicenseOrClaimCondition data with the now provided data.
     *
     * @var bool $isUpdated
     */
     ...
     *  ddex:Elements of the LicenseOrClaimCondition as defined in IETF RfC 4646. The default
     *  is the same as indicated for the containing composite. ddex:Language and Script are
     ...
     *  ddex:Message) of the LicenseOrClaimCondition within the ddex:Release or
     *  ddex:Creation which contains it. This is a ddex:LocalLicenseOrClaimConditionAnchor
    ...
    /**
     * A ddex:Composite containing ddex:Types and
     *  number of Usages of the ddex:Release.
     *
     ...
     *  ddex:RoyaltyRate.
     *
     * @var \DDEX\MWL\MWL_212\RoyaltyRateType[] $royaltyRate
     */
    private $royaltyRate = [
     ...
     *  ddex:PercentageRate.
     *
     * @var \DDEX\MWL\MWL_212\PercentageRateType[] $percentageRate
     */
    ...
    /**
     * An ddex:Amount which is paid in
     *  advance.
     *
     ...
     *  ddex:MusicalWork is an Arrangement of a ddex:Work in the ddex:PublicDomain (=Yes)
     *  or not (=No).
     *
    ...
    /**
     * A ddex:Flag indicating whether a clause
     *  is a controlled composition clause (=True) or not (=False).
     *
     ...
     *
     * @var \DDEX\MWL\MWL_212\ControlledCompositionClauseType $controlledCompositionClause
     */
    private $controlledCompositionClause = null;

    /**
     * A ddex:Flag indicating whether all the
     *  rate fields are to be paid per use (=True) or as a one-off payment
     *  (=False).
     *
    ...
    /**
     * A ddex:Flag indicating that the royalty
     *  rate terms will be overridden if someone else is paid more (=True) or not
     *  (=False).
     *
    ...
    /**
     * A ddex:Flag indicating whether conditions
     *  are applicable to predominantly musical ddex:Releases only (=True) or not
     *  (=False).
     *
    ...
    /**
     * A ddex:Composite containing details of a
     *  ddex:TaxRate applicable to the total ddex:Amount to be paid.
     *
    ...
    /**
     * A ddex:Composite containing details of a
     *  ddex:Type of ddex:Calculation method used by which the royalties are to be
     *  determined. This is a text string with no prescribed allowed
     *  values.
     *
    ...
    /**
     * A ddex:Composite containing an
     *  ddex:Annotation referring to documentation.
     *
     ...
     *  context (such as ddex:Dates, number of uses) in which the ddex:Rate is valid. The
     *  default is that the ddex:Rate applies indefinitely from the xs:date of issue of
     *  the Licence.
     *
     * @var \DDEX\MWL\MWL_212\RateValidityType $rateValidity
     */
     ...
     *  form of an ddex:Identifier, ddex:Name or ddex:Description) regarding the
     *  Usage.
     *
    ...
    /**
     * A ddex:Composite containing details of a
     *  ddex:Price at which the ddex:Release is to be offered.
     *
     ...
     *  special ddex:Deal is made between the ddex:Licensor and the ddex:Licensee
     *  (=True) or not (=False) regarding the royalties or payments due to be paid for
     *  Releases distributed under this ddex:Deal.
     *
    ...
    /**
     * A ddex:Composite containing supporting
    ...
    /**
     * A ddex:Composite containing technical
     *  details of the ddex:Release.
     *
     ...
     *  or more ddex:References contained in the mwl:LicenseOrClaimCondition. The
     *  condition only applies when the ddex:Work is used in the context of the
     *  ddex:Releases or ddex:Resources referenced in this element.
     *
     * @var \DDEX\MWL\MWL_212\LicenseOrClaimConditionReferenceListType $licenseOrClaimConditionReferenceList
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\RoyaltyRateType $royaltyRate
     */
    public function addToRoyaltyRate(\DDEX\MWL\MWL_212\RoyaltyRateType $royaltyRate)
    {
     ...
     *  ddex:RoyaltyRate.
     *
     * @return \DDEX\MWL\MWL_212\RoyaltyRateType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\PercentageRateType $percentageRate
     */
    public function addToPercentageRate(\DDEX\MWL\MWL_212\PercentageRateType $percentageRate)
    {
     ...
     *  ddex:PercentageRate.
     *
     * @return \DDEX\MWL\MWL_212\PercentageRateType[]
     */
     ...
     *  a controlled composition clause.
     *
     * @return \DDEX\MWL\MWL_212\ControlledCompositionClauseType
     */
     ...
     *  a controlled composition clause.
     *
     * @param \DDEX\MWL\MWL_212\ControlledCompositionClauseType $controlledCompositionClause
     * @return self
     */
    public function setControlledCompositionClause(?\DDEX\MWL\MWL_212\ControlledCompositionClauseType $controlledCompositionClause = null)
    {
     ...
     *  the Licence.
     *
     * @return \DDEX\MWL\MWL_212\RateValidityType
     */
     ...
     *  the Licence.
     *
     * @param \DDEX\MWL\MWL_212\RateValidityType $rateValidity
     * @return self
     */
    public function setRateValidity(?\DDEX\MWL\MWL_212\RateValidityType $rateValidity = null)
    {
     ...
     *  ddex:Releases or ddex:Resources referenced in this element.
     *
     * @return \DDEX\MWL\MWL_212\LicenseOrClaimConditionReferenceListType
     */
     ...
     *  ddex:Releases or ddex:Resources referenced in this element.
     *
     * @param \DDEX\MWL\MWL_212\LicenseOrClaimConditionReferenceListType $licenseOrClaimConditionReferenceList
     * @return self
     */
    public function setLicenseOrClaimConditionReferenceList(?\DDEX\MWL\MWL_212\LicenseOrClaimConditionReferenceListType $licenseOrClaimConditionReferenceList = null)
    {
