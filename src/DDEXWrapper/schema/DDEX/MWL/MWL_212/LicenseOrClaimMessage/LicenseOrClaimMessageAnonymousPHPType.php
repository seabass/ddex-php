...
namespace DDEX\MWL\MWL_212\LicenseOrClaimMessage;
...
class LicenseOrClaimMessageAnonymousPHPType
{
     ...
     *  ddex:Elements of the mwl:LicenseOrClaimMessage as defined in IETF RfC 4646.
     ...
     *  the ddex:Licenses or ddex:Claims.
     *
     * @var \DDEX\MWL\MWL_212\LicenseOrClaimType[] $licenseOrClaimList
     */
    private $licenseOrClaimList = null;

    /**
     * A ddex:Composite containing details of
     *  the ddex:Licenses or ddex:Claims that are refused.
     *
     * @var \DDEX\MWL\MWL_212\RefusedLicenseOrClaimType[] $refusedLicenseOrClaimList
     */
    private $refusedLicenseOrClaimList = null;

    /**
     * A ddex:Composite containing details of
     *  one or more ddex:Works being part of the Release(s) referred to in the
    ...
    /**
     * A ddex:Composite containing details of
     *  one or more ddex:Resources being part of the Release(s) referred to in the
     *  ddex:License or ddex:Claim.
     *
    ...
    /**
     * A ddex:Composite containing details of
     *  one or more ddex:Releases referred to in the ddex:License or
     *  ddex:Claim.
     *
    ...
    /**
     * A ddex:Composite containing details of
     *  ddex:RightShares referred to in the ddex:License or
     *  ddex:Claim.
     *
    ...
    /**
     * A ddex:Composite containing details of
     *  conditions and/or limitations for Usages which are referred to in the
     *  ddex:License or ddex:Claim.
     *
     ...
     *  details to support invoicing.
     *
     * @var \DDEX\MWL\MWL_212\InvoiceSupportInformationListType $invoiceSupportInformationList
     */
     ...
     */
    public function addToLicenseOrClaimList(\DDEX\MWL\MWL_212\LicenseOrClaimType $licenseOrClaim)
    {
     ...
     *  the ddex:Licenses or ddex:Claims.
     *
     * @param \DDEX\MWL\MWL_212\LicenseOrClaimType[] $licenseOrClaimList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\RefusedLicenseOrClaimType $refusedLicenseOrClaim
     */
    public function addToRefusedLicenseOrClaimList(\DDEX\MWL\MWL_212\RefusedLicenseOrClaimType $refusedLicenseOrClaim)
    {
     ...
     *  the ddex:Licenses or ddex:Claims that are refused.
     *
     * @return \DDEX\MWL\MWL_212\RefusedLicenseOrClaimType[]
     */
     ...
     *  the ddex:Licenses or ddex:Claims that are refused.
     *
     * @param \DDEX\MWL\MWL_212\RefusedLicenseOrClaimType[] $refusedLicenseOrClaimList
     * @return self
     */
     ...
     *  details to support invoicing.
     *
     * @return \DDEX\MWL\MWL_212\InvoiceSupportInformationListType
     */
     ...
     *  details to support invoicing.
     *
     * @param \DDEX\MWL\MWL_212\InvoiceSupportInformationListType $invoiceSupportInformationList
     * @return self
     */
    public function setInvoiceSupportInformationList(?\DDEX\MWL\MWL_212\InvoiceSupportInformationListType $invoiceSupportInformationList = null)
    {
