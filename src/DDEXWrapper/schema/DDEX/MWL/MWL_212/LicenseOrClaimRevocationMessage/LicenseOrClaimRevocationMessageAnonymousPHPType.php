...
namespace DDEX\MWL\MWL_212\LicenseOrClaimRevocationMessage;
...
class LicenseOrClaimRevocationMessageAnonymousPHPType
{
     ...
     *  ddex:Elements of the mwl:LicenseOrClaimRevocationMessage as defined in IETF RfC
     ...
     *  mwl:LicenseOrClaimRevocationMessage.
     *
     ...
     *  the ddex:License or ddex:Claim that is being revoked.
     *
     * @var \DDEX\MWL\MWL_212\LicenseOrClaimRevocationItemType[] $licenseOrClaimRevocationItem
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\LicenseOrClaimRevocationItemType $licenseOrClaimRevocationItem
     */
    public function addToLicenseOrClaimRevocationItem(\DDEX\MWL\MWL_212\LicenseOrClaimRevocationItemType $licenseOrClaimRevocationItem)
    {
     ...
     *  the ddex:License or ddex:Claim that is being revoked.
     *
     * @return \DDEX\MWL\MWL_212\LicenseOrClaimRevocationItemType[]
     */
