...
class LicensingProcessStatusItemType
{
     ...
     *  ddex:Identifier of the process status item of the ddex:License or ddex:Claim
     *  request.
     *
    ...
    /**
     * The operational status of the licensing
     *  process.
     *
    ...
    /**
     * A ddex:Composite containing details of an
     *  ddex:Identifier of the ddex:License or ddex:Claim request.
     *
