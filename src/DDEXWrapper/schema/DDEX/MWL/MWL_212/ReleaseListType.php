...
class ReleaseListType
{
     ...
     *  ddex:Elements of the mwl:ReleaseList as defined in IETF RfC 4646. The default is the
     ...
     *
     * @var \DDEX\MWL\MWL_212\ReleaseType[] $release
     */
    private $release = [
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\ReleaseType $release
     */
    public function addToRelease(\DDEX\MWL\MWL_212\ReleaseType $release)
    {
     ...
     *  ddex:DDEX ddex:Release.
     *
     * @return \DDEX\MWL\MWL_212\ReleaseType[]
     */
