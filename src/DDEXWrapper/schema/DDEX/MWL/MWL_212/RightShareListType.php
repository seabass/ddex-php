...
class RightShareListType
{
     ...
     *  ddex:Elements of the mwl:RightShareList as defined in IETF RfC 4646. The default is
     ...
     *  ddex:RightShare.
     *
     * @var \DDEX\MWL\MWL_212\RightShareType[] $rightShare
     */
    private $rightShare = [
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\RightShareType $rightShare
     */
    public function addToRightShare(\DDEX\MWL\MWL_212\RightShareType $rightShare)
    {
     ...
     *  ddex:RightShare.
     *
     * @return \DDEX\MWL\MWL_212\RightShareType[]
     */
