...
class LicenseRevocationItemType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\LicenseRefusalReasonType $reason
     */
    private $reason = null;
     ...
     * A Composite containing details of the reason for the revocation.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\LicenseRefusalReasonType
     */
     ...
     * A Composite containing details of the reason for the revocation.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\LicenseRefusalReasonType $reason
     * @return self
     */
    public function setReason(?\DDEX\MWN\MWN_US_LIC_100\LicenseRefusalReasonType $reason = null)
    {
        $this->reason = $reason;
        return $this;
    }
