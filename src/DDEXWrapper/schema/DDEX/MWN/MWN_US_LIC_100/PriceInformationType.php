...
class PriceInformationType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\DescriptionType $description
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\PriceTypeType $priceType
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\PriceType $wholesalePricePerUnit
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\PriceType $bulkOrderWholesalePricePerUnit
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\PriceType $suggestedRetailPrice
     */
     ...
     * A Composite containing a Description of the differences between multiple PriceInformation Composites.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\DescriptionType
     */
     ...
     * A Composite containing a Description of the differences between multiple PriceInformation Composites.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\DescriptionType $description
     * @return self
     */
    public function setDescription(?\DDEX\MWN\MWN_US_LIC_100\DescriptionType $description = null)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\PriceTypeType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\PriceTypeType $priceType
     * @return self
     */
    public function setPriceType(?\DDEX\MWN\MWN_US_LIC_100\PriceTypeType $priceType = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\PriceType
     */
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\PriceType $wholesalePricePerUnit
     * @return self
     */
    public function setWholesalePricePerUnit(?\DDEX\MWN\MWN_US_LIC_100\PriceType $wholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit, which informs the informs the DSP of the Price the Release should be offered at. Note that the size of a bulk order is defined in the contract between MessageSender and the MessageRecipient. This element should not be combined with PriceType.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\PriceType $bulkOrderWholesalePricePerUnit
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnit(?\DDEX\MWN\MWN_US_LIC_100\PriceType $bulkOrderWholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a suggested retail Price.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\PriceType $suggestedRetailPrice
     * @return self
     */
    public function setSuggestedRetailPrice(?\DDEX\MWN\MWN_US_LIC_100\PriceType $suggestedRetailPrice = null)
    {
