...
class RightsClaimPolicyType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\ConditionForRightsClaimPolicyType[] $condition
     */
    private $condition = [
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\ConditionForRightsClaimPolicyType $condition
     */
    public function addToCondition(\DDEX\MWN\MWN_US_LIC_100\ConditionForRightsClaimPolicyType $condition)
    {
     ...
     * A Composite containing details of Conditions. If more than one Condition is specified, then all of them have to be fulfilled (i.e. they are combined using the logical operator AND).
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\ConditionForRightsClaimPolicyType[]
     */
