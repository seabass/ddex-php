...
class AtomWriterType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\CreativeMusicalWorkContributorRoleType[] $role
     */
    private $role = [
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DDEX\MWN\MWN_US_LIC_101\DetailedPartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\DetailedPartyIdType[]
     */
     ...
     */
    public function addToPartyName(\DDEX\MWN\MWN_US_LIC_101\PartyNameType $partyName)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\CreativeMusicalWorkContributorRoleType $role
     */
    public function addToRole(\DDEX\MWN\MWN_US_LIC_101\CreativeMusicalWorkContributorRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * A Composite containing details of a role played by the Contributor in relation to the MusicalWork. Note: This can be used in a DdexMessage in relation to any Work, Performance or Fixation any of which may form the whole or part of the Resource itself. Example: if an 'AssociatedPerformer' is shown as a Contributor to a MusicalWork it refers to a performer of a Resource (e.g. a SoundRecording) expressing the MusicalWork.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\CreativeMusicalWorkContributorRoleType[]
     */
