...
class FtpMessageHeaderType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\MessagingPartyType $messageSender
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\MessagingPartyType $messageRecipient
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\DdexDigitalSignatureType $signature
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\MessagingPartyType
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\MessagingPartyType $messageSender
     * @return self
     */
    public function setMessageSender(\DDEX\MWN\MWN_US_LIC_101\MessagingPartyType $messageSender)
    {
     ...
     * A Composite containing details of the MessageRecipient.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\MessagingPartyType $messageRecipient
     * @return self
     */
    public function setMessageRecipient(\DDEX\MWN\MWN_US_LIC_101\MessagingPartyType $messageRecipient)
    {
     ...
     * A digital signature in accordance with DDEX-DSIG.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\DdexDigitalSignatureType
     */
     ...
     * A digital signature in accordance with DDEX-DSIG.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\DdexDigitalSignatureType $signature
     * @return self
     */
    public function setSignature(?\DDEX\MWN\MWN_US_LIC_101\DdexDigitalSignatureType $signature = null)
    {
