...
class LicenseRejectionType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\ProprietaryIdType $licenseRejectionId
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\LicenseRejectionReasonType $licenseRejectionReason
     */
     ...
     * A Composite containing details of an Identifier of the License Rejection.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\ProprietaryIdType $licenseRejectionId
     * @return self
     */
    public function setLicenseRejectionId(\DDEX\MWN\MWN_US_LIC_101\ProprietaryIdType $licenseRejectionId)
    {
     ...
     * A Composite containing a reason for rejecting a License.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\LicenseRejectionReasonType
     */
     ...
     * A Composite containing a reason for rejecting a License.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\LicenseRejectionReasonType $licenseRejectionReason
     * @return self
     */
    public function setLicenseRejectionReason(\DDEX\MWN\MWN_US_LIC_101\LicenseRejectionReasonType $licenseRejectionReason)
    {
