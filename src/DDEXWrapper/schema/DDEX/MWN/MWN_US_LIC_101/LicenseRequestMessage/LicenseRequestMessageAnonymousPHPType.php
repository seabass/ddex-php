...
namespace DDEX\MWN\MWN_US_LIC_101\LicenseRequestMessage;
...
class LicenseRequestMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\ResourceListType $resourceList
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\ReleaseType[] $releaseList
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\LicenseConditionType[] $conditionList
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\LicenseRequestType[] $licenseRequestList
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\ResourceListType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\ResourceListType $resourceList
     * @return self
     */
    public function setResourceList(?\DDEX\MWN\MWN_US_LIC_101\ResourceListType $resourceList = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\ReleaseType $release
     */
    public function addToReleaseList(\DDEX\MWN\MWN_US_LIC_101\ReleaseType $release)
    {
     ...
     * A Composite containing details of one or more Releases relating to the requests.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\ReleaseType[]
     */
     ...
     * A Composite containing details of one or more Releases relating to the requests.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\ReleaseType[] $releaseList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\LicenseConditionType $condition
     */
    public function addToConditionList(\DDEX\MWN\MWN_US_LIC_101\LicenseConditionType $condition)
    {
     ...
     * A Composite containing details of a list of conditions and/or limitations for Usages.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\LicenseConditionType[]
     */
     ...
     * A Composite containing details of a list of conditions and/or limitations for Usages.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\LicenseConditionType[] $conditionList
     * @return self
     */
     ...
     */
    public function addToLicenseRequestList(\DDEX\MWN\MWN_US_LIC_101\LicenseRequestType $licenseRequest)
    {
     ...
     * A Composite containing details of one or more Requests for a License.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\LicenseRequestType[] $licenseRequestList
     * @return self
     */
