...
class MessagingPartyType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\PartyNameType $partyName
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\NameType $tradingName
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\MWN\MWN_US_LIC_101\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party handling the Message. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\PartyIdType[]
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\PartyNameType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\PartyNameType $partyName
     * @return self
     */
    public function setPartyName(?\DDEX\MWN\MWN_US_LIC_101\PartyNameType $partyName = null)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\MWN\MWN_US_LIC_101\NameType $tradingName = null)
    {
