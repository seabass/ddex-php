...
class ReleaseType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\ReleaseTypeType $releaseType
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\ReleaseIdForNotificationType $releaseId
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\PLineType $pLine
     */
    private $pLine = null;
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\CLineType $cLine
     */
    private $cLine = null;
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\EventDateType $releaseDate
     */
     ...
     * A Composite containing details of the form in which a ReleaseCreator anticipates offering the Release to Consumers. This may be overridden by the ReleaseType for specific Territories as specified in the ReleaseDetailsByTerritory Composite.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\ReleaseTypeType
     */
     ...
     * A Composite containing details of the form in which a ReleaseCreator anticipates offering the Release to Consumers. This may be overridden by the ReleaseType for specific Territories as specified in the ReleaseDetailsByTerritory Composite.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\ReleaseTypeType $releaseType
     * @return self
     */
    public function setReleaseType(\DDEX\MWN\MWN_US_LIC_101\ReleaseTypeType $releaseType)
    {
     ...
     * A Composite containing details of ReleaseIds. If available, a GRid shall always to be used. If the Release contains only one SoundRecording, the ISRC of the SoundRecording may be used instead. If the Release is an abstraction of a complete PhysicalProduct (such as a CD Album), the ICPN of the PhysicalProduct may be used instead. More than one of these identifiers may be provided.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\ReleaseIdForNotificationType
     */
     ...
     * A Composite containing details of ReleaseIds. If available, a GRid shall always to be used. If the Release contains only one SoundRecording, the ISRC of the SoundRecording may be used instead. If the Release is an abstraction of a complete PhysicalProduct (such as a CD Album), the ICPN of the PhysicalProduct may be used instead. More than one of these identifiers may be provided.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\ReleaseIdForNotificationType $releaseId
     * @return self
     */
    public function setReleaseId(\DDEX\MWN\MWN_US_LIC_101\ReleaseIdForNotificationType $releaseId)
    {
     ...
     * @return self
     */
    public function setDisplayArtistName(\DDEX\MWN\MWN_US_LIC_101\DisplayArtistNameType $displayArtistName)
    {
     ...
     * A Composite containing details of the PLine for the Release.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\PLineType
     */
     ...
     * A Composite containing details of the PLine for the Release.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\PLineType $pLine
     * @return self
     */
    public function setPLine(?\DDEX\MWN\MWN_US_LIC_101\PLineType $pLine = null)
    {
        $this->pLine = $pLine;
        return $this;
    }
     ...
     * A Composite containing details of the CLine for the Release.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\CLineType
     */
     ...
     * A Composite containing details of the CLine for the Release.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\CLineType $cLine
     * @return self
     */
    public function setCLine(?\DDEX\MWN\MWN_US_LIC_101\CLineType $cLine = null)
    {
        $this->cLine = $cLine;
        return $this;
    }
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY[-MM[-DD]]).
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\EventDateType
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY[-MM[-DD]]).
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\EventDateType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DDEX\MWN\MWN_US_LIC_101\EventDateType $releaseDate = null)
    {
