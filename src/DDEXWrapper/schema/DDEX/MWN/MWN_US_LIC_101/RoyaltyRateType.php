...
class RoyaltyRateType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\RoyaltyCodeType $royaltyCode
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\RoyaltyAmountType $royaltyAmount
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\PercentageRateType[] $percentageRate
     */
     ...
     * A Composite containing details of the Type of the RoyaltyRate. Either this Element or RoyaltyAmount shall be present, but not both.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\RoyaltyCodeType
     */
     ...
     * A Composite containing details of the Type of the RoyaltyRate. Either this Element or RoyaltyAmount shall be present, but not both.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\RoyaltyCodeType $royaltyCode
     * @return self
     */
    public function setRoyaltyCode(?\DDEX\MWN\MWN_US_LIC_101\RoyaltyCodeType $royaltyCode = null)
    {
     ...
     * A Composite containing details of a RoyaltyAmount. Either this Element or RoyaltyCode shall be present, but not both.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\RoyaltyAmountType $royaltyAmount
     * @return self
     */
    public function setRoyaltyAmount(?\DDEX\MWN\MWN_US_LIC_101\RoyaltyAmountType $royaltyAmount = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\PercentageRateType $percentageRate
     */
    public function addToPercentageRate(\DDEX\MWN\MWN_US_LIC_101\PercentageRateType $percentageRate)
    {
     ...
     * A Composite containing details of a PercentageRate. The percentage is given as a xs:decimal value with up to 6 digits (e.g. '12.5' represents 12.5%).
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\PercentageRateType[]
     */
