...
class SupplementalDocumentType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\ProprietaryIdType $referencedDocumentId
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\ProprietaryIdType $documentId
     */
     ...
     * A Composite containing details of an Identifier of a previously sent document.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\ProprietaryIdType $referencedDocumentId
     * @return self
     */
    public function setReferencedDocumentId(?\DDEX\MWN\MWN_US_LIC_101\ProprietaryIdType $referencedDocumentId = null)
    {
     ...
     * A Composite containing details of the Identifier of the document sent in this Message, for future reference.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\ProprietaryIdType $documentId
     * @return self
     */
    public function setDocumentId(?\DDEX\MWN\MWN_US_LIC_101\ProprietaryIdType $documentId = null)
    {
