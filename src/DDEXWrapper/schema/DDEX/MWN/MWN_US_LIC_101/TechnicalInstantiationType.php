...
class TechnicalInstantiationType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\VideoDefinitionTypeType $videoDefinitionType
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\BitRateType $bitRate
     */
     ...
     * A Type of resolution (or definition) in which a Video is provided.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\VideoDefinitionTypeType
     */
     ...
     * A Type of resolution (or definition) in which a Video is provided.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\VideoDefinitionTypeType $videoDefinitionType
     * @return self
     */
    public function setVideoDefinitionType(?\DDEX\MWN\MWN_US_LIC_101\VideoDefinitionTypeType $videoDefinitionType = null)
    {
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\BitRateType
     */
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\BitRateType $bitRate
     * @return self
     */
    public function setBitRate(?\DDEX\MWN\MWN_US_LIC_101\BitRateType $bitRate = null)
    {
