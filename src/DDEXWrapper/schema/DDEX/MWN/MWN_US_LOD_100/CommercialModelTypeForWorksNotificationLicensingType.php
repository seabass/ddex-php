...
/**
 * Class representing CommercialModelTypeForWorksNotificationLicensingType
 *
 * A Composite containing details of a CommercialModelType.
 * Explanatory Note: This Composite is named CommercialModelTypeForWorksNotificationLicensing to disambiguate it from the basic CommercialModelType Composite. The name indicates that it is MWNL specific.
 * XSD Type: CommercialModelTypeForWorksNotificationLicensing
 */
class CommercialModelTypeForWorksNotificationLicensingType
{
    /**
     * @var string $__value
     */
