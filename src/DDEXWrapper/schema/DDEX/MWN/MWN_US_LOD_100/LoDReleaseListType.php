...
/**
 * Class representing LoDReleaseListType
 *
 * A Composite containing a list of CatalogReleaseReferences for Releases included in a CatalogTransfer.
 * XSD Type: LoDReleaseList
 */
class LoDReleaseListType
{
    /**
