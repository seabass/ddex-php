...
class MusicalWorkType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LOD_100\WriterType[] $writer
     */
    private $writer = [
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LOD_100\WriterType $writer
     */
    public function addToWriter(\DDEX\MWN\MWN_US_LOD_100\WriterType $writer)
    {
        $this->writer[] = $writer;
        return $this;
    }
     ...
     * A Composite containing details a MusicalWorkContributor to the MusicalWork.
     *
     * @return \DDEX\MWN\MWN_US_LOD_100\WriterType[]
     */
