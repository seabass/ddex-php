...
/**
 * Class representing UseTypeForWorksNotificationLicensingType
 *
 * A Composite containing details of a UseType.
 * Explanatory Note: This Composite is named UseTypeForWorksNotificationLicensing to disambiguate it from the basic UseType Composite. The name indicates that it is MWNL specific.
 * XSD Type: UseTypeForWorksNotificationLicensing
 */
class UseTypeForWorksNotificationLicensingType
{
    /**
     * @var string $__value
     */
