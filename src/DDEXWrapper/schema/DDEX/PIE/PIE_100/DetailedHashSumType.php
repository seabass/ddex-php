...
class DetailedHashSumType
{
     ...
     *
     * @var \DDEX\PIE\PIE_100\HashSumAlgorithmTypeType $algorithm
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @return \DDEX\PIE\PIE_100\HashSumAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @param \DDEX\PIE\PIE_100\HashSumAlgorithmTypeType $algorithm
     * @return self
     */
    public function setAlgorithm(\DDEX\PIE\PIE_100\HashSumAlgorithmTypeType $algorithm)
    {
