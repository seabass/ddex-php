...
class EntryType
{
     ...
     *
     * @var \DDEX\PIE\PIE_100\PersonType[] $author
     */
    private $author = [
     ...
     *
     * @var \DDEX\PIE\PIE_100\CategoryType[] $category
     */
    private $category = [
     ...
     *
     * @var \DDEX\PIE\PIE_100\ContentType $content
     */
     ...
     *
     * @var \DDEX\PIE\PIE_100\PersonType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @var \DDEX\PIE\PIE_100\LinkType[] $link
     */
    private $link = [
     ...
     *
     * @var \DDEX\PIE\PIE_100\TextType $rights
     */
    private $rights = null;
     ...
     *
     * @var \DDEX\PIE\PIE_100\SourceType $source
     */
    private $source = null;
     ...
     *
     * @var \DDEX\PIE\PIE_100\TextType $summary
     */
     ...
     *
     * @var \DDEX\PIE\PIE_100\TextType $title
     */
    private $title = null;
    ...
    /**
     * A Composite containing details of a Party. This is either the only entity about which the relevant PieMessage talks or the main one.
     *
     * @var \DDEX\PIE\PIE_100\PartyDescriptorForEntryType $party
     */
    private $party = null;
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\PersonType $author
     */
    public function addToAuthor(\DDEX\PIE\PIE_100\PersonType $author)
    {
        $this->author[] = $author;
        return $this;
    }
     ...
     * A Composite containing details of the Name, Identifier and Role(s) of an author of a Resource.
     *
     * @return \DDEX\PIE\PIE_100\PersonType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\CategoryType $category
     */
    public function addToCategory(\DDEX\PIE\PIE_100\CategoryType $category)
    {
     ...
     * A Composite containing details of a category.
     *
     * @return \DDEX\PIE\PIE_100\CategoryType[]
     */
     ...
     * A Composite containing details of a content.
     *
     * @return \DDEX\PIE\PIE_100\ContentType
     */
     ...
     * A Composite containing details of a content.
     *
     * @param \DDEX\PIE\PIE_100\ContentType $content
     * @return self
     */
    public function setContent(?\DDEX\PIE\PIE_100\ContentType $content = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\PersonType $contributor
     */
    public function addToContributor(\DDEX\PIE\PIE_100\PersonType $contributor)
    {
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\LinkType $link
     */
    public function addToLink(\DDEX\PIE\PIE_100\LinkType $link)
    {
        $this->link[] = $link;
        return $this;
    }
     ...
     * A Composite containing details of a link.
     *
     * @return \DDEX\PIE\PIE_100\LinkType[]
     */
     ...
     * A Composite containing details of rights.
     *
     * @return \DDEX\PIE\PIE_100\TextType
     */
     ...
     * A Composite containing details of rights.
     *
     * @param \DDEX\PIE\PIE_100\TextType $rights
     * @return self
     */
    public function setRights(?\DDEX\PIE\PIE_100\TextType $rights = null)
    {
        $this->rights = $rights;
        return $this;
    }
     ...
     * A Composite containing details of a source.
     *
     * @return \DDEX\PIE\PIE_100\SourceType
     */
     ...
     * A Composite containing details of a source.
     *
     * @param \DDEX\PIE\PIE_100\SourceType $source
     * @return self
     */
    public function setSource(?\DDEX\PIE\PIE_100\SourceType $source = null)
    {
        $this->source = $source;
        return $this;
    }
     ...
     * A Composite containing details of a summary.
     *
     * @param \DDEX\PIE\PIE_100\TextType $summary
     * @return self
     */
    public function setSummary(?\DDEX\PIE\PIE_100\TextType $summary = null)
    {
     ...
     * A Composite containing details of a title. The title should contain three pieces of information separated by a semicolon and a space character: (1) the DPID of the message sender (without dashes); (2) the subscription ID; and (3) the Date when the entry was added to the feed queue (in the ISO format yyyy-mm-dd).
     *
     * @param \DDEX\PIE\PIE_100\TextType $title
     * @return self
     */
    public function setTitle(?\DDEX\PIE\PIE_100\TextType $title = null)
    {
        $this->title = $title;
        return $this;
    }
     ...
     * A Composite containing details of a Party. This is either the only entity about which the relevant PieMessage talks or the main one.
     *
     * @return \DDEX\PIE\PIE_100\PartyDescriptorForEntryType
     */
     ...
     * A Composite containing details of a Party. This is either the only entity about which the relevant PieMessage talks or the main one.
     *
     * @param \DDEX\PIE\PIE_100\PartyDescriptorForEntryType $party
     * @return self
     */
    public function setParty(?\DDEX\PIE\PIE_100\PartyDescriptorForEntryType $party = null)
    {
        $this->party = $party;
        return $this;
    }
