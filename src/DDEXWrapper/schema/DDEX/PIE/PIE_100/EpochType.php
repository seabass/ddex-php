...
class EpochType
{
     ...
     *
     * @var \DDEX\PIE\PIE_100\NameType[] $value
     */
    private $value = [
     ...
     *
     * @var \DDEX\PIE\PIE_100\PartyDescriptorWithPronunciationType[] $relatedArtist
     */
     ...
     *
     * @var \DDEX\PIE\PIE_100\RelatedCreationType[] $relatedCreation
     */
     ...
     *
     * @var \DDEX\PIE\PIE_100\DateType $startDate
     */
     ...
     *
     * @var \DDEX\PIE\PIE_100\DateType $endDate
     */
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\NameType $value
     */
    public function addToValue(\DDEX\PIE\PIE_100\NameType $value)
    {
        $this->value[] = $value;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\PartyDescriptorWithPronunciationType $relatedArtist
     */
    public function addToRelatedArtist(\DDEX\PIE\PIE_100\PartyDescriptorWithPronunciationType $relatedArtist)
    {
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\RelatedCreationType $relatedCreation
     */
    public function addToRelatedCreation(\DDEX\PIE\PIE_100\RelatedCreationType $relatedCreation)
    {
     ...
     * A Composite containing details of a Creation (a Work, a Release or a Resource) that is part of the epoch.
     *
     * @return \DDEX\PIE\PIE_100\RelatedCreationType[]
     */
     ...
     * The Date that marks the beginning of the epoch. It can be represented as a calendar Year, Month or Day (in ISO 8601 format: YYYY, YYYY-MM or YYYY-MM-DD).
     *
     * @return \DDEX\PIE\PIE_100\DateType
     */
     ...
     * The Date that marks the beginning of the epoch. It can be represented as a calendar Year, Month or Day (in ISO 8601 format: YYYY, YYYY-MM or YYYY-MM-DD).
     *
     * @param \DDEX\PIE\PIE_100\DateType $startDate
     * @return self
     */
    public function setStartDate(?\DDEX\PIE\PIE_100\DateType $startDate = null)
    {
     ...
     * The Date that marks the end of the epoch. It can be represented as a calendar Year, Month or Day (in ISO 8601 format: YYYY, YYYY-MM or YYYY-MM-DD).
     *
     * @param \DDEX\PIE\PIE_100\DateType $endDate
     * @return self
     */
    public function setEndDate(?\DDEX\PIE\PIE_100\DateType $endDate = null)
    {
