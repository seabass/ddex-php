...
namespace DDEX\RDR_C\RDR_C_110\ManifestMessage;
...
class ManifestMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\FtpMessageHeaderType $ftpMessageHeader
     */
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\MessageNotificationPeriodType $messageNotificationPeriod
     */
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\MessageInBatchType[] $messageInBatch
     */
     ...
     * The MessageHeader for the ManifestMessage.
     *
     * @return \DDEX\RDR_C\RDR_C_110\FtpMessageHeaderType
     */
     ...
     * The MessageHeader for the ManifestMessage.
     *
     * @param \DDEX\RDR_C\RDR_C_110\FtpMessageHeaderType $ftpMessageHeader
     * @return self
     */
    public function setFtpMessageHeader(\DDEX\RDR_C\RDR_C_110\FtpMessageHeaderType $ftpMessageHeader)
    {
     ...
     * A Composite containing details of a reporting Period covered by the Message. It must contain at least one out of StartDate or EndDate. The StartDate must be earlier than the EndDate if both are provided.
     *
     * @return \DDEX\RDR_C\RDR_C_110\MessageNotificationPeriodType
     */
     ...
     * A Composite containing details of a reporting Period covered by the Message. It must contain at least one out of StartDate or EndDate. The StartDate must be earlier than the EndDate if both are provided.
     *
     * @param \DDEX\RDR_C\RDR_C_110\MessageNotificationPeriodType $messageNotificationPeriod
     * @return self
     */
    public function setMessageNotificationPeriod(?\DDEX\RDR_C\RDR_C_110\MessageNotificationPeriodType $messageNotificationPeriod = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RDR_C\RDR_C_110\MessageInBatchType $messageInBatch
     */
    public function addToMessageInBatch(\DDEX\RDR_C\RDR_C_110\MessageInBatchType $messageInBatch)
    {
     ...
     * A Composite containing details of a Message in the Batch.
     *
     * @return \DDEX\RDR_C\RDR_C_110\MessageInBatchType[]
     */
