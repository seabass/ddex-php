...
/**
 * Class representing InitialProducerType
 *
 * A Composite containing details of a Party that is an InitialProducer. A Party may be described through Name and Identifier.
 * XSD Type: InitialProducer
 */
class InitialProducerType
{
    /**
    ...
    /**
     * A Territory of the Party. The use of ISO TerritoryCodes is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
     * @var \DDEX\RDR_N\RDR_N_150\AllTerritoryCodeNoWorldwideType[] $territoryCode
     */
     ...
     *
     * @return self
     * @param \DDEX\RDR_N\RDR_N_150\AllTerritoryCodeNoWorldwideType $territoryCode
     */
    public function addToTerritoryCode(\DDEX\RDR_N\RDR_N_150\AllTerritoryCodeNoWorldwideType $territoryCode)
    {
