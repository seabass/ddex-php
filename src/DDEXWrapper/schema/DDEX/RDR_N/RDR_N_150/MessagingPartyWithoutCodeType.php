...
class MessagingPartyWithoutCodeType
{
     ...
     *
     * @var \DDEX\RDR_N\RDR_N_150\PartyNameWithoutCodeType $partyName
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @return \DDEX\RDR_N\RDR_N_150\PartyNameWithoutCodeType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @param \DDEX\RDR_N\RDR_N_150\PartyNameWithoutCodeType $partyName
     * @return self
     */
    public function setPartyName(?\DDEX\RDR_N\RDR_N_150\PartyNameWithoutCodeType $partyName = null)
    {
