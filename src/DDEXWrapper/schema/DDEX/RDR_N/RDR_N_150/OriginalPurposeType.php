...
/**
 * Class representing OriginalPurposeType
 *
 * A Composite containing details of an original purpose of a recording.
 * XSD Type: OriginalPurpose
 */
class OriginalPurposeType
{
    /**
     * @var string $__value
     */
