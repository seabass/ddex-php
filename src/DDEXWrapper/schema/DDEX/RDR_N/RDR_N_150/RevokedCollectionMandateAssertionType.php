...
/**
 * Class representing RevokedCollectionMandateAssertionType
 *
 * A Composite containing details of a revoked Assertion of collection Mandates.
 * XSD Type: RevokedCollectionMandateAssertion
 */
class RevokedCollectionMandateAssertionType
{
    /**
     ...
     *
     * @var \DDEX\RDR_N\RDR_N_150\CollectionMandateInRevocationType[] $assignedCollectionMandate
     */
     ...
     *
     * @return self
     * @param \DDEX\RDR_N\RDR_N_150\CollectionMandateInRevocationType $assignedCollectionMandate
     */
    public function addToAssignedCollectionMandate(\DDEX\RDR_N\RDR_N_150\CollectionMandateInRevocationType $assignedCollectionMandate)
    {
     ...
     * A Composite containing details of a collection Mandate.
     *
     * @return \DDEX\RDR_N\RDR_N_150\CollectionMandateInRevocationType[]
     */
