...
class DataCarrierType
{
     ...
     *
     * @var \DDEX\RIN\RIN10F\ProprietaryIdType[] $dataCarrierId
     */
     ...
     */
    public function addToDataCarrierId(\DDEX\RIN\RIN10F\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of an Identifier of the DataCarrier.
     *
     * @param \DDEX\RIN\RIN10F\ProprietaryIdType[] $dataCarrierId
     * @return self
     */
