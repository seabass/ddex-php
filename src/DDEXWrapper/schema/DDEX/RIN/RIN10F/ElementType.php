...
class ElementType
{
     ...
     *
     * @var \DDEX\RIN\RIN10F\ProprietaryIdType[] $elementId
     */
     ...
     *
     * @var \DDEX\RIN\RIN10F\ElementDataCarrierReferenceType $elementDataCarrierReference
     */
     ...
     */
    public function addToElementId(\DDEX\RIN\RIN10F\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of an Identifier of the Element.
     *
     * @param \DDEX\RIN\RIN10F\ProprietaryIdType[] $elementId
     * @return self
     */
     ...
     * A Composite containing details of a DataCarrier in which the Element is used.
     *
     * @return \DDEX\RIN\RIN10F\ElementDataCarrierReferenceType
     */
     ...
     * A Composite containing details of a DataCarrier in which the Element is used.
     *
     * @param \DDEX\RIN\RIN10F\ElementDataCarrierReferenceType $elementDataCarrierReference
     * @return self
     */
    public function setElementDataCarrierReference(\DDEX\RIN\RIN10F\ElementDataCarrierReferenceType $elementDataCarrierReference)
    {
