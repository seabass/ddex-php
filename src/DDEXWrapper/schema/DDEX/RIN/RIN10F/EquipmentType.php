...
class EquipmentType
{
     ...
     *
     * @var \DDEX\RIN\RIN10F\ProprietaryIdType[] $equipmentId
     */
     ...
     */
    public function addToEquipmentId(\DDEX\RIN\RIN10F\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of an Identifier of the Equipment.
     *
     * @param \DDEX\RIN\RIN10F\ProprietaryIdType[] $equipmentId
     * @return self
     */
