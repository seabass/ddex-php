...
class PartyType
{
     ...
     *
     * @var \DDEX\RIN\RIN11F\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\RIN\RIN11F\DetailedPartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\RIN\RIN11F\AffiliationType[] $affiliation
     */
    private $affiliation = [
     ...
     *
     * @var \DDEX\RIN\RIN11F\RelatedPartyType[] $relatedParty
     */
     ...
     *
     * @var \DDEX\RIN\RIN11F\AllTerritoryCodeType $territoryOfResidency
     */
     ...
     *
     * @var \DDEX\RIN\RIN11F\PostalAddressType[] $postalAddress
     */
     ...
     *
     * @var \DDEX\RIN\RIN11F\PhoneNumberType[] $phoneNumber
     */
    private $phoneNumber = [
     ...
     *
     * @var \DDEX\RIN\RIN11F\EmailAddressType[] $emailAddress
     */
     ...
     *
     * @var \DDEX\RIN\RIN11F\CurrentTerritoryCodeType[] $nationality
     */
    private $nationality = [
     ...
     *
     * @var \DDEX\RIN\RIN11F\EventDateType $dateAndPlaceOfBirth
     */
     ...
     *
     * @var \DDEX\RIN\RIN11F\EventDateType $dateAndPlaceOfDeath
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DDEX\RIN\RIN11F\DetailedPartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\RIN\RIN11F\DetailedPartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\DetailedPartyNameType $partyName
     */
    public function addToPartyName(\DDEX\RIN\RIN11F\DetailedPartyNameType $partyName)
    {
     ...
     * A Composite containing details of the PartyName(s).
     *
     * @return \DDEX\RIN\RIN11F\DetailedPartyNameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\AffiliationType $affiliation
     */
    public function addToAffiliation(\DDEX\RIN\RIN11F\AffiliationType $affiliation)
    {
     ...
     * A Composite containing details of an affiliation.
     *
     * @return \DDEX\RIN\RIN11F\AffiliationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\RelatedPartyType $relatedParty
     */
    public function addToRelatedParty(\DDEX\RIN\RIN11F\RelatedPartyType $relatedParty)
    {
     ...
     * A Composite containing details of a PartyRelatedPartyReference referring to a Party that is related to the current Party.
     *
     * @return \DDEX\RIN\RIN11F\RelatedPartyType[]
     */
     ...
     * The country of main residency of the Party.
     *
     * @return \DDEX\RIN\RIN11F\AllTerritoryCodeType
     */
     ...
     * The country of main residency of the Party.
     *
     * @param \DDEX\RIN\RIN11F\AllTerritoryCodeType $territoryOfResidency
     * @return self
     */
    public function setTerritoryOfResidency(?\DDEX\RIN\RIN11F\AllTerritoryCodeType $territoryOfResidency = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\PostalAddressType $postalAddress
     */
    public function addToPostalAddress(\DDEX\RIN\RIN11F\PostalAddressType $postalAddress)
    {
     ...
     * A Composite containing details of a PostalAddress of the Party.
     *
     * @return \DDEX\RIN\RIN11F\PostalAddressType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\PhoneNumberType $phoneNumber
     */
    public function addToPhoneNumber(\DDEX\RIN\RIN11F\PhoneNumberType $phoneNumber)
    {
     ...
     * A Composite containing details of a PhoneNumber of the Party.
     *
     * @return \DDEX\RIN\RIN11F\PhoneNumberType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\EmailAddressType $emailAddress
     */
    public function addToEmailAddress(\DDEX\RIN\RIN11F\EmailAddressType $emailAddress)
    {
     ...
     * A Composite containing details of an EmailAddress of the Party.
     *
     * @return \DDEX\RIN\RIN11F\EmailAddressType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\CurrentTerritoryCodeType $nationality
     */
    public function addToNationality(\DDEX\RIN\RIN11F\CurrentTerritoryCodeType $nationality)
    {
     ...
     * The nationality of the Party.
     *
     * @return \DDEX\RIN\RIN11F\CurrentTerritoryCodeType[]
     */
     ...
     * A Composite containing details of the Date and Place of birth. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN11F\EventDateType $dateAndPlaceOfBirth
     * @return self
     */
    public function setDateAndPlaceOfBirth(?\DDEX\RIN\RIN11F\EventDateType $dateAndPlaceOfBirth = null)
    {
     ...
     * A Composite containing details of the Date and Place of death. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN11F\EventDateType $dateAndPlaceOfDeath
     * @return self
     */
    public function setDateAndPlaceOfDeath(?\DDEX\RIN\RIN11F\EventDateType $dateAndPlaceOfDeath = null)
    {
