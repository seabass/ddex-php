...
class SessionType
{
     ...
     *
     * @var \DDEX\RIN\RIN11F\ProprietaryIdType[] $sessionId
     */
     ...
     *
     * @var \DDEX\RIN\RIN11F\VenueType[] $venue
     */
    private $venue = [
     ...
     *
     * @var \DDEX\RIN\RIN11F\SessionContributorReferenceType[] $contributor
     */
    private $contributor = [
     ...
     */
    public function addToSessionId(\DDEX\RIN\RIN11F\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of an Identifier of the Session.
     *
     * @param \DDEX\RIN\RIN11F\ProprietaryIdType[] $sessionId
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\VenueType $venue
     */
    public function addToVenue(\DDEX\RIN\RIN11F\VenueType $venue)
    {
        $this->venue[] = $venue;
        return $this;
    }
     ...
     * A Composite containing details of the venue where the Session took place.
     *
     * @return \DDEX\RIN\RIN11F\VenueType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\SessionContributorReferenceType $contributor
     */
    public function addToContributor(\DDEX\RIN\RIN11F\SessionContributorReferenceType $contributor)
    {
     ...
     * A Composite containing details of a Contributor to the Session.
     *
     * @return \DDEX\RIN\RIN11F\SessionContributorReferenceType[]
     */
