...
class AffiliationType
{
     ...
     *
     * @var \DDEX\RIN\RIN11M\CurrentTerritoryCodeType[] $territoryCode
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\CurrentTerritoryCodeType[] $excludedTerritoryCode
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\ValidityPeriodType $validityPeriod
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\SimpleRightsTypeType[] $rightsType
     */
    private $rightsType = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\CurrentTerritoryCodeType $territoryCode
     */
    public function addToTerritoryCode(\DDEX\RIN\RIN11M\CurrentTerritoryCodeType $territoryCode)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\CurrentTerritoryCodeType $excludedTerritoryCode
     */
    public function addToExcludedTerritoryCode(\DDEX\RIN\RIN11M\CurrentTerritoryCodeType $excludedTerritoryCode)
    {
     ...
     * A Composite containing details about the Period of Time for which the society affiliation is valid.
     *
     * @return \DDEX\RIN\RIN11M\ValidityPeriodType
     */
     ...
     * A Composite containing details about the Period of Time for which the society affiliation is valid.
     *
     * @param \DDEX\RIN\RIN11M\ValidityPeriodType $validityPeriod
     * @return self
     */
    public function setValidityPeriod(?\DDEX\RIN\RIN11M\ValidityPeriodType $validityPeriod = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\SimpleRightsTypeType $rightsType
     */
    public function addToRightsType(\DDEX\RIN\RIN11M\SimpleRightsTypeType $rightsType)
    {
     ...
     * A Composite containing details of a rights type.
     *
     * @return \DDEX\RIN\RIN11M\SimpleRightsTypeType[]
     */
