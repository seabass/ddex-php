...
class PartyDescriptorType
{
     ...
     *
     * @var \DDEX\RIN\RIN11M\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\PartyNameType $partyName
     */
    public function addToPartyName(\DDEX\RIN\RIN11M\PartyNameType $partyName)
    {
     ...
     * A Composite containing details of the PartyName(s).
     *
     * @return \DDEX\RIN\RIN11M\PartyNameType[]
     */
