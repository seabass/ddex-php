...
class PartyType
{
     ...
     *
     * @var \DDEX\RIN\RIN11M\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\RIN\RIN11M\DetailedPartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\RIN\RIN11M\AffiliationType[] $affiliation
     */
    private $affiliation = [
     ...
     *
     * @var \DDEX\RIN\RIN11M\RelatedPartyType[] $relatedParty
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\AllTerritoryCodeType $territoryOfResidency
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\PostalAddressType[] $postalAddress
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\PhoneNumberType[] $phoneNumber
     */
    private $phoneNumber = [
     ...
     *
     * @var \DDEX\RIN\RIN11M\EmailAddressType[] $emailAddress
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\CurrentTerritoryCodeType[] $nationality
     */
    private $nationality = [
     ...
     *
     * @var \DDEX\RIN\RIN11M\EventDateType $dateAndPlaceOfBirth
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\EventDateType $dateAndPlaceOfDeath
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DDEX\RIN\RIN11M\DetailedPartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\RIN\RIN11M\DetailedPartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\DetailedPartyNameType $partyName
     */
    public function addToPartyName(\DDEX\RIN\RIN11M\DetailedPartyNameType $partyName)
    {
     ...
     * A Composite containing details of the PartyName(s).
     *
     * @return \DDEX\RIN\RIN11M\DetailedPartyNameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\AffiliationType $affiliation
     */
    public function addToAffiliation(\DDEX\RIN\RIN11M\AffiliationType $affiliation)
    {
     ...
     * A Composite containing details of an affiliation.
     *
     * @return \DDEX\RIN\RIN11M\AffiliationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\RelatedPartyType $relatedParty
     */
    public function addToRelatedParty(\DDEX\RIN\RIN11M\RelatedPartyType $relatedParty)
    {
     ...
     * A Composite containing details of a PartyRelatedPartyReference referring to a Party that is related to the current Party.
     *
     * @return \DDEX\RIN\RIN11M\RelatedPartyType[]
     */
     ...
     * The country of main residency of the Party.
     *
     * @param \DDEX\RIN\RIN11M\AllTerritoryCodeType $territoryOfResidency
     * @return self
     */
    public function setTerritoryOfResidency(?\DDEX\RIN\RIN11M\AllTerritoryCodeType $territoryOfResidency = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\PostalAddressType $postalAddress
     */
    public function addToPostalAddress(\DDEX\RIN\RIN11M\PostalAddressType $postalAddress)
    {
     ...
     * A Composite containing details of a PostalAddress of the Party.
     *
     * @return \DDEX\RIN\RIN11M\PostalAddressType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\PhoneNumberType $phoneNumber
     */
    public function addToPhoneNumber(\DDEX\RIN\RIN11M\PhoneNumberType $phoneNumber)
    {
     ...
     * A Composite containing details of a PhoneNumber of the Party.
     *
     * @return \DDEX\RIN\RIN11M\PhoneNumberType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\EmailAddressType $emailAddress
     */
    public function addToEmailAddress(\DDEX\RIN\RIN11M\EmailAddressType $emailAddress)
    {
     ...
     * A Composite containing details of an EmailAddress of the Party.
     *
     * @return \DDEX\RIN\RIN11M\EmailAddressType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\CurrentTerritoryCodeType $nationality
     */
    public function addToNationality(\DDEX\RIN\RIN11M\CurrentTerritoryCodeType $nationality)
    {
     ...
     * The nationality of the Party.
     *
     * @return \DDEX\RIN\RIN11M\CurrentTerritoryCodeType[]
     */
     ...
     * A Composite containing details of the Date and Place of birth. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @return \DDEX\RIN\RIN11M\EventDateType
     */
     ...
     * A Composite containing details of the Date and Place of birth. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN11M\EventDateType $dateAndPlaceOfBirth
     * @return self
     */
    public function setDateAndPlaceOfBirth(?\DDEX\RIN\RIN11M\EventDateType $dateAndPlaceOfBirth = null)
    {
     ...
     * A Composite containing details of the Date and Place of death. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN11M\EventDateType $dateAndPlaceOfDeath
     * @return self
     */
    public function setDateAndPlaceOfDeath(?\DDEX\RIN\RIN11M\EventDateType $dateAndPlaceOfDeath = null)
    {
