...
class RecordingComponentType
{
     ...
     *
     * @var \DDEX\RIN\RIN11M\ProprietaryIdType[] $recordingComponentId
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\RecordingComponentContributorReferenceType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @var \DDEX\RIN\RIN11M\EventDateType $creationDate
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\ProprietaryIdType $proprietaryId
     */
    public function addToRecordingComponentId(\DDEX\RIN\RIN11M\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of an Identifier of the RecordingComponent.
     *
     * @return \DDEX\RIN\RIN11M\ProprietaryIdType[]
     */
     ...
     * A Composite containing details of an Identifier of the RecordingComponent.
     *
     * @param \DDEX\RIN\RIN11M\ProprietaryIdType[] $recordingComponentId
     * @return self
     */
     ...
     * @return self
     */
    public function setComment(?\DDEX\RIN\RIN11M\CommentType $comment = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\RecordingComponentContributorReferenceType $contributor
     */
    public function addToContributor(\DDEX\RIN\RIN11M\RecordingComponentContributorReferenceType $contributor)
    {
     ...
     * A Composite containing a RecordingComponentContributorReference.
     *
     * @return \DDEX\RIN\RIN11M\RecordingComponentContributorReferenceType[]
     */
     ...
     * A Composite containing details of the Date at which the RecordingComponent was created. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN11M\EventDateType $creationDate
     * @return self
     */
    public function setCreationDate(?\DDEX\RIN\RIN11M\EventDateType $creationDate = null)
    {
