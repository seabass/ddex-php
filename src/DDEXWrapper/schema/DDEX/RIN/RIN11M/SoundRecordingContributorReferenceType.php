...
class SoundRecordingContributorReferenceType
{
     ...
     *
     * @var \DDEX\RIN\RIN11M\ContributorRoleType[] $role
     */
    private $role = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\ContributorRoleType $role
     */
    public function addToRole(\DDEX\RIN\RIN11M\ContributorRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * A Composite containing details of a role played by the Contributor in relation to the Resource.
     *
     * @return \DDEX\RIN\RIN11M\ContributorRoleType[]
     */
