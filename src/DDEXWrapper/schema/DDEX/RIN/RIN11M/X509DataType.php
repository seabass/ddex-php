...
class X509DataType
{
     ...
     *
     * @var \DDEX\RIN\RIN11M\PartyIdType $partyId
     */
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\RIN\RIN11M\PartyIdType
     */
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @param \DDEX\RIN\RIN11M\PartyIdType $partyId
     * @return self
     */
    public function setPartyId(?\DDEX\RIN\RIN11M\PartyIdType $partyId = null)
    {
