...
namespace DDEX\RIN\RIN_200\ManifestMessage;
...
class ManifestMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\FtpMessageHeaderType $messageHeader
     */
     ...
     *
     * @var \DDEX\RIN\RIN_200\MessageNotificationPeriodType $messageNotificationPeriod
     */
     ...
     *
     * @var \DDEX\RIN\RIN_200\MessageInBatchType[] $messageInBatch
     */
     ...
     * The MessageHeader for the ManifestMessage.
     *
     * @return \DDEX\RIN\RIN_200\FtpMessageHeaderType
     */
     ...
     * The MessageHeader for the ManifestMessage.
     *
     * @param \DDEX\RIN\RIN_200\FtpMessageHeaderType $messageHeader
     * @return self
     */
    public function setMessageHeader(\DDEX\RIN\RIN_200\FtpMessageHeaderType $messageHeader)
    {
     ...
     * A Composite containing details of a reporting Period covered by the Messages. It must contain at least one out of StartDate or EndDate. The StartDate must be earlier than the EndDate if both are provided.
     *
     * @return \DDEX\RIN\RIN_200\MessageNotificationPeriodType
     */
     ...
     * A Composite containing details of a reporting Period covered by the Messages. It must contain at least one out of StartDate or EndDate. The StartDate must be earlier than the EndDate if both are provided.
     *
     * @param \DDEX\RIN\RIN_200\MessageNotificationPeriodType $messageNotificationPeriod
     * @return self
     */
    public function setMessageNotificationPeriod(\DDEX\RIN\RIN_200\MessageNotificationPeriodType $messageNotificationPeriod)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\MessageInBatchType $messageInBatch
     */
    public function addToMessageInBatch(\DDEX\RIN\RIN_200\MessageInBatchType $messageInBatch)
    {
     ...
     * A Composite containing details of a Message in the Batch.
     *
     * @return \DDEX\RIN\RIN_200\MessageInBatchType[]
     */
