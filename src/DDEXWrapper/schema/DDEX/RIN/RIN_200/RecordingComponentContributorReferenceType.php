...
class RecordingComponentContributorReferenceType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\ContributorRoleType[] $role
     */
    private $role = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\ContributorRoleType $role
     */
    public function addToRole(\DDEX\RIN\RIN_200\ContributorRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * A Composite containing details of a role played by the Contributor in relation to the Resource.
     *
     * @return \DDEX\RIN\RIN_200\ContributorRoleType[]
     */
