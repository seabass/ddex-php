...
class SessionType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\ProprietaryIdType[] $sessionId
     */
     ...
     *
     * @var \DDEX\RIN\RIN_200\VenueType[] $venue
     */
    private $venue = [
     ...
     *
     * @var \DDEX\RIN\RIN_200\SessionContributorReferenceType[] $contributor
     */
    private $contributor = [
     ...
     */
    public function addToSessionId(\DDEX\RIN\RIN_200\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of an Identifier of the Session.
     *
     * @param \DDEX\RIN\RIN_200\ProprietaryIdType[] $sessionId
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\VenueType $venue
     */
    public function addToVenue(\DDEX\RIN\RIN_200\VenueType $venue)
    {
        $this->venue[] = $venue;
        return $this;
    }
     ...
     * A Composite containing details of the venue where the Session took place.
     *
     * @return \DDEX\RIN\RIN_200\VenueType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\SessionContributorReferenceType $contributor
     */
    public function addToContributor(\DDEX\RIN\RIN_200\SessionContributorReferenceType $contributor)
    {
     ...
     * A Composite containing details of a Contributor to the Session.
     *
     * @return \DDEX\RIN\RIN_200\SessionContributorReferenceType[]
     */
