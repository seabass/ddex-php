...
class StatusType
{
    ...
    /**
     * The Namespace of the Status. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the Status. This is represented in an XML schema as an XML Attribute.
     *
