...
class TitleDisplayInformationType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\PrefixType[] $prefix
     */
    private $prefix = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\PrefixType $prefix
     */
    public function addToPrefix(\DDEX\RIN\RIN_200\PrefixType $prefix)
    {
        $this->prefix[] = $prefix;
        return $this;
    }
     ...
     * A Descriptor that precedes the display artist name when multiple display artist names are given.
     *
     * @return \DDEX\RIN\RIN_200\PrefixType[]
     */
