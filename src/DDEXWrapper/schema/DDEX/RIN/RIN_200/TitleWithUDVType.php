...
/**
 * Class representing TitleWithUDVType
 *
 * A Composite containing details of a Title.
 * Explanatory Note: This Composite is named TitleWithUDV to disambiguate it from the basic Title Composite.
 * XSD Type: TitleWithUDV
 */
class TitleWithUDVType
{
    /**
     ...
     *
     * @var \DDEX\RIN\RIN_200\SubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\SubTitleType $subTitle
     */
    public function addToSubTitle(\DDEX\RIN\RIN_200\SubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DDEX\RIN\RIN_200\SubTitleType[]
     */
