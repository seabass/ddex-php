...
class DisplayArtistType
{
     ...
     *
     * @var \DDEX\RIN\RIN_210\TitleDisplayInformationType[] $titleDisplayInformation
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\ContributorRoleType[] $artisticRole
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\TitleDisplayInformationType $titleDisplayInformation
     */
    public function addToTitleDisplayInformation(\DDEX\RIN\RIN_210\TitleDisplayInformationType $titleDisplayInformation)
    {
     ...
     * A Composite containing information on how a RecordCompany wishes Artist information to be presented to Consumers as part of the Title (and in addition to displaying the DisplayArtist information).
     *
     * @return \DDEX\RIN\RIN_210\TitleDisplayInformationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\ContributorRoleType $artisticRole
     */
    public function addToArtisticRole(\DDEX\RIN\RIN_210\ContributorRoleType $artisticRole)
    {
     ...
     * A Composite containing details of a ContributorRole played by the DisplayArtist.
     *
     * @return \DDEX\RIN\RIN_210\ContributorRoleType[]
     */
