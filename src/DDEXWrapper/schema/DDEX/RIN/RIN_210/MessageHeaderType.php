...
class MessageHeaderType
{
    ...
    /**
     * A Software app that processed this RIN Message.
     *
     * @var string $rinProcessor
     */
    private $rinProcessor = null;

    /**
     * A VersionId of the Software app that processed this RIN Message.
     *
     * @var string $rinProcessorVersionid
     */
    private $rinProcessorVersionid = null;

    /**
     * A Composite containing details of the MessageSender.
     *
     * @var \DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType $messageSender
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType $sentOnBehalfOf
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType[] $messageRecipient
     */
    ...
    /**
     * The VersionId of the Message. This allows adding an incremental Version number to allow the MessageRecipient to put multiple Messages in order even if they are received out of sequence.
     *
     ...
     *
     * @var \DDEX\RIN\RIN_210\MessageAuditTrailEventType[] $messageAuditTrail
     */
    private $messageAuditTrail = null;

    /**
     * A MessageVersionId of a RIN Message that has provided metadata to this RIN Message. For now this only deals with RIN files from the same RIN processor.
     *
     * @var string[] $importedMessageVersionid
     */
    private $importedMessageVersionid = [
    ...
    /**
     * Gets as rinProcessor
     *
     * A Software app that processed this RIN Message.
     *
     * @return string
     */
    public function getRinProcessor()
    {
        return $this->rinProcessor;
    }

    /**
     * Sets a new rinProcessor
     *
     * A Software app that processed this RIN Message.
     *
     * @param string $rinProcessor
     * @return self
     */
    public function setRinProcessor($rinProcessor)
    {
        $this->rinProcessor = $rinProcessor;
        return $this;
    }

    /**
     * Gets as rinProcessorVersionid
     *
     * A VersionId of the Software app that processed this RIN Message.
     *
     * @return string
     */
    public function getRinProcessorVersionid()
    {
        return $this->rinProcessorVersionid;
    }

    /**
     * Sets a new rinProcessorVersionid
     *
     * A VersionId of the Software app that processed this RIN Message.
     *
     * @param string $rinProcessorVersionid
     * @return self
     */
    public function setRinProcessorVersionid($rinProcessorVersionid)
    {
        $this->rinProcessorVersionid = $rinProcessorVersionid;
        return $this;
    }
     ...
     * A Composite containing details of the MessageSender.
     *
     * @return \DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @param \DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType $messageSender
     * @return self
     */
    public function setMessageSender(\DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType $messageSender)
    {
     ...
     * A Composite containing details of the Party on whose behalf the Message is sent.
     *
     * @param \DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType $sentOnBehalfOf
     * @return self
     */
    public function setSentOnBehalfOf(?\DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType $sentOnBehalfOf = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType $messageRecipient
     */
    public function addToMessageRecipient(\DDEX\RIN\RIN_210\MessagingPartyWithoutCodeType $messageRecipient)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrail(\DDEX\RIN\RIN_210\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @return \DDEX\RIN\RIN_210\MessageAuditTrailEventType[]
     */
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @param \DDEX\RIN\RIN_210\MessageAuditTrailEventType[] $messageAuditTrail
     * @return self
     */
    ...
    /**
     * Adds as importedMessageVersionid
     *
     * A MessageVersionId of a RIN Message that has provided metadata to this RIN Message. For now this only deals with RIN files from the same RIN processor.
     *
     * @return self
     * @param string $importedMessageVersionid
     */
    public function addToImportedMessageVersionid($importedMessageVersionid)
    {
        $this->importedMessageVersionid[] = $importedMessageVersionid;
        return $this;
    }

    /**
     * isset importedMessageVersionid
     *
     * A MessageVersionId of a RIN Message that has provided metadata to this RIN Message. For now this only deals with RIN files from the same RIN processor.
     *
     * @param int|string $index
     * @return bool
     */
    public function issetImportedMessageVersionid($index)
    {
        return isset($this->importedMessageVersionid[$index]);
    }

    /**
     * unset importedMessageVersionid
     *
     * A MessageVersionId of a RIN Message that has provided metadata to this RIN Message. For now this only deals with RIN files from the same RIN processor.
     *
     * @param int|string $index
     * @return void
     */
    public function unsetImportedMessageVersionid($index)
    {
        unset($this->importedMessageVersionid[$index]);
    }

    /**
     * Gets as importedMessageVersionid
     *
     * A MessageVersionId of a RIN Message that has provided metadata to this RIN Message. For now this only deals with RIN files from the same RIN processor.
     *
     * @return string[]
     */
    public function getImportedMessageVersionid()
    {
        return $this->importedMessageVersionid;
    }

    /**
     * Sets a new importedMessageVersionid
     *
     * A MessageVersionId of a RIN Message that has provided metadata to this RIN Message. For now this only deals with RIN files from the same RIN processor.
     *
     * @param string[] $importedMessageVersionid
     * @return self
     */
    public function setImportedMessageVersionid(array $importedMessageVersionid = null)
    {
        $this->importedMessageVersionid = $importedMessageVersionid;
        return $this;
    }
