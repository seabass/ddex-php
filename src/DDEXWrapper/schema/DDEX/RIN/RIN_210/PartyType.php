...
class PartyType
{
     ...
     *
     * @var \DDEX\RIN\RIN_210\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\RIN\RIN_210\DetailedPartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\RIN\RIN_210\AffiliationType[] $affiliation
     */
    private $affiliation = [
     ...
     *
     * @var \DDEX\RIN\RIN_210\RelatedPartyType[] $relatedParty
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\AllTerritoryCodeType $territoryOfResidency
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\PostalAddressType[] $postalAddress
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\PhoneNumberType[] $phoneNumber
     */
    private $phoneNumber = [
     ...
     *
     * @var \DDEX\RIN\RIN_210\EmailAddressType[] $emailAddress
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\CurrentTerritoryCodeType[] $nationality
     */
    private $nationality = [
     ...
     *
     * @var \DDEX\RIN\RIN_210\EventDateType $dateAndPlaceOfBirth
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\EventDateType $dateAndPlaceOfDeath
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DDEX\RIN\RIN_210\DetailedPartyIdType $partyId)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors,-artists-and-writers/contributors,-artists-and-writers/
     *
     * @return \DDEX\RIN\RIN_210\DetailedPartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\DetailedPartyNameType $partyName
     */
    public function addToPartyName(\DDEX\RIN\RIN_210\DetailedPartyNameType $partyName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @return \DDEX\RIN\RIN_210\DetailedPartyNameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\AffiliationType $affiliation
     */
    public function addToAffiliation(\DDEX\RIN\RIN_210\AffiliationType $affiliation)
    {
     ...
     * A Composite containing details of an affiliation.
     *
     * @return \DDEX\RIN\RIN_210\AffiliationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\RelatedPartyType $relatedParty
     */
    public function addToRelatedParty(\DDEX\RIN\RIN_210\RelatedPartyType $relatedParty)
    {
     ...
     * A Composite containing details of a PartyRelatedPartyReference referring to a Party that is related to the current Party. This can be used to express, for instance, relationships between a band and its members or between a label and its parent company.
     *
     * @return \DDEX\RIN\RIN_210\RelatedPartyType[]
     */
     ...
     * The country of main residency of the Party.
     *
     * @return \DDEX\RIN\RIN_210\AllTerritoryCodeType
     */
     ...
     * The country of main residency of the Party.
     *
     * @param \DDEX\RIN\RIN_210\AllTerritoryCodeType $territoryOfResidency
     * @return self
     */
    public function setTerritoryOfResidency(?\DDEX\RIN\RIN_210\AllTerritoryCodeType $territoryOfResidency = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\PostalAddressType $postalAddress
     */
    public function addToPostalAddress(\DDEX\RIN\RIN_210\PostalAddressType $postalAddress)
    {
     ...
     * A Composite containing details of a PostalAddress of the Party.
     *
     * @return \DDEX\RIN\RIN_210\PostalAddressType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\PhoneNumberType $phoneNumber
     */
    public function addToPhoneNumber(\DDEX\RIN\RIN_210\PhoneNumberType $phoneNumber)
    {
     ...
     * A Composite containing details of a PhoneNumber of the Party.
     *
     * @return \DDEX\RIN\RIN_210\PhoneNumberType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\EmailAddressType $emailAddress
     */
    public function addToEmailAddress(\DDEX\RIN\RIN_210\EmailAddressType $emailAddress)
    {
     ...
     * A Composite containing details of an EmailAddress of the Party.
     *
     * @return \DDEX\RIN\RIN_210\EmailAddressType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\CurrentTerritoryCodeType $nationality
     */
    public function addToNationality(\DDEX\RIN\RIN_210\CurrentTerritoryCodeType $nationality)
    {
     ...
     * The nationality of the Party.
     *
     * @return \DDEX\RIN\RIN_210\CurrentTerritoryCodeType[]
     */
     ...
     * A Composite containing details of the Date and Place of birth. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN_210\EventDateType $dateAndPlaceOfBirth
     * @return self
     */
    public function setDateAndPlaceOfBirth(?\DDEX\RIN\RIN_210\EventDateType $dateAndPlaceOfBirth = null)
    {
     ...
     * A Composite containing details of the Date and Place of death. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN_210\EventDateType $dateAndPlaceOfDeath
     * @return self
     */
    public function setDateAndPlaceOfDeath(?\DDEX\RIN\RIN_210\EventDateType $dateAndPlaceOfDeath = null)
    {
