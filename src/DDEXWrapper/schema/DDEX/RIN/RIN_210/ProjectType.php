...
class ProjectType
{
     ...
     *
     * @var \DDEX\RIN\RIN_210\ProprietaryIdType[] $projectId
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\ProjectContributorReferenceType[] $contributor
     */
    private $contributor = [
     ...
     */
    public function addToProjectId(\DDEX\RIN\RIN_210\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of an Identifier of the Project. This is often referred to as a project number.
     *
     * @param \DDEX\RIN\RIN_210\ProprietaryIdType[] $projectId
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\ProjectContributorReferenceType $contributor
     */
    public function addToContributor(\DDEX\RIN\RIN_210\ProjectContributorReferenceType $contributor)
    {
     ...
     * A Composite containing a ProjectContributorReference.
     *
     * @return \DDEX\RIN\RIN_210\ProjectContributorReferenceType[]
     */
