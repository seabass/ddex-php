...
/**
 * Class representing TransferDestinationType
 *
 * A Composite containing details of a destination of a Transfer.
 * XSD Type: TransferDestination
 */
class TransferDestinationType
{
    /**
     * A Reference for a DataCarrier used as a destination for the Transfer (specific to this File). This is a LocalDataCarrierAnchorReference starting with the letter D.
     *
     ...
     *
     * @var \DDEX\RIN\RIN_210\DetailsType[] $details
     */
    private $details = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\DetailsType $details
     */
    public function addToDetails(\DDEX\RIN\RIN_210\DetailsType $details)
    {
     ...
     * A Composite containing further details of the Transfer.
     *
     * @return \DDEX\RIN\RIN_210\DetailsType[]
     */
