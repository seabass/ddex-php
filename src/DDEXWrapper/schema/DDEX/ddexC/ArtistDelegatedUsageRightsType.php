 ...
 *
 * A ddex:Composite containing details of the kinds of usage for which rights have been delegated by an ddex:Artist.
...
class ArtistDelegatedUsageRightsType
{
    ...
    /**
     * A ddex:Type of membership of the ddex:Artist.
     *
