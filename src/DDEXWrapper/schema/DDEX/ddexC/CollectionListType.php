...
class CollectionListType
{
     ...
     *
     * @var \DDEX\ddexC\CollectionType[] $collection
     */
    private $collection = [
     ...
     *
     * @return self
     * @param \DDEX\ddexC\CollectionType $collection
     */
    public function addToCollection(\DDEX\ddexC\CollectionType $collection)
    {
     ...
     * A ddex:Composite containing details of a ddex:Collection contained in a ddex:Resource.
     *
     * @return \DDEX\ddexC\CollectionType[]
     */
