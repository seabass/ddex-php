...
class CollectionType
{
     ...
     *
     * @var \DDEX\ddexC\CollectionDetailsByTerritoryType[] $collectionDetailsByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\ddexC\CollectionDetailsByTerritoryType $collectionDetailsByTerritory
     */
    public function addToCollectionDetailsByTerritory(\DDEX\ddexC\CollectionDetailsByTerritoryType $collectionDetailsByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ddex:Collection which may vary according to ddex:Territory of release.
     *
     * @return \DDEX\ddexC\CollectionDetailsByTerritoryType[]
     */
