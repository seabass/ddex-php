 ...
 *
 * A ddex:Composite containing details of contact ddex:Identifiers of a ddex:Party.
 * XSD Type: ContactId
 */
class ContactIdType
{
    /**
     * An ddex:EmailAddress of the ddex:Party.
     *
    ...
    /**
     * A ddex:PhoneNumber of the ddex:Party.
     *
    ...
    /**
     * A ddex:FaxNumber of the ddex:Party.
     *
