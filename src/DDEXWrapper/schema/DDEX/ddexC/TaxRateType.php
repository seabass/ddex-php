...
class TaxRateType
{
     ...
     *
     * @var \DDEX\ddexC\TaxTypeType[] $taxType
     */
    private $taxType = [
     ...
     *
     * @var \DDEX\ddexC\TaxScopeType[] $taxScope
     */
    private $taxScope = [
     ...
     *
     * @return self
     * @param \DDEX\ddexC\TaxTypeType $taxType
     */
    public function addToTaxType(\DDEX\ddexC\TaxTypeType $taxType)
    {
     ...
     *
     * @return self
     * @param \DDEX\ddexC\TaxScopeType $taxScope
     */
    public function addToTaxScope(\DDEX\ddexC\TaxScopeType $taxScope)
    {
     ...
     * A ddex:Composite containing details of the ddex:Type of ddex:Tax according to its scope.
     *
     * @return \DDEX\ddexC\TaxScopeType[]
     */
