...
class ConditionForRightsClaimPolicyType
{
     ...
     *
     * @var \DDEX\CT\CT_100\SegmentType[] $segment
     */
    private $segment = [
     ...
     *
     * @var \DDEX\CT\CT_100\ServiceExceptionType[] $serviceException
     */
     ...
     *
     * @return self
     * @param \DDEX\CT\CT_100\SegmentType $segment
     */
    public function addToSegment(\DDEX\CT\CT_100\SegmentType $segment)
    {
     ...
     * A Composite containing details of a segment of the Resource to which the Condition is applicable. If no segment is specified, the whole Resource is subject the RightsClaim Policy.
     *
     * @return \DDEX\CT\CT_100\SegmentType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\CT\CT_100\ServiceExceptionType $serviceException
     */
    public function addToServiceException(\DDEX\CT\CT_100\ServiceExceptionType $serviceException)
    {
     ...
     * A Composite containing details of a Service that is an exception to the Condition. For these exceptions, usage does not need to be reported for fingerprinting and web monitoring services.
     *
     * @return \DDEX\CT\CT_100\ServiceExceptionType[]
     */
