...
class PriceInformationWithTypeType
{
     ...
     *
     * @var \DDEX\CT\CT_100\PriceTypeType $priceCode
     */
     ...
     *
     * @var \DDEX\CT\CT_100\PriceType $wholesalePricePerUnit
     */
     ...
     *
     * @var \DDEX\CT\CT_100\PriceType $bulkOrderWholesalePricePerUnit
     */
     ...
     *
     * @var \DDEX\CT\CT_100\PriceType $suggestedRetailPrice
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @return \DDEX\CT\CT_100\PriceTypeType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @param \DDEX\CT\CT_100\PriceTypeType $priceCode
     * @return self
     */
    public function setPriceCode(?\DDEX\CT\CT_100\PriceTypeType $priceCode = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @return \DDEX\CT\CT_100\PriceType
     */
     ...
     * A Composite containing details of a wholesale Price for a single unit of Usage, which informs the informs the DSP of the Price the Release should be offered at. Note that this Price applies to all UseTypes referenced in a DealTerm Composite. This element should not be combined with PriceType.
     *
     * @param \DDEX\CT\CT_100\PriceType $wholesalePricePerUnit
     * @return self
     */
    public function setWholesalePricePerUnit(?\DDEX\CT\CT_100\PriceType $wholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a wholesale Price for a single unit, which informs the informs the DSP of the Price the Release should be offered at. Note that the size of a bulk order is defined in the contract between MessageSender and the MessageRecipient. This element should not be combined with PriceType.
     *
     * @param \DDEX\CT\CT_100\PriceType $bulkOrderWholesalePricePerUnit
     * @return self
     */
    public function setBulkOrderWholesalePricePerUnit(?\DDEX\CT\CT_100\PriceType $bulkOrderWholesalePricePerUnit = null)
    {
     ...
     * A Composite containing details of a suggested retail Price.
     *
     * @param \DDEX\CT\CT_100\PriceType $suggestedRetailPrice
     * @return self
     */
    public function setSuggestedRetailPrice(?\DDEX\CT\CT_100\PriceType $suggestedRetailPrice = null)
    {
