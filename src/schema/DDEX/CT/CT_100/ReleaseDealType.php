...
class ReleaseDealType
{
     ...
     *
     * @var \DDEX\CT\CT_100\DealType[] $deal
     */
    private $deal = [
     ...
     *
     * @return self
     * @param \DDEX\CT\CT_100\DealType $deal
     */
    public function addToDeal(\DDEX\CT\CT_100\DealType $deal)
    {
        $this->deal[] = $deal;
        return $this;
    }
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/no-takedown-in-initial-deal
     *
     * @return \DDEX\CT\CT_100\DealType[]
     */
