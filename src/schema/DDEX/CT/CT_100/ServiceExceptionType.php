...
class ServiceExceptionType
{
     ...
     *
     * @var \DDEX\CT\CT_100\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\CT\CT_100\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @var \DDEX\CT\CT_100\NameType $tradingName
     */
     ...
     *
     * @var \DDEX\CT\CT_100\ChannelType[] $channel
     */
    private $channel = [
     ...
     *
     * @return self
     * @param \DDEX\CT\CT_100\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DDEX\CT\CT_100\DetailedPartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\CT\CT_100\DetailedPartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\CT\CT_100\PartyNameType $partyName
     */
    public function addToPartyName(\DDEX\CT\CT_100\PartyNameType $partyName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @return \DDEX\CT\CT_100\PartyNameType[]
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @param \DDEX\CT\CT_100\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\CT\CT_100\NameType $tradingName = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\CT\CT_100\ChannelType $channel
     */
    public function addToChannel(\DDEX\CT\CT_100\ChannelType $channel)
    {
     ...
     * A Composite containing details of an excluded channel provided by the Service. This channel may be specific to an Artist.
     *
     * @return \DDEX\CT\CT_100\ChannelType[]
     */
