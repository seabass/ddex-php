...
class InvoiceItemType
{
     ...
     *
     * @var \DDEX\DSR\DSR_400\SalesReportMessageReferenceType[] $salesReportMessageReference
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\SalesReportMessageReferenceType $salesReportMessageReference
     */
    public function addToSalesReportMessageReference(\DDEX\DSR\DSR_400\SalesReportMessageReferenceType $salesReportMessageReference)
    {
     ...
     * A ddex:Composite containing a reference to the sales report ddex:Message containing usage reports for which an invoice is provided.
     *
     * @return \DDEX\DSR\DSR_400\SalesReportMessageReferenceType[]
     */
