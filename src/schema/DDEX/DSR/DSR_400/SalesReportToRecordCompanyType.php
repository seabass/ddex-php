...
class SalesReportToRecordCompanyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_400\SalesToRecordCompanyByCommercialModelType[] $salesByCommercialModel
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\SalesToRecordCompanyByCommercialModelType $salesByCommercialModel
     */
    public function addToSalesByCommercialModel(\DDEX\DSR\DSR_400\SalesToRecordCompanyByCommercialModelType $salesByCommercialModel)
    {
     ...
     * A ddex:Composite containing details of ddex:SalesTransactions reported by the ddex:DSP to the record company for a specific ddex:CommercialModelType.
     *
     * @return \DDEX\DSR\DSR_400\SalesToRecordCompanyByCommercialModelType[]
     */
