...
namespace DDEX\DSR\DSR_400\SalesReportToSocietyMessage;
...
class SalesReportToSocietyMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\DSR\DSR_400\ContainedReleaseSummaryType[] $containedReleaseSummary
     */
     ...
     *
     * @var \DDEX\DSR\DSR_400\ResourceListType $containedResourceList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_400\ReleaseListType $containedReleaseList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_400\SalesReportToSocietyType[] $salesReport
     */
    private $salesReport = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\ContainedReleaseSummaryType $containedReleaseSummary
     */
    public function addToContainedReleaseSummary(\DDEX\DSR\DSR_400\ContainedReleaseSummaryType $containedReleaseSummary)
    {
     ...
     * A ddex:Composite containing summary details of a ddex:Release for which sales data is provided in the dsr:SalesReportToSocietyMessage. Either this ddex:Element or at least one of ddex:ContainedMusicalWorkList, ddex:ContainedResourceList and ddex:ContainedReleaseList is required. Typically a dsr:SalesReportToSocietyMessage only contains either this ddex:Element or a set of ddex:ContainedMusicalWorkList, ddex:ContainedResourceList and ddex:ContainedReleaseList are used.
     *
     * @return \DDEX\DSR\DSR_400\ContainedReleaseSummaryType[]
     */
     ...
     * A ddex:Composite containing details of one or more ddex:Resources contained in ddex:Releases for which sales data is provided in the dsr:SalesReportToSocietyMessage. If this ddex:Element is used, the ddex:ContainedReleaseSummary ddex:Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_400\ResourceListType
     */
     ...
     * A ddex:Composite containing details of one or more ddex:Resources contained in ddex:Releases for which sales data is provided in the dsr:SalesReportToSocietyMessage. If this ddex:Element is used, the ddex:ContainedReleaseSummary ddex:Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_400\ResourceListType $containedResourceList
     * @return self
     */
    public function setContainedResourceList(?\DDEX\DSR\DSR_400\ResourceListType $containedResourceList = null)
    {
     ...
     * A ddex:Composite containing details of one or more ddex:Releases for which sales data is provided in the dsr:SalesReportToSocietyMessage. If this ddex:Element is used, the ddex:ContainedReleaseSummary ddex:Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_400\ReleaseListType
     */
     ...
     * A ddex:Composite containing details of one or more ddex:Releases for which sales data is provided in the dsr:SalesReportToSocietyMessage. If this ddex:Element is used, the ddex:ContainedReleaseSummary ddex:Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_400\ReleaseListType $containedReleaseList
     * @return self
     */
    public function setContainedReleaseList(?\DDEX\DSR\DSR_400\ReleaseListType $containedReleaseList = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\SalesReportToSocietyType $salesReport
     */
    public function addToSalesReport(\DDEX\DSR\DSR_400\SalesReportToSocietyType $salesReport)
    {
     ...
     * A ddex:Composite containing details of ddex:SalesTransactions by a ddex:DSP reported to a ddex:MusicalWork ddex:Licensor.
     *
     * @return \DDEX\DSR\DSR_400\SalesReportToSocietyType[]
     */
