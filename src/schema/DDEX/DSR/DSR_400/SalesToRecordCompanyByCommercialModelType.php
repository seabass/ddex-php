...
class SalesToRecordCompanyByCommercialModelType
{
     ...
     *
     * @var \DDEX\DSR\DSR_400\SalesToRecordCompanyByTerritoryType[] $salesByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\SalesToRecordCompanyByTerritoryType $salesByTerritory
     */
    public function addToSalesByTerritory(\DDEX\DSR\DSR_400\SalesToRecordCompanyByTerritoryType $salesByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:SalesTransactions reported by the ddex:DSP to the record company for a specific ddex:Territory.
     *
     * @return \DDEX\DSR\DSR_400\SalesToRecordCompanyByTerritoryType[]
     */
