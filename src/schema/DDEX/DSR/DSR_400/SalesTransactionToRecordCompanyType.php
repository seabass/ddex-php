...
class SalesTransactionToRecordCompanyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_400\SalesDataToRecordCompanyType[] $salesData
     */
    private $salesData = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_400\SalesDataToRecordCompanyType $salesData
     */
    public function addToSalesData(\DDEX\DSR\DSR_400\SalesDataToRecordCompanyType $salesData)
    {
     ...
     * A ddex:Composite containing details of ddex:SalesTransactions of the ddex:Release governed by the ddex:Deal.
     *
     * @return \DDEX\DSR\DSR_400\SalesDataToRecordCompanyType[]
     */
