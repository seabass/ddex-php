 ...
 *
 * A ddex:Composite containing details of ddex:SalesTransactions for a ddex:Release or a ddex:Resource, reported by a ddex:DSP to a record company.
...
class ReleaseTransactionsToRecordCompanyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_410\SalesTransactionToRecordCompanyType[] $salesTransaction
     */
    ...
    /**
     * A ddex:Composite containing details of the total ddex:Duration of the ddex:Release or ddex:Resource that has been used (this may be less than the total ddex:Duration), specified for a ddex:UseType (using the ISO 8601:2004 PT[[hhH]mmM]ssS format, where lower case characters indicate variables, upper case characters are part of the xs:string, e.g. one hour, two minutes and three seconds would be PT1H2M3S). This applies only to single-Resource ddex:Releases.
     *
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\SalesTransactionToRecordCompanyType $salesTransaction
     */
    public function addToSalesTransaction(\DDEX\DSR\DSR_410\SalesTransactionToRecordCompanyType $salesTransaction)
    {
     ...
     * A ddex:Composite containing details of a ddex:SalesTransaction for specified Usages of the ddex:Release or ddex:Resource.
     *
     * @return \DDEX\DSR\DSR_410\SalesTransactionToRecordCompanyType[]
     */
