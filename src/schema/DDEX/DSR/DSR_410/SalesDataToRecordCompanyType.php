...
class SalesDataToRecordCompanyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_410\SalesDataGroupingToRecordCompanyType $salesDataGrouping
     */
     ...
     * A ddex:Composite containing details of the criteria by which sales reports to record companies are grouped.
     *
     * @return \DDEX\DSR\DSR_410\SalesDataGroupingToRecordCompanyType
     */
     ...
     * A ddex:Composite containing details of the criteria by which sales reports to record companies are grouped.
     *
     * @param \DDEX\DSR\DSR_410\SalesDataGroupingToRecordCompanyType $salesDataGrouping
     * @return self
     */
    public function setSalesDataGrouping(?\DDEX\DSR\DSR_410\SalesDataGroupingToRecordCompanyType $salesDataGrouping = null)
    {
