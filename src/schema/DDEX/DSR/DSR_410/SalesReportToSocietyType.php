...
class SalesReportToSocietyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_410\DspDetailsForSocietyType $dSP
     */
    private $dSP = null;
     ...
     *
     * @var \DDEX\DSR\DSR_410\SalesToSocietyByCommercialModelType[] $salesByCommercialModel
     */
     ...
     * A ddex:Composite containing details of the ddex:DSP (as ddex:Licensee) whose ddex:SalesTransactions are being reported.
     *
     * @return \DDEX\DSR\DSR_410\DspDetailsForSocietyType
     */
     ...
     * A ddex:Composite containing details of the ddex:DSP (as ddex:Licensee) whose ddex:SalesTransactions are being reported.
     *
     * @param \DDEX\DSR\DSR_410\DspDetailsForSocietyType $dSP
     * @return self
     */
    public function setDSP(\DDEX\DSR\DSR_410\DspDetailsForSocietyType $dSP)
    {
        $this->dSP = $dSP;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\SalesToSocietyByCommercialModelType $salesByCommercialModel
     */
    public function addToSalesByCommercialModel(\DDEX\DSR\DSR_410\SalesToSocietyByCommercialModelType $salesByCommercialModel)
    {
     ...
     * A ddex:Composite containing details of ddex:SalesTransactions reported by the ddex:DSP to the ddex:MusicalWork ddex:Licensor for a specific ddex:CommercialModelType.
     *
     * @return \DDEX\DSR\DSR_410\SalesToSocietyByCommercialModelType[]
     */
