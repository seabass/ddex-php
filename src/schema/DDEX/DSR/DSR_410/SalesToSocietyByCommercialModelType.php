...
class SalesToSocietyByCommercialModelType
{
     ...
     *
     * @var \DDEX\DSR\DSR_410\SalesToSocietyByTerritoryType[] $salesByTerritory
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\SalesToSocietyByTerritoryType $salesByTerritory
     */
    public function addToSalesByTerritory(\DDEX\DSR\DSR_410\SalesToSocietyByTerritoryType $salesByTerritory)
    {
     ...
     * A ddex:Composite containing details of ddex:SalesTransactions reported by the ddex:DSP to the ddex:MusicalWork ddex:Licensor for a specific ddex:Territory.
     *
     * @return \DDEX\DSR\DSR_410\SalesToSocietyByTerritoryType[]
     */
