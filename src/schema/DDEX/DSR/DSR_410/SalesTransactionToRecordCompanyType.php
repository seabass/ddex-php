 ...
 *
 * A ddex:Composite containing details of a ddex:SalesTransaction for specified Usages of a ddex:Release.
...
class SalesTransactionToRecordCompanyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_410\SalesDataToRecordCompanyType[] $salesData
     */
    private $salesData = [
    ...
    /**
     * The ddex:Flag indicating whether sales data will be forwarded by the ddex:DSP (or any ddex:Organization reporting on behalf of the ddex:DSP) to the appropriate ddex:MusicalWork ddex:Licensor (=False) or if this has to be done by the ddex:MessageRecipient (=True).
     *
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\SalesDataToRecordCompanyType $salesData
     */
    public function addToSalesData(\DDEX\DSR\DSR_410\SalesDataToRecordCompanyType $salesData)
    {
     ...
     * A ddex:Composite containing details of ddex:SalesTransactions of the ddex:Release governed by the ddex:Deal.
     *
     * @return \DDEX\DSR\DSR_410\SalesDataToRecordCompanyType[]
     */
