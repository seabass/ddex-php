...
class SalesTransactionToSocietyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_410\SalesDataToSocietyType[] $salesData
     */
    private $salesData = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_410\SalesDataToSocietyType $salesData
     */
    public function addToSalesData(\DDEX\DSR\DSR_410\SalesDataToSocietyType $salesData)
    {
     ...
     * A ddex:Composite containing details of ddex:SalesTransactions of the ddex:Release governed by the ddex:Deal.
     *
     * @return \DDEX\DSR\DSR_410\SalesDataToSocietyType[]
     */
