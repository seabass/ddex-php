...
class ArtistType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\ArtistRoleType[] $artistRole
     */
    private $artistRole = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\ArtistRoleType $artistRole
     */
    public function addToArtistRole(\DDEX\DSR\DSR_420\ArtistRoleType $artistRole)
    {
     ...
     * A Composite containing details of a role played by the Artist in relation to other Artists.
     *
     * @return \DDEX\DSR\DSR_420\ArtistRoleType[]
     */
