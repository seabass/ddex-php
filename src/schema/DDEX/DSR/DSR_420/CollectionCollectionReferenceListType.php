...
class CollectionCollectionReferenceListType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\CollectionCollectionReferenceType[] $collectionCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\CollectionCollectionReferenceType $collectionCollectionReference
     */
    public function addToCollectionCollectionReference(\DDEX\DSR\DSR_420\CollectionCollectionReferenceType $collectionCollectionReference)
    {
     ...
     * A Composite containing a CollectionCollectionReference for a Collection (specific to this Message).
     *
     * @return \DDEX\DSR\DSR_420\CollectionCollectionReferenceType[]
     */
