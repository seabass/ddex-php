...
class DealForSocietiesType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\SummaryDealType $summaryDeal
     */
     ...
     * @return self
     */
    public function setDetailedDeal(?\DDEX\DSR\DSR_420\DetailedDealType $detailedDeal = null)
    {
     ...
     * A Composite containing a summary of the terms and conditions of the Deal. Either this Element or the DetailedDeal are required, but not both.
     *
     * @return \DDEX\DSR\DSR_420\SummaryDealType
     */
     ...
     * A Composite containing a summary of the terms and conditions of the Deal. Either this Element or the DetailedDeal are required, but not both.
     *
     * @param \DDEX\DSR\DSR_420\SummaryDealType $summaryDeal
     * @return self
     */
    public function setSummaryDeal(?\DDEX\DSR\DSR_420\SummaryDealType $summaryDeal = null)
    {
