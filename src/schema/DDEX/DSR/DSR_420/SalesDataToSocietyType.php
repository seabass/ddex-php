...
class SalesDataToSocietyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\SalesDataGroupingToSocietyType $salesDataGrouping
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\PriceConsumerPaidExcSalesTaxType $priceConsumerPaidExcSalesTax
     */
     ...
     * A Composite containing details of the criteria by which sales reports to societies are grouped.
     *
     * @return \DDEX\DSR\DSR_420\SalesDataGroupingToSocietyType
     */
     ...
     * A Composite containing details of the criteria by which sales reports to societies are grouped.
     *
     * @param \DDEX\DSR\DSR_420\SalesDataGroupingToSocietyType $salesDataGrouping
     * @return self
     */
    public function setSalesDataGrouping(?\DDEX\DSR\DSR_420\SalesDataGroupingToSocietyType $salesDataGrouping = null)
    {
     ...
     * A Composite containing details of a PriceConsumerPaidExcSalesTax. This Element is to be used only when no Deal Composite is available which applies to the sales.
     *
     * @return \DDEX\DSR\DSR_420\PriceConsumerPaidExcSalesTaxType
     */
     ...
     * A Composite containing details of a PriceConsumerPaidExcSalesTax. This Element is to be used only when no Deal Composite is available which applies to the sales.
     *
     * @param \DDEX\DSR\DSR_420\PriceConsumerPaidExcSalesTaxType $priceConsumerPaidExcSalesTax
     * @return self
     */
    public function setPriceConsumerPaidExcSalesTax(?\DDEX\DSR\DSR_420\PriceConsumerPaidExcSalesTaxType $priceConsumerPaidExcSalesTax = null)
    {
