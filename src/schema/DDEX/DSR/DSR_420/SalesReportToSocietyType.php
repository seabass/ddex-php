...
class SalesReportToSocietyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\DspDetailsForSocietyType $dSP
     */
    private $dSP = null;
     ...
     *
     * @var \DDEX\DSR\DSR_420\PartyDescriptorType $licensor
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\SalesToSocietyByCommercialModelType[] $salesByCommercialModel
     */
     ...
     * A Composite containing details of the DSP (as Licensee) whose SalesTransactions are being reported.
     *
     * @return \DDEX\DSR\DSR_420\DspDetailsForSocietyType
     */
     ...
     * A Composite containing details of the DSP (as Licensee) whose SalesTransactions are being reported.
     *
     * @param \DDEX\DSR\DSR_420\DspDetailsForSocietyType $dSP
     * @return self
     */
    public function setDSP(\DDEX\DSR\DSR_420\DspDetailsForSocietyType $dSP)
    {
        $this->dSP = $dSP;
        return $this;
    }
     ...
     * A Composite containing details of the Party granting the permission for Usage.
     *
     * @return \DDEX\DSR\DSR_420\PartyDescriptorType
     */
     ...
     * A Composite containing details of the Party granting the permission for Usage.
     *
     * @param \DDEX\DSR\DSR_420\PartyDescriptorType $licensor
     * @return self
     */
    public function setLicensor(?\DDEX\DSR\DSR_420\PartyDescriptorType $licensor = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\SalesToSocietyByCommercialModelType $salesByCommercialModel
     */
    public function addToSalesByCommercialModel(\DDEX\DSR\DSR_420\SalesToSocietyByCommercialModelType $salesByCommercialModel)
    {
     ...
     * A Composite containing details of SalesTransactions reported by the DSP to the MusicalWork Licensor for a specific CommercialModelType.
     *
     * @return \DDEX\DSR\DSR_420\SalesToSocietyByCommercialModelType[]
     */
