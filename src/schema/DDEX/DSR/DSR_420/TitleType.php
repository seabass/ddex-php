...
class TitleType
{
     ...
     *
     * @var \DDEX\DSR\DSR_420\TitleTextType $titleText
     */
     ...
     *
     * @var \DDEX\DSR\DSR_420\TypedSubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     * A Composite containing the text of the Title.
     *
     * @return \DDEX\DSR\DSR_420\TitleTextType
     */
     ...
     * A Composite containing the text of the Title.
     *
     * @param \DDEX\DSR\DSR_420\TitleTextType $titleText
     * @return self
     */
    public function setTitleText(\DDEX\DSR\DSR_420\TitleTextType $titleText)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_420\TypedSubTitleType $subTitle
     */
    public function addToSubTitle(\DDEX\DSR\DSR_420\TypedSubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DDEX\DSR\DSR_420\TypedSubTitleType[]
     */
