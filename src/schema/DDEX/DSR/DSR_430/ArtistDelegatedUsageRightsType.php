...
class ArtistDelegatedUsageRightsType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\PeriodType $periodOfRightsDelegation
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\CurrentTerritoryCodeType[] $territoryOfRightsDelegation
     */
     ...
     * A Composite containing details about a Period of Time for which the delegation of usage rights applies. Periods are typically described by at least a StartDate or EndDate.
     *
     * @param \DDEX\DSR\DSR_430\PeriodType $periodOfRightsDelegation
     * @return self
     */
    public function setPeriodOfRightsDelegation(\DDEX\DSR\DSR_430\PeriodType $periodOfRightsDelegation)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\CurrentTerritoryCodeType $territoryOfRightsDelegation
     */
    public function addToTerritoryOfRightsDelegation(\DDEX\DSR\DSR_430\CurrentTerritoryCodeType $territoryOfRightsDelegation)
    {
