...
class ArtistType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\ArtistRoleType[] $artistRole
     */
    private $artistRole = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\ArtistRoleType $artistRole
     */
    public function addToArtistRole(\DDEX\DSR\DSR_430\ArtistRoleType $artistRole)
    {
