...
{
    /**
     * The Language and script for the Elements of the ReleaseSummary as defined in IETF RfC 5646. The default is the same as indicated for the containing composite. Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
     ...
     *
     * @var \DDEX\DSR\DSR_430\ReleaseSummaryDetailsByTerritoryType[] $releaseSummaryDetailsByTerritory
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\RelatedReleaseType[] $relatedRelease
     */
     ...
     * @return self
     */
    public function setReleaseType(?\DDEX\DSR\DSR_430\ReleaseTypeType $releaseType = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory
     */
    public function addToReleaseSummaryDetailsByTerritory(\DDEX\DSR\DSR_430\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory)
    {
     ...
     * A Composite containing summary details of Descriptors and other attributes of the Release which may vary according to Territory of Release. Territory of Release may be the world.
     *
     * @return \DDEX\DSR\DSR_430\ReleaseSummaryDetailsByTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DDEX\DSR\DSR_430\RelatedReleaseType $relatedRelease)
    {
     ...
     * A Composite containing details of a Release (or a PhysicalProduct or a DigitalProduct derived from such a Release) which is related to the Release.
     *
     * @return \DDEX\DSR\DSR_430\RelatedReleaseType[]
     */
