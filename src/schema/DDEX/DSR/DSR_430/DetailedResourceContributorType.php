...
class DetailedResourceContributorType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\DSR\DSR_430\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\DSR\DSR_430\ResourceContributorRoleType[] $resourceContributorRole
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\EventDateType $dateAndPlaceOfBirth
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\EventDateType $dateAndPlaceOfDeath
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ArtistRoleType $primaryRole
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\GoverningAgreementTypeType $governingAgreementType
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ContactIdType $contactInformation
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\AllTerritoryCodeType $territoryOfResidency
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\CurrentTerritoryCodeType $citizenship
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ArtistRoleType[] $additionalRoles
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\GenreType[] $genre
     */
    private $genre = [
     ...
     *
     * @var \DDEX\DSR\DSR_430\MembershipType[] $membership
     */
    private $membership = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\DSR\DSR_430\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, Producers or other Creators.
     *
     * @return \DDEX\DSR\DSR_430\PartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\PartyNameType $partyName
     */
    public function addToPartyName(\DDEX\DSR\DSR_430\PartyNameType $partyName)
    {
     ...
     * A Composite containing details of the PartyName(s).
     *
     * @return \DDEX\DSR\DSR_430\PartyNameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\ResourceContributorRoleType $resourceContributorRole
     */
    public function addToResourceContributorRole(\DDEX\DSR\DSR_430\ResourceContributorRoleType $resourceContributorRole)
    {
     ...
     * A Composite containing details of a role played by the Contributor.
     *
     * @return \DDEX\DSR\DSR_430\ResourceContributorRoleType[]
     */
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated by the Artist.
     *
     * @return \DDEX\DSR\DSR_430\ArtistDelegatedUsageRightsType
     */
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated by the Artist.
     *
     * @param \DDEX\DSR\DSR_430\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     * @return self
     */
    public function setArtistDelegatedUsageRights(?\DDEX\DSR\DSR_430\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights = null)
    {
     ...
     * A Composite containing details of the Date and Place of birth. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\DSR\DSR_430\EventDateType $dateAndPlaceOfBirth
     * @return self
     */
    public function setDateAndPlaceOfBirth(?\DDEX\DSR\DSR_430\EventDateType $dateAndPlaceOfBirth = null)
    {
     ...
     * A Composite containing details of the Date and Place of death. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\DSR\DSR_430\EventDateType $dateAndPlaceOfDeath
     * @return self
     */
    public function setDateAndPlaceOfDeath(?\DDEX\DSR\DSR_430\EventDateType $dateAndPlaceOfDeath = null)
    {
     ...
     * A Composite containing details of the primary role played by the Artist in relation to other Artists.
     *
     * @return \DDEX\DSR\DSR_430\ArtistRoleType
     */
     ...
     * A Composite containing details of the primary role played by the Artist in relation to other Artists.
     *
     * @param \DDEX\DSR\DSR_430\ArtistRoleType $primaryRole
     * @return self
     */
    public function setPrimaryRole(?\DDEX\DSR\DSR_430\ArtistRoleType $primaryRole = null)
    {
     ...
     * A Composite containing details of a Type of an agreement that covers the Artist's participation in making a SoundRecording.
     *
     * @return \DDEX\DSR\DSR_430\GoverningAgreementTypeType
     */
     ...
     * A Composite containing details of a Type of an agreement that covers the Artist's participation in making a SoundRecording.
     *
     * @param \DDEX\DSR\DSR_430\GoverningAgreementTypeType $governingAgreementType
     * @return self
     */
    public function setGoverningAgreementType(?\DDEX\DSR\DSR_430\GoverningAgreementTypeType $governingAgreementType = null)
    {
     ...
     * A Composite containing details of contact Identifiers of the Artist.
     *
     * @return \DDEX\DSR\DSR_430\ContactIdType
     */
     ...
     * A Composite containing details of contact Identifiers of the Artist.
     *
     * @param \DDEX\DSR\DSR_430\ContactIdType $contactInformation
     * @return self
     */
    public function setContactInformation(?\DDEX\DSR\DSR_430\ContactIdType $contactInformation = null)
    {
     ...
     * The country of main residency of the Artist.
     *
     * @return \DDEX\DSR\DSR_430\AllTerritoryCodeType
     */
     ...
     * The country of main residency of the Artist.
     *
     * @param \DDEX\DSR\DSR_430\AllTerritoryCodeType $territoryOfResidency
     * @return self
     */
    public function setTerritoryOfResidency(?\DDEX\DSR\DSR_430\AllTerritoryCodeType $territoryOfResidency = null)
    {
     ...
     * The country of whose citizenship the Artist has.
     *
     * @param \DDEX\DSR\DSR_430\CurrentTerritoryCodeType $citizenship
     * @return self
     */
    public function setCitizenship(?\DDEX\DSR\DSR_430\CurrentTerritoryCodeType $citizenship = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\ArtistRoleType $additionalRoles
     */
    public function addToAdditionalRoles(\DDEX\DSR\DSR_430\ArtistRoleType $additionalRoles)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\GenreType $genre
     */
    public function addToGenre(\DDEX\DSR\DSR_430\GenreType $genre)
    {
        $this->genre[] = $genre;
        return $this;
    }
     ...
     * A Composite containing details of a typical or main Genre relating to the Artist.
     *
     * @return \DDEX\DSR\DSR_430\GenreType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\MembershipType $membership
     */
    public function addToMembership(\DDEX\DSR\DSR_430\MembershipType $membership)
    {
     ...
     * A Composite containing details of a membership in a collective rights management organization.
     *
     * @return \DDEX\DSR\DSR_430\MembershipType[]
     */
