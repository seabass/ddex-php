...
class MIDIType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\MidiTypeType $midiType
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ResourceProprietaryIdType[] $midiId
     */
    private $midiId = [
     ...
     *
     * @var \DDEX\DSR\DSR_430\MusicalWorkIdType[] $indirectMidiId
     */
    ...
    /**
     * A Composite containing details of the Date and Place of the Event in which the MIDI was originally mastered (either in analogue or digital form). This is a string with the syntax YYYY[-MM[-DD]]. This element is deprecated. DDEX advises that it may be removed at a future date and therefore recommends against using it.
     *
     ...
     *
     * @var \DDEX\DSR\DSR_430\MidiDetailsByTerritoryType[] $midiDetailsByTerritory
     */
     ...
     * A Composite containing details of the Type of the MIDI.
     *
     * @return \DDEX\DSR\DSR_430\MidiTypeType
     */
     ...
     * A Composite containing details of the Type of the MIDI.
     *
     * @param \DDEX\DSR\DSR_430\MidiTypeType $midiType
     * @return self
     */
    public function setMidiType(?\DDEX\DSR\DSR_430\MidiTypeType $midiType = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\ResourceProprietaryIdType $midiId
     */
    public function addToMidiId(\DDEX\DSR\DSR_430\ResourceProprietaryIdType $midiId)
    {
        $this->midiId[] = $midiId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\MusicalWorkIdType $indirectMidiId
     */
    public function addToIndirectMidiId(\DDEX\DSR\DSR_430\MusicalWorkIdType $indirectMidiId)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\MidiDetailsByTerritoryType $midiDetailsByTerritory
     */
    public function addToMidiDetailsByTerritory(\DDEX\DSR\DSR_430\MidiDetailsByTerritoryType $midiDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the MIDI which may vary according to Territory of release.
     *
     * @return \DDEX\DSR\DSR_430\MidiDetailsByTerritoryType[]
     */
