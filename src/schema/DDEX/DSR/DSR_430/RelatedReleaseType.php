...
class RelatedReleaseType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\ReleaseRelationshipTypeType $releaseRelationshipType
     */
     ...
     * @return self
     */
    public function setReferenceTitle(?\DDEX\DSR\DSR_430\ReferenceTitleType $referenceTitle = null)
    {
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @return \DDEX\DSR\DSR_430\ReleaseRelationshipTypeType
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @param \DDEX\DSR\DSR_430\ReleaseRelationshipTypeType $releaseRelationshipType
     * @return self
     */
    public function setReleaseRelationshipType(\DDEX\DSR\DSR_430\ReleaseRelationshipTypeType $releaseRelationshipType)
    {
