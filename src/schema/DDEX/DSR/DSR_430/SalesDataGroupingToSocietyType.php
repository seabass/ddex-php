...
{
    /**
     * The Language and script for the Elements of the SalesDataGrouping as defined in IETF RfC 5646. The default is the same as indicated for the containing composite. Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * The StartDate or actual Date of the sales report. This is a string with the syntax YYYY[-MM[-DD]].
     *
    ...
    /**
     * The EndDate of the sales report if different from EndDate of the transaction Period which is given in the MessageHeader. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @var string $endDate
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\StoreLocationDescriptorType $storeLocationDescriptor
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\DescriptionType $promotionalActivityDescription
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\DealForSocietiesType $deal
     */
    private $deal = null;
     ...
     * A Composite containing the Descriptor (typically an xs:ID assigned by the DSP) of the store in which the Kiosk is located.
     *
     * @return \DDEX\DSR\DSR_430\StoreLocationDescriptorType
     */
     ...
     * A Composite containing the Descriptor (typically an xs:ID assigned by the DSP) of the store in which the Kiosk is located.
     *
     * @param \DDEX\DSR\DSR_430\StoreLocationDescriptorType $storeLocationDescriptor
     * @return self
     */
    public function setStoreLocationDescriptor(?\DDEX\DSR\DSR_430\StoreLocationDescriptorType $storeLocationDescriptor = null)
    {
     ...
     * A Composite containing the freetext Description of a promotional activity.
     *
     * @param \DDEX\DSR\DSR_430\DescriptionType $promotionalActivityDescription
     * @return self
     */
    public function setPromotionalActivityDescription(?\DDEX\DSR\DSR_430\DescriptionType $promotionalActivityDescription = null)
    {
     ...
     * A Composite containing details of the Deal under which sales were transacted. The reported figures are based on best knowledge on the side of the MessageSender with respect to the intellectual property rights controlled by the MessageRecipient (the default is that 100% ownership is assumed).
     *
     * @return \DDEX\DSR\DSR_430\DealForSocietiesType
     */
     ...
     * A Composite containing details of the Deal under which sales were transacted. The reported figures are based on best knowledge on the side of the MessageSender with respect to the intellectual property rights controlled by the MessageRecipient (the default is that 100% ownership is assumed).
     *
     * @param \DDEX\DSR\DSR_430\DealForSocietiesType $deal
     * @return self
     */
    public function setDeal(?\DDEX\DSR\DSR_430\DealForSocietiesType $deal = null)
    {
        $this->deal = $deal;
        return $this;
    }
