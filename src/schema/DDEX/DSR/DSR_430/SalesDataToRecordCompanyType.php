...
class SalesDataToRecordCompanyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\SalesDataGroupingToRecordCompanyType $salesDataGrouping
     */
     ...
     * A Composite containing details of the criteria by which sales reports to record companies are grouped.
     *
     * @return \DDEX\DSR\DSR_430\SalesDataGroupingToRecordCompanyType
     */
     ...
     * A Composite containing details of the criteria by which sales reports to record companies are grouped.
     *
     * @param \DDEX\DSR\DSR_430\SalesDataGroupingToRecordCompanyType $salesDataGrouping
     * @return self
     */
    public function setSalesDataGrouping(?\DDEX\DSR\DSR_430\SalesDataGroupingToRecordCompanyType $salesDataGrouping = null)
    {
