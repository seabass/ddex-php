...
namespace DDEX\DSR\DSR_430\SalesReportToSocietyMessage;
...
class SalesReportToSocietyMessageAnonymousPHPType
{
    ...
    /**
     * The Language and script for the Elements of the SalesReportToSocietyMessage as defined in IETF RfC 5646. Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
     ...
     *
     * @var \DDEX\DSR\DSR_430\MessageHeaderType $messageHeader
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\MessageNotificationPeriodType $messageNotificationPeriod
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\RemittanceAdviceType $remittanceAdvice
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ContainedReleaseSummaryType[] $containedReleaseSummary
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\WorkListType $containedWorkList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\CueSheetType[] $containedCueSheetList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ResourceListType $containedResourceList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\CollectionListType $containedCollectionList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\ReleaseListType $containedReleaseList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_430\SalesReportToSocietyType[] $salesReport
     */
    private $salesReport = [
     ...
     * The MessageHeader for the SalesReportToSocietyMessage.
     *
     * @return \DDEX\DSR\DSR_430\MessageHeaderType
     */
     ...
     * The MessageHeader for the SalesReportToSocietyMessage.
     *
     * @param \DDEX\DSR\DSR_430\MessageHeaderType $messageHeader
     * @return self
     */
    public function setMessageHeader(\DDEX\DSR\DSR_430\MessageHeaderType $messageHeader)
    {
     ...
     * A Composite containing details of the Period covered by the SalesReportToSocietyMessage.
     *
     * @return \DDEX\DSR\DSR_430\MessageNotificationPeriodType
     */
     ...
     * A Composite containing details of the Period covered by the SalesReportToSocietyMessage.
     *
     * @param \DDEX\DSR\DSR_430\MessageNotificationPeriodType $messageNotificationPeriod
     * @return self
     */
    public function setMessageNotificationPeriod(\DDEX\DSR\DSR_430\MessageNotificationPeriodType $messageNotificationPeriod)
    {
     ...
     * A textual commentary about the method for settlement of payments between MessageSender and MessageRecipient (e.g. 'international bank transfer initiated on 2006-09-18').
     *
     * @return \DDEX\DSR\DSR_430\RemittanceAdviceType
     */
     ...
     * A textual commentary about the method for settlement of payments between MessageSender and MessageRecipient (e.g. 'international bank transfer initiated on 2006-09-18').
     *
     * @param \DDEX\DSR\DSR_430\RemittanceAdviceType $remittanceAdvice
     * @return self
     */
    public function setRemittanceAdvice(?\DDEX\DSR\DSR_430\RemittanceAdviceType $remittanceAdvice = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\ContainedReleaseSummaryType $containedReleaseSummary
     */
    public function addToContainedReleaseSummary(\DDEX\DSR\DSR_430\ContainedReleaseSummaryType $containedReleaseSummary)
    {
     ...
     * A Composite containing summary details of a Release for which sales data is provided in the SalesReportToSocietyMessage. Either this Element or at least one of ContainedMusicalWorkList, ContainedResourceList and ContainedReleaseList is required. Typically a SalesReportToSocietyMessage only contains either this Element or a set of ContainedMusicalWorkList, ContainedResourceList and ContainedReleaseList are used.
     *
     * @return \DDEX\DSR\DSR_430\ContainedReleaseSummaryType[]
     */
     ...
     * A Composite containing details of one or more MusicalWorks contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_430\WorkListType
     */
     ...
     * A Composite containing details of one or more MusicalWorks contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_430\WorkListType $containedWorkList
     * @return self
     */
    public function setContainedWorkList(?\DDEX\DSR\DSR_430\WorkListType $containedWorkList = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\CueSheetType $cueSheet
     */
    public function addToContainedCueSheetList(\DDEX\DSR\DSR_430\CueSheetType $cueSheet)
    {
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_430\CueSheetType[]
     */
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_430\CueSheetType[] $containedCueSheetList
     * @return self
     */
     ...
     * A Composite containing details of one or more Resources contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_430\ResourceListType
     */
     ...
     * A Composite containing details of one or more Resources contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_430\ResourceListType $containedResourceList
     * @return self
     */
    public function setContainedResourceList(?\DDEX\DSR\DSR_430\ResourceListType $containedResourceList = null)
    {
     ...
     * A Composite containing details of one or more Collections contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_430\CollectionListType
     */
     ...
     * A Composite containing details of one or more Collections contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_430\CollectionListType $containedCollectionList
     * @return self
     */
    public function setContainedCollectionList(?\DDEX\DSR\DSR_430\CollectionListType $containedCollectionList = null)
    {
     ...
     * A Composite containing details of one or more Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_430\ReleaseListType
     */
     ...
     * A Composite containing details of one or more Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_430\ReleaseListType $containedReleaseList
     * @return self
     */
    public function setContainedReleaseList(?\DDEX\DSR\DSR_430\ReleaseListType $containedReleaseList = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\SalesReportToSocietyType $salesReport
     */
    public function addToSalesReport(\DDEX\DSR\DSR_430\SalesReportToSocietyType $salesReport)
    {
     ...
     * A Composite containing details of SalesTransactions by a DSP reported to a MusicalWork Licensor.
     *
     * @return \DDEX\DSR\DSR_430\SalesReportToSocietyType[]
     */
     ...
     * @return self
     */
    public function setRoyaltyAmount(?\DDEX\DSR\DSR_430\RoyaltyAmountType $royaltyAmount = null)
    {
