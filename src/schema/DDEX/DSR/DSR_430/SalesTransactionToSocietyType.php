...
class SalesTransactionToSocietyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_430\SalesDataToSocietyType[] $salesData
     */
    private $salesData = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_430\SalesDataToSocietyType $salesData
     */
    public function addToSalesData(\DDEX\DSR\DSR_430\SalesDataToSocietyType $salesData)
    {
     ...
     * A Composite containing details of SalesTransactions of the Release governed by the Deal.
     *
     * @return \DDEX\DSR\DSR_430\SalesDataToSocietyType[]
     */
