...
class InvoiceItemType
{
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\ProprietaryIdType $invoiceItemId
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\RightsAgreementIdType[] $licenseOrClaimId
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\PeriodType $invoicePeriod
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\SalesReportMessageReferenceType[] $salesReportMessageReference
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\PriceType $releaseUsagePrice
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\TariffReferenceType $appliedTariff
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\AppliedRoyaltyRateType $appliedRoyaltyRate
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\RoyaltyAmountType $calculatedRoyaltyAmountPerUse
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\TaxType[] $calculatedTax
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\RoyaltyAmountType $calculatedRoyaltyAmountPerInvoice
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\RightsTypeType[] $rightsType
     */
    private $rightsType = [
     ...
     * A Composite containing details of an Identifier of the InvoiceItem.
     *
     * @param \DDEX\DSR\DSR_43D1\ProprietaryIdType $invoiceItemId
     * @return self
     */
    public function setInvoiceItemId(\DDEX\DSR\DSR_43D1\ProprietaryIdType $invoiceItemId)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\RightsAgreementIdType $licenseOrClaimId
     */
    public function addToLicenseOrClaimId(\DDEX\DSR\DSR_43D1\RightsAgreementIdType $licenseOrClaimId)
    {
     ...
     * A Composite containing details about the Period of Time covered by the Invoice.
     *
     * @return \DDEX\DSR\DSR_43D1\PeriodType
     */
     ...
     * A Composite containing details about the Period of Time covered by the Invoice.
     *
     * @param \DDEX\DSR\DSR_43D1\PeriodType $invoicePeriod
     * @return self
     */
    public function setInvoicePeriod(\DDEX\DSR\DSR_43D1\PeriodType $invoicePeriod)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\SalesReportMessageReferenceType $salesReportMessageReference
     */
    public function addToSalesReportMessageReference(\DDEX\DSR\DSR_43D1\SalesReportMessageReferenceType $salesReportMessageReference)
    {
     ...
     * A Composite containing a reference to the sales report Message containing usage reports for which an invoice is provided.
     *
     * @return \DDEX\DSR\DSR_43D1\SalesReportMessageReferenceType[]
     */
     ...
     * A Composite containing details of the Price for each of the Usages of a Release.
     *
     * @return \DDEX\DSR\DSR_43D1\PriceType
     */
     ...
     * A Composite containing details of the Price for each of the Usages of a Release.
     *
     * @param \DDEX\DSR\DSR_43D1\PriceType $releaseUsagePrice
     * @return self
     */
    public function setReleaseUsagePrice(\DDEX\DSR\DSR_43D1\PriceType $releaseUsagePrice)
    {
     ...
     * A Composite containing details of a Reference to a TextDocument containing details of a Tariff (in the form of an Identifier, Name or Description).
     *
     * @param \DDEX\DSR\DSR_43D1\TariffReferenceType $appliedTariff
     * @return self
     */
    public function setAppliedTariff(?\DDEX\DSR\DSR_43D1\TariffReferenceType $appliedTariff = null)
    {
     ...
     * A Composite containing the details of the RoyaltyRate that has been applied when issuing the invoice.
     *
     * @return \DDEX\DSR\DSR_43D1\AppliedRoyaltyRateType
     */
     ...
     * A Composite containing the details of the RoyaltyRate that has been applied when issuing the invoice.
     *
     * @param \DDEX\DSR\DSR_43D1\AppliedRoyaltyRateType $appliedRoyaltyRate
     * @return self
     */
    public function setAppliedRoyaltyRate(\DDEX\DSR\DSR_43D1\AppliedRoyaltyRateType $appliedRoyaltyRate)
    {
     ...
     * A Composite containing details of the RoyaltyAmount that has been calculated to be due for the given Usage and ReleaseUsagePrice, based on the applied Tariff when issuing the invoice.
     *
     * @return \DDEX\DSR\DSR_43D1\RoyaltyAmountType
     */
     ...
     * A Composite containing details of the RoyaltyAmount that has been calculated to be due for the given Usage and ReleaseUsagePrice, based on the applied Tariff when issuing the invoice.
     *
     * @param \DDEX\DSR\DSR_43D1\RoyaltyAmountType $calculatedRoyaltyAmountPerUse
     * @return self
     */
    public function setCalculatedRoyaltyAmountPerUse(\DDEX\DSR\DSR_43D1\RoyaltyAmountType $calculatedRoyaltyAmountPerUse)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\TaxType $calculatedTax
     */
    public function addToCalculatedTax(\DDEX\DSR\DSR_43D1\TaxType $calculatedTax)
    {
     ...
     * A Composite containing details of the Tax applicable to the CalculatedRoyaltyAmountPerUse.
     *
     * @return \DDEX\DSR\DSR_43D1\TaxType[]
     */
     ...
     * A Composite containing details of the RoyaltyAmount that has been calculated for a given Invoice item.
     *
     * @param \DDEX\DSR\DSR_43D1\RoyaltyAmountType $calculatedRoyaltyAmountPerInvoice
     * @return self
     */
    public function setCalculatedRoyaltyAmountPerInvoice(\DDEX\DSR\DSR_43D1\RoyaltyAmountType $calculatedRoyaltyAmountPerInvoice)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\RightsTypeType $rightsType
     */
    public function addToRightsType(\DDEX\DSR\DSR_43D1\RightsTypeType $rightsType)
    {
     ...
     * A Composite containing details of the RightsType for a given Invoice item.
     *
     * @return \DDEX\DSR\DSR_43D1\RightsTypeType[]
     */
