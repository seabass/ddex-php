...
class ReleaseTransactionsToRecordCompanyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\ResourceTypeType $resourceType
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\DealForRecordCompaniesType $deal
     */
    private $deal = null;
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\SalesTransactionToRecordCompanyType[] $salesTransaction
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\CommentType $comment
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\DurationByUseTypeType[] $durationUsed
     */
     ...
     * A Composite containing details of the Type of the Resource.
     *
     * @return \DDEX\DSR\DSR_43D1\ResourceTypeType
     */
     ...
     * A Composite containing details of the Type of the Resource.
     *
     * @param \DDEX\DSR\DSR_43D1\ResourceTypeType $resourceType
     * @return self
     */
    public function setResourceType(?\DDEX\DSR\DSR_43D1\ResourceTypeType $resourceType = null)
    {
     ...
     * A Composite containing details of the terms and conditions of the Deal under which sales were transacted. (Note: The Amount reported in this Composite is an estimate based on best knowledge on the side of the MessageSender with respect to the intellectual property rights controlled by the MessageRecipient. The default is that 100% ownership is assumed).
     *
     * @return \DDEX\DSR\DSR_43D1\DealForRecordCompaniesType
     */
     ...
     * A Composite containing details of the terms and conditions of the Deal under which sales were transacted. (Note: The Amount reported in this Composite is an estimate based on best knowledge on the side of the MessageSender with respect to the intellectual property rights controlled by the MessageRecipient. The default is that 100% ownership is assumed).
     *
     * @param \DDEX\DSR\DSR_43D1\DealForRecordCompaniesType $deal
     * @return self
     */
    public function setDeal(?\DDEX\DSR\DSR_43D1\DealForRecordCompaniesType $deal = null)
    {
        $this->deal = $deal;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\SalesTransactionToRecordCompanyType $salesTransaction
     */
    public function addToSalesTransaction(\DDEX\DSR\DSR_43D1\SalesTransactionToRecordCompanyType $salesTransaction)
    {
     ...
     * A Composite containing details of a SalesTransaction for specified Usages of the Release or Resource.
     *
     * @return \DDEX\DSR\DSR_43D1\SalesTransactionToRecordCompanyType[]
     */
     ...
     * A Composite containing the Comment about the ReleaseTransactions Composite.
     *
     * @return \DDEX\DSR\DSR_43D1\CommentType
     */
     ...
     * A Composite containing the Comment about the ReleaseTransactions Composite.
     *
     * @param \DDEX\DSR\DSR_43D1\CommentType $comment
     * @return self
     */
    public function setComment(?\DDEX\DSR\DSR_43D1\CommentType $comment = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\DurationByUseTypeType $durationUsed
     */
    public function addToDurationUsed(\DDEX\DSR\DSR_43D1\DurationByUseTypeType $durationUsed)
    {
     ...
     * A Composite containing details of the total Duration of the Release or Resource that has been used (this may be less than the total Duration), specified for a UseType (using the ISO 8601:2004 PT[[hhH]mmM]ssS format, where lower case characters indicate variables, upper case characters are part of the xs:string, e.g. one hour, two minutes and three seconds would be PT1H2M3S). This applies only to single-Resource Releases.
     *
     * @return \DDEX\DSR\DSR_43D1\DurationByUseTypeType[]
     */
