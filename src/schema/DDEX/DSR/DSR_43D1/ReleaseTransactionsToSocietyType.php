...
class ReleaseTransactionsToSocietyType
{
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\DetailedDealType $deal
     */
    private $deal = null;
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\SalesTransactionToSocietyType[] $salesTransaction
     */
     ...
     * A Composite containing details of the terms and conditions of the Deal under which sales were transacted. (Note: The Amount reported in this Composite is an estimate based on best knowledge on the side of the MessageSender with respect to the intellectual property rights controlled by the MessageRecipient. The default is that 100% ownership is assumed).
     *
     * @param \DDEX\DSR\DSR_43D1\DetailedDealType $deal
     * @return self
     */
    public function setDeal(?\DDEX\DSR\DSR_43D1\DetailedDealType $deal = null)
    {
        $this->deal = $deal;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\SalesTransactionToSocietyType $salesTransaction
     */
    public function addToSalesTransaction(\DDEX\DSR\DSR_43D1\SalesTransactionToSocietyType $salesTransaction)
    {
     ...
     * A Composite containing details of a SalesTransaction for specified Usages of the Release or Resource.
     *
     * @return \DDEX\DSR\DSR_43D1\SalesTransactionToSocietyType[]
     */
