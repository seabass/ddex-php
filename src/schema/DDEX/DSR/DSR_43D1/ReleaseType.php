...
class ReleaseType
{
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\ReleaseCollectionReferenceType[] $releaseCollectionReferenceList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\ReleaseDetailsByTerritoryType[] $releaseDetailsByTerritory
     */
    ...
    /**
     * The Duration of the video content (using the ISO 8601:2004 PT[[hhH]mmM]ssS format, where lower case characters indicate variables, upper case characters are part of the xs:string, e.g. one hour, two minutes and three seconds would be PT1H2M3S).
     *
    ...
    /**
     * A Composite containing details of the Date and Place of the Event in which the Release was created.
     *
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\EventDateType $originalReleaseDate
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\ReleaseResourceReferenceType $releaseResourceReference
     */
    public function addToReleaseResourceReferenceList(\DDEX\DSR\DSR_43D1\ReleaseResourceReferenceType $releaseResourceReference)
    {
     ...
     * A Composite containing details of one or more Resources contained in the Release.
     *
     * @return \DDEX\DSR\DSR_43D1\ReleaseResourceReferenceType[]
     */
     ...
     * A Composite containing details of one or more Resources contained in the Release.
     *
     * @param \DDEX\DSR\DSR_43D1\ReleaseResourceReferenceType[] $releaseResourceReferenceList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\ReleaseCollectionReferenceType $releaseCollectionReference
     */
    public function addToReleaseCollectionReferenceList(\DDEX\DSR\DSR_43D1\ReleaseCollectionReferenceType $releaseCollectionReference)
    {
     ...
     * A Composite containing details of one or more Collections contained in the Release.
     *
     * @return \DDEX\DSR\DSR_43D1\ReleaseCollectionReferenceType[]
     */
     ...
     * A Composite containing details of one or more Collections contained in the Release.
     *
     * @param \DDEX\DSR\DSR_43D1\ReleaseCollectionReferenceType[] $releaseCollectionReferenceList
     * @return self
     */
     ...
     */
    public function addToReleaseType(\DDEX\DSR\DSR_43D1\ReleaseTypeType $releaseType)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory
     */
    public function addToReleaseDetailsByTerritory(\DDEX\DSR\DSR_43D1\ReleaseDetailsByTerritoryType $releaseDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the Release which may vary according to Territory of release.
     *
     * @return \DDEX\DSR\DSR_43D1\ReleaseDetailsByTerritoryType[]
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DDEX\DSR\DSR_43D1\EventDateType $originalReleaseDate
     * @return self
     */
    public function setOriginalReleaseDate(?\DDEX\DSR\DSR_43D1\EventDateType $originalReleaseDate = null)
    {
