...
namespace DDEX\DSR\DSR_43D1\SalesReportToSocietyMessage;
...
class SalesReportToSocietyMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\MessageNotificationPeriodType $messageNotificationPeriod
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\RemittanceAdviceType $remittanceAdvice
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\WorkListType $containedWorkList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\CueSheetType[] $containedCueSheetList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\ResourceListType $containedResourceList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\CollectionListType $containedCollectionList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\ReleaseListType $containedReleaseList
     */
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\SalesReportToSocietyType[] $salesReport
     */
    private $salesReport = [
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\RoyaltyAmountType $royaltyAmount
     */
     ...
     * A Composite containing details of the Period covered by the SalesReportToSocietyMessage.
     *
     * @return \DDEX\DSR\DSR_43D1\MessageNotificationPeriodType
     */
     ...
     * A Composite containing details of the Period covered by the SalesReportToSocietyMessage.
     *
     * @param \DDEX\DSR\DSR_43D1\MessageNotificationPeriodType $messageNotificationPeriod
     * @return self
     */
    public function setMessageNotificationPeriod(\DDEX\DSR\DSR_43D1\MessageNotificationPeriodType $messageNotificationPeriod)
    {
     ...
     * A textual commentary about the method for settlement of payments between MessageSender and MessageRecipient (e.g. 'international bank transfer initiated on 2006-09-18').
     *
     * @return \DDEX\DSR\DSR_43D1\RemittanceAdviceType
     */
     ...
     * A textual commentary about the method for settlement of payments between MessageSender and MessageRecipient (e.g. 'international bank transfer initiated on 2006-09-18').
     *
     * @param \DDEX\DSR\DSR_43D1\RemittanceAdviceType $remittanceAdvice
     * @return self
     */
    public function setRemittanceAdvice(?\DDEX\DSR\DSR_43D1\RemittanceAdviceType $remittanceAdvice = null)
    {
     ...
     * A Composite containing details of one or more MusicalWorks contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_43D1\WorkListType
     */
     ...
     * A Composite containing details of one or more MusicalWorks contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_43D1\WorkListType $containedWorkList
     * @return self
     */
    public function setContainedWorkList(?\DDEX\DSR\DSR_43D1\WorkListType $containedWorkList = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\CueSheetType $cueSheet
     */
    public function addToContainedCueSheetList(\DDEX\DSR\DSR_43D1\CueSheetType $cueSheet)
    {
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_43D1\CueSheetType[]
     */
     ...
     * A Composite containing details of one or more CueSheets contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_43D1\CueSheetType[] $containedCueSheetList
     * @return self
     */
     ...
     * A Composite containing details of one or more Resources contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_43D1\ResourceListType
     */
     ...
     * A Composite containing details of one or more Resources contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_43D1\ResourceListType $containedResourceList
     * @return self
     */
    public function setContainedResourceList(?\DDEX\DSR\DSR_43D1\ResourceListType $containedResourceList = null)
    {
     ...
     * A Composite containing details of one or more Collections contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_43D1\CollectionListType
     */
     ...
     * A Composite containing details of one or more Collections contained in Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_43D1\CollectionListType $containedCollectionList
     * @return self
     */
    public function setContainedCollectionList(?\DDEX\DSR\DSR_43D1\CollectionListType $containedCollectionList = null)
    {
     ...
     * A Composite containing details of one or more Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @return \DDEX\DSR\DSR_43D1\ReleaseListType
     */
     ...
     * A Composite containing details of one or more Releases for which sales data is provided in the SalesReportToSocietyMessage. If this Element is used, the ContainedReleaseSummary Element shall not be used.
     *
     * @param \DDEX\DSR\DSR_43D1\ReleaseListType $containedReleaseList
     * @return self
     */
    public function setContainedReleaseList(?\DDEX\DSR\DSR_43D1\ReleaseListType $containedReleaseList = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\SalesReportToSocietyType $salesReport
     */
    public function addToSalesReport(\DDEX\DSR\DSR_43D1\SalesReportToSocietyType $salesReport)
    {
     ...
     * A Composite containing details of SalesTransactions by a DSP reported to a MusicalWork Licensor.
     *
     * @return \DDEX\DSR\DSR_43D1\SalesReportToSocietyType[]
     */
     ...
     * A Composite containing details of the RoyaltyAmount due. This is an estimate based on best knowledge on the side of the MessageSender with respect to the intellectual property Rights controlled by the MessageRecipient (The default is that 100% ownership is assumed).
     *
     * @param \DDEX\DSR\DSR_43D1\RoyaltyAmountType $royaltyAmount
     * @return self
     */
    public function setRoyaltyAmount(?\DDEX\DSR\DSR_43D1\RoyaltyAmountType $royaltyAmount = null)
    {
