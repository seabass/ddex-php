...
class TaxRateType
{
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\TaxTypeType[] $taxType
     */
    private $taxType = [
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\TaxScopeType[] $taxScope
     */
    private $taxScope = [
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\TaxTypeType $taxType
     */
    public function addToTaxType(\DDEX\DSR\DSR_43D1\TaxTypeType $taxType)
    {
     ...
     * A Composite containing details of the Type of Tax.
     *
     * @return \DDEX\DSR\DSR_43D1\TaxTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\DSR\DSR_43D1\TaxScopeType $taxScope
     */
    public function addToTaxScope(\DDEX\DSR\DSR_43D1\TaxScopeType $taxScope)
    {
     ...
     * A Composite containing details of the Type of Tax according to its scope.
     *
     * @return \DDEX\DSR\DSR_43D1\TaxScopeType[]
     */
