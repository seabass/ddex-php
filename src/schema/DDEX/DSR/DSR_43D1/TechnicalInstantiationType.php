...
class TechnicalInstantiationType
{
     ...
     *
     * @var \DDEX\DSR\DSR_43D1\BitRateType $bitRate
     */
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @return \DDEX\DSR\DSR_43D1\BitRateType
     */
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\DSR\DSR_43D1\BitRateType $bitRate
     * @return self
     */
    public function setBitRate(?\DDEX\DSR\DSR_43D1\BitRateType $bitRate = null)
    {
