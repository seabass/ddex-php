...
class ResourceGroupContentItemType
{
     ...
     *
     * @var \DDEX\ddexC\ReleaseResourceReferenceType $releaseResourceReference
     */
     ...
     *
     * @var \DDEX\ddexC\LinkedReleaseResourceReferenceType[] $linkedReleaseResourceReference
     */
     ...
     */
    public function addToResourceType(\DDEX\ddexC\ResourceTypeType $resourceType)
    {
     ...
     * @return self
     */
    public function setReleaseResourceReference(\DDEX\ddexC\ReleaseResourceReferenceType $releaseResourceReference)
    {
     ...
     *
     * @return self
     * @param \DDEX\ddexC\LinkedReleaseResourceReferenceType $linkedReleaseResourceReference
     */
    public function addToLinkedReleaseResourceReference(\DDEX\ddexC\LinkedReleaseResourceReferenceType $linkedReleaseResourceReference)
    {
     ...
     * A ddex:Composite containing details of a ddex:ReleaseResourceReference (specific to this ddex:Message) for a ddex:Resource which is linked to this ddex:ContentItem. Example: an ddex:Image, ddex:Text or ddex:NonMusicalWorkVideo associated with a ddex:SoundRecording. This ddex:LocalAnchorReference is a xs:string starting with the letter A.
     *
     * @return \DDEX\ddexC\LinkedReleaseResourceReferenceType[]
     */
