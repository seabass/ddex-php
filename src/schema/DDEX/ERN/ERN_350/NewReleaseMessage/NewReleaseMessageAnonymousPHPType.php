...
namespace DDEX\ERN\ERN_350\NewReleaseMessage;
...
class NewReleaseMessageAnonymousPHPType
{
    ...
    /**
     * A ddex:Flag indicating whether the ern:NewReleaseMessage is sent as part of a backfill activity (as opposed to providing ongoing deliveries of frontline ddex:Releases) (=True) or not (=False). When this element is not present, the context is assumed to be False.
     *
     * @var bool $isBackfill
     */
     ...
     *
     * @var \DDEX\ERN\ERN_350\CatalogTransferType $catalogTransfer
     */
     ...
     *
     * @var \DDEX\ERN\ERN_350\CueSheetType[] $cueSheetList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_350\ResourceListType $resourceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_350\CollectionListType $collectionList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_350\ReleaseListType $releaseList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_350\DealListType $dealList
     */
     ...
     * A ddex:Composite containing details of a ddex:Price change.
     *
     * @return \DDEX\ERN\ERN_350\CatalogTransferType
     */
     ...
     * A ddex:Composite containing details of a ddex:Price change.
     *
     * @param \DDEX\ERN\ERN_350\CatalogTransferType $catalogTransfer
     * @return self
     */
    public function setCatalogTransfer(?\DDEX\ERN\ERN_350\CatalogTransferType $catalogTransfer = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_350\CueSheetType $cueSheet
     */
    public function addToCueSheetList(\DDEX\ERN\ERN_350\CueSheetType $cueSheet)
    {
     ...
     * A ddex:Composite containing details of one or more ddex:CueSheets contained in ddex:Releases for which data is provided in the ern:NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_350\CueSheetType[]
     */
     ...
     * A ddex:Composite containing details of one or more ddex:CueSheets contained in ddex:Releases for which data is provided in the ern:NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_350\CueSheetType[] $cueSheetList
     * @return self
     */
     ...
     * A ddex:Composite containing details of one or more ddex:Resources.
     *
     * @return \DDEX\ERN\ERN_350\ResourceListType
     */
     ...
     * A ddex:Composite containing details of one or more ddex:Resources.
     *
     * @param \DDEX\ERN\ERN_350\ResourceListType $resourceList
     * @return self
     */
    public function setResourceList(\DDEX\ERN\ERN_350\ResourceListType $resourceList)
    {
     ...
     * A ddex:Composite containing details of one or more ddex:Collections contained in ddex:Releases for which data is provided in the ern:NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_350\CollectionListType
     */
     ...
     * A ddex:Composite containing details of one or more ddex:Collections contained in ddex:Releases for which data is provided in the ern:NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_350\CollectionListType $collectionList
     * @return self
     */
    public function setCollectionList(?\DDEX\ERN\ERN_350\CollectionListType $collectionList = null)
    {
     ...
     * A ddex:Composite containing details of one or more ddex:DDEX ddex:Releases contained in the ern:NewReleaseMessage.
     *
     * @return \DDEX\ERN\ERN_350\ReleaseListType
     */
     ...
     * A ddex:Composite containing details of one or more ddex:DDEX ddex:Releases contained in the ern:NewReleaseMessage.
     *
     * @param \DDEX\ERN\ERN_350\ReleaseListType $releaseList
     * @return self
     */
    public function setReleaseList(\DDEX\ERN\ERN_350\ReleaseListType $releaseList)
    {
     ...
     * A ddex:Composite containing details of one or more ddex:Deals governing the Usage of the ddex:Releases in the ddex:Message.
     *
     * @return \DDEX\ERN\ERN_350\DealListType
     */
     ...
     * A ddex:Composite containing details of one or more ddex:Deals governing the Usage of the ddex:Releases in the ddex:Message.
     *
     * @param \DDEX\ERN\ERN_350\DealListType $dealList
     * @return self
     */
    public function setDealList(?\DDEX\ERN\ERN_350\DealListType $dealList = null)
    {
