...
class DealListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_351\ReleaseDealType[] $releaseDeal
     */
    private $releaseDeal = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_351\ReleaseDealType $releaseDeal
     */
    public function addToReleaseDeal(\DDEX\ERN\ERN_351\ReleaseDealType $releaseDeal)
    {
     ...
     * A ddex:Composite containing details of one or more ddex:Deals pertaining to one or more ddex:Releases.
     *
     * @return \DDEX\ERN\ERN_351\ReleaseDealType[]
     */
