...
class ReleaseListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_351\ReleaseType[] $release
     */
    private $release = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_351\ReleaseType $release
     */
    public function addToRelease(\DDEX\ERN\ERN_351\ReleaseType $release)
    {
     ...
     * A ddex:Composite containing details of a ddex:DDEX ddex:Release.
     *
     * @return \DDEX\ERN\ERN_351\ReleaseType[]
     */
