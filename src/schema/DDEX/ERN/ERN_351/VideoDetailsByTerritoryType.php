...
class VideoDetailsByTerritoryType
{
    ...
    /**
     * A ddex:Composite containing details of a ddex:DisplayConductor for the ddex:Video. A ddex:DisplayConductor may be described through ddex:Name, ddex:Identifier and Roles.
     *
    ...
    /**
     * A ddex:Composite containing details of a ddex:Contributor to the ddex:Video.
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:RightsController of Rights in the ddex:Video.
     *
     * @var \DDEX\ERN\ERN_351\RightsControllerType[] $rightsController
     */
     ...
     *
     * @var \DDEX\ddexC\HostSoundCarrierType[] $hostSoundCarrier
     */
     ...
     *
     * @var \DDEX\ERN\ERN_351\TechnicalVideoDetailsType[] $technicalVideoDetails
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_351\RightsControllerType $rightsController
     */
    public function addToRightsController(\DDEX\ERN\ERN_351\RightsControllerType $rightsController)
    {
     ...
     * A ddex:Composite containing details of ddex:RightsController of Rights in the ddex:Video.
     *
     * @return \DDEX\ERN\ERN_351\RightsControllerType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ddexC\HostSoundCarrierType $hostSoundCarrier
     */
    public function addToHostSoundCarrier(\DDEX\ddexC\HostSoundCarrierType $hostSoundCarrier)
    {
     ...
     * A ddex:Composite containing details of a ddex:HostSoundCarrier on which the ddex:Video appears (e.g., the CD on which it was originally released). This ddex:Composite exists in the Release Notification Message Suite Standard, to support the identification and matching of ddex:Video information.
     *
     * @return \DDEX\ddexC\HostSoundCarrierType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_351\TechnicalVideoDetailsType $technicalVideoDetails
     */
    public function addToTechnicalVideoDetails(\DDEX\ERN\ERN_351\TechnicalVideoDetailsType $technicalVideoDetails)
    {
     ...
     * A ddex:Composite containing technical details of the ddex:Video.
     *
     * @return \DDEX\ERN\ERN_351\TechnicalVideoDetailsType[]
     */
