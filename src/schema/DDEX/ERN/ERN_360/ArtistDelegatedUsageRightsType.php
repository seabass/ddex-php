...
class ArtistDelegatedUsageRightsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_360\PeriodType $periodOfRightsDelegation
     */
    private $periodOfRightsDelegation = null;

    /**
     * A Territory for which the delegation of usage rights applies (represented by an ISO 3166-1 TerritoryCode).
     *
     ...
     * A Composite containing details about a Period of Time for which the delegation of usage rights applies. Periods are typically described by at least a StartDate or EndDate.
     *
     * @param \DDEX\ERN\ERN_360\PeriodType $periodOfRightsDelegation
     * @return self
     */
    public function setPeriodOfRightsDelegation(\DDEX\ERN\ERN_360\PeriodType $periodOfRightsDelegation)
    {
