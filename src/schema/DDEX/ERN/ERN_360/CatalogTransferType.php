...
class CatalogTransferType
{
     ...
     *
     * @var \DDEX\ERN\ERN_360\EventDateType $effectiveTransferDate
     */
    ...
    /**
     * A Territory to which the CatalogTransfer applies (represented by an ISO 3166-1 TerritoryCode). Either this Element or ExcludedTerritory must be present, but not both.
     *
    ...
    /**
     * A Territory to which the CatalogTransfer does not apply (represented by an ISO 3166-1 TerritoryCode). Either this Element or Territory must be present, but not both.
     *
     ...
     *
     * @var \DDEX\ERN\ERN_360\PartyDescriptorType $transferringFrom
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\PartyDescriptorType $transferringTo
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the catalog is or was transferred.
     *
     * @param \DDEX\ERN\ERN_360\EventDateType $effectiveTransferDate
     * @return self
     */
    public function setEffectiveTransferDate(?\DDEX\ERN\ERN_360\EventDateType $effectiveTransferDate = null)
    {
     ...
     * A Composite containing details of the old RightsController.
     *
     * @return \DDEX\ERN\ERN_360\PartyDescriptorType
     */
     ...
     * A Composite containing details of the old RightsController.
     *
     * @param \DDEX\ERN\ERN_360\PartyDescriptorType $transferringFrom
     * @return self
     */
    public function setTransferringFrom(\DDEX\ERN\ERN_360\PartyDescriptorType $transferringFrom)
    {
     ...
     * A Composite containing details of the new RightsController.
     *
     * @param \DDEX\ERN\ERN_360\PartyDescriptorType $transferringTo
     * @return self
     */
    public function setTransferringTo(\DDEX\ERN\ERN_360\PartyDescriptorType $transferringTo)
    {
