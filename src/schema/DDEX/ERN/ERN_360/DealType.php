...
class DealType
{
     ...
     *
     * @var \DDEX\ERN\ERN_360\DealReferenceType[] $dealReference
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\DealTermsType $dealTerms
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\ResourceUsageType $resourceUsage
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\WebPageType[] $distributionChannelPage
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\DealReferenceType $dealReference
     */
    public function addToDealReference(\DDEX\ERN\ERN_360\DealReferenceType $dealReference)
    {
     ...
     * A Composite containing a Reference to a TextDocument containing details of the Deal (in the form of an Identifier, Name or Description).
     *
     * @return \DDEX\ERN\ERN_360\DealReferenceType[]
     */
     ...
     * A Composite containing details of the terms of the Deal.
     *
     * @return \DDEX\ERN\ERN_360\DealTermsType
     */
     ...
     * A Composite containing details of the terms of the Deal.
     *
     * @param \DDEX\ERN\ERN_360\DealTermsType $dealTerms
     * @return self
     */
    public function setDealTerms(?\DDEX\ERN\ERN_360\DealTermsType $dealTerms = null)
    {
     ...
     * A Composite containing details of one or more Usages that govern a Resource in the Deal where the Usage of the Resource differs from the Usage of the other Resources in the same Release.
     *
     * @return \DDEX\ERN\ERN_360\ResourceUsageType
     */
     ...
     * A Composite containing details of one or more Usages that govern a Resource in the Deal where the Usage of the Resource differs from the Usage of the other Resources in the same Release.
     *
     * @param \DDEX\ERN\ERN_360\ResourceUsageType $resourceUsage
     * @return self
     */
    public function setResourceUsage(?\DDEX\ERN\ERN_360\ResourceUsageType $resourceUsage = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\WebPageType $distributionChannelPage
     */
    public function addToDistributionChannelPage(\DDEX\ERN\ERN_360\WebPageType $distributionChannelPage)
    {
