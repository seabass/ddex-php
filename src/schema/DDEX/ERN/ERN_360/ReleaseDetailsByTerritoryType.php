...
class ReleaseDetailsByTerritoryType
{
     ...
     *
     * @var \DDEX\ERN\ERN_360\NameType[] $displayArtistName
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\AdministratingRecordCompanyType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\RelatedReleaseType[] $relatedRelease
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\ResourceGroupType[] $resourceGroup
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\EventDateType $releaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\EventDateType $originalDigitalReleaseDate
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\NameType $displayArtistName
     */
    public function addToDisplayArtistName(\DDEX\ERN\ERN_360\NameType $displayArtistName)
    {
     ...
     * A Composite containing the Name to be used by a DSP when presenting Artist details of the Release to a Consumer.
     *
     * @return \DDEX\ERN\ERN_360\NameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\AdministratingRecordCompanyType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DDEX\ERN\ERN_360\AdministratingRecordCompanyType $administratingRecordCompany)
    {
     ...
     * A Composite containing details of the AdministratingRecordCompany for the Release.
     *
     * @return \DDEX\ERN\ERN_360\AdministratingRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DDEX\ERN\ERN_360\RelatedReleaseType $relatedRelease)
    {
     ...
     * A Composite containing details of a Release (or a PhysicalProduct or a DigitalProduct derived from such a Release) which is related to this Release.
     *
     * @return \DDEX\ERN\ERN_360\RelatedReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\ResourceGroupType $resourceGroup
     */
    public function addToResourceGroup(\DDEX\ERN\ERN_360\ResourceGroupType $resourceGroup)
    {
     ...
     * A Composite containing details of a group of some or all of the Resources in the Release. ResourceGroups are used to signal groupings or sequences of Resources within a Release. Examples include individual carriers in a multi-carrier Release or classical Work groupings as well as the default order of Resources within a Release.
     *
     * @return \DDEX\ERN\ERN_360\ResourceGroupType[]
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DDEX\ERN\ERN_360\EventDateType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DDEX\ERN\ERN_360\EventDateType $releaseDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available in electronic/online format for Usage (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DDEX\ERN\ERN_360\EventDateType $originalDigitalReleaseDate
     * @return self
     */
    public function setOriginalDigitalReleaseDate(?\DDEX\ERN\ERN_360\EventDateType $originalDigitalReleaseDate = null)
    {
