...
class ResourceContributorType
{
     ...
     *
     * @var \DDEX\ERN\ERN_360\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\ERN\ERN_360\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\ERN\ERN_360\ResourceContributorRoleType[] $resourceContributorRole
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\EventDateType $dateAndPlaceOfBirth
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\EventDateType $dateAndPlaceOfDeath
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\ArtistRoleType $primaryRole
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\GoverningAgreementTypeType $governingAgreementType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\ContactIdType $contactInformation
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\ArtistRoleType[] $additionalRoles
     */
     ...
     *
     * @var \DDEX\ERN\ERN_360\MembershipType[] $membership
     */
    private $membership = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\ERN\ERN_360\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, Producers or other Creators.
     *
     * @return \DDEX\ERN\ERN_360\PartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\PartyNameType $partyName
     */
    public function addToPartyName(\DDEX\ERN\ERN_360\PartyNameType $partyName)
    {
     ...
     * A Composite containing details of the PartyName(s).
     *
     * @return \DDEX\ERN\ERN_360\PartyNameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\ResourceContributorRoleType $resourceContributorRole
     */
    public function addToResourceContributorRole(\DDEX\ERN\ERN_360\ResourceContributorRoleType $resourceContributorRole)
    {
     ...
     * A Composite containing details of a role played by the Contributor.
     *
     * @return \DDEX\ERN\ERN_360\ResourceContributorRoleType[]
     */
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated by the Artist.
     *
     * @return \DDEX\ERN\ERN_360\ArtistDelegatedUsageRightsType
     */
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated by the Artist.
     *
     * @param \DDEX\ERN\ERN_360\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     * @return self
     */
    public function setArtistDelegatedUsageRights(?\DDEX\ERN\ERN_360\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights = null)
    {
     ...
     * A Composite containing details of the Date and Place of birth.
     *
     * @param \DDEX\ERN\ERN_360\EventDateType $dateAndPlaceOfBirth
     * @return self
     */
    public function setDateAndPlaceOfBirth(?\DDEX\ERN\ERN_360\EventDateType $dateAndPlaceOfBirth = null)
    {
     ...
     * A Composite containing details of the Date and Place of death.
     *
     * @param \DDEX\ERN\ERN_360\EventDateType $dateAndPlaceOfDeath
     * @return self
     */
    public function setDateAndPlaceOfDeath(?\DDEX\ERN\ERN_360\EventDateType $dateAndPlaceOfDeath = null)
    {
     ...
     * A Composite containing details of the primary role played by the Artist in relation to other Artists.
     *
     * @return \DDEX\ERN\ERN_360\ArtistRoleType
     */
     ...
     * A Composite containing details of the primary role played by the Artist in relation to other Artists.
     *
     * @param \DDEX\ERN\ERN_360\ArtistRoleType $primaryRole
     * @return self
     */
    public function setPrimaryRole(?\DDEX\ERN\ERN_360\ArtistRoleType $primaryRole = null)
    {
     ...
     * A Composite containing details of a Type of an agreement that covers the Artist's participation in making a SoundRecording.
     *
     * @return \DDEX\ERN\ERN_360\GoverningAgreementTypeType
     */
     ...
     * A Composite containing details of a Type of an agreement that covers the Artist's participation in making a SoundRecording.
     *
     * @param \DDEX\ERN\ERN_360\GoverningAgreementTypeType $governingAgreementType
     * @return self
     */
    public function setGoverningAgreementType(?\DDEX\ERN\ERN_360\GoverningAgreementTypeType $governingAgreementType = null)
    {
     ...
     * A Composite containing details of contact Identifiers of the Artist.
     *
     * @return \DDEX\ERN\ERN_360\ContactIdType
     */
     ...
     * A Composite containing details of contact Identifiers of the Artist.
     *
     * @param \DDEX\ERN\ERN_360\ContactIdType $contactInformation
     * @return self
     */
    public function setContactInformation(?\DDEX\ERN\ERN_360\ContactIdType $contactInformation = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\ArtistRoleType $additionalRoles
     */
    public function addToAdditionalRoles(\DDEX\ERN\ERN_360\ArtistRoleType $additionalRoles)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_360\MembershipType $membership
     */
    public function addToMembership(\DDEX\ERN\ERN_360\MembershipType $membership)
    {
     ...
     * A Composite containing details of a membership in a collective rights management organization.
     *
     * @return \DDEX\ERN\ERN_360\MembershipType[]
     */
