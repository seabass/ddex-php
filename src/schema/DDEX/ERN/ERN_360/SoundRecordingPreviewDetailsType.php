...
class SoundRecordingPreviewDetailsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_360\DescriptionType $partType
     */
     ...
     * A Composite containing a Description of the Type of Part that the preview relates to, e.g. chorus or intro.
     *
     * @param \DDEX\ERN\ERN_360\DescriptionType $partType
     * @return self
     */
    public function setPartType(?\DDEX\ERN\ERN_360\DescriptionType $partType = null)
    {
