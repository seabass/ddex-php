...
class CollectionCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DDEX\ERN\ERN_370\CollectionCollectionReferenceType[] $collectionCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_370\CollectionCollectionReferenceType $collectionCollectionReference
     */
    public function addToCollectionCollectionReference(\DDEX\ERN\ERN_370\CollectionCollectionReferenceType $collectionCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DDEX\ERN\ERN_370\CollectionCollectionReferenceType[]
     */
