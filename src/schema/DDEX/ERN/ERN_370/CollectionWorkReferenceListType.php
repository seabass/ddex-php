...
class CollectionWorkReferenceListType
{
     ...
     *  Message).
     *
     * @var \DDEX\ERN\ERN_370\CollectionWorkReferenceType[] $collectionWorkReference
     */
     ...
     */
    public function addToCollectionWorkReference(\DDEX\ERN\ERN_370\CollectionWorkReferenceType $collectionWorkReference)
    {
