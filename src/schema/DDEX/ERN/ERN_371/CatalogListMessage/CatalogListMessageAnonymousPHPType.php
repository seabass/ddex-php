...
namespace DDEX\ERN\ERN_371\CatalogListMessage;
...
class CatalogListMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_371\CatalogItemType[] $catalogItem
     */
    private $catalogItem = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\CatalogItemType $catalogItem
     */
    public function addToCatalogItem(\DDEX\ERN\ERN_371\CatalogItemType $catalogItem)
    {
     ...
     *  Release which is an item of the catalog.
     *
     * @return \DDEX\ERN\ERN_371\CatalogItemType[]
     */
