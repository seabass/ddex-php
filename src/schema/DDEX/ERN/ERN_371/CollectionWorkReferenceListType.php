...
class CollectionWorkReferenceListType
{
     ...
     *  Message).
     *
     * @var \DDEX\ERN\ERN_371\CollectionWorkReferenceType[] $collectionWorkReference
     */
     ...
     */
    public function addToCollectionWorkReference(\DDEX\ERN\ERN_371\CollectionWorkReferenceType $collectionWorkReference)
    {
