...
class ResourceListType
{
     ...
     *  SoundRecording.
     *
     * @var \DDEX\ERN\ERN_371\SoundRecordingType[] $soundRecording
     */
     ...
     *  MIDI.
     *
     * @var \DDEX\ERN\ERN_371\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *  Video.
     *
     * @var \DDEX\ERN\ERN_371\VideoType[] $video
     */
    private $video = [
     ...
     *  Image.
     *
     * @var \DDEX\ERN\ERN_371\ImageType[] $image
     */
    private $image = [
     ...
     *  Text.
     *
     * @var \DDEX\ERN\ERN_371\TextType[] $text
     */
    private $text = [
     ...
     *  SheetMusic.
     *
     * @var \DDEX\ERN\ERN_371\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *  of Software.
     *
     * @var \DDEX\ERN\ERN_371\SoftwareType[] $software
     */
    private $software = [
     ...
     *  UserDefinedResource.
     *
     * @var \DDEX\ERN\ERN_371\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\ERN\ERN_371\SoundRecordingType $soundRecording)
    {
     ...
     *  SoundRecording.
     *
     * @return \DDEX\ERN\ERN_371\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\MIDIType $mIDI
     */
    public function addToMIDI(\DDEX\ERN\ERN_371\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     *  MIDI.
     *
     * @return \DDEX\ERN\ERN_371\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\VideoType $video
     */
    public function addToVideo(\DDEX\ERN\ERN_371\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     *  Video.
     *
     * @return \DDEX\ERN\ERN_371\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\ImageType $image
     */
    public function addToImage(\DDEX\ERN\ERN_371\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     *  Image.
     *
     * @return \DDEX\ERN\ERN_371\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\TextType $text
     */
    public function addToText(\DDEX\ERN\ERN_371\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     *  Text.
     *
     * @return \DDEX\ERN\ERN_371\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\ERN\ERN_371\SheetMusicType $sheetMusic)
    {
     ...
     *  SheetMusic.
     *
     * @return \DDEX\ERN\ERN_371\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\SoftwareType $software
     */
    public function addToSoftware(\DDEX\ERN\ERN_371\SoftwareType $software)
    {
     ...
     *  of Software.
     *
     * @return \DDEX\ERN\ERN_371\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DDEX\ERN\ERN_371\UserDefinedResourceType $userDefinedResource)
    {
     ...
     *  UserDefinedResource.
     *
     * @return \DDEX\ERN\ERN_371\UserDefinedResourceType[]
     */
