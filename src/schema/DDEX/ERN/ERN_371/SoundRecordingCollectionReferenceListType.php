...
class SoundRecordingCollectionReferenceListType
{
     ...
     *  Message).
     *
     * @var \DDEX\ERN\ERN_371\SoundRecordingCollectionReferenceType[] $soundRecordingCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_371\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference
     */
    public function addToSoundRecordingCollectionReference(\DDEX\ERN\ERN_371\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference)
    {
     ...
     *  Message).
     *
     * @return \DDEX\ERN\ERN_371\SoundRecordingCollectionReferenceType[]
     */
