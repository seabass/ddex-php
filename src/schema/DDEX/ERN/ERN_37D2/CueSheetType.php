...
class CueSheetType
{
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\ProprietaryIdType[] $cueSheetId
     */
    private $cueSheetId = [
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\CueSheetTypeType $cueSheetType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\CueType[] $cue
     */
    private $cue = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\ProprietaryIdType $cueSheetId
     */
    public function addToCueSheetId(\DDEX\ERN\ERN_37D2\ProprietaryIdType $cueSheetId)
    {
     ...
     * A Composite containing details of a Type of the CueSheet.
     *
     * @return \DDEX\ERN\ERN_37D2\CueSheetTypeType
     */
     ...
     * A Composite containing details of a Type of the CueSheet.
     *
     * @param \DDEX\ERN\ERN_37D2\CueSheetTypeType $cueSheetType
     * @return self
     */
    public function setCueSheetType(\DDEX\ERN\ERN_37D2\CueSheetTypeType $cueSheetType)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\CueType $cue
     */
    public function addToCue(\DDEX\ERN\ERN_37D2\CueType $cue)
    {
        $this->cue[] = $cue;
        return $this;
    }
     ...
     * A Composite containing details of a Cue.
     *
     * @return \DDEX\ERN\ERN_37D2\CueType[]
     */
