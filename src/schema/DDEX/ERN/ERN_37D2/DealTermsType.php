...
class DealTermsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\CommercialModelTypeType[] $commercialModelType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\UsageType[] $usage
     */
    private $usage = [
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\DSPType[] $distributionChannel
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\DSPType[] $excludedDistributionChannel
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\PriceInformationType[] $priceInformation
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\PromotionalCodeType $promotionalCode
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\PeriodType[] $validityPeriod
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\ConsumerRentalPeriodType $consumerRentalPeriod
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\EventDateType $preOrderReleaseDate
     */
     ...
     *
     * @var \DateTime $releaseDisplayStartDate
     */
    private $releaseDisplayStartDate = null;

    /**
     * A Date on which the Track list is made first available for display (it overrides the generic ReleaseDisplayStartDate if supplied). If no TrackListingPreviewStartDate is provided, the StartDate for the Deal is used instead. The TrackListingPreviewStartDate may not be later than the StartDate for the Deal.
     *
     * @var \DateTime $trackListingPreviewStartDate
     */
    private $trackListingPreviewStartDate = null;

    /**
     * A Date on which the cover art is made first available for display (it overrides the generic ReleaseDisplayStartDate if supplied). If no CoverArtPreviewStartDate is provided, the StartDate for the Deal is used instead. The CoverArtPreviewStartDate may not be later than the StartDate for the Deal.
     *
     * @var \DateTime $coverArtPreviewStartDate
     */
    private $coverArtPreviewStartDate = null;

    /**
     * A Date on which an audio or video clip is made first available for display (it overrides the generic ReleaseDisplayStartDate if supplied). If no ClipPreviewStartDate is provided, the StartDate for the Deal is used instead. The ClipPreviewStartDate may not be later than the StartDate for the Deal.
     *
     * @var \DateTime $clipPreviewStartDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\EventDateType $preOrderPreviewDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\RelatedReleaseOfferSetType[] $relatedReleaseOfferSet
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\PhysicalReturnsType $physicalReturns
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\RightsClaimPolicyType[] $rightsClaimPolicy
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\WebPolicyType[] $webPolicy
     */
    private $webPolicy = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\CommercialModelTypeType $commercialModelType
     */
    public function addToCommercialModelType(\DDEX\ERN\ERN_37D2\CommercialModelTypeType $commercialModelType)
    {
     ...
     * A Composite containing details of the fundamental business model which applies to the Deal (e.g. SubscriptionModel and PayAsYouGoModel). The CommercialModelType indicates how the Consumer pays for the Service or Release.
     *
     * @return \DDEX\ERN\ERN_37D2\CommercialModelTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\UsageType $usage
     */
    public function addToUsage(\DDEX\ERN\ERN_37D2\UsageType $usage)
    {
        $this->usage[] = $usage;
        return $this;
    }
     ...
     * A Composite containing the Types and number of Usages applicable to a Release to which the Deal applies.
     *
     * @return \DDEX\ERN\ERN_37D2\UsageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\DSPType $distributionChannel
     */
    public function addToDistributionChannel(\DDEX\ERN\ERN_37D2\DSPType $distributionChannel)
    {
     ...
     * A Composite containing details of the DSP through whose DistributionChannel the sales are permitted. If none are provided no limitations on the DistributionChannels are given.
     *
     * @return \DDEX\ERN\ERN_37D2\DSPType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\DSPType $excludedDistributionChannel
     */
    public function addToExcludedDistributionChannel(\DDEX\ERN\ERN_37D2\DSPType $excludedDistributionChannel)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\PriceInformationType $priceInformation
     */
    public function addToPriceInformation(\DDEX\ERN\ERN_37D2\PriceInformationType $priceInformation)
    {
     ...
     * A Composite containing details of a Price. Note that this Price applies to all UseTypes referenced in this Composite.
     *
     * @return \DDEX\ERN\ERN_37D2\PriceInformationType[]
     */
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @return \DDEX\ERN\ERN_37D2\PromotionalCodeType
     */
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @param \DDEX\ERN\ERN_37D2\PromotionalCodeType $promotionalCode
     * @return self
     */
    public function setPromotionalCode(?\DDEX\ERN\ERN_37D2\PromotionalCodeType $promotionalCode = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\PeriodType $validityPeriod
     */
    public function addToValidityPeriod(\DDEX\ERN\ERN_37D2\PeriodType $validityPeriod)
    {
     ...
     * A Composite containing details about a Period of Time during which the Deal is valid. No StartDate in this Composite means that the Deal is valid as per contractual relationship between MessageSender and MessageRecipient. No EndDate in this Composite means that the Deal is valid until further notice.
     *
     * @return \DDEX\ERN\ERN_37D2\PeriodType[]
     */
     ...
     * A Composite containing details of a Period the DSP may rent something to a Customer.
     *
     * @return \DDEX\ERN\ERN_37D2\ConsumerRentalPeriodType
     */
     ...
     * A Composite containing details of a Period the DSP may rent something to a Customer.
     *
     * @param \DDEX\ERN\ERN_37D2\ConsumerRentalPeriodType $consumerRentalPeriod
     * @return self
     */
    public function setConsumerRentalPeriod(?\DDEX\ERN\ERN_37D2\ConsumerRentalPeriodType $consumerRentalPeriod = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the related Release is made available for pre-ordering.
     *
     * @param \DDEX\ERN\ERN_37D2\EventDateType $preOrderReleaseDate
     * @return self
     */
    public function setPreOrderReleaseDate(?\DDEX\ERN\ERN_37D2\EventDateType $preOrderReleaseDate = null)
    {
     ...
     * A Date on which the Release is made first available for display. If other Track list, cover art and clip preview dates are not provided, then this date covers them as well (assuming clips are available). If no ReleaseDisplayStartDate is provided, the StartDate for the Deal is used instead. The ReleaseDisplayStartDate may not be later than the StartDate for the Deal. If the MessageRecipient is not able to cater for such granular display policies, the MessageRecipient may be forced to not display any Release information until a much later date.
     *
     * @param \DateTime $releaseDisplayStartDate
     * @return self
     */
    public function setReleaseDisplayStartDate(?\DateTime $releaseDisplayStartDate = null)
    {
     ...
     * A Date on which the Track list is made first available for display (it overrides the generic ReleaseDisplayStartDate if supplied). If no TrackListingPreviewStartDate is provided, the StartDate for the Deal is used instead. The TrackListingPreviewStartDate may not be later than the StartDate for the Deal.
     *
     * @param \DateTime $trackListingPreviewStartDate
     * @return self
     */
    public function setTrackListingPreviewStartDate(?\DateTime $trackListingPreviewStartDate = null)
    {
     ...
     * A Date on which the cover art is made first available for display (it overrides the generic ReleaseDisplayStartDate if supplied). If no CoverArtPreviewStartDate is provided, the StartDate for the Deal is used instead. The CoverArtPreviewStartDate may not be later than the StartDate for the Deal.
     *
     * @param \DateTime $coverArtPreviewStartDate
     * @return self
     */
    public function setCoverArtPreviewStartDate(?\DateTime $coverArtPreviewStartDate = null)
    {
     ...
     * A Date on which an audio or video clip is made first available for display (it overrides the generic ReleaseDisplayStartDate if supplied). If no ClipPreviewStartDate is provided, the StartDate for the Deal is used instead. The ClipPreviewStartDate may not be later than the StartDate for the Deal.
     *
     * @param \DateTime $clipPreviewStartDate
     * @return self
     */
    public function setClipPreviewStartDate(?\DateTime $clipPreviewStartDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the pre-ordered Release is made first available for previewing (it overrides the generic ReleaseDisplayStartDate if supplied). If no PreOrderPreviewDate is provided, the StartDate for the Deal is used instead. The PreOrderPreviewDate may not be later than the StartDate for the Deal. This element has been deprecated and may be deleted in a future version of this message.
     *
     * @param \DDEX\ERN\ERN_37D2\EventDateType $preOrderPreviewDate
     * @return self
     */
    public function setPreOrderPreviewDate(?\DDEX\ERN\ERN_37D2\EventDateType $preOrderPreviewDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\RelatedReleaseOfferSetType $relatedReleaseOfferSet
     */
    public function addToRelatedReleaseOfferSet(\DDEX\ERN\ERN_37D2\RelatedReleaseOfferSetType $relatedReleaseOfferSet)
    {
     ...
     * A Composite containing details of one or more offers related to the Release.
     *
     * @return \DDEX\ERN\ERN_37D2\RelatedReleaseOfferSetType[]
     */
     ...
     * A Composite containing details of physical returns.
     *
     * @return \DDEX\ERN\ERN_37D2\PhysicalReturnsType
     */
     ...
     * A Composite containing details of physical returns.
     *
     * @param \DDEX\ERN\ERN_37D2\PhysicalReturnsType $physicalReturns
     * @return self
     */
    public function setPhysicalReturns(?\DDEX\ERN\ERN_37D2\PhysicalReturnsType $physicalReturns = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\RightsClaimPolicyType $rightsClaimPolicy
     */
    public function addToRightsClaimPolicy(\DDEX\ERN\ERN_37D2\RightsClaimPolicyType $rightsClaimPolicy)
    {
     ...
     * A Composite containing details of a rights claim policy.
     *
     * @return \DDEX\ERN\ERN_37D2\RightsClaimPolicyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\WebPolicyType $webPolicy
     */
    public function addToWebPolicy(\DDEX\ERN\ERN_37D2\WebPolicyType $webPolicy)
    {
     ...
     * A Composite containing details of UserGeneratedContent permissions.
     *
     * @return \DDEX\ERN\ERN_37D2\WebPolicyType[]
     */
