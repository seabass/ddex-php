...
class MusicalWorkContributorType
{
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\MusicalWorkContributorRoleType[] $musicalWorkContributorRole
     */
     ...
     *
     * @var \DDEX\ERN\ERN_37D2\SocietyAffiliationType[] $societyAffiliation
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\MusicalWorkContributorRoleType $musicalWorkContributorRole
     */
    public function addToMusicalWorkContributorRole(\DDEX\ERN\ERN_37D2\MusicalWorkContributorRoleType $musicalWorkContributorRole)
    {
     ...
     * A Composite containing details of a role played by the Contributor in relation to the MusicalWork. Note: This can be used in a DdexMessage in relation to any Work, Performance or Fixation any of which may form the whole or part of the Resource itself. Example: if an 'AssociatedPerformer' is shown as a Contributor to a MusicalWork it refers to a performer of a Resource (e.g. a SoundRecording) expressing the MusicalWork.
     *
     * @return \DDEX\ERN\ERN_37D2\MusicalWorkContributorRoleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_37D2\SocietyAffiliationType $societyAffiliation
     */
    public function addToSocietyAffiliation(\DDEX\ERN\ERN_37D2\SocietyAffiliationType $societyAffiliation)
    {
     ...
     * A Composite containing details of a society affiliation for the MusicalWorkContributor.
     *
     * @return \DDEX\ERN\ERN_37D2\SocietyAffiliationType[]
     */
