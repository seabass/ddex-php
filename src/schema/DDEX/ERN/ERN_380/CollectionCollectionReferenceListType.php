...
class CollectionCollectionReferenceListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_380\CollectionCollectionReferenceType[] $collectionCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\CollectionCollectionReferenceType $collectionCollectionReference
     */
    public function addToCollectionCollectionReference(\DDEX\ERN\ERN_380\CollectionCollectionReferenceType $collectionCollectionReference)
    {
     ...
     * A Composite containing a CollectionCollectionReference for a Collection (specific to this Message).
     *
     * @return \DDEX\ERN\ERN_380\CollectionCollectionReferenceType[]
     */
