...
class GenreType
{
     ...
     *
     * @var \DDEX\ERN\ERN_380\DescriptionType $genreText
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\DescriptionType $subGenre
     */
     ...
     * A Composite containing a Description of a genre or style (such as Musical, literary or audio-visual) with which a Creation is associated.
     *
     * @param \DDEX\ERN\ERN_380\DescriptionType $genreText
     * @return self
     */
    public function setGenreText(\DDEX\ERN\ERN_380\DescriptionType $genreText)
    {
     ...
     * A Composite containing a Description of a secondary genre or style with which a Creation is associated.
     *
     * @param \DDEX\ERN\ERN_380\DescriptionType $subGenre
     * @return self
     */
    public function setSubGenre(?\DDEX\ERN\ERN_380\DescriptionType $subGenre = null)
    {
