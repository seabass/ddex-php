...
class MIDIType
{
     ...
     *
     * @var \DDEX\ERN\ERN_380\MidiTypeType $midiType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\ResourceProprietaryIdType[] $midiId
     */
    private $midiId = [
     ...
     *
     * @var \DDEX\ERN\ERN_380\MusicalWorkIdType[] $indirectMidiId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_380\MidiDetailsByTerritoryType[] $midiDetailsByTerritory
     */
     ...
     * A Composite containing details of the Type of the MIDI.
     *
     * @return \DDEX\ERN\ERN_380\MidiTypeType
     */
     ...
     * A Composite containing details of the Type of the MIDI.
     *
     * @param \DDEX\ERN\ERN_380\MidiTypeType $midiType
     * @return self
     */
    public function setMidiType(?\DDEX\ERN\ERN_380\MidiTypeType $midiType = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\ResourceProprietaryIdType $midiId
     */
    public function addToMidiId(\DDEX\ERN\ERN_380\ResourceProprietaryIdType $midiId)
    {
        $this->midiId[] = $midiId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\MusicalWorkIdType $indirectMidiId
     */
    public function addToIndirectMidiId(\DDEX\ERN\ERN_380\MusicalWorkIdType $indirectMidiId)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_380\MidiDetailsByTerritoryType $midiDetailsByTerritory
     */
    public function addToMidiDetailsByTerritory(\DDEX\ERN\ERN_380\MidiDetailsByTerritoryType $midiDetailsByTerritory)
    {
     ...
     * A Composite containing details of Descriptors and other attributes of the MIDI which may vary according to Territory of release.
     *
     * @return \DDEX\ERN\ERN_380\MidiDetailsByTerritoryType[]
     */
