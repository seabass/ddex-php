...
namespace DDEX\ERN\ERN_381\CatalogListMessage;
...
class CatalogListMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_381\CatalogItemType[] $catalogItem
     */
    private $catalogItem = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\CatalogItemType $catalogItem
     */
    public function addToCatalogItem(\DDEX\ERN\ERN_381\CatalogItemType $catalogItem)
    {
     ...
     * A Composite containing details of a Release which is an item of the catalog.
     *
     * @return \DDEX\ERN\ERN_381\CatalogItemType[]
     */
