...
class ReleaseListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_381\ReleaseType[] $release
     */
    private $release = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_381\ReleaseType $release
     */
    public function addToRelease(\DDEX\ERN\ERN_381\ReleaseType $release)
    {
     ...
     * A Composite containing details of a DDEX Release.
     *
     * @return \DDEX\ERN\ERN_381\ReleaseType[]
     */
