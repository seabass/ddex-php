...
class TechnicalSoundRecordingDetailsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_381\BitRateType $bitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_381\SamplingRateType $samplingRate
     */
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_381\BitRateType $bitRate
     * @return self
     */
    public function setBitRate(?\DDEX\ERN\ERN_381\BitRateType $bitRate = null)
    {
     ...
     * A Composite containing the sampling rate of the SoundRecording and a UnitOfMeasure (the default is Hz).
     *
     * @param \DDEX\ERN\ERN_381\SamplingRateType $samplingRate
     * @return self
     */
    public function setSamplingRate(?\DDEX\ERN\ERN_381\SamplingRateType $samplingRate = null)
    {
