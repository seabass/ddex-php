...
class RightsClaimPolicyType
{
     ...
     *  conditions.
     *
     * @var \DDEX\ERN\ERN_383\ConditionType[] $condition
     */
    private $condition = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_383\ConditionType $condition
     */
    public function addToCondition(\DDEX\ERN\ERN_383\ConditionType $condition)
    {
     ...
     *  conditions.
     *
     * @return \DDEX\ERN\ERN_383\ConditionType[]
     */
