...
class PurgedReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_400\TitleType[] $title
     */
    private $title = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\DetailedResourceContributorType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\TitleType $title
     */
    public function addToTitle(\DDEX\ERN\ERN_400\TitleType $title)
    {
        $this->title[] = $title;
        return $this;
    }
     ...
     * A Composite containing details of a Title of the Release.
     *
     * @return \DDEX\ERN\ERN_400\TitleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\DetailedResourceContributorType $contributor
     */
    public function addToContributor(\DDEX\ERN\ERN_400\DetailedResourceContributorType $contributor)
    {
     ...
     * A Composite containing details of a Contributor to the Release.
     *
     * @return \DDEX\ERN\ERN_400\DetailedResourceContributorType[]
     */
