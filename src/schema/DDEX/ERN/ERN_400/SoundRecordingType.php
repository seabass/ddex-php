...
class SoundRecordingType
{
     ...
     *
     * @var \DDEX\ERN\ERN_400\SoundRecordingTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \DDEX\ERN\ERN_400\SoundRecordingIdType[] $resourceId
     */
    private $resourceId = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\FirstPublicationDateType[] $firstPublicationDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\TechnicalSoundRecordingDetailsType[] $technicalDetails
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\RagaType[] $raga
     */
    private $raga = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\TalaType[] $tala
     */
    private $tala = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\DeityType[] $deity
     */
    private $deity = [
     ...
     * A Composite containing details of the Type of the SoundRecording.
     *
     * @return \DDEX\ERN\ERN_400\SoundRecordingTypeType
     */
     ...
     * A Composite containing details of the Type of the SoundRecording.
     *
     * @param \DDEX\ERN\ERN_400\SoundRecordingTypeType $type
     * @return self
     */
    public function setType(\DDEX\ERN\ERN_400\SoundRecordingTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\SoundRecordingIdType $resourceId
     */
    public function addToResourceId(\DDEX\ERN\ERN_400\SoundRecordingIdType $resourceId)
    {
     ...
     * A Composite containing details of a SoundRecordingId.
     *
     * @return \DDEX\ERN\ERN_400\SoundRecordingIdType[]
     */
     ...
     * @return self
     */
    public function setRemasteredDate(?\DDEX\ERN\ERN_400\EventDateWithoutTerritoryType $remasteredDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\FirstPublicationDateType $firstPublicationDate
     */
    public function addToFirstPublicationDate(\DDEX\ERN\ERN_400\FirstPublicationDateType $firstPublicationDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the SoundRecording was first published, whether for physical or electronic/online distribution. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @return \DDEX\ERN\ERN_400\FirstPublicationDateType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\TechnicalSoundRecordingDetailsType $technicalDetails
     */
    public function addToTechnicalDetails(\DDEX\ERN\ERN_400\TechnicalSoundRecordingDetailsType $technicalDetails)
    {
     ...
     * A Composite containing technical details of the SoundRecording.
     *
     * @return \DDEX\ERN\ERN_400\TechnicalSoundRecordingDetailsType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\RagaType $raga
     */
    public function addToRaga(\DDEX\ERN\ERN_400\RagaType $raga)
    {
        $this->raga[] = $raga;
        return $this;
    }
     ...
     * A Description of the melodic mode of a MusicalWork in the SoundRecording.
     *
     * @return \DDEX\ERN\ERN_400\RagaType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\TalaType $tala
     */
    public function addToTala(\DDEX\ERN\ERN_400\TalaType $tala)
    {
        $this->tala[] = $tala;
        return $this;
    }
     ...
     * A Description of the rhythmic pattern of a MusicalWork in the SoundRecording.
     *
     * @return \DDEX\ERN\ERN_400\TalaType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\DeityType $deity
     */
    public function addToDeity(\DDEX\ERN\ERN_400\DeityType $deity)
    {
        $this->deity[] = $deity;
        return $this;
    }
     ...
     * A deity name relating to the SoundRecording.
     *
     * @return \DDEX\ERN\ERN_400\DeityType[]
     */
