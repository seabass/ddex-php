...
class TechnicalSoundRecordingDetailsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_400\BitRateType $bitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\BitRateType $originalBitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\SamplingRateType $samplingRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\SamplingRateType $originalSamplingRate
     */
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_400\BitRateType $bitRate
     * @return self
     */
    public function setBitRate(?\DDEX\ERN\ERN_400\BitRateType $bitRate = null)
    {
     ...
     * A Composite containing the BitRate for the audio data recording and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_400\BitRateType $originalBitRate
     * @return self
     */
    public function setOriginalBitRate(?\DDEX\ERN\ERN_400\BitRateType $originalBitRate = null)
    {
     ...
     * A Composite containing the sampling rate of the SoundRecording and a UnitOfMeasure (the default is Hz).
     *
     * @param \DDEX\ERN\ERN_400\SamplingRateType $samplingRate
     * @return self
     */
    public function setSamplingRate(?\DDEX\ERN\ERN_400\SamplingRateType $samplingRate = null)
    {
     ...
     * A Composite containing the sampling rate of the SoundRecording during the recording, and a UnitOfMeasure (the default is Hz).
     *
     * @param \DDEX\ERN\ERN_400\SamplingRateType $originalSamplingRate
     * @return self
     */
    public function setOriginalSamplingRate(?\DDEX\ERN\ERN_400\SamplingRateType $originalSamplingRate = null)
    {
