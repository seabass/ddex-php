...
class VideoType
{
     ...
     *
     * @var \DDEX\ERN\ERN_400\VideoTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \DDEX\ERN\ERN_400\VideoIdType[] $resourceId
     */
    private $resourceId = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\MusicalWorkIdType[] $workId
     */
    private $workId = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\CharacterType[] $character
     */
    private $character = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\PLineWithDefaultType[] $pLine
     */
    private $pLine = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\EventDateWithoutTerritoryType $masteredDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\EventDateWithoutTerritoryType[] $remasteredDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\AvRatingType[] $avRating
     */
    private $avRating = [
     ...
     *
     * @var \DDEX\ERN\ERN_400\ReasonType $reasonForCueSheetAbsence
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\InstrumentationDescriptionType $instrumentationDescription
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\ResourceContainedResourceReferenceType[] $resourceContainedResourceReferenceList
     */
     ...
     *
     * @var \DDEX\ERN\ERN_400\TechnicalVideoDetailsType[] $technicalDetails
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @return \DDEX\ERN\ERN_400\VideoTypeType
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @param \DDEX\ERN\ERN_400\VideoTypeType $type
     * @return self
     */
    public function setType(\DDEX\ERN\ERN_400\VideoTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\VideoIdType $resourceId
     */
    public function addToResourceId(\DDEX\ERN\ERN_400\VideoIdType $resourceId)
    {
     ...
     * A Composite containing details of an Identifier of the Video.
     *
     * @return \DDEX\ERN\ERN_400\VideoIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\MusicalWorkIdType $workId
     */
    public function addToWorkId(\DDEX\ERN\ERN_400\MusicalWorkIdType $workId)
    {
        $this->workId[] = $workId;
        return $this;
    }
     ...
     * A Composite containing details of a MusicalWorkId of a MusicalWork used in the Video.
     *
     * @return \DDEX\ERN\ERN_400\MusicalWorkIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\CharacterType $character
     */
    public function addToCharacter(\DDEX\ERN\ERN_400\CharacterType $character)
    {
     ...
     * A Composite containing details of a Character in the Video. A Character may be described through Name, Identifier and Roles.
     *
     * @return \DDEX\ERN\ERN_400\CharacterType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\PLineWithDefaultType $pLine
     */
    public function addToPLine(\DDEX\ERN\ERN_400\PLineWithDefaultType $pLine)
    {
        $this->pLine[] = $pLine;
        return $this;
    }
     ...
     * A Composite containing details of the PLine for the Video.
     *
     * @return \DDEX\ERN\ERN_400\PLineWithDefaultType[]
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the Video was originally mastered (in either analogue or digital form). This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_400\EventDateWithoutTerritoryType $masteredDate
     * @return self
     */
    public function setMasteredDate(?\DDEX\ERN\ERN_400\EventDateWithoutTerritoryType $masteredDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\EventDateWithoutTerritoryType $remasteredDate
     */
    public function addToRemasteredDate(\DDEX\ERN\ERN_400\EventDateWithoutTerritoryType $remasteredDate)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\AvRatingType $avRating
     */
    public function addToAvRating(\DDEX\ERN\ERN_400\AvRatingType $avRating)
    {
     ...
     * A Composite containing details of a rating for the Video.
     *
     * @return \DDEX\ERN\ERN_400\AvRatingType[]
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @return \DDEX\ERN\ERN_400\ReasonType
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @param \DDEX\ERN\ERN_400\ReasonType $reasonForCueSheetAbsence
     * @return self
     */
    public function setReasonForCueSheetAbsence(?\DDEX\ERN\ERN_400\ReasonType $reasonForCueSheetAbsence = null)
    {
     ...
     * A Composite containing a Description of the Type of instrumentation of the MusicalWork(s) in the Video.
     *
     * @return \DDEX\ERN\ERN_400\InstrumentationDescriptionType
     */
     ...
     * A Composite containing a Description of the Type of instrumentation of the MusicalWork(s) in the Video.
     *
     * @param \DDEX\ERN\ERN_400\InstrumentationDescriptionType $instrumentationDescription
     * @return self
     */
    public function setInstrumentationDescription(?\DDEX\ERN\ERN_400\InstrumentationDescriptionType $instrumentationDescription = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\ResourceContainedResourceReferenceType $resourceContainedResourceReference
     */
    public function addToResourceContainedResourceReferenceList(\DDEX\ERN\ERN_400\ResourceContainedResourceReferenceType $resourceContainedResourceReference)
    {
     ...
     * A Composite containing details of ResourceContainedResourceReferences referring to a Resource that is contained in the current Video.
     *
     * @return \DDEX\ERN\ERN_400\ResourceContainedResourceReferenceType[]
     */
     ...
     * A Composite containing details of ResourceContainedResourceReferences referring to a Resource that is contained in the current Video.
     *
     * @param \DDEX\ERN\ERN_400\ResourceContainedResourceReferenceType[] $resourceContainedResourceReferenceList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_400\TechnicalVideoDetailsType $technicalDetails
     */
    public function addToTechnicalDetails(\DDEX\ERN\ERN_400\TechnicalVideoDetailsType $technicalDetails)
    {
     ...
     * A Composite containing technical details of the Video.
     *
     * @return \DDEX\ERN\ERN_400\TechnicalVideoDetailsType[]
     */
