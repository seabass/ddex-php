...
class PeriodWithoutFlagsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_410\EventDateWithoutFlagsType $startDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_410\EventDateWithoutFlagsType $endDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_410\EventDateTimeWithoutFlagsType $startDateTime
     */
     ...
     *
     * @var \DDEX\ERN\ERN_410\EventDateTimeWithoutFlagsType $endDateTime
     */
     ...
     * A Composite containing details of the Date and Place of an Event that marks the beginning of the Period (in ISO 8601:2004 format: YYYY-MM-DD). The StartDate must be no later than the EndDate if both are provided.
     *
     * @param \DDEX\ERN\ERN_410\EventDateWithoutFlagsType $startDate
     * @return self
     */
    public function setStartDate(?\DDEX\ERN\ERN_410\EventDateWithoutFlagsType $startDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of an Event that marks the end of the Period (in ISO 8601:2004 format: YYYY-MM-DD). The EndDate must not be earlier than the StartDate if both are provided.
     *
     * @param \DDEX\ERN\ERN_410\EventDateWithoutFlagsType $endDate
     * @return self
     */
    public function setEndDate(?\DDEX\ERN\ERN_410\EventDateWithoutFlagsType $endDate = null)
    {
     ...
     * A Composite containing details of the DateTime and Place of an Event that marks the beginning of the Period (in ISO 8601:2004 format: YYYY-DD-MMThh:mm:ss). The StartDateTime must be no later than the EndDateTime if both are provided.
     *
     * @return \DDEX\ERN\ERN_410\EventDateTimeWithoutFlagsType
     */
     ...
     * A Composite containing details of the DateTime and Place of an Event that marks the beginning of the Period (in ISO 8601:2004 format: YYYY-DD-MMThh:mm:ss). The StartDateTime must be no later than the EndDateTime if both are provided.
     *
     * @param \DDEX\ERN\ERN_410\EventDateTimeWithoutFlagsType $startDateTime
     * @return self
     */
    public function setStartDateTime(?\DDEX\ERN\ERN_410\EventDateTimeWithoutFlagsType $startDateTime = null)
    {
     ...
     * A Composite containing details of the DateTime and Place of an Event that marks the end of the Period (in ISO 8601:2004 format: YYYY-DD-MMThh:mm:ss). The EndDateTime must not be earlier than the StartDateTime if both are provided.
     *
     * @param \DDEX\ERN\ERN_410\EventDateTimeWithoutFlagsType $endDateTime
     * @return self
     */
    public function setEndDateTime(?\DDEX\ERN\ERN_410\EventDateTimeWithoutFlagsType $endDateTime = null)
    {
