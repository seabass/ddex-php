...
namespace DDEX\ERN\ERN_410\PurgeReleaseMessage;
...
class PurgeReleaseMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_410\PurgedReleaseType $purgedRelease
     */
     ...
     * A Composite containing details of a DDEX Release to be purged.
     *
     * @return \DDEX\ERN\ERN_410\PurgedReleaseType
     */
     ...
     * A Composite containing details of a DDEX Release to be purged.
     *
     * @param \DDEX\ERN\ERN_410\PurgedReleaseType $purgedRelease
     * @return self
     */
    public function setPurgedRelease(\DDEX\ERN\ERN_410\PurgedReleaseType $purgedRelease)
    {
