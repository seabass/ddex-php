...
class AvRatingType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\RatingAgencyType $agency
     */
    private $agency = null;
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @return \DDEX\ERN\ERN_411\RatingAgencyType
     */
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @param \DDEX\ERN\ERN_411\RatingAgencyType $agency
     * @return self
     */
    public function setAgency(\DDEX\ERN\ERN_411\RatingAgencyType $agency)
    {
        $this->agency = $agency;
        return $this;
    }
