...
class ChapterType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\ProprietaryIdType[] $chapterId
     */
    private $chapterId = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\ProprietaryIdType $chapterId
     */
    public function addToChapterId(\DDEX\ERN\ERN_411\ProprietaryIdType $chapterId)
    {
     ...
     * A Composite containing details of an Identifier of the Chapter.
     *
     * @return \DDEX\ERN\ERN_411\ProprietaryIdType[]
     */
