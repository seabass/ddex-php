...
class DelegatedUsageRightsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\UseTypeType[] $useType
     */
    private $useType = [
     ...
     *
     * @var \DDEX\ERN\ERN_411\PeriodType $periodOfRightsDelegation
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\CurrentTerritoryCodeType[] $territoryOfRightsDelegation
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\UseTypeType $useType
     */
    public function addToUseType(\DDEX\ERN\ERN_411\UseTypeType $useType)
    {
     ...
     * A Composite containing details of the use for which Rights are delegated.
     *
     * @return \DDEX\ERN\ERN_411\UseTypeType[]
     */
     ...
     * A Composite containing details about a Period of Time for which the delegation of usage Rights applies. Periods are typically described by at least a StartDate or EndDate.
     *
     * @return \DDEX\ERN\ERN_411\PeriodType
     */
     ...
     * A Composite containing details about a Period of Time for which the delegation of usage Rights applies. Periods are typically described by at least a StartDate or EndDate.
     *
     * @param \DDEX\ERN\ERN_411\PeriodType $periodOfRightsDelegation
     * @return self
     */
    public function setPeriodOfRightsDelegation(?\DDEX\ERN\ERN_411\PeriodType $periodOfRightsDelegation = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\CurrentTerritoryCodeType $territoryOfRightsDelegation
     */
    public function addToTerritoryOfRightsDelegation(\DDEX\ERN\ERN_411\CurrentTerritoryCodeType $territoryOfRightsDelegation)
    {
