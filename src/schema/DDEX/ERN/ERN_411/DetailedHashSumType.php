...
class DetailedHashSumType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\HashSumAlgorithmTypeType $algorithm
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @return \DDEX\ERN\ERN_411\HashSumAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @param \DDEX\ERN\ERN_411\HashSumAlgorithmTypeType $algorithm
     * @return self
     */
    public function setAlgorithm(\DDEX\ERN\ERN_411\HashSumAlgorithmTypeType $algorithm)
    {
