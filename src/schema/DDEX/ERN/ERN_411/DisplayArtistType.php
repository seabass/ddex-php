...
class DisplayArtistType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\DisplayArtistRoleType $displayArtistRole
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\ContributorRoleType[] $artisticRole
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\TitleDisplayInformationType[] $titleDisplayInformation
     */
     ...
     * A Composite containing details of a Role played by the DisplayArtist.
     *
     * @return \DDEX\ERN\ERN_411\DisplayArtistRoleType
     */
     ...
     * A Composite containing details of a Role played by the DisplayArtist.
     *
     * @param \DDEX\ERN\ERN_411\DisplayArtistRoleType $displayArtistRole
     * @return self
     */
    public function setDisplayArtistRole(\DDEX\ERN\ERN_411\DisplayArtistRoleType $displayArtistRole)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\ContributorRoleType $artisticRole
     */
    public function addToArtisticRole(\DDEX\ERN\ERN_411\ContributorRoleType $artisticRole)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\TitleDisplayInformationType $titleDisplayInformation
     */
    public function addToTitleDisplayInformation(\DDEX\ERN\ERN_411\TitleDisplayInformationType $titleDisplayInformation)
    {
     ...
     * A Composite containing information on how a RecordCompany wishes Artist information to be presented to Consumers as part of the Title (and in addition to displaying the DisplayArtist information).
     *
     * @return \DDEX\ERN\ERN_411\TitleDisplayInformationType[]
     */
