...
class ReleaseDealType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\DealType[] $deal
     */
    private $deal = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\DealType $deal
     */
    public function addToDeal(\DDEX\ERN\ERN_411\DealType $deal)
    {
        $this->deal[] = $deal;
        return $this;
    }
     ...
     * A Composite containing details of a Deal governing the Usage of all Releases identified in the ReleaseDeal Composite.
     *
     * @return \DDEX\ERN\ERN_411\DealType[]
     */
