...
class ResourceListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_411\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DDEX\ERN\ERN_411\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DDEX\ERN\ERN_411\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DDEX\ERN\ERN_411\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DDEX\ERN\ERN_411\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DDEX\ERN\ERN_411\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\ERN\ERN_411\SoundRecordingType $soundRecording)
    {
     ...
     * A Composite containing details of a SoundRecording.
     *
     * @return \DDEX\ERN\ERN_411\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\VideoType $video
     */
    public function addToVideo(\DDEX\ERN\ERN_411\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A Composite containing details of a Video.
     *
     * @return \DDEX\ERN\ERN_411\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\ImageType $image
     */
    public function addToImage(\DDEX\ERN\ERN_411\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A Composite containing details of an Image.
     *
     * @return \DDEX\ERN\ERN_411\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\TextType $text
     */
    public function addToText(\DDEX\ERN\ERN_411\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A Composite containing details of a Text.
     *
     * @return \DDEX\ERN\ERN_411\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\ERN\ERN_411\SheetMusicType $sheetMusic)
    {
     ...
     * A Composite containing details of a SheetMusic.
     *
     * @return \DDEX\ERN\ERN_411\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_411\SoftwareType $software
     */
    public function addToSoftware(\DDEX\ERN\ERN_411\SoftwareType $software)
    {
     ...
     * A Composite containing details of an item of Software.
     *
     * @return \DDEX\ERN\ERN_411\SoftwareType[]
     */
