...
class DealTermsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_420\CurrentTerritoryCodeType[] $territoryCode
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\CurrentTerritoryCodeType[] $excludedTerritoryCode
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\PeriodWithStartDateType[] $validityPeriod
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\CommercialModelTypeType[] $commercialModelType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\DiscoverableUseTypeType[] $useType
     */
    private $useType = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\UserInterfaceTypeType[] $userInterfaceType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\CarrierTypeType[] $carrierType
     */
    private $carrierType = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\DealTermsTechnicalInstantiationType $technicalInstantiation
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\DSPType[] $distributionChannel
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\DSPType[] $excludedDistributionChannel
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\RightsClaimPolicyType[] $rightsClaimPolicy
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\PriceInformationWithTypeType[] $priceInformation
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\PromotionalCodeType $promotionalCode
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\PhysicalReturnsType $physicalReturns
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\CurrentTerritoryCodeType $territoryCode
     */
    public function addToTerritoryCode(\DDEX\ERN\ERN_420\CurrentTerritoryCodeType $territoryCode)
    {
     ...
     * A Territory in which the Deal applies. Either this Element or ExcludedTerritory must be present, but not both. The use of ISO TerritoryCodes (or the term 'Worldwide') is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
     * @return \DDEX\ERN\ERN_420\CurrentTerritoryCodeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\CurrentTerritoryCodeType $excludedTerritoryCode
     */
    public function addToExcludedTerritoryCode(\DDEX\ERN\ERN_420\CurrentTerritoryCodeType $excludedTerritoryCode)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\PeriodWithStartDateType $validityPeriod
     */
    public function addToValidityPeriod(\DDEX\ERN\ERN_420\PeriodWithStartDateType $validityPeriod)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/start-dates%2C-end-dates%2C-start-datetimes-and-end-datetimes
     *
     * @return \DDEX\ERN\ERN_420\PeriodWithStartDateType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\CommercialModelTypeType $commercialModelType
     */
    public function addToCommercialModelType(\DDEX\ERN\ERN_420\CommercialModelTypeType $commercialModelType)
    {
     ...
     * A Composite containing details of the fundamental business model which applies to the Deal (e.g. SubscriptionModel and PayAsYouGoModel). The CommercialModelType indicates how the Consumer pays for the Service or Release.
     *
     * @return \DDEX\ERN\ERN_420\CommercialModelTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\DiscoverableUseTypeType $useType
     */
    public function addToUseType(\DDEX\ERN\ERN_420\DiscoverableUseTypeType $useType)
    {
     ...
     * A Composite containing details of a nature of a Service, or a Release, as used by a Consumer. The UseType is mandatory unless the terms of the Deal were communicated beforehand (possibly out of band) and then referenced using a DealReference.
     *
     * @return \DDEX\ERN\ERN_420\DiscoverableUseTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\UserInterfaceTypeType $userInterfaceType
     */
    public function addToUserInterfaceType(\DDEX\ERN\ERN_420\UserInterfaceTypeType $userInterfaceType)
    {
     ...
     * A Composite containing details of a physical interface by which a Consumer uses a Service or Release.
     *
     * @return \DDEX\ERN\ERN_420\UserInterfaceTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\CarrierTypeType $carrierType
     */
    public function addToCarrierType(\DDEX\ERN\ERN_420\CarrierTypeType $carrierType)
    {
     ...
     * A Composite containing details of a Carrier.
     *
     * @return \DDEX\ERN\ERN_420\CarrierTypeType[]
     */
     ...
     * A Composite containing technical details of the Release.
     *
     * @return \DDEX\ERN\ERN_420\DealTermsTechnicalInstantiationType
     */
     ...
     * A Composite containing technical details of the Release.
     *
     * @param \DDEX\ERN\ERN_420\DealTermsTechnicalInstantiationType $technicalInstantiation
     * @return self
     */
    public function setTechnicalInstantiation(?\DDEX\ERN\ERN_420\DealTermsTechnicalInstantiationType $technicalInstantiation = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\DSPType $distributionChannel
     */
    public function addToDistributionChannel(\DDEX\ERN\ERN_420\DSPType $distributionChannel)
    {
     ...
     * A Composite containing details of the DSP through whose DistributionChannel the sales are permitted. If none are provided no limitations on the DistributionChannels are given.
     *
     * @return \DDEX\ERN\ERN_420\DSPType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\DSPType $excludedDistributionChannel
     */
    public function addToExcludedDistributionChannel(\DDEX\ERN\ERN_420\DSPType $excludedDistributionChannel)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\RightsClaimPolicyType $rightsClaimPolicy
     */
    public function addToRightsClaimPolicy(\DDEX\ERN\ERN_420\RightsClaimPolicyType $rightsClaimPolicy)
    {
     ...
     * A Composite containing details of a rights claim policy.
     *
     * @return \DDEX\ERN\ERN_420\RightsClaimPolicyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\PriceInformationWithTypeType $priceInformation
     */
    public function addToPriceInformation(\DDEX\ERN\ERN_420\PriceInformationWithTypeType $priceInformation)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @return \DDEX\ERN\ERN_420\PriceInformationWithTypeType[]
     */
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @return \DDEX\ERN\ERN_420\PromotionalCodeType
     */
     ...
     * A Composite containing details of a PromotionalCode.
     *
     * @param \DDEX\ERN\ERN_420\PromotionalCodeType $promotionalCode
     * @return self
     */
    public function setPromotionalCode(?\DDEX\ERN\ERN_420\PromotionalCodeType $promotionalCode = null)
    {
     ...
     * A Composite containing details of physical returns.
     *
     * @return \DDEX\ERN\ERN_420\PhysicalReturnsType
     */
     ...
     * A Composite containing details of physical returns.
     *
     * @param \DDEX\ERN\ERN_420\PhysicalReturnsType $physicalReturns
     * @return self
     */
    public function setPhysicalReturns(?\DDEX\ERN\ERN_420\PhysicalReturnsType $physicalReturns = null)
    {
