...
class DetailedResourceContributorType
{
     ...
     *
     * @var \DDEX\ERN\ERN_420\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\ContributorRoleType[] $role
     */
    private $role = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\InstrumentTypeType[] $instrumentType
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DDEX\ERN\ERN_420\DetailedPartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\ERN\ERN_420\DetailedPartyIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\PartyNameType $partyName
     */
    public function addToPartyName(\DDEX\ERN\ERN_420\PartyNameType $partyName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @return \DDEX\ERN\ERN_420\PartyNameType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\ContributorRoleType $role
     */
    public function addToRole(\DDEX\ERN\ERN_420\ContributorRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * A Composite containing details of a Role played by the Contributor.
     *
     * @return \DDEX\ERN\ERN_420\ContributorRoleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\InstrumentTypeType $instrumentType
     */
    public function addToInstrumentType(\DDEX\ERN\ERN_420\InstrumentTypeType $instrumentType)
    {
     ...
     * A Type of musical Instrument played by the Artist.
     *
     * @return \DDEX\ERN\ERN_420\InstrumentTypeType[]
     */
