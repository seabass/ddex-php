...
class LocationAndDateOfSessionType
{
     ...
     * The Type of Session.
     *
     * @var \DDEX\ERN\ERN_420\SessionTypeType[] $sessionType
     */
    private $sessionType = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\PeriodType $period
     */
    private $period = null;
     ...
     *
     * @var \DDEX\ERN\ERN_420\VenueType[] $venue
     */
    private $venue = [
     ...
     *
     * @var \DDEX\ERN\ERN_420\TextWithFormatType $comment
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\PartyWithRoleType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\SessionTypeType $sessionType
     */
    public function addToSessionType(\DDEX\ERN\ERN_420\SessionTypeType $sessionType)
    {
     ...
     * The Type of Session.
     *
     * @return \DDEX\ERN\ERN_420\SessionTypeType[]
     */
     ...
     * A Composite containing details about a Period of the Session. Periods are typically described by at least a StartDate or EndDate.
     *
     * @return \DDEX\ERN\ERN_420\PeriodType
     */
     ...
     * A Composite containing details about a Period of the Session. Periods are typically described by at least a StartDate or EndDate.
     *
     * @param \DDEX\ERN\ERN_420\PeriodType $period
     * @return self
     */
    public function setPeriod(?\DDEX\ERN\ERN_420\PeriodType $period = null)
    {
        $this->period = $period;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\VenueType $venue
     */
    public function addToVenue(\DDEX\ERN\ERN_420\VenueType $venue)
    {
        $this->venue[] = $venue;
        return $this;
    }
     ...
     * A Composite containing details of the venue where the Session took place.
     *
     * @return \DDEX\ERN\ERN_420\VenueType[]
     */
     ...
     * A Composite containing a human-readable Comment about the Session.
     *
     * @return \DDEX\ERN\ERN_420\TextWithFormatType
     */
     ...
     * A Composite containing a human-readable Comment about the Session.
     *
     * @param \DDEX\ERN\ERN_420\TextWithFormatType $comment
     * @return self
     */
    public function setComment(?\DDEX\ERN\ERN_420\TextWithFormatType $comment = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\PartyWithRoleType $contributor
     */
    public function addToContributor(\DDEX\ERN\ERN_420\PartyWithRoleType $contributor)
    {
     ...
     * A Composite containing details of a Contributor.
     *
     * @return \DDEX\ERN\ERN_420\PartyWithRoleType[]
     */
