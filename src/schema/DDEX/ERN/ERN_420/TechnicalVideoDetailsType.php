...
class TechnicalVideoDetailsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_420\VideoIdType $encodingId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\BitRateType $overallBitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\ContainerFormatType $containerFormat
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\VideoCodecTypeType $videoCodecType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\BitRateType $videoBitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\FrameRateType $frameRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\ExtentType $imageHeight
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\ExtentType $imageWidth
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\AspectRatioType $aspectRatio
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\CoreAreaType $coreArea
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\AudioCodecTypeType $audioCodecType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\BitRateType $audioBitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\SamplingRateType $audioSamplingRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\SoundRecordingPreviewDetailsType $previewDetails
     */
     ...
     *
     * @var \DDEX\ERN\ERN_420\FileType $file
     */
    private $file = null;
     ...
     *
     * @var \DDEX\ERN\ERN_420\FingerprintType[] $fingerprint
     */
    private $fingerprint = [
     ...
     * A Composite containing details of an identifier of the encoding. The default is that all encodings for a Video share a common identifier (as provided on the Video composite) and that, looking at the ISRC standard for instance, there should not be a different identifier for different encodings (unless there is a substantial difference). However, reality indicates that different identifiers have been allocated and therefore should be communicable.
     *
     * @param \DDEX\ERN\ERN_420\VideoIdType $encodingId
     * @return self
     */
    public function setEncodingId(?\DDEX\ERN\ERN_420\VideoIdType $encodingId = null)
    {
     ...
     * A Composite containing the overall BitRate and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_420\BitRateType $overallBitRate
     * @return self
     */
    public function setOverallBitRate(?\DDEX\ERN\ERN_420\BitRateType $overallBitRate = null)
    {
     ...
     * A Composite containing details of a ContainerFormat.
     *
     * @return \DDEX\ERN\ERN_420\ContainerFormatType
     */
     ...
     * A Composite containing details of a ContainerFormat.
     *
     * @param \DDEX\ERN\ERN_420\ContainerFormatType $containerFormat
     * @return self
     */
    public function setContainerFormat(?\DDEX\ERN\ERN_420\ContainerFormatType $containerFormat = null)
    {
     ...
     * A Composite containing details of a Type of VideoCodec.
     *
     * @return \DDEX\ERN\ERN_420\VideoCodecTypeType
     */
     ...
     * A Composite containing details of a Type of VideoCodec.
     *
     * @param \DDEX\ERN\ERN_420\VideoCodecTypeType $videoCodecType
     * @return self
     */
    public function setVideoCodecType(?\DDEX\ERN\ERN_420\VideoCodecTypeType $videoCodecType = null)
    {
     ...
     * A Composite containing the BitRate for the video data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_420\BitRateType $videoBitRate
     * @return self
     */
    public function setVideoBitRate(?\DDEX\ERN\ERN_420\BitRateType $videoBitRate = null)
    {
     ...
     * A Composite containing the Rate for a number of frames shown in the Video in a specific Period of Time and a UnitOfMeasure (the default is Hz, interlaced).
     *
     * @return \DDEX\ERN\ERN_420\FrameRateType
     */
     ...
     * A Composite containing the Rate for a number of frames shown in the Video in a specific Period of Time and a UnitOfMeasure (the default is Hz, interlaced).
     *
     * @param \DDEX\ERN\ERN_420\FrameRateType $frameRate
     * @return self
     */
    public function setFrameRate(?\DDEX\ERN\ERN_420\FrameRateType $frameRate = null)
    {
     ...
     * A Composite containing the vertical Extent of an Image of the Video and a UnitOfMeasure (the default is Pixels).
     *
     * @return \DDEX\ERN\ERN_420\ExtentType
     */
     ...
     * A Composite containing the vertical Extent of an Image of the Video and a UnitOfMeasure (the default is Pixels).
     *
     * @param \DDEX\ERN\ERN_420\ExtentType $imageHeight
     * @return self
     */
    public function setImageHeight(?\DDEX\ERN\ERN_420\ExtentType $imageHeight = null)
    {
     ...
     * A Composite containing the horizontal Extent of an Image of the Video and a UnitOfMeasure (the default is Pixels).
     *
     * @param \DDEX\ERN\ERN_420\ExtentType $imageWidth
     * @return self
     */
    public function setImageWidth(?\DDEX\ERN\ERN_420\ExtentType $imageWidth = null)
    {
     ...
     * A Composite containing the ratio formed by dividing the ImageHeight by the ImageWidth.
     *
     * @return \DDEX\ERN\ERN_420\AspectRatioType
     */
     ...
     * A Composite containing the ratio formed by dividing the ImageHeight by the ImageWidth.
     *
     * @param \DDEX\ERN\ERN_420\AspectRatioType $aspectRatio
     * @return self
     */
    public function setAspectRatio(?\DDEX\ERN\ERN_420\AspectRatioType $aspectRatio = null)
    {
     ...
     * A Composite containing details of the core part of the Video.
     *
     * @return \DDEX\ERN\ERN_420\CoreAreaType
     */
     ...
     * A Composite containing details of the core part of the Video.
     *
     * @param \DDEX\ERN\ERN_420\CoreAreaType $coreArea
     * @return self
     */
    public function setCoreArea(?\DDEX\ERN\ERN_420\CoreAreaType $coreArea = null)
    {
     ...
     * A Composite containing details of a Type of AudioCodec.
     *
     * @return \DDEX\ERN\ERN_420\AudioCodecTypeType
     */
     ...
     * A Composite containing details of a Type of AudioCodec.
     *
     * @param \DDEX\ERN\ERN_420\AudioCodecTypeType $audioCodecType
     * @return self
     */
    public function setAudioCodecType(?\DDEX\ERN\ERN_420\AudioCodecTypeType $audioCodecType = null)
    {
     ...
     * A Composite containing the BitRate for the audio data and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_420\BitRateType $audioBitRate
     * @return self
     */
    public function setAudioBitRate(?\DDEX\ERN\ERN_420\BitRateType $audioBitRate = null)
    {
     ...
     * A Composite containing the SamplingRate for the audio data and a UnitOfMeasure (the default is Hz).
     *
     * @return \DDEX\ERN\ERN_420\SamplingRateType
     */
     ...
     * A Composite containing the SamplingRate for the audio data and a UnitOfMeasure (the default is Hz).
     *
     * @param \DDEX\ERN\ERN_420\SamplingRateType $audioSamplingRate
     * @return self
     */
    public function setAudioSamplingRate(?\DDEX\ERN\ERN_420\SamplingRateType $audioSamplingRate = null)
    {
     ...
     * A Composite containing details of a preview.
     *
     * @return \DDEX\ERN\ERN_420\SoundRecordingPreviewDetailsType
     */
     ...
     * A Composite containing details of a preview.
     *
     * @param \DDEX\ERN\ERN_420\SoundRecordingPreviewDetailsType $previewDetails
     * @return self
     */
    public function setPreviewDetails(?\DDEX\ERN\ERN_420\SoundRecordingPreviewDetailsType $previewDetails = null)
    {
     ...
     * A Composite containing details of a File containing the Video that a DSP can obtain.
     *
     * @return \DDEX\ERN\ERN_420\FileType
     */
     ...
     * A Composite containing details of a File containing the Video that a DSP can obtain.
     *
     * @param \DDEX\ERN\ERN_420\FileType $file
     * @return self
     */
    public function setFile(?\DDEX\ERN\ERN_420\FileType $file = null)
    {
        $this->file = $file;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_420\FingerprintType $fingerprint
     */
    public function addToFingerprint(\DDEX\ERN\ERN_420\FingerprintType $fingerprint)
    {
     ...
     * A Composite containing details of a Fingerprint and its governing algorithm.
     *
     * @return \DDEX\ERN\ERN_420\FingerprintType[]
     */
