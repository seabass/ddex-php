...
class DisplayTitleType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\DisplaySubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\DisplaySubTitleType $subTitle
     */
    public function addToSubTitle(\DDEX\ERN\ERN_430\DisplaySubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DDEX\ERN\ERN_430\DisplaySubTitleType[]
     */
