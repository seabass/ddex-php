...
class GenreCategoryType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\GenreCategoryValueType $value
     */
    private $value = null;
     ...
     *
     * @var \DDEX\ERN\ERN_430\TextWithoutTerritoryType[] $description
     */
    private $description = [
     ...
     * A Composite containing details of a Genre Category value.
     *
     * @return \DDEX\ERN\ERN_430\GenreCategoryValueType
     */
     ...
     * A Composite containing details of a Genre Category value.
     *
     * @param \DDEX\ERN\ERN_430\GenreCategoryValueType $value
     * @return self
     */
    public function setValue(\DDEX\ERN\ERN_430\GenreCategoryValueType $value)
    {
        $this->value = $value;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\TextWithoutTerritoryType $description
     */
    public function addToDescription(\DDEX\ERN\ERN_430\TextWithoutTerritoryType $description)
    {
     ...
     * A Composite containing a Description of the Genre Category.
     *
     * @return \DDEX\ERN\ERN_430\TextWithoutTerritoryType[]
     */
