...
class MessageHeaderType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType $messageSender
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType $sentOnBehalfOf
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType[] $messageRecipient
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\MessageAuditTrailEventType[] $messageAuditTrail
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @return \DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @param \DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType $messageSender
     * @return self
     */
    public function setMessageSender(\DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType $messageSender)
    {
     ...
     * A Composite containing details of the Party on whose behalf the Message is sent.
     *
     * @param \DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType $sentOnBehalfOf
     * @return self
     */
    public function setSentOnBehalfOf(?\DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType $sentOnBehalfOf = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType $messageRecipient
     */
    public function addToMessageRecipient(\DDEX\ERN\ERN_430\MessagingPartyWithoutCodeType $messageRecipient)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrail(\DDEX\ERN\ERN_430\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @return \DDEX\ERN\ERN_430\MessageAuditTrailEventType[]
     */
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @param \DDEX\ERN\ERN_430\MessageAuditTrailEventType[] $messageAuditTrail
     * @return self
     */
