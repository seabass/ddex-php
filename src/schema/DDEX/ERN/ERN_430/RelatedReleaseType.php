...
class RelatedReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\ReleaseRelationshipTypeType $releaseRelationshipType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\ReleaseLabelReferenceType[] $releaseLabelReference
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\EventDateWithoutFlagsType $releaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\EventDateWithoutFlagsType $originalReleaseDate
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @return \DDEX\ERN\ERN_430\ReleaseRelationshipTypeType
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @param \DDEX\ERN\ERN_430\ReleaseRelationshipTypeType $releaseRelationshipType
     * @return self
     */
    public function setReleaseRelationshipType(\DDEX\ERN\ERN_430\ReleaseRelationshipTypeType $releaseRelationshipType)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\ReleaseLabelReferenceType $releaseLabelReference
     */
    public function addToReleaseLabelReference(\DDEX\ERN\ERN_430\ReleaseLabelReferenceType $releaseLabelReference)
    {
     ...
     * A Reference for a label of the Release (specific to this Message). This is a LocalPartyAnchorReference starting with the letter P.
     *
     * @return \DDEX\ERN\ERN_430\ReleaseLabelReferenceType[]
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the related Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601 format: YYYY-MM-DD).
     *
     * @param \DDEX\ERN\ERN_430\EventDateWithoutFlagsType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DDEX\ERN\ERN_430\EventDateWithoutFlagsType $releaseDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the collection of tracks for the Release (e.g. the equivalent physical album on vinyl) was or will be first made available for Usage, whether for physical or electronic/online distribution (in ISO 8601 format: YYYY-MM-DD).
     *
     * @param \DDEX\ERN\ERN_430\EventDateWithoutFlagsType $originalReleaseDate
     * @return self
     */
    public function setOriginalReleaseDate(?\DDEX\ERN\ERN_430\EventDateWithoutFlagsType $originalReleaseDate = null)
    {
