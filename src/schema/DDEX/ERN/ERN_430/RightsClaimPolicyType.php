...
class RightsClaimPolicyType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\ConditionForRightsClaimPolicyType[] $condition
     */
    private $condition = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\ConditionForRightsClaimPolicyType $condition
     */
    public function addToCondition(\DDEX\ERN\ERN_430\ConditionForRightsClaimPolicyType $condition)
    {
     ...
     * A Composite containing details of Conditions. If more than one Condition is specified, then all of them have to be fulfilled (i.e. they are combined using the logical operator AND).
     *
     * @return \DDEX\ERN\ERN_430\ConditionForRightsClaimPolicyType[]
     */
