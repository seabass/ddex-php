...
class SoundRecordingType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\SoundRecordingTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \DDEX\ERN\ERN_430\SoundRecordingEditionType[] $soundRecordingEdition
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\FirstPublicationDateType[] $firstPublicationDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\LocationAndDateOfSessionType[] $locationAndDateOfSession
     */
     ...
     * A Composite containing details of the Type of the SoundRecording.
     *
     * @return \DDEX\ERN\ERN_430\SoundRecordingTypeType
     */
     ...
     * A Composite containing details of the Type of the SoundRecording.
     *
     * @param \DDEX\ERN\ERN_430\SoundRecordingTypeType $type
     * @return self
     */
    public function setType(\DDEX\ERN\ERN_430\SoundRecordingTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\SoundRecordingEditionType $soundRecordingEdition
     */
    public function addToSoundRecordingEdition(\DDEX\ERN\ERN_430\SoundRecordingEditionType $soundRecordingEdition)
    {
     ...
     * A Composite containing details of a SoundRecording that has been created based on the same content as the 'main' SoundRecording but specifically for a different encoding such as immersive audio. It can be the same SoundRecording (in accordance with the ISRC standard) but more likely than not will be a different SoundRecording because the sound engineer/producer will be different. If an element in this Composite is not provided, the data is assumed to be the same as for the 'main' SoundRecording.
     *
     * @return \DDEX\ERN\ERN_430\SoundRecordingEditionType[]
     */
     ...
     * @return self
     */
    public function setRemasteredDate(?\DDEX\ERN\ERN_430\EventDateWithoutFlagsType $remasteredDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\FirstPublicationDateType $firstPublicationDate
     */
    public function addToFirstPublicationDate(\DDEX\ERN\ERN_430\FirstPublicationDateType $firstPublicationDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the SoundRecording was first published, whether for physical or electronic/online distribution. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @return \DDEX\ERN\ERN_430\FirstPublicationDateType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\LocationAndDateOfSessionType $locationAndDateOfSession
     */
    public function addToLocationAndDateOfSession(\DDEX\ERN\ERN_430\LocationAndDateOfSessionType $locationAndDateOfSession)
    {
     ...
     * A Composite containing details of a RecordingSession.
     *
     * @return \DDEX\ERN\ERN_430\LocationAndDateOfSessionType[]
     */
