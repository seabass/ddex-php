...
class VideoClipDetailsType
{
     ...
     * A Type of clip.
     *
     * @var \DDEX\ERN\ERN_430\ClipTypeType $clipType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\TimingType[] $timing
     */
    private $timing = [
     ...
     * A Type of clip.
     *
     * @return \DDEX\ERN\ERN_430\ClipTypeType
     */
     ...
     * A Type of clip.
     *
     * @param \DDEX\ERN\ERN_430\ClipTypeType $clipType
     * @return self
     */
    public function setClipType(\DDEX\ERN\ERN_430\ClipTypeType $clipType)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\TimingType $timing
     */
    public function addToTiming(\DDEX\ERN\ERN_430\TimingType $timing)
    {
        $this->timing[] = $timing;
        return $this;
    }
     ...
     * A Composite containing details of a StartTime, EndTime and a Duration of the clip.
     *
     * @return \DDEX\ERN\ERN_430\TimingType[]
     */
