...
class VideoType
{
     ...
     *
     * @var \DDEX\ERN\ERN_430\VideoTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \DDEX\ERN\ERN_430\VideoEditionType[] $videoEdition
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\RecordingFormatType[] $recordingFormat
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\MusicalWorkIdType[] $workId
     */
    private $workId = [
     ...
     *
     * @var \DDEX\ERN\ERN_430\DisplayTitleTextType[] $displayTitleText
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\DisplayTitleType[] $displayTitle
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\AdditionalTitleType[] $additionalTitle
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\VersionTypeType[] $versionType
     */
    private $versionType = [
     ...
     *
     * @var \DDEX\ERN\ERN_430\DisplayArtistNameWithDefaultType[] $displayArtistName
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @var \DDEX\ERN\ERN_430\DisplayArtistType[] $displayArtist
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\ContributorType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @var \DDEX\ERN\ERN_430\CharacterType[] $character
     */
    private $character = [
     ...
     *
     * @var \DDEX\ERN\ERN_430\ResourceRightsControllerType[] $resourceRightsController
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\WorkRightsControllerType[] $workRightsController
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\CourtesyLineWithDefaultType[] $courtesyLine
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\EventDateWithoutFlagsType $creationDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\EventDateWithoutFlagsType $masteredDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\EventDateWithoutFlagsType[] $remasteredDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\FulfillmentDateWithTerritoryType[] $firstPublicationDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\ParentalWarningTypeWithTerritoryType[] $parentalWarningType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\AvRatingType[] $avRating
     */
    private $avRating = [
     ...
     *
     * @var \DDEX\ERN\ERN_430\RelatedReleaseType[] $relatedRelease
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\RelatedResourceType[] $relatedResource
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\ReasonType $reasonForCueSheetAbsence
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\DisplayCreditsType[] $displayCredits
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\LanguageType[] $languageOfPerformance
     */
     ...
     *
     * @var \DDEX\ERN\ERN_430\ResourceContainedResourceReferenceType[] $resourceContainedResourceReferenceList
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @return \DDEX\ERN\ERN_430\VideoTypeType
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @param \DDEX\ERN\ERN_430\VideoTypeType $type
     * @return self
     */
    public function setType(\DDEX\ERN\ERN_430\VideoTypeType $type)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\VideoEditionType $videoEdition
     */
    public function addToVideoEdition(\DDEX\ERN\ERN_430\VideoEditionType $videoEdition)
    {
     ...
     * A Composite containing details of a Video that has been created based on the same content as the 'main' Video but specifically for a different encoding for the audio such as immersive audio. It can be the same Video (in accordance with the ISRC standard) but more likely than not will be a different Video because the sound engineer/producer will be different. If an element in this Composite is not provided, the data is assumed to be the same as for the 'main' Video.
     *
     * @return \DDEX\ERN\ERN_430\VideoEditionType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\RecordingFormatType $recordingFormat
     */
    public function addToRecordingFormat(\DDEX\ERN\ERN_430\RecordingFormatType $recordingFormat)
    {
     ...
     * A Composite containing details of a Type of the Video based on its content, intended audience, format or technical characteristics.
     *
     * @return \DDEX\ERN\ERN_430\RecordingFormatType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\MusicalWorkIdType $workId
     */
    public function addToWorkId(\DDEX\ERN\ERN_430\MusicalWorkIdType $workId)
    {
        $this->workId[] = $workId;
        return $this;
    }
     ...
     * A Composite containing details of a MusicalWorkId of a MusicalWork used in the Video.
     *
     * @return \DDEX\ERN\ERN_430\MusicalWorkIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\DisplayTitleTextType $displayTitleText
     */
    public function addToDisplayTitleText(\DDEX\ERN\ERN_430\DisplayTitleTextType $displayTitleText)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @return \DDEX\ERN\ERN_430\DisplayTitleTextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\DisplayTitleType $displayTitle
     */
    public function addToDisplayTitle(\DDEX\ERN\ERN_430\DisplayTitleType $displayTitle)
    {
     ...
     * A Composite containing details of a Title of the Video as the MessageSender suggests it should be shown to the Consumer. In many instances this is the only Title to be communicated for any given Creation. Multiple instances can be supplied with an ApplicableTerritoryCode and/or LanguageAndScriptCode.
     *
     * @return \DDEX\ERN\ERN_430\DisplayTitleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\AdditionalTitleType $additionalTitle
     */
    public function addToAdditionalTitle(\DDEX\ERN\ERN_430\AdditionalTitleType $additionalTitle)
    {
     ...
     * A Composite containing details of an AdditionalTitle of the Video. If multiple instances with an ApplicableTerritoryCode are provided, then the first one provides the default that is then superseded by subsequent instances.
     *
     * @return \DDEX\ERN\ERN_430\AdditionalTitleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\VersionTypeType $versionType
     */
    public function addToVersionType(\DDEX\ERN\ERN_430\VersionTypeType $versionType)
    {
     ...
     * A Composite containing details of a Type of Version given by the releasing party to characterise and differentiate one Video from another with identical or similar Title metadata. VersionTypes may be used for disambiguating a Video that has been derived from another Video by using the value EditedVersion. EditedVersion value is often combined with another VersionType such as RadioVersion.
     *
     * @return \DDEX\ERN\ERN_430\VersionTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\DisplayArtistNameWithDefaultType $displayArtistName
     */
    public function addToDisplayArtistName(\DDEX\ERN\ERN_430\DisplayArtistNameWithDefaultType $displayArtistName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @return \DDEX\ERN\ERN_430\DisplayArtistNameWithDefaultType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\DisplayArtistType $displayArtist
     */
    public function addToDisplayArtist(\DDEX\ERN\ERN_430\DisplayArtistType $displayArtist)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @return \DDEX\ERN\ERN_430\DisplayArtistType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\ContributorType $contributor
     */
    public function addToContributor(\DDEX\ERN\ERN_430\ContributorType $contributor)
    {
     ...
     * A Composite containing details of a Contributor to the Video.
     *
     * @return \DDEX\ERN\ERN_430\ContributorType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\CharacterType $character
     */
    public function addToCharacter(\DDEX\ERN\ERN_430\CharacterType $character)
    {
     ...
     * A Composite containing details of a Character in the Video. A Character may be described through Name, Identifier and Roles.
     *
     * @return \DDEX\ERN\ERN_430\CharacterType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\ResourceRightsControllerType $resourceRightsController
     */
    public function addToResourceRightsController(\DDEX\ERN\ERN_430\ResourceRightsControllerType $resourceRightsController)
    {
     ...
     * A Composite containing details of RightsController of Rights in the Video.
     *
     * @return \DDEX\ERN\ERN_430\ResourceRightsControllerType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\WorkRightsControllerType $workRightsController
     */
    public function addToWorkRightsController(\DDEX\ERN\ERN_430\WorkRightsControllerType $workRightsController)
    {
     ...
     * A Composite containing details of RightsController of Rights in the Work.
     *
     * @return \DDEX\ERN\ERN_430\WorkRightsControllerType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\CourtesyLineWithDefaultType $courtesyLine
     */
    public function addToCourtesyLine(\DDEX\ERN\ERN_430\CourtesyLineWithDefaultType $courtesyLine)
    {
     ...
     * A Composite containing an Annotation Annotation which acknowledges record companies and/or other Parties giving permission for guests Artists or others featured on the Video.
     *
     * @return \DDEX\ERN\ERN_430\CourtesyLineWithDefaultType[]
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the Video was created. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @return \DDEX\ERN\ERN_430\EventDateWithoutFlagsType
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the Video was created. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_430\EventDateWithoutFlagsType $creationDate
     * @return self
     */
    public function setCreationDate(?\DDEX\ERN\ERN_430\EventDateWithoutFlagsType $creationDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Video was originally mastered (in either analogue or digital form). This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\ERN\ERN_430\EventDateWithoutFlagsType $masteredDate
     * @return self
     */
    public function setMasteredDate(?\DDEX\ERN\ERN_430\EventDateWithoutFlagsType $masteredDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\EventDateWithoutFlagsType $remasteredDate
     */
    public function addToRemasteredDate(\DDEX\ERN\ERN_430\EventDateWithoutFlagsType $remasteredDate)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\FulfillmentDateWithTerritoryType $firstPublicationDate
     */
    public function addToFirstPublicationDate(\DDEX\ERN\ERN_430\FulfillmentDateWithTerritoryType $firstPublicationDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Video was first published, whether for physical or electronic/online distribution. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @return \DDEX\ERN\ERN_430\FulfillmentDateWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\ParentalWarningTypeWithTerritoryType $parentalWarningType
     */
    public function addToParentalWarningType(\DDEX\ERN\ERN_430\ParentalWarningTypeWithTerritoryType $parentalWarningType)
    {
     ...
     * A Composite containing details of the classification of the Video according to advice which it carries about the level of explicitness or offensiveness of its content.
     *
     * @return \DDEX\ERN\ERN_430\ParentalWarningTypeWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\AvRatingType $avRating
     */
    public function addToAvRating(\DDEX\ERN\ERN_430\AvRatingType $avRating)
    {
     ...
     * A Composite containing details of a rating for the Video.
     *
     * @return \DDEX\ERN\ERN_430\AvRatingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DDEX\ERN\ERN_430\RelatedReleaseType $relatedRelease)
    {
     ...
     * A Composite containing details of a Release (or a PhysicalProduct or a DigitalProduct derived from such a Release) which is related to current Video.
     *
     * @return \DDEX\ERN\ERN_430\RelatedReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\RelatedResourceType $relatedResource
     */
    public function addToRelatedResource(\DDEX\ERN\ERN_430\RelatedResourceType $relatedResource)
    {
     ...
     * A Composite containing details of a ResourceRelatedResourceReference referring to a Resource that is related to the current Video.
     *
     * @return \DDEX\ERN\ERN_430\RelatedResourceType[]
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @return \DDEX\ERN\ERN_430\ReasonType
     */
     ...
     * A Composite containing the textual Description of the reason for the Identifier being used as a proxy.
     *
     * @param \DDEX\ERN\ERN_430\ReasonType $reasonForCueSheetAbsence
     * @return self
     */
    public function setReasonForCueSheetAbsence(?\DDEX\ERN\ERN_430\ReasonType $reasonForCueSheetAbsence = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\DisplayCreditsType $displayCredits
     */
    public function addToDisplayCredits(\DDEX\ERN\ERN_430\DisplayCreditsType $displayCredits)
    {
     ...
     * A Role and instrumentation for which a Party is credited.
     *
     * @return \DDEX\ERN\ERN_430\DisplayCreditsType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\LanguageType $languageOfPerformance
     */
    public function addToLanguageOfPerformance(\DDEX\ERN\ERN_430\LanguageType $languageOfPerformance)
    {
     ...
     * The original Language of the Performance as defined in IETF RfC 5646. Language and Script are provided as lang[-script][-region][-variant].
     *
     * @return \DDEX\ERN\ERN_430\LanguageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_430\ResourceContainedResourceReferenceType $resourceContainedResourceReference
     */
    public function addToResourceContainedResourceReferenceList(\DDEX\ERN\ERN_430\ResourceContainedResourceReferenceType $resourceContainedResourceReference)
    {
     ...
     * A Composite containing details of ResourceContainedResourceReferences referring to a Resource that is contained in the current Video.
     *
     * @return \DDEX\ERN\ERN_430\ResourceContainedResourceReferenceType[]
     */
     ...
     * A Composite containing details of ResourceContainedResourceReferences referring to a Resource that is contained in the current Video.
     *
     * @param \DDEX\ERN\ERN_430\ResourceContainedResourceReferenceType[] $resourceContainedResourceReferenceList
     * @return self
     */
