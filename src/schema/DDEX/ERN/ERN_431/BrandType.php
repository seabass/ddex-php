...
class BrandType
{
     ...
     *
     * @var \DDEX\ERN\ERN_431\ProprietaryIdentifierType[] $brandId
     */
    private $brandId = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\PartyNameWithTerritoryType[] $brandName
     */
    private $brandName = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ProprietaryIdentifierType $brandId
     */
    public function addToBrandId(\DDEX\ERN\ERN_431\ProprietaryIdentifierType $brandId)
    {
     ...
     * A Composite containing details of a ProprietaryId for the Brand.
     *
     * @return \DDEX\ERN\ERN_431\ProprietaryIdentifierType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\PartyNameWithTerritoryType $brandName
     */
    public function addToBrandName(\DDEX\ERN\ERN_431\PartyNameWithTerritoryType $brandName)
    {
