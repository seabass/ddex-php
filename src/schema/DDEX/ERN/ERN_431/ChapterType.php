...
class ChapterType
{
     ...
     *
     * @var \DDEX\ERN\ERN_431\ChapterIdType[] $chapterId
     */
    private $chapterId = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ChapterIdType $chapterId
     */
    public function addToChapterId(\DDEX\ERN\ERN_431\ChapterIdType $chapterId)
    {
     ...
     * A Composite containing details of an Identifier of the Chapter or of the content of the Chapter.
     *
     * @return \DDEX\ERN\ERN_431\ChapterIdType[]
     */
