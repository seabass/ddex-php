...
class DetailedResourceContributorType
{
     ...
     *
     * @var \DDEX\ERN\ERN_431\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\PartyNameType $partyName
     */
    public function addToPartyName(\DDEX\ERN\ERN_431\PartyNameType $partyName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @return \DDEX\ERN\ERN_431\PartyNameType[]
     */
