...
class EditionContributorType
{
     ...
     *
     * @var \DDEX\ERN\ERN_431\SpecialContributorTypeType $specialContributor
     */
     ...
     *
     * @var \DDEX\ERN\ERN_431\ContributorRoleType[] $role
     */
    private $role = [
     ...
     *
     * @var \DDEX\ERN\ERN_431\IsCreditedType $isCredited
     */
     ...
     * A special Type of Contributor.
     *
     * @param \DDEX\ERN\ERN_431\SpecialContributorTypeType $specialContributor
     * @return self
     */
    public function setSpecialContributor(?\DDEX\ERN\ERN_431\SpecialContributorTypeType $specialContributor = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_431\ContributorRoleType $role
     */
    public function addToRole(\DDEX\ERN\ERN_431\ContributorRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * A Flag indicating whether the Contributor is credited as having played a role in creating the Recording (=true) or not (=false).
     *
     * @return \DDEX\ERN\ERN_431\IsCreditedType
     */
     ...
     * A Flag indicating whether the Contributor is credited as having played a role in creating the Recording (=true) or not (=false).
     *
     * @param \DDEX\ERN\ERN_431\IsCreditedType $isCredited
     * @return self
     */
    public function setIsCredited(?\DDEX\ERN\ERN_431\IsCreditedType $isCredited = null)
    {
