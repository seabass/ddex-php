...
class AdministratingRecordCompanyType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\AdministratingRecordCompanyRoleType $role
     */
    private $role = null;
     ...
     * The role played by the Party responsible for administering Rights in a Resource or a Release.
     *
     * @return \DDEX\ERN\ERN_432\AdministratingRecordCompanyRoleType
     */
     ...
     * The role played by the Party responsible for administering Rights in a Resource or a Release.
     *
     * @param \DDEX\ERN\ERN_432\AdministratingRecordCompanyRoleType $role
     * @return self
     */
    public function setRole(\DDEX\ERN\ERN_432\AdministratingRecordCompanyRoleType $role)
    {
        $this->role = $role;
        return $this;
    }
