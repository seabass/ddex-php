...
class AvRatingType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\RatingAgencyType $agency
     */
    private $agency = null;
     ...
     *
     * @var \DDEX\ERN\ERN_432\RatingReasonType $reason
     */
    private $reason = null;
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @return \DDEX\ERN\ERN_432\RatingAgencyType
     */
     ...
     * A Composite containing details of an Organization that issues the AvRating.
     *
     * @param \DDEX\ERN\ERN_432\RatingAgencyType $agency
     * @return self
     */
    public function setAgency(\DDEX\ERN\ERN_432\RatingAgencyType $agency)
    {
        $this->agency = $agency;
        return $this;
    }
     ...
     * A Composite containing details of a Reason for a rating being applied.
     *
     * @return \DDEX\ERN\ERN_432\RatingReasonType
     */
     ...
     * A Composite containing details of a Reason for a rating being applied.
     *
     * @param \DDEX\ERN\ERN_432\RatingReasonType $reason
     * @return self
     */
    public function setReason(?\DDEX\ERN\ERN_432\RatingReasonType $reason = null)
    {
        $this->reason = $reason;
        return $this;
    }
