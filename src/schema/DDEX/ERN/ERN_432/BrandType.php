...
class BrandType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\ProprietaryIdType[] $brandId
     */
    private $brandId = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\PartyNameWithTerritoryType[] $brandName
     */
    private $brandName = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ProprietaryIdType $brandId
     */
    public function addToBrandId(\DDEX\ERN\ERN_432\ProprietaryIdType $brandId)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\PartyNameWithTerritoryType $brandName
     */
    public function addToBrandName(\DDEX\ERN\ERN_432\PartyNameWithTerritoryType $brandName)
    {
