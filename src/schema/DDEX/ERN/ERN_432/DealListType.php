...
class DealListType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\ReleaseDealType[] $releaseDeal
     */
    private $releaseDeal = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\ReleaseVisibilityType[] $releaseVisibility
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\TrackReleaseVisibilityType[] $trackReleaseVisibility
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ReleaseDealType $releaseDeal
     */
    public function addToReleaseDeal(\DDEX\ERN\ERN_432\ReleaseDealType $releaseDeal)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/complex-deals-can-be-dangerous
     *
     * @return \DDEX\ERN\ERN_432\ReleaseDealType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ReleaseVisibilityType $releaseVisibility
     */
    public function addToReleaseVisibility(\DDEX\ERN\ERN_432\ReleaseVisibilityType $releaseVisibility)
    {
     ...
     * A Composite containing details of a set of Dates specifying when a Release can be shown to Consumers.
     *
     * @return \DDEX\ERN\ERN_432\ReleaseVisibilityType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\TrackReleaseVisibilityType $trackReleaseVisibility
     */
    public function addToTrackReleaseVisibility(\DDEX\ERN\ERN_432\TrackReleaseVisibilityType $trackReleaseVisibility)
    {
     ...
     * A Composite containing details of a set of Dates specifying when a TrackRelease can be shown to Consumers.
     *
     * @return \DDEX\ERN\ERN_432\TrackReleaseVisibilityType[]
     */
