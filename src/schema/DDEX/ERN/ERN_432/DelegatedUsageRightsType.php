...
class DelegatedUsageRightsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\UseTypeType[] $useType
     */
    private $useType = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\PeriodType $periodOfRightsDelegation
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\AllTerritoryCodeType[] $territoryOfRightsDelegation
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\UseTypeType $useType
     */
    public function addToUseType(\DDEX\ERN\ERN_432\UseTypeType $useType)
    {
     ...
     * A Composite containing details of the use for which Rights are delegated.
     *
     * @return \DDEX\ERN\ERN_432\UseTypeType[]
     */
     ...
     * A Composite containing details about a Period of Time for which the delegation of usage Rights applies. Periods are typically described by at least a StartDate or EndDate.
     *
     * @param \DDEX\ERN\ERN_432\PeriodType $periodOfRightsDelegation
     * @return self
     */
    public function setPeriodOfRightsDelegation(?\DDEX\ERN\ERN_432\PeriodType $periodOfRightsDelegation = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\AllTerritoryCodeType $territoryOfRightsDelegation
     */
    public function addToTerritoryOfRightsDelegation(\DDEX\ERN\ERN_432\AllTerritoryCodeType $territoryOfRightsDelegation)
    {
     ...
     * A Territory for which the delegation of usage rights applies.
     *
     * @return \DDEX\ERN\ERN_432\AllTerritoryCodeType[]
     */
