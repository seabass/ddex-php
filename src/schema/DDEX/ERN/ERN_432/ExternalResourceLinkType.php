...
class ExternalResourceLinkType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\PeriodWithoutFlagsType $validityPeriod
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\ExternallyLinkedResourceTypeType[] $externallyLinkedResourceType
     */
     ...
     * A Composite containing details about the Period of Time during which the ExternalResourceLink is active. StartDate and EndDate are deprecated and StartDateTime/EndDateTime should be used instead. DDEX advises that StartDate and EndDate may be removed at a future date and therefore recommends against using them.
     *
     * @return \DDEX\ERN\ERN_432\PeriodWithoutFlagsType
     */
     ...
     * A Composite containing details about the Period of Time during which the ExternalResourceLink is active. StartDate and EndDate are deprecated and StartDateTime/EndDateTime should be used instead. DDEX advises that StartDate and EndDate may be removed at a future date and therefore recommends against using them.
     *
     * @param \DDEX\ERN\ERN_432\PeriodWithoutFlagsType $validityPeriod
     * @return self
     */
    public function setValidityPeriod(?\DDEX\ERN\ERN_432\PeriodWithoutFlagsType $validityPeriod = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ExternallyLinkedResourceTypeType $externallyLinkedResourceType
     */
    public function addToExternallyLinkedResourceType(\DDEX\ERN\ERN_432\ExternallyLinkedResourceTypeType $externallyLinkedResourceType)
    {
     ...
     * A Composite containing details of the Type of a Resource pointed to by the ExternalResourceLink.
     *
     * @return \DDEX\ERN\ERN_432\ExternallyLinkedResourceTypeType[]
     */
