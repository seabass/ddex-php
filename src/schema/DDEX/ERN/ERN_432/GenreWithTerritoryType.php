...
class GenreWithTerritoryType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\GenreCategoryType[] $genreCategory
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\SubGenreCategoryType[] $subGenreCategory
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\GenreCategoryType $genreCategory
     */
    public function addToGenreCategory(\DDEX\ERN\ERN_432\GenreCategoryType $genreCategory)
    {
     ...
     * A Composite containing details of a Genre Category to which the Release belongs.
     *
     * @return \DDEX\ERN\ERN_432\GenreCategoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\SubGenreCategoryType $subGenreCategory
     */
    public function addToSubGenreCategory(\DDEX\ERN\ERN_432\SubGenreCategoryType $subGenreCategory)
    {
     ...
     * A Composite containing details of a sub-genre of the Release. The sub-genre is a specialization of the genre and therefore the GenreCategory needs to be provided if this element is provided.
     *
     * @return \DDEX\ERN\ERN_432\SubGenreCategoryType[]
     */
