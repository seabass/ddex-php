...
class ReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\ReleaseTypeForReleaseNotificationType[] $releaseType
     */
    private $releaseType = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\ReleaseIdType $releaseId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\DisplayTitleTextType[] $displayTitleText
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\DisplayTitleType[] $displayTitle
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\DisplayTitleType[] $formalTitle
     */
    private $formalTitle = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\DisplayTitleType[] $groupingTitle
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\VersionTypeType[] $versionType
     */
    private $versionType = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\DisplayArtistNameWithOriginalLanguageType[] $displayArtistName
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @var \DDEX\ERN\ERN_432\DisplayArtistType[] $displayArtist
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\ReleaseLabelReferenceWithPartyType[] $releaseLabelReference
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\AdministratingRecordCompanyType[] $administratingRecordCompany
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\PLineType[] $pLine
     */
    private $pLine = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\CLineType[] $cLine
     */
    private $cLine = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\CourtesyLineType[] $courtesyLine
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\GenreWithTerritoryType[] $displayGenre
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\EventDateWithDefaultType[] $releaseDate
     */
    private $releaseDate = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\EventDateWithDefaultType[] $originalReleaseDate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\ParentalWarningTypeWithStandardType[] $parentalWarningType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\AvRatingType[] $avRating
     */
    private $avRating = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\RelatedReleaseType[] $relatedRelease
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\RelatedResourceType[] $relatedResource
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\ResourceGroupType $resourceGroup
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\ExternalResourceLinkType[] $externalResourceLink
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\KeywordsWithTerritoryType[] $keywords
     */
    private $keywords = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\SynopsisWithTerritoryType[] $synopsis
     */
    private $synopsis = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\RagaType[] $raga
     */
    private $raga = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\TalaType[] $tala
     */
    private $tala = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\DeityType[] $deity
     */
    private $deity = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\MarketingCommentType[] $marketingComment
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ReleaseTypeForReleaseNotificationType $releaseType
     */
    public function addToReleaseType(\DDEX\ERN\ERN_432\ReleaseTypeForReleaseNotificationType $releaseType)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/release-types-for-trackreleases
     *
     * @return \DDEX\ERN\ERN_432\ReleaseTypeForReleaseNotificationType[]
     */
     ...
     * A Composite containing details of ReleaseIds. If available, a GRid has to be used. If the Release is an abstraction of a complete PhysicalProduct (such as a CD Album), the ICPN of the PhysicalProduct may be used instead.
     *
     * @return \DDEX\ERN\ERN_432\ReleaseIdType
     */
     ...
     * A Composite containing details of ReleaseIds. If available, a GRid has to be used. If the Release is an abstraction of a complete PhysicalProduct (such as a CD Album), the ICPN of the PhysicalProduct may be used instead.
     *
     * @param \DDEX\ERN\ERN_432\ReleaseIdType $releaseId
     * @return self
     */
    public function setReleaseId(\DDEX\ERN\ERN_432\ReleaseIdType $releaseId)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\DisplayTitleTextType $displayTitleText
     */
    public function addToDisplayTitleText(\DDEX\ERN\ERN_432\DisplayTitleTextType $displayTitleText)
    {
     ...
     * A Composite containing details of a Title of the Release as the MessageSender suggests it should be shown to the Consumer. In many instances this is the only Title to be communicated for any given Creation. Multiple instances can be supplied with an ApplicableTerritoryCode and/or LanguageAndScriptCode. One such element is required for each DisplayTitle element and its content typically provides the same information as the concatenation of the DisplayTitle's sub-elements.
     *
     * @return \DDEX\ERN\ERN_432\DisplayTitleTextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\DisplayTitleType $displayTitle
     */
    public function addToDisplayTitle(\DDEX\ERN\ERN_432\DisplayTitleType $displayTitle)
    {
     ...
     * A Composite containing details of a Title of the Release as the MessageSender suggests it should be shown to the Consumer. In many instances this is the only Title to be communicated for any given Creation. Multiple instances can be supplied with an ApplicableTerritoryCode and/or LanguageAndScriptCode.
     *
     * @return \DDEX\ERN\ERN_432\DisplayTitleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\DisplayTitleType $formalTitle
     */
    public function addToFormalTitle(\DDEX\ERN\ERN_432\DisplayTitleType $formalTitle)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\DisplayTitleType $groupingTitle
     */
    public function addToGroupingTitle(\DDEX\ERN\ERN_432\DisplayTitleType $groupingTitle)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\VersionTypeType $versionType
     */
    public function addToVersionType(\DDEX\ERN\ERN_432\VersionTypeType $versionType)
    {
     ...
     * A Composite containing details of a Type of Version given by the releasing party to characterise and differentiate one Release from another with identical or similar Title metadata. VersionTypes may be used for disambiguating a Release that has been derived from another Release by using the value EditedVersion. EditedVersion value is often combined with another VersionType such as RadioVersion.
     *
     * @return \DDEX\ERN\ERN_432\VersionTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\DisplayArtistNameWithOriginalLanguageType $displayArtistName
     */
    public function addToDisplayArtistName(\DDEX\ERN\ERN_432\DisplayArtistNameWithOriginalLanguageType $displayArtistName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @return \DDEX\ERN\ERN_432\DisplayArtistNameWithOriginalLanguageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\DisplayArtistType $displayArtist
     */
    public function addToDisplayArtist(\DDEX\ERN\ERN_432\DisplayArtistType $displayArtist)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/information-on-displayartists%2C-displayartistnames%2C-contributors-and-indirectcontributors
     *
     * @return \DDEX\ERN\ERN_432\DisplayArtistType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ReleaseLabelReferenceWithPartyType $releaseLabelReference
     */
    public function addToReleaseLabelReference(\DDEX\ERN\ERN_432\ReleaseLabelReferenceWithPartyType $releaseLabelReference)
    {
     ...
     * A Reference for a label of the Release (specific to this Message). This is a LocalPartyAnchorReference starting with the letter P.
     *
     * @return \DDEX\ERN\ERN_432\ReleaseLabelReferenceWithPartyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\AdministratingRecordCompanyType $administratingRecordCompany
     */
    public function addToAdministratingRecordCompany(\DDEX\ERN\ERN_432\AdministratingRecordCompanyType $administratingRecordCompany)
    {
     ...
     * A Composite containing details of the AdministratingRecordCompany for the Release.
     *
     * @return \DDEX\ERN\ERN_432\AdministratingRecordCompanyType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\PLineType $pLine
     */
    public function addToPLine(\DDEX\ERN\ERN_432\PLineType $pLine)
    {
        $this->pLine[] = $pLine;
        return $this;
    }
     ...
     * A Composite containing details of the PLine for the Release.
     *
     * @return \DDEX\ERN\ERN_432\PLineType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\CLineType $cLine
     */
    public function addToCLine(\DDEX\ERN\ERN_432\CLineType $cLine)
    {
        $this->cLine[] = $cLine;
        return $this;
    }
     ...
     * A Composite containing details of the CLine for the Release.
     *
     * @return \DDEX\ERN\ERN_432\CLineType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\CourtesyLineType $courtesyLine
     */
    public function addToCourtesyLine(\DDEX\ERN\ERN_432\CourtesyLineType $courtesyLine)
    {
     ...
     * A Composite containing an Annotation which acknowledges record companies and/or other Parties giving permission for guests Artists or others featured on the Release.
     *
     * @return \DDEX\ERN\ERN_432\CourtesyLineType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\GenreWithTerritoryType $displayGenre
     */
    public function addToDisplayGenre(\DDEX\ERN\ERN_432\GenreWithTerritoryType $displayGenre)
    {
     ...
     * A Composite containing details of a Genre considered appropriate for marketing the Release by the publishing record company often in conjunction with the display artist(s).
     *
     * @return \DDEX\ERN\ERN_432\GenreWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\EventDateWithDefaultType $releaseDate
     */
    public function addToReleaseDate(\DDEX\ERN\ERN_432\EventDateWithDefaultType $releaseDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601 format: YYYY[-MM[-DD]]). This Element is for display and cataloguing purposes only.
     *
     * @return \DDEX\ERN\ERN_432\EventDateWithDefaultType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\EventDateWithDefaultType $originalReleaseDate
     */
    public function addToOriginalReleaseDate(\DDEX\ERN\ERN_432\EventDateWithDefaultType $originalReleaseDate)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ParentalWarningTypeWithStandardType $parentalWarningType
     */
    public function addToParentalWarningType(\DDEX\ERN\ERN_432\ParentalWarningTypeWithStandardType $parentalWarningType)
    {
     ...
     * A Composite containing details of the classification of the Release according to advice which it carries about the level of explicitness or offensiveness of its content.
     *
     * @return \DDEX\ERN\ERN_432\ParentalWarningTypeWithStandardType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\AvRatingType $avRating
     */
    public function addToAvRating(\DDEX\ERN\ERN_432\AvRatingType $avRating)
    {
     ...
     * A Composite containing details of a rating for the Release.
     *
     * @return \DDEX\ERN\ERN_432\AvRatingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\RelatedReleaseType $relatedRelease
     */
    public function addToRelatedRelease(\DDEX\ERN\ERN_432\RelatedReleaseType $relatedRelease)
    {
     ...
     * A Composite containing details of a Release (or a PhysicalProduct or a DigitalProduct derived from such a Release) which is related to this Release.
     *
     * @return \DDEX\ERN\ERN_432\RelatedReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\RelatedResourceType $relatedResource
     */
    public function addToRelatedResource(\DDEX\ERN\ERN_432\RelatedResourceType $relatedResource)
    {
     ...
     * A Composite containing details of a Resource which is related to this Release.
     *
     * @return \DDEX\ERN\ERN_432\RelatedResourceType[]
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @return \DDEX\ERN\ERN_432\ResourceGroupType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-releaseresourcework-metadata/sequencing-resources
     *
     * @param \DDEX\ERN\ERN_432\ResourceGroupType $resourceGroup
     * @return self
     */
    public function setResourceGroup(\DDEX\ERN\ERN_432\ResourceGroupType $resourceGroup)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ExternalResourceLinkType $externalResourceLink
     */
    public function addToExternalResourceLink(\DDEX\ERN\ERN_432\ExternalResourceLinkType $externalResourceLink)
    {
     ...
     * A Composite containing details of promotional or other material related to the Release.
     *
     * @return \DDEX\ERN\ERN_432\ExternalResourceLinkType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\KeywordsWithTerritoryType $keywords
     */
    public function addToKeywords(\DDEX\ERN\ERN_432\KeywordsWithTerritoryType $keywords)
    {
     ...
     * A Composite containing details of a Description of the Release containing Keywords.
     *
     * @return \DDEX\ERN\ERN_432\KeywordsWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\SynopsisWithTerritoryType $synopsis
     */
    public function addToSynopsis(\DDEX\ERN\ERN_432\SynopsisWithTerritoryType $synopsis)
    {
     ...
     * A Composite containing details of a Synopsis of the Release.
     *
     * @return \DDEX\ERN\ERN_432\SynopsisWithTerritoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\RagaType $raga
     */
    public function addToRaga(\DDEX\ERN\ERN_432\RagaType $raga)
    {
        $this->raga[] = $raga;
        return $this;
    }
     ...
     * A Description of the melodic mode of a MusicalWork in the Release.
     *
     * @return \DDEX\ERN\ERN_432\RagaType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\TalaType $tala
     */
    public function addToTala(\DDEX\ERN\ERN_432\TalaType $tala)
    {
        $this->tala[] = $tala;
        return $this;
    }
     ...
     * A Description of the rhythmic pattern of a MusicalWork in the Release.
     *
     * @return \DDEX\ERN\ERN_432\TalaType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\DeityType $deity
     */
    public function addToDeity(\DDEX\ERN\ERN_432\DeityType $deity)
    {
        $this->deity[] = $deity;
        return $this;
    }
     ...
     * A deity name relating to the Release.
     *
     * @return \DDEX\ERN\ERN_432\DeityType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\MarketingCommentType $marketingComment
     */
    public function addToMarketingComment(\DDEX\ERN\ERN_432\MarketingCommentType $marketingComment)
    {
     ...
     * A Composite containing a Comment about the promotion and marketing of the Release.
     *
     * @return \DDEX\ERN\ERN_432\MarketingCommentType[]
     */
