...
class ResourceRightsControllerType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\PercentageType $rightSharePercentage
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\DelegatedUsageRightsType[] $delegatedUsageRights
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/communication-of-percentages
     *
     * @return \DDEX\ERN\ERN_432\PercentageType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/communication-of-percentages
     *
     * @param \DDEX\ERN\ERN_432\PercentageType $rightSharePercentage
     * @return self
     */
    public function setRightSharePercentage(?\DDEX\ERN\ERN_432\PercentageType $rightSharePercentage = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\DelegatedUsageRightsType $delegatedUsageRights
     */
    public function addToDelegatedUsageRights(\DDEX\ERN\ERN_432\DelegatedUsageRightsType $delegatedUsageRights)
    {
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated.
     *
     * @return \DDEX\ERN\ERN_432\DelegatedUsageRightsType[]
     */
