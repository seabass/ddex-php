...
class RightsClaimPolicyType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\ConditionForRightsClaimPolicyType[] $condition
     */
    private $condition = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\RightsClaimPolicyReasonType $rightsClaimPolicyReason
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ConditionForRightsClaimPolicyType $condition
     */
    public function addToCondition(\DDEX\ERN\ERN_432\ConditionForRightsClaimPolicyType $condition)
    {
     ...
     * A Composite containing details of Conditions. If more than one Condition is specified, then all of them have to be fulfilled (i.e. they are combined using the logical operator AND).
     *
     * @return \DDEX\ERN\ERN_432\ConditionForRightsClaimPolicyType[]
     */
     ...
     * A Reason why a rights claim policy has been set.
     *
     * @return \DDEX\ERN\ERN_432\RightsClaimPolicyReasonType
     */
     ...
     * A Reason why a rights claim policy has been set.
     *
     * @param \DDEX\ERN\ERN_432\RightsClaimPolicyReasonType $rightsClaimPolicyReason
     * @return self
     */
    public function setRightsClaimPolicyReason(?\DDEX\ERN\ERN_432\RightsClaimPolicyReasonType $rightsClaimPolicyReason = null)
    {
