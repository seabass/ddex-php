...
class ServiceExceptionType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @var \DDEX\ERN\ERN_432\NameType $tradingName
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\ChannelType[] $channel
     */
    private $channel = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\PartyNameType $partyName
     */
    public function addToPartyName(\DDEX\ERN\ERN_432\PartyNameType $partyName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @return \DDEX\ERN\ERN_432\PartyNameType[]
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @param \DDEX\ERN\ERN_432\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\ERN\ERN_432\NameType $tradingName = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\ChannelType $channel
     */
    public function addToChannel(\DDEX\ERN\ERN_432\ChannelType $channel)
    {
     ...
     * A Composite containing details of an excluded channel provided by the Service. This channel may be specific to an Artist.
     *
     * @return \DDEX\ERN\ERN_432\ChannelType[]
     */
