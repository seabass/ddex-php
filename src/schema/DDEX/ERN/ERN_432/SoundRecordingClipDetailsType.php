...
class SoundRecordingClipDetailsType
{
     ...
     * A Type of clip.
     *
     * @var \DDEX\ERN\ERN_432\ClipTypeType $clipType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\TimingType[] $timing
     */
    private $timing = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\AudioDeliveryFileType[] $deliveryFile
     */
     ...
     * A Type of clip.
     *
     * @return \DDEX\ERN\ERN_432\ClipTypeType
     */
     ...
     * A Type of clip.
     *
     * @param \DDEX\ERN\ERN_432\ClipTypeType $clipType
     * @return self
     */
    public function setClipType(\DDEX\ERN\ERN_432\ClipTypeType $clipType)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\TimingType $timing
     */
    public function addToTiming(\DDEX\ERN\ERN_432\TimingType $timing)
    {
        $this->timing[] = $timing;
        return $this;
    }
     ...
     * A Composite containing details of a StartTime, EndTime and a Duration of the clip.
     *
     * @return \DDEX\ERN\ERN_432\TimingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\AudioDeliveryFileType $deliveryFile
     */
    public function addToDeliveryFile(\DDEX\ERN\ERN_432\AudioDeliveryFileType $deliveryFile)
    {
     ...
     * A Composite containing details of a delivery File.
     *
     * @return \DDEX\ERN\ERN_432\AudioDeliveryFileType[]
     */
