...
class TechnicalVideoDetailsType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\BitRateType $overallBitRate
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\VideoDeliveryFileType[] $deliveryFile
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\VideoClipDetailsType[] $clipDetails
     */
    private $clipDetails = [
     ...
     * A Composite containing the overall BitRate and a UnitOfMeasure (the default is kbps).
     *
     * @param \DDEX\ERN\ERN_432\BitRateType $overallBitRate
     * @return self
     */
    public function setOverallBitRate(?\DDEX\ERN\ERN_432\BitRateType $overallBitRate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\VideoDeliveryFileType $deliveryFile
     */
    public function addToDeliveryFile(\DDEX\ERN\ERN_432\VideoDeliveryFileType $deliveryFile)
    {
     ...
     * A Composite containing details of a delivery File.
     *
     * @return \DDEX\ERN\ERN_432\VideoDeliveryFileType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\VideoClipDetailsType $clipDetails
     */
    public function addToClipDetails(\DDEX\ERN\ERN_432\VideoClipDetailsType $clipDetails)
    {
     ...
     * A Composite containing details of a preview.
     *
     * @return \DDEX\ERN\ERN_432\VideoClipDetailsType[]
     */
