...
class TitleDisplayInformationType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\PrefixType[] $prefix
     */
    private $prefix = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\PrefixType $prefix
     */
    public function addToPrefix(\DDEX\ERN\ERN_432\PrefixType $prefix)
    {
        $this->prefix[] = $prefix;
        return $this;
    }
     ...
     * A Descriptor that precedes the display artist name when multiple display artist names are given.
     *
     * @return \DDEX\ERN\ERN_432\PrefixType[]
     */
