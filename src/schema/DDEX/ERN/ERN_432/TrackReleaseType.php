...
class TrackReleaseType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\LinkedReleaseResourceReferenceType[] $linkedReleaseResourceReference
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\LinkedReleaseResourceReferenceType $linkedReleaseResourceReference
     */
    public function addToLinkedReleaseResourceReference(\DDEX\ERN\ERN_432\LinkedReleaseResourceReferenceType $linkedReleaseResourceReference)
    {
     ...
     * A Composite containing details of a ReleaseResourceReference (specific to this Message) for a Resource which is linked to this Release. Example: an Image or Text associated with a SoundRecording. This LocalAnchorReference is a xs:string starting with the letter A.
     *
     * @return \DDEX\ERN\ERN_432\LinkedReleaseResourceReferenceType[]
     */
