...
class VideoEditionType
{
     ...
     *
     * @var \DDEX\ERN\ERN_432\VideoIdType[] $resourceId
     */
    private $resourceId = [
     ...
     *
     * @var \DDEX\ERN\ERN_432\EditionContributorType[] $editionContributor
     */
     ...
     *
     * @var \DDEX\ERN\ERN_432\TechnicalVideoDetailsType[] $technicalDetails
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\VideoIdType $resourceId
     */
    public function addToResourceId(\DDEX\ERN\ERN_432\VideoIdType $resourceId)
    {
     ...
     * A Composite containing details of a VideoId.
     *
     * @return \DDEX\ERN\ERN_432\VideoIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\EditionContributorType $editionContributor
     */
    public function addToEditionContributor(\DDEX\ERN\ERN_432\EditionContributorType $editionContributor)
    {
     ...
     * A Composite containing details of a Contributor to the VideoEdition (but not all other editions).
     *
     * @return \DDEX\ERN\ERN_432\EditionContributorType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_432\TechnicalVideoDetailsType $technicalDetails
     */
    public function addToTechnicalDetails(\DDEX\ERN\ERN_432\TechnicalVideoDetailsType $technicalDetails)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-binaries/communicating-binaries
     *
     * @return \DDEX\ERN\ERN_432\TechnicalVideoDetailsType[]
     */
