 ...
 *
 * A Composite containing details of a FileStatus.
 * XSD Type: FileStatus
 */
class FileStatusType
{
    ...
    /**
     * The Namespace of the FileStatus. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the FileStatus. This is represented in an XML schema as an XML Attribute.
     *
