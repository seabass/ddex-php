...
class FtpMessageHeaderType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_160\MessagingPartyType $messageSender
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_160\MessagingPartyType $messageRecipient
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_160\DdexDigitalSignatureType $signature
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_160\MessagingPartyType
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_160\MessagingPartyType $messageSender
     * @return self
     */
    public function setMessageSender(\DDEX\ERN\ERN_C_SFTP_160\MessagingPartyType $messageSender)
    {
     ...
     * A Composite containing details of the MessageRecipient.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_160\MessagingPartyType $messageRecipient
     * @return self
     */
    public function setMessageRecipient(\DDEX\ERN\ERN_C_SFTP_160\MessagingPartyType $messageRecipient)
    {
     ...
     * A digital signature in accordance with DDEX-DSIG.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_160\DdexDigitalSignatureType
     */
     ...
     * A digital signature in accordance with DDEX-DSIG.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_160\DdexDigitalSignatureType $signature
     * @return self
     */
    public function setSignature(?\DDEX\ERN\ERN_C_SFTP_160\DdexDigitalSignatureType $signature = null)
    {
