...
class MessagingPartyType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_160\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_160\PartyNameType $partyName
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_160\NameType $tradingName
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_160\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\ERN\ERN_C_SFTP_160\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party handling the Message. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, Producers or other Creators.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_160\PartyIdType[]
     */
     ...
     * A Composite containing details of the PartyNames for the Party handling the Message.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_160\PartyNameType
     */
     ...
     * A Composite containing details of the PartyNames for the Party handling the Message.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_160\PartyNameType $partyName
     * @return self
     */
    public function setPartyName(?\DDEX\ERN\ERN_C_SFTP_160\PartyNameType $partyName = null)
    {
     ...
     * A Composite containing a TradingName for the Party handling the Message.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_160\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\ERN\ERN_C_SFTP_160\NameType $tradingName = null)
    {
