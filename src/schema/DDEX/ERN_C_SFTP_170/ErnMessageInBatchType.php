...
class ErnMessageInBatchType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\ReleaseIdType[] $includedReleaseId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\MessageActionTypeType $deliveryType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\ProductTypeType $productType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\HashSumType $hashSum
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_170\ReleaseIdType $includedReleaseId
     */
    public function addToIncludedReleaseId(\DDEX\ERN\ERN_C_SFTP_170\ReleaseIdType $includedReleaseId)
    {
     ...
     * A Composite containing details of the Type of action that the MessageSender applies to the Message.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_170\MessageActionTypeType
     */
     ...
     * A Composite containing details of the Type of action that the MessageSender applies to the Message.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_170\MessageActionTypeType $deliveryType
     * @return self
     */
    public function setDeliveryType(\DDEX\ERN\ERN_C_SFTP_170\MessageActionTypeType $deliveryType)
    {
     ...
     * A Composite containing details of the Type of a Product defining which kinds of Products are within the delivered batch. Each batch may only contain one type of Products.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_170\ProductTypeType
     */
     ...
     * A Composite containing details of the Type of a Product defining which kinds of Products are within the delivered batch. Each batch may only contain one type of Products.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_170\ProductTypeType $productType
     * @return self
     */
    public function setProductType(\DDEX\ERN\ERN_C_SFTP_170\ProductTypeType $productType)
    {
     ...
     * A Composite containing a HashSum of the File and information about the algorithm with which it has been generated.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_170\HashSumType
     */
     ...
     * A Composite containing a HashSum of the File and information about the algorithm with which it has been generated.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_170\HashSumType $hashSum
     * @return self
     */
    public function setHashSum(?\DDEX\ERN\ERN_C_SFTP_170\HashSumType $hashSum = null)
    {
