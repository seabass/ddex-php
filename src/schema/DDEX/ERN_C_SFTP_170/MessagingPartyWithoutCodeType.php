...
class MessagingPartyWithoutCodeType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\PartyNameWithoutCodeType $partyName
     */
     ...
     * A Composite containing details of the PartyNames for the Party handling the Message.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_170\PartyNameWithoutCodeType
     */
     ...
     * A Composite containing details of the PartyNames for the Party handling the Message.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_170\PartyNameWithoutCodeType $partyName
     * @return self
     */
    public function setPartyName(?\DDEX\ERN\ERN_C_SFTP_170\PartyNameWithoutCodeType $partyName = null)
    {
