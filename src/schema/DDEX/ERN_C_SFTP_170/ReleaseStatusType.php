...
namespace DDEX\ERN\ERN_C_SFTP_170;
...
class ReleaseStatusType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\ReleaseIdType $releaseId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\SupplyChainStatusType $releaseStatus
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\ProposedActionTypeType $proposedActionType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\ResourceIdType[] $affectedResource
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_170\AcknowledgementType[] $acknowledgement
     */
     ...
     * A Composite containing details of ReleaseIds. If available, a GRid has to be used. If the Release contains only one SoundRecording, the ISRC of the SoundRecording may be used instead. If the Release is an abstraction of a complete PhysicalProduct (such as a CD Album), the ICPN of the PhysicalProduct may be used instead.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_170\ReleaseIdType
     */
     ...
     * A Composite containing details of ReleaseIds. If available, a GRid has to be used. If the Release contains only one SoundRecording, the ISRC of the SoundRecording may be used instead. If the Release is an abstraction of a complete PhysicalProduct (such as a CD Album), the ICPN of the PhysicalProduct may be used instead.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_170\ReleaseIdType $releaseId
     * @return self
     */
    public function setReleaseId(\DDEX\ERN\ERN_C_SFTP_170\ReleaseIdType $releaseId)
    {
     ...
     * A Composite containing details of the status of the Release.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_170\SupplyChainStatusType
     */
     ...
     * A Composite containing details of the status of the Release.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_170\SupplyChainStatusType $releaseStatus
     * @return self
     */
    public function setReleaseStatus(\DDEX\ERN\ERN_C_SFTP_170\SupplyChainStatusType $releaseStatus)
    {
     ...
     * A Composite containing details of the Type of action that is proposed by the MessageSender.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_170\ProposedActionTypeType
     */
     ...
     * A Composite containing details of the Type of action that is proposed by the MessageSender.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_170\ProposedActionTypeType $proposedActionType
     * @return self
     */
    public function setProposedActionType(?\DDEX\ERN\ERN_C_SFTP_170\ProposedActionTypeType $proposedActionType = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_170\ResourceIdType $affectedResource
     */
    public function addToAffectedResource(\DDEX\ERN\ERN_C_SFTP_170\ResourceIdType $affectedResource)
    {
     ...
     * A Composite containing details of ResourceIds for the Resources that are affected.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_170\ResourceIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_170\AcknowledgementType $acknowledgement
     */
    public function addToAcknowledgement(\DDEX\ERN\ERN_C_SFTP_170\AcknowledgementType $acknowledgement)
    {
     ...
     * A Composite containing details of an acknowledgement.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_170\AcknowledgementType[]
     */
