...
class StatusType
{
    ...
    /**
     * The Namespace of the Message Status. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the Message Status. This is represented in an XML schema as an XML Attribute.
     *
