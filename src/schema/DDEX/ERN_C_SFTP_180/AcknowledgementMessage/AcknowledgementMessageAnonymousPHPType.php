...
namespace DDEX\ERN\ERN_C_SFTP_180\AcknowledgementMessage;
...
class AcknowledgementMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\MessageHeaderType $messageHeader
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\ReleaseStatusType[] $releaseStatus
     */
     ...
     * The MessageHeader for the AcknowledgementMessage.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\MessageHeaderType
     */
     ...
     * The MessageHeader for the AcknowledgementMessage.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_180\MessageHeaderType $messageHeader
     * @return self
     */
    public function setMessageHeader(\DDEX\ERN\ERN_C_SFTP_180\MessageHeaderType $messageHeader)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_180\ReleaseStatusType $releaseStatus
     */
    public function addToReleaseStatus(\DDEX\ERN\ERN_C_SFTP_180\ReleaseStatusType $releaseStatus)
    {
     ...
     * A Composite containing details of the Release status.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\ReleaseStatusType[]
     */
