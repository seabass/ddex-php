...
class ErnMessageInBatchType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\ReleaseIdType[] $includedReleaseId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\MessageActionTypeType $deliveryType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\ProductTypeType $productType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\HashSumType $hashSum
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_180\ReleaseIdType $includedReleaseId
     */
    public function addToIncludedReleaseId(\DDEX\ERN\ERN_C_SFTP_180\ReleaseIdType $includedReleaseId)
    {
     ...
     * A Composite containing details of the Type of action that the MessageSender applies to the Message.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\MessageActionTypeType
     */
     ...
     * A Composite containing details of the Type of action that the MessageSender applies to the Message.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_180\MessageActionTypeType $deliveryType
     * @return self
     */
    public function setDeliveryType(\DDEX\ERN\ERN_C_SFTP_180\MessageActionTypeType $deliveryType)
    {
     ...
     * A Composite containing details of the Type of a Product defining which kinds of Products are within the delivered batch. Each batch may only contain one type of Products.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\ProductTypeType
     */
     ...
     * A Composite containing details of the Type of a Product defining which kinds of Products are within the delivered batch. Each batch may only contain one type of Products.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_180\ProductTypeType $productType
     * @return self
     */
    public function setProductType(\DDEX\ERN\ERN_C_SFTP_180\ProductTypeType $productType)
    {
     ...
     * A Composite containing a HashSum of the File and information about the algorithm with which it has been generated.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\HashSumType
     */
     ...
     * A Composite containing a HashSum of the File and information about the algorithm with which it has been generated.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_180\HashSumType $hashSum
     * @return self
     */
    public function setHashSum(?\DDEX\ERN\ERN_C_SFTP_180\HashSumType $hashSum = null)
    {
