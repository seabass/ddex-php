...
class HashSumType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\HashSumAlgorithmTypeType $hashSumAlgorithmType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\HashSumAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_180\HashSumAlgorithmTypeType $hashSumAlgorithmType
     * @return self
     */
    public function setHashSumAlgorithmType(\DDEX\ERN\ERN_C_SFTP_180\HashSumAlgorithmTypeType $hashSumAlgorithmType)
    {
