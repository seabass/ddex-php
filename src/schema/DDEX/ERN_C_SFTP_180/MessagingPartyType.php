...
class MessagingPartyType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\PartyNameType $partyName
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\NameType $tradingName
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_180\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\ERN\ERN_C_SFTP_180\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party handling the Message. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\PartyIdType[]
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\PartyNameType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @param \DDEX\ERN\ERN_C_SFTP_180\PartyNameType $partyName
     * @return self
     */
    public function setPartyName(?\DDEX\ERN\ERN_C_SFTP_180\PartyNameType $partyName = null)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @param \DDEX\ERN\ERN_C_SFTP_180\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\ERN\ERN_C_SFTP_180\NameType $tradingName = null)
    {
