...
class PartyDescriptorType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_180\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DDEX\ERN\ERN_C_SFTP_180\DetailedPartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\DetailedPartyIdType[]
     */
     ...
     */
    public function addToPartyName(\DDEX\ERN\ERN_C_SFTP_180\PartyNameType $partyName)
    {
