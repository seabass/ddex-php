...
class ReleaseIdType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\CatalogNumberType $catalogNumber
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_180\ProprietaryIdType[] $proprietaryId
     */
     ...
     * A Composite containing details of the CatalogNumber of the Release.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\CatalogNumberType
     */
     ...
     * A Composite containing details of the CatalogNumber of the Release.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_180\CatalogNumberType $catalogNumber
     * @return self
     */
    public function setCatalogNumber(?\DDEX\ERN\ERN_C_SFTP_180\CatalogNumberType $catalogNumber = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_180\ProprietaryIdType $proprietaryId
     */
    public function addToProprietaryId(\DDEX\ERN\ERN_C_SFTP_180\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of a ProprietaryIdentifier of the Release.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_180\ProprietaryIdType[]
     */
