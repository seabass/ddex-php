...
namespace DDEX\ERN\ERN_C_SFTP_181\AcknowledgementMessage;
...
class AcknowledgementMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\MessageHeaderType $messageHeader
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\ReleaseStatusType[] $releaseStatus
     */
     ...
     * The MessageHeader for the AcknowledgementMessage.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\MessageHeaderType
     */
     ...
     * The MessageHeader for the AcknowledgementMessage.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\MessageHeaderType $messageHeader
     * @return self
     */
    public function setMessageHeader(\DDEX\ERN\ERN_C_SFTP_181\MessageHeaderType $messageHeader)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_181\ReleaseStatusType $releaseStatus
     */
    public function addToReleaseStatus(\DDEX\ERN\ERN_C_SFTP_181\ReleaseStatusType $releaseStatus)
    {
     ...
     * A Composite containing details of the Release status.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\ReleaseStatusType[]
     */
