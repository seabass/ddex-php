...
class ErnMessageInBatchType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\ReleaseIdType[] $includedReleaseId
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\MessageActionTypeType $deliveryType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\ProductTypeType $productType
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_181\ReleaseIdType $includedReleaseId
     */
    public function addToIncludedReleaseId(\DDEX\ERN\ERN_C_SFTP_181\ReleaseIdType $includedReleaseId)
    {
     ...
     * A Composite containing details of the Type of action that the MessageSender applies to the Message.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\MessageActionTypeType
     */
     ...
     * A Composite containing details of the Type of action that the MessageSender applies to the Message.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\MessageActionTypeType $deliveryType
     * @return self
     */
    public function setDeliveryType(\DDEX\ERN\ERN_C_SFTP_181\MessageActionTypeType $deliveryType)
    {
     ...
     * A Composite containing details of the Type of a Product defining which kinds of Products are within the delivered batch. Each batch may only contain one type of Products.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\ProductTypeType
     */
     ...
     * A Composite containing details of the Type of a Product defining which kinds of Products are within the delivered batch. Each batch may only contain one type of Products.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\ProductTypeType $productType
     * @return self
     */
    public function setProductType(\DDEX\ERN\ERN_C_SFTP_181\ProductTypeType $productType)
    {
