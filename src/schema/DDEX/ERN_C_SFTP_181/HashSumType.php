...
class HashSumType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\HashSumAlgorithmTypeType $hashSumAlgorithmType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the hash sum.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\HashSumAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the hash sum.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\HashSumAlgorithmTypeType $hashSumAlgorithmType
     * @return self
     */
    public function setHashSumAlgorithmType(\DDEX\ERN\ERN_C_SFTP_181\HashSumAlgorithmTypeType $hashSumAlgorithmType)
    {
