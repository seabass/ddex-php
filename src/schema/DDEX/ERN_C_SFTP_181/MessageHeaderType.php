...
class MessageHeaderType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $messageSender
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $sentOnBehalfOf
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType[] $messageRecipient
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $sentAsRequestedBy
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\MessageAuditTrailEventType[] $messageAuditTrail
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $messageSender
     * @return self
     */
    public function setMessageSender(\DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $messageSender)
    {
     ...
     * A Composite containing details of the Party on whose behalf the Message is sent.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $sentOnBehalfOf
     * @return self
     */
    public function setSentOnBehalfOf(?\DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $sentOnBehalfOf = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $messageRecipient
     */
    public function addToMessageRecipient(\DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $messageRecipient)
    {
     ...
     * A Composite containing details of the Party on whose request the Message is sent.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $sentAsRequestedBy
     * @return self
     */
    public function setSentAsRequestedBy(?\DDEX\ERN\ERN_C_SFTP_181\MessagingPartyWithoutCodeType $sentAsRequestedBy = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_SFTP_181\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrail(\DDEX\ERN\ERN_C_SFTP_181\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\MessageAuditTrailEventType[]
     */
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\MessageAuditTrailEventType[] $messageAuditTrail
     * @return self
     */
