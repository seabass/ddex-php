...
class MessageStatusType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\StatusType $status
     */
    private $status = null;
     ...
     * A Composite containing details of the status of the Message.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\StatusType
     */
     ...
     * A Composite containing details of the status of the Message.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\StatusType $status
     * @return self
     */
    public function setStatus(\DDEX\ERN\ERN_C_SFTP_181\StatusType $status)
    {
        $this->status = $status;
        return $this;
    }
