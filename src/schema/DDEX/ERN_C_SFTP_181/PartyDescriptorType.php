...
class PartyDescriptorType
{
     ...
     */
    public function addToPartyId(\DDEX\ERN\ERN_C_SFTP_181\DetailedPartyIdType $partyId)
    {
     ...
     */
    public function addToPartyName(\DDEX\ERN\ERN_C_SFTP_181\PartyNameType $partyName)
    {
