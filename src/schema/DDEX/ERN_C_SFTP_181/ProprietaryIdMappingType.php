...
class ProprietaryIdMappingType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\FormalIdentifierType $formalIdentifier
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_SFTP_181\ProprietaryIdWithOptionalAttributeType $proprietaryId
     */
     ...
     * A Composite containing details of an Identifier that is formally used.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\FormalIdentifierType
     */
     ...
     * A Composite containing details of an Identifier that is formally used.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\FormalIdentifierType $formalIdentifier
     * @return self
     */
    public function setFormalIdentifier(\DDEX\ERN\ERN_C_SFTP_181\FormalIdentifierType $formalIdentifier)
    {
     ...
     * A Composite containing details of a ProprietaryIdentifier for the above Identifier.
     *
     * @return \DDEX\ERN\ERN_C_SFTP_181\ProprietaryIdWithOptionalAttributeType
     */
     ...
     * A Composite containing details of a ProprietaryIdentifier for the above Identifier.
     *
     * @param \DDEX\ERN\ERN_C_SFTP_181\ProprietaryIdWithOptionalAttributeType $proprietaryId
     * @return self
     */
    public function setProprietaryId(\DDEX\ERN\ERN_C_SFTP_181\ProprietaryIdWithOptionalAttributeType $proprietaryId)
    {
