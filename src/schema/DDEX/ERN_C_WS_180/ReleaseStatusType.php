...
class ReleaseStatusType
{
     ...
     *
     * @var \DDEX\ERN\ERN_C_WS_180\SupplyChainStatusType $releaseStatus
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_WS_180\ProposedActionTypeType $proposedActionType
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_WS_180\ProprietaryIdMappingType[] $proprietaryIdMapping
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_WS_180\ResourceIdType[] $affectedResource
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_WS_180\AcknowledgementType[] $acknowledgement
     */
     ...
     *
     * @var \DDEX\ERN\ERN_C_WS_180\PartyDescriptorType[] $claimant
     */
    private $claimant = [
     ...
     * @return self
     */
    public function setReleaseId(\DDEX\ERN\ERN_C_WS_180\ReleaseIdType $releaseId)
    {
     ...
     * A Composite containing details of the status of the Release.
     *
     * @return \DDEX\ERN\ERN_C_WS_180\SupplyChainStatusType
     */
     ...
     * A Composite containing details of the status of the Release.
     *
     * @param \DDEX\ERN\ERN_C_WS_180\SupplyChainStatusType $releaseStatus
     * @return self
     */
    public function setReleaseStatus(\DDEX\ERN\ERN_C_WS_180\SupplyChainStatusType $releaseStatus)
    {
     ...
     * A Composite containing details of the Type of action that is proposed by the MessageSender.
     *
     * @return \DDEX\ERN\ERN_C_WS_180\ProposedActionTypeType
     */
     ...
     * A Composite containing details of the Type of action that is proposed by the MessageSender.
     *
     * @param \DDEX\ERN\ERN_C_WS_180\ProposedActionTypeType $proposedActionType
     * @return self
     */
    public function setProposedActionType(?\DDEX\ERN\ERN_C_WS_180\ProposedActionTypeType $proposedActionType = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_WS_180\ProprietaryIdMappingType $proprietaryIdMapping
     */
    public function addToProprietaryIdMapping(\DDEX\ERN\ERN_C_WS_180\ProprietaryIdMappingType $proprietaryIdMapping)
    {
     ...
     * A Composite containing details of a ProprietaryIdentifier mapping.
     *
     * @return \DDEX\ERN\ERN_C_WS_180\ProprietaryIdMappingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_WS_180\ResourceIdType $affectedResource
     */
    public function addToAffectedResource(\DDEX\ERN\ERN_C_WS_180\ResourceIdType $affectedResource)
    {
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_WS_180\AcknowledgementType $acknowledgement
     */
    public function addToAcknowledgement(\DDEX\ERN\ERN_C_WS_180\AcknowledgementType $acknowledgement)
    {
     ...
     * A Composite containing details of an acknowledgement.
     *
     * @return \DDEX\ERN\ERN_C_WS_180\AcknowledgementType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\ERN\ERN_C_WS_180\PartyDescriptorType $claimant
     */
    public function addToClaimant(\DDEX\ERN\ERN_C_WS_180\PartyDescriptorType $claimant)
    {
     ...
     * A Composite containing details of a Party that has also claimed the same SoundRecording for the same territory and time.
     *
     * @return \DDEX\ERN\ERN_C_WS_180\PartyDescriptorType[]
     */
