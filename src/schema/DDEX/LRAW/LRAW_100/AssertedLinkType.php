...
class AssertedLinkType
{
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\AssertionType[] $assertion
     */
    private $assertion = [
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\SoundRecordingType $soundRecording
     */
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\VideoType $video
     */
    private $video = null;
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\MusicalWorkType[] $musicalWork
     */
    private $musicalWork = [
     ...
     * @return self
     */
    public function setLinkId(\DDEX\LRAW\LRAW_100\LinkIdType $linkId)
    {
        $this->linkId = $linkId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_100\AssertionType $assertion
     */
    public function addToAssertion(\DDEX\LRAW\LRAW_100\AssertionType $assertion)
    {
     ...
     * A Composite containing details of an assertion about the link between the SoundRecording and one or more MusicalWorks that it uses.
     *
     * @return \DDEX\LRAW\LRAW_100\AssertionType[]
     */
     ...
     * A Composite containing details of the SoundRecording for which the link to the MusicalWorks is asserted.
     *
     * @return \DDEX\LRAW\LRAW_100\SoundRecordingType
     */
     ...
     * A Composite containing details of the SoundRecording for which the link to the MusicalWorks is asserted.
     *
     * @param \DDEX\LRAW\LRAW_100\SoundRecordingType $soundRecording
     * @return self
     */
    public function setSoundRecording(?\DDEX\LRAW\LRAW_100\SoundRecordingType $soundRecording = null)
    {
     ...
     * A Composite containing details of the Video for which the link to the MusicalWorks is asserted.
     *
     * @return \DDEX\LRAW\LRAW_100\VideoType
     */
     ...
     * A Composite containing details of the Video for which the link to the MusicalWorks is asserted.
     *
     * @param \DDEX\LRAW\LRAW_100\VideoType $video
     * @return self
     */
    public function setVideo(?\DDEX\LRAW\LRAW_100\VideoType $video = null)
    {
        $this->video = $video;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_100\MusicalWorkType $musicalWork
     */
    public function addToMusicalWork(\DDEX\LRAW\LRAW_100\MusicalWorkType $musicalWork)
    {
     ...
     * A Composite containing details of a MusicalWork used by the SoundRecording.
     *
     * @return \DDEX\LRAW\LRAW_100\MusicalWorkType[]
     */
