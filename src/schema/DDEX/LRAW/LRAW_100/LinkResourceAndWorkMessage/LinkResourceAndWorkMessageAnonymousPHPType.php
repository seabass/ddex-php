...
namespace DDEX\LRAW\LRAW_100\LinkResourceAndWorkMessage;
...
class LinkResourceAndWorkMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\PartyType[] $partyList
     */
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\AssertedLinkType[] $assertedLink
     */
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_100\PartyType $party
     */
    public function addToPartyList(\DDEX\LRAW\LRAW_100\PartyType $party)
    {
     ...
     * A Composite containing details of one or more Parties relating to the reported MusicalWorks.
     *
     * @return \DDEX\LRAW\LRAW_100\PartyType[]
     */
     ...
     * A Composite containing details of one or more Parties relating to the reported MusicalWorks.
     *
     * @param \DDEX\LRAW\LRAW_100\PartyType[] $partyList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_100\AssertedLinkType $assertedLink
     */
    public function addToAssertedLink(\DDEX\LRAW\LRAW_100\AssertedLinkType $assertedLink)
    {
     ...
     * A Composite containing details of the link between a SoundRecording and one or more MusicalWorks that it uses.
     *
     * @return \DDEX\LRAW\LRAW_100\AssertedLinkType[]
     */
