...
class MessageAuditTrailType
{
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\MessageAuditTrailEventType[] $messageAuditTrailEvent
     */
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_100\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrailEvent(\DDEX\LRAW\LRAW_100\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing details of a Party handling the Message and the Time at which the handling took place.
     *
     * @return \DDEX\LRAW\LRAW_100\MessageAuditTrailEventType[]
     */
