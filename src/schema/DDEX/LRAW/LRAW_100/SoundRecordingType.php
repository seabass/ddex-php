...
class SoundRecordingType
{
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\SoundRecordingIdType[] $resourceId
     */
    private $resourceId = [
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\NameType $displayArtistName
     */
     ...
     *
     * @var \DDEX\LRAW\LRAW_100\ArtistType[] $displayArtist
     */
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_100\SoundRecordingIdType $resourceId
     */
    public function addToResourceId(\DDEX\LRAW\LRAW_100\SoundRecordingIdType $resourceId)
    {
     ...
     * A Composite containing details of SoundRecordingIds.
     *
     * @return \DDEX\LRAW\LRAW_100\SoundRecordingIdType[]
     */
     ...
     * A Composite containing the Name to be used by a DSP when presenting Artist details of the Resource to a Consumer. A Resource-level DisplayArtistName shall only be provided if it differs from the DisplayArtistName for a Release that contains the Resource and is communicated in the same XML message.
     *
     * @param \DDEX\LRAW\LRAW_100\NameType $displayArtistName
     * @return self
     */
    public function setDisplayArtistName(?\DDEX\LRAW\LRAW_100\NameType $displayArtistName = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_100\ArtistType $displayArtist
     */
    public function addToDisplayArtist(\DDEX\LRAW\LRAW_100\ArtistType $displayArtist)
    {
     ...
     * A Composite containing details of the DisplayArtist for the SoundRecording. The DisplayArtist may be described through Name, Identifier and Roles.
     *
     * @return \DDEX\LRAW\LRAW_100\ArtistType[]
     */
