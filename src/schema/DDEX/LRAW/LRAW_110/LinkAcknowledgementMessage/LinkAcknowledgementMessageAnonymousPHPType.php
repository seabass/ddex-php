...
namespace DDEX\LRAW\LRAW_110\LinkAcknowledgementMessage;
...
class LinkAcknowledgementMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\LRAW\LRAW_110\StatusType $status
     */
    private $status = null;
     ...
     */
    public function addToLinkId(\DDEX\LRAW\LRAW_110\LinkIdType $linkId)
    {
        $this->linkId[] = $linkId;
        return $this;
    }
     ...
     * A Status that is acknowledged.
     *
     * @return \DDEX\LRAW\LRAW_110\StatusType
     */
     ...
     * A Status that is acknowledged.
     *
     * @param \DDEX\LRAW\LRAW_110\StatusType $status
     * @return self
     */
    public function setStatus(\DDEX\LRAW\LRAW_110\StatusType $status)
    {
        $this->status = $status;
        return $this;
    }
