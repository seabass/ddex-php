...
{
    /**
     * The Language and script for the Elements of the MessageAuditTrail as defined in IETF RfC 5646. The default is the same as indicated for the containing composite. Language and Script are provided as lang[-script][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
     ...
     *
     * @var \DDEX\LRAW\LRAW_110\MessageAuditTrailEventType[] $messageAuditTrailEvent
     */
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_110\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrailEvent(\DDEX\LRAW\LRAW_110\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing details of a Party handling the Message and the Time at which the handling took place.
     *
     * @return \DDEX\LRAW\LRAW_110\MessageAuditTrailEventType[]
     */
