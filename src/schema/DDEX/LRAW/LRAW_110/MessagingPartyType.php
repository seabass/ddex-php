...
class MessagingPartyType
{
     ...
     *
     * @var \DDEX\LRAW\LRAW_110\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\LRAW\LRAW_110\NameType $tradingName
     */
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_110\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\LRAW\LRAW_110\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party handling the Message. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\LRAW\LRAW_110\PartyIdType[]
     */
     ...
     * @return self
     */
    public function setPartyName(?\DDEX\LRAW\LRAW_110\PartyNameType $partyName = null)
    {
     ...
     * A Composite containing a TradingName for the Party handling the Message.
     *
     * @param \DDEX\LRAW\LRAW_110\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\LRAW\LRAW_110\NameType $tradingName = null)
    {
