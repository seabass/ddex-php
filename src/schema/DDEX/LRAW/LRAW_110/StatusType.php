 ...
 *
 * A Composite containing details of a Status.
 * XSD Type: Status
 */
class StatusType
{
    ...
    /**
     * The Namespace of the detailed Status. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A user-defined detailed Status that is acknowledged. This is represented in an XML schema as an XML Attribute.
     *
