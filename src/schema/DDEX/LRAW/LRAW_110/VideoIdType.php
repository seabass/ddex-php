...
class VideoIdType
{
     ...
     *
     * @var \DDEX\LRAW\LRAW_110\CatalogNumberType $catalogNumber
     */
     ...
     *
     * @var \DDEX\LRAW\LRAW_110\ProprietaryIdType[] $proprietaryId
     */
     ...
     * A Composite containing details of the CatalogNumber of the Video.
     *
     * @return \DDEX\LRAW\LRAW_110\CatalogNumberType
     */
     ...
     * A Composite containing details of the CatalogNumber of the Video.
     *
     * @param \DDEX\LRAW\LRAW_110\CatalogNumberType $catalogNumber
     * @return self
     */
    public function setCatalogNumber(?\DDEX\LRAW\LRAW_110\CatalogNumberType $catalogNumber = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\LRAW\LRAW_110\ProprietaryIdType $proprietaryId
     */
    public function addToProprietaryId(\DDEX\LRAW\LRAW_110\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of a ProprietaryIdentifier of the Video (usually one per society involved in the messaging).
     *
     * @return \DDEX\LRAW\LRAW_110\ProprietaryIdType[]
     */
