...
class AnnotationType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\TextWithFormatType $text
     */
    private $text = null;
     ...
     * The text of the Annotation.
     *
     * @param \DDEX\MEAD\MEAD_100\TextWithFormatType $text
     * @return self
     */
    public function setText(\DDEX\MEAD\MEAD_100\TextWithFormatType $text)
    {
        $this->text = $text;
        return $this;
    }
