...
class ArtisticInfluenceType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\ResourceType[] $resource
     */
    private $resource = [
     ...
     */
    public function addToParty(\DDEX\MEAD\MEAD_100\PartyWithNamesType $party)
    {
        $this->party[] = $party;
        return $this;
    }
     ...
     */
    public function addToWork(\DDEX\MEAD\MEAD_100\WorkType $work)
    {
        $this->work[] = $work;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\ResourceType $resource
     */
    public function addToResource(\DDEX\MEAD\MEAD_100\ResourceType $resource)
    {
     ...
     */
    public function addToRelease(\DDEX\MEAD\MEAD_100\ReleaseType $release)
    {
