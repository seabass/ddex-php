...
class BiographyType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\BiographyTextType[] $text
     */
    private $text = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\BiographyTextType $text
     */
    public function addToText(\DDEX\MEAD\MEAD_100\BiographyTextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A Composite containing details of the biography text.
     *
     * @return \DDEX\MEAD\MEAD_100\BiographyTextType[]
     */
