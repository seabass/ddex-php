...
class CommentaryNoteType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\TextWithoutTerritoryType[] $text
     */
    private $text = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\CommentaryNoteTypeType[] $commentaryNoteType
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PartyWithNamesType[] $author
     */
    private $author = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\TextWithoutTerritoryType $text
     */
    public function addToText(\DDEX\MEAD\MEAD_100\TextWithoutTerritoryType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\CommentaryNoteTypeType $commentaryNoteType
     */
    public function addToCommentaryNoteType(\DDEX\MEAD\MEAD_100\CommentaryNoteTypeType $commentaryNoteType)
    {
     ...
     * A type of the commentary note.
     *
     * @return \DDEX\MEAD\MEAD_100\CommentaryNoteTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\PartyWithNamesType $author
     */
    public function addToAuthor(\DDEX\MEAD\MEAD_100\PartyWithNamesType $author)
    {
        $this->author[] = $author;
        return $this;
    }
