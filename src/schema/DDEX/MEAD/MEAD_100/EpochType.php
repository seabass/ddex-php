...
class EpochType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\NameType[] $value
     */
    private $value = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PartyWithNamesType[] $relatedArtist
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\DateType $startDate
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\DateType $endDate
     */
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\NameType $value
     */
    public function addToValue(\DDEX\MEAD\MEAD_100\NameType $value)
    {
        $this->value[] = $value;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\PartyWithNamesType $relatedArtist
     */
    public function addToRelatedArtist(\DDEX\MEAD\MEAD_100\PartyWithNamesType $relatedArtist)
    {
     ...
     * The Date that marks the beginning of the epoch. It can be represented as a calendar Year, Month or Day (in ISO 8601:2004 format: YYYY, YYYY-MM or YYYY-MM-DD).
     *
     * @return \DDEX\MEAD\MEAD_100\DateType
     */
     ...
     * The Date that marks the beginning of the epoch. It can be represented as a calendar Year, Month or Day (in ISO 8601:2004 format: YYYY, YYYY-MM or YYYY-MM-DD).
     *
     * @param \DDEX\MEAD\MEAD_100\DateType $startDate
     * @return self
     */
    public function setStartDate(?\DDEX\MEAD\MEAD_100\DateType $startDate = null)
    {
     ...
     * The Date that marks the end of the epoch. It can be represented as a calendar Year, Month or Day (in ISO 8601:2004 format: YYYY, YYYY-MM or YYYY-MM-DD).
     *
     * @param \DDEX\MEAD\MEAD_100\DateType $endDate
     * @return self
     */
    public function setEndDate(?\DDEX\MEAD\MEAD_100\DateType $endDate = null)
    {
