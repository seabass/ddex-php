...
class FocusTrackType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\DisplayArtistNameWithPronunciationType[] $displayArtistName
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PeriodWithTimeType[] $periodOfBeingFocusTrack
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\TextWithoutTerritoryType[] $comment
     */
    private $comment = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\DisplayArtistNameWithPronunciationType $displayArtistName
     */
    public function addToDisplayArtistName(\DDEX\MEAD\MEAD_100\DisplayArtistNameWithPronunciationType $displayArtistName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/communicating-displayartists-and-displayartistname
     *
     * @return \DDEX\MEAD\MEAD_100\DisplayArtistNameWithPronunciationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\PeriodWithTimeType $periodOfBeingFocusTrack
     */
    public function addToPeriodOfBeingFocusTrack(\DDEX\MEAD\MEAD_100\PeriodWithTimeType $periodOfBeingFocusTrack)
    {
     ...
     * A Composite containing details about a focus track period. StartDate and EndDate are deprecated and StartDateTime/EndDateTime should be used instead. DDEX advises that StartDate and EndDate may be removed at a future date and therefore recommends against using them.
     *
     * @return \DDEX\MEAD\MEAD_100\PeriodWithTimeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\TextWithoutTerritoryType $comment
     */
    public function addToComment(\DDEX\MEAD\MEAD_100\TextWithoutTerritoryType $comment)
    {
