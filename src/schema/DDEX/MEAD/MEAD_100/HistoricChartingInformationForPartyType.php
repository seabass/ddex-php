...
class HistoricChartingInformationForPartyType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\CurrentTerritoryCodeType $territoryCode
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\ChartNameType[] $chartName
     */
    private $chartName = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\DurationType $durationInCharts
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\ChartEntryType[] $chartEntry
     */
    private $chartEntry = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\WorkType $chartedWork
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\ResourceType $chartedResource
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\ReleaseType $chartedRelease
     */
     ...
     * A Territory of the charts. The use of ISO TerritoryCodes (or the term 'Worldwide') is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
     * @return \DDEX\MEAD\MEAD_100\CurrentTerritoryCodeType
     */
     ...
     * A Territory of the charts. The use of ISO TerritoryCodes (or the term 'Worldwide') is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
     * @param \DDEX\MEAD\MEAD_100\CurrentTerritoryCodeType $territoryCode
     * @return self
     */
    public function setTerritoryCode(\DDEX\MEAD\MEAD_100\CurrentTerritoryCodeType $territoryCode)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\ChartNameType $chartName
     */
    public function addToChartName(\DDEX\MEAD\MEAD_100\ChartNameType $chartName)
    {
     ...
     * A Name of the charts.
     *
     * @return \DDEX\MEAD\MEAD_100\ChartNameType[]
     */
     ...
     * The Duration for which the Creation or the Party was in the charts.
     *
     * @return \DDEX\MEAD\MEAD_100\DurationType
     */
     ...
     * The Duration for which the Creation or the Party was in the charts.
     *
     * @param \DDEX\MEAD\MEAD_100\DurationType $durationInCharts
     * @return self
     */
    public function setDurationInCharts(?\DDEX\MEAD\MEAD_100\DurationType $durationInCharts = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\ChartEntryType $chartEntry
     */
    public function addToChartEntry(\DDEX\MEAD\MEAD_100\ChartEntryType $chartEntry)
    {
     ...
     * A Composite containing details of the Date and Place of the usage (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @return \DDEX\MEAD\MEAD_100\ChartEntryType[]
     */
     ...
     * A Composite containing details of a charted Work.
     *
     * @param \DDEX\MEAD\MEAD_100\WorkType $chartedWork
     * @return self
     */
    public function setChartedWork(?\DDEX\MEAD\MEAD_100\WorkType $chartedWork = null)
    {
     ...
     * A Composite containing details of a charted Resource.
     *
     * @return \DDEX\MEAD\MEAD_100\ResourceType
     */
     ...
     * A Composite containing details of a charted Resource.
     *
     * @param \DDEX\MEAD\MEAD_100\ResourceType $chartedResource
     * @return self
     */
    public function setChartedResource(?\DDEX\MEAD\MEAD_100\ResourceType $chartedResource = null)
    {
     ...
     * A Composite containing details of a charted Release.
     *
     * @param \DDEX\MEAD\MEAD_100\ReleaseType $chartedRelease
     * @return self
     */
    public function setChartedRelease(?\DDEX\MEAD\MEAD_100\ReleaseType $chartedRelease = null)
    {
