...
class LocationAndDateOfSessionType
{
     ...
     * The Type of Session.
     *
     * @var \DDEX\MEAD\MEAD_100\SessionTypeType[] $sessionType
     */
    private $sessionType = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PeriodType $period
     */
    private $period = null;
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\VenueType[] $venue
     */
    private $venue = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PartyWithRoleType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\SessionTypeType $sessionType
     */
    public function addToSessionType(\DDEX\MEAD\MEAD_100\SessionTypeType $sessionType)
    {
     ...
     * The Type of Session.
     *
     * @return \DDEX\MEAD\MEAD_100\SessionTypeType[]
     */
     ...
     * A Composite containing details about a Period of the Session. Periods are typically described by at least a StartDate or EndDate.
     *
     * @return \DDEX\MEAD\MEAD_100\PeriodType
     */
     ...
     * A Composite containing details about a Period of the Session. Periods are typically described by at least a StartDate or EndDate.
     *
     * @param \DDEX\MEAD\MEAD_100\PeriodType $period
     * @return self
     */
    public function setPeriod(?\DDEX\MEAD\MEAD_100\PeriodType $period = null)
    {
        $this->period = $period;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\VenueType $venue
     */
    public function addToVenue(\DDEX\MEAD\MEAD_100\VenueType $venue)
    {
        $this->venue[] = $venue;
        return $this;
    }
     ...
     * A Composite containing details of the venue where the Session took place.
     *
     * @return \DDEX\MEAD\MEAD_100\VenueType[]
     */
     ...
     * @return self
     */
    public function setComment(?\DDEX\MEAD\MEAD_100\TextWithFormatType $comment = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\PartyWithRoleType $contributor
     */
    public function addToContributor(\DDEX\MEAD\MEAD_100\PartyWithRoleType $contributor)
    {
     ...
     * A Composite containing details of a Contributor.
     *
     * @return \DDEX\MEAD\MEAD_100\PartyWithRoleType[]
     */
