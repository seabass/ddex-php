...
namespace DDEX\MEAD\MEAD_100\MeadMessage;
...
class MeadMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\MessageHeaderType $messageHeader
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\MetadataSourceType[] $metadataSourceList
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PartyInformationType[] $partyInformationList
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\WorkInformationType[] $workInformationList
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\ResourceInformationType[] $resourceInformationList
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\ReleaseInformationType[] $releaseInformationList
     */
     ...
     * The MessageHeader for the MeadMessage.
     *
     * @return \DDEX\MEAD\MEAD_100\MessageHeaderType
     */
     ...
     * The MessageHeader for the MeadMessage.
     *
     * @param \DDEX\MEAD\MEAD_100\MessageHeaderType $messageHeader
     * @return self
     */
    public function setMessageHeader(\DDEX\MEAD\MEAD_100\MessageHeaderType $messageHeader)
    {
     ...
     */
    public function addToMetadataSourceList(\DDEX\MEAD\MEAD_100\MetadataSourceType $metadataSource)
    {
     ...
     * A Composite containing details of one or more Parties that created the metadata.
     *
     * @param \DDEX\MEAD\MEAD_100\MetadataSourceType[] $metadataSourceList
     * @return self
     */
     ...
     */
    public function addToPartyInformationList(\DDEX\MEAD\MEAD_100\PartyInformationType $partyInformation)
    {
     ...
     * A Composite containing detailed information about one or more Parties.
     *
     * @param \DDEX\MEAD\MEAD_100\PartyInformationType[] $partyInformationList
     * @return self
     */
     ...
     */
    public function addToWorkInformationList(\DDEX\MEAD\MEAD_100\WorkInformationType $workInformation)
    {
     ...
     * A Composite containing detailed information about one or more Works
     *
     * @param \DDEX\MEAD\MEAD_100\WorkInformationType[] $workInformationList
     * @return self
     */
     ...
     */
    public function addToResourceInformationList(\DDEX\MEAD\MEAD_100\ResourceInformationType $resourceInformation)
    {
     ...
     * A Composite containing detailed information about one or more Resources.
     *
     * @param \DDEX\MEAD\MEAD_100\ResourceInformationType[] $resourceInformationList
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\ReleaseInformationType $releaseInformation
     */
    public function addToReleaseInformationList(\DDEX\MEAD\MEAD_100\ReleaseInformationType $releaseInformation)
    {
     ...
     * A Composite containing detailed information about one or more Releases.
     *
     * @return \DDEX\MEAD\MEAD_100\ReleaseInformationType[]
     */
     ...
     * A Composite containing detailed information about one or more Releases.
     *
     * @param \DDEX\MEAD\MEAD_100\ReleaseInformationType[] $releaseInformationList
     * @return self
     */
