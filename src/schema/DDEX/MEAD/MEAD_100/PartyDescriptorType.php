...
class PartyDescriptorType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PartyNameType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\PartyNameType $partyName
     */
    public function addToPartyName(\DDEX\MEAD\MEAD_100\PartyNameType $partyName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @return \DDEX\MEAD\MEAD_100\PartyNameType[]
     */
