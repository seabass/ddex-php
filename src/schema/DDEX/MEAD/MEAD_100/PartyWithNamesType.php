...
/**
 * Class representing PartyWithNamesType
 *
 * A Composite containing details of a Party.
 * Explanatory Note: This Composite is named PartyWithNames to disambiguate it from the basic Party Composite.
 * XSD Type: PartyWithNames
 */
class PartyWithNamesType
{
    /**
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PartyNameWithTerritoryType[] $name
     */
    private $name = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\PartyNameWithTerritoryType $name
     */
    public function addToName(\DDEX\MEAD\MEAD_100\PartyNameWithTerritoryType $name)
    {
        $this->name[] = $name;
        return $this;
    }
