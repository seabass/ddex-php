...
class WorkSummaryType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\TitleWithPronunciationType[] $workTitle
     */
    private $workTitle = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_100\PartyNameWithTerritoryType[] $writer
     */
    private $writer = [
     ...
     * @return self
     */
    public function setMusicalWorkId(\DDEX\MEAD\MEAD_100\MusicalWorkIdType $musicalWorkId)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\TitleWithPronunciationType $workTitle
     */
    public function addToWorkTitle(\DDEX\MEAD\MEAD_100\TitleWithPronunciationType $workTitle)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_100\PartyNameWithTerritoryType $writer
     */
    public function addToWriter(\DDEX\MEAD\MEAD_100\PartyNameWithTerritoryType $writer)
    {
        $this->writer[] = $writer;
        return $this;
    }
