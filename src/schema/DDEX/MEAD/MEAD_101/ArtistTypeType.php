...
class ArtistTypeType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\ArtistTypeValueType $value
     */
    private $value = null;
     ...
     * A Composite containing details of an artist type value.
     *
     * @return \DDEX\MEAD\MEAD_101\ArtistTypeValueType
     */
     ...
     * A Composite containing details of an artist type value.
     *
     * @param \DDEX\MEAD\MEAD_101\ArtistTypeValueType $value
     * @return self
     */
    public function setValue(\DDEX\MEAD\MEAD_101\ArtistTypeValueType $value)
    {
        $this->value = $value;
        return $this;
    }
