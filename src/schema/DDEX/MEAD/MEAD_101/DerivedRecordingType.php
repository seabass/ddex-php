...
/**
 * Class representing DerivedRecordingType
 *
 * A Composite containing details of a Recording of a Work.
 * XSD Type: DerivedRecording
 */
class DerivedRecordingType
{
    /**
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\RelatedResourceTypeType $relatedResourceType
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\DisplayArtistNameWithDefaultType $displayArtistName
     */
     ...
     * A Type of the related Resource.
     *
     * @return \DDEX\MEAD\MEAD_101\RelatedResourceTypeType
     */
     ...
     * A Type of the related Resource.
     *
     * @param \DDEX\MEAD\MEAD_101\RelatedResourceTypeType $relatedResourceType
     * @return self
     */
    public function setRelatedResourceType(?\DDEX\MEAD\MEAD_101\RelatedResourceTypeType $relatedResourceType = null)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/communicating-displayartists-and-displayartistname
     *
     * @return \DDEX\MEAD\MEAD_101\DisplayArtistNameWithDefaultType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/communicating-displayartists-and-displayartistname
     *
     * @param \DDEX\MEAD\MEAD_101\DisplayArtistNameWithDefaultType $displayArtistName
     * @return self
     */
    public function setDisplayArtistName(\DDEX\MEAD\MEAD_101\DisplayArtistNameWithDefaultType $displayArtistName)
    {
