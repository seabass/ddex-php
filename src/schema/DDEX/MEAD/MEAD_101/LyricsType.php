...
class LyricsType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\LyricsTextType $text
     */
    private $text = null;
     ...
     * The text of the Lyrics.
     *
     * @return \DDEX\MEAD\MEAD_101\LyricsTextType
     */
     ...
     * The text of the Lyrics.
     *
     * @param \DDEX\MEAD\MEAD_101\LyricsTextType $text
     * @return self
     */
    public function setText(\DDEX\MEAD\MEAD_101\LyricsTextType $text)
    {
        $this->text = $text;
        return $this;
    }
