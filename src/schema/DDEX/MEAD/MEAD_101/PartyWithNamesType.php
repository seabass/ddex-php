...
class PartyWithNamesType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\PartyNameWithTerritoryType[] $name
     */
    private $name = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_101\PartyNameWithTerritoryType $name
     */
    public function addToName(\DDEX\MEAD\MEAD_101\PartyNameWithTerritoryType $name)
    {
        $this->name[] = $name;
        return $this;
    }
