...
class PseudonymType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\PartyNameWithPronunciationType $name
     */
    private $name = null;
     ...
     * A Composite containing summary details of a Name.
     *
     * @param \DDEX\MEAD\MEAD_101\PartyNameWithPronunciationType $name
     * @return self
     */
    public function setName(\DDEX\MEAD\MEAD_101\PartyNameWithPronunciationType $name)
    {
        $this->name = $name;
        return $this;
    }
