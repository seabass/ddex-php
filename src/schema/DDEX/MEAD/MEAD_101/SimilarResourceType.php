...
class SimilarResourceType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\AnnotationType[] $description
     */
    private $description = [
     ...
     * @return self
     */
    public function setResource(\DDEX\MEAD\MEAD_101\ResourceType $resource)
    {
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_101\AnnotationType $description
     */
    public function addToDescription(\DDEX\MEAD\MEAD_101\AnnotationType $description)
    {
