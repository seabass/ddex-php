...
class TimeSignatureModulationType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\TempoType $tempo
     */
    private $tempo = null;
     ...
     * A Composite containing details of a tempo of the modulation.
     *
     * @return \DDEX\MEAD\MEAD_101\TempoType
     */
     ...
     * A Composite containing details of a tempo of the modulation.
     *
     * @param \DDEX\MEAD\MEAD_101\TempoType $tempo
     * @return self
     */
    public function setTempo(?\DDEX\MEAD\MEAD_101\TempoType $tempo = null)
    {
        $this->tempo = $tempo;
        return $this;
    }
