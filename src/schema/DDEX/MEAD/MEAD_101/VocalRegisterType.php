...
/**
 * Class representing VocalRegisterType
 *
 * A Composite containing details of a vocal register.
 * XSD Type: VocalRegister
 */
class VocalRegisterType
{
    /**
     ...
     *
     * @var \DDEX\MEAD\MEAD_101\VocalRegisterValueType $value
     */
    private $value = null;
     ...
     * The value of the vocal register.
     *
     * @return \DDEX\MEAD\MEAD_101\VocalRegisterValueType
     */
     ...
     * The value of the vocal register.
     *
     * @param \DDEX\MEAD\MEAD_101\VocalRegisterValueType $value
     * @return self
     */
    public function setValue(\DDEX\MEAD\MEAD_101\VocalRegisterValueType $value)
    {
        $this->value = $value;
        return $this;
    }
