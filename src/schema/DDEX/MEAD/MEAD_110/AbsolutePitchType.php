...
/**
 * Class representing AbsolutePitchType
 *
 * A Composite containing details of an absolute pitch.
 * XSD Type: AbsolutePitch
 */
class AbsolutePitchType
{
    /**
    ...
    /**
     * The value of the absolute pitch of the A above middle C (a’) in Hertz.
     *
     * @var float $value
     */
    private $value = null;
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\ModulationType[] $modulation
     */
    private $modulation = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_110\ModulationType $modulation
     */
    public function addToModulation(\DDEX\MEAD\MEAD_110\ModulationType $modulation)
    {
     ...
     * A Composite containing details of a modulation.
     *
     * @return \DDEX\MEAD\MEAD_110\ModulationType[]
     */
