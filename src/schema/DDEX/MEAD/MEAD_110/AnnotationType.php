...
class AnnotationType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\TextWithFormatType $text
     */
    private $text = null;
     ...
     * The text of the Annotation.
     *
     * @param \DDEX\MEAD\MEAD_110\TextWithFormatType $text
     * @return self
     */
    public function setText(\DDEX\MEAD\MEAD_110\TextWithFormatType $text)
    {
        $this->text = $text;
        return $this;
    }
