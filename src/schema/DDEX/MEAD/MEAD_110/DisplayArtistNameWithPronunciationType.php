...
class DisplayArtistNameWithPronunciationType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\DisplayArtistNameWithDefaultType $name
     */
    private $name = null;
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @return \DDEX\MEAD\MEAD_110\DisplayArtistNameWithDefaultType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @param \DDEX\MEAD\MEAD_110\DisplayArtistNameWithDefaultType $name
     * @return self
     */
    public function setName(\DDEX\MEAD\MEAD_110\DisplayArtistNameWithDefaultType $name)
    {
        $this->name = $name;
        return $this;
    }
