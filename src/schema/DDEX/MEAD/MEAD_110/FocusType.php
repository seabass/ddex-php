...
class FocusType
{
    ...
    /**
     * A Composite containing details of a Party that is not described in DisplayArtist or Writer.
     *
     * @var \DDEX\MEAD\MEAD_110\PartyDescriptorWithPronunciationType[] $party
     */
    private $party = [
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\PeriodWithTimeType[] $periodOfBeingFocus
     */
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\TextWithoutTerritoryType[] $comment
     */
    private $comment = [
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_110\PartyDescriptorWithPronunciationType $party
     */
    public function addToParty(\DDEX\MEAD\MEAD_110\PartyDescriptorWithPronunciationType $party)
    {
        $this->party[] = $party;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_110\PeriodWithTimeType $periodOfBeingFocus
     */
    public function addToPeriodOfBeingFocus(\DDEX\MEAD\MEAD_110\PeriodWithTimeType $periodOfBeingFocus)
    {
     ...
     * A Composite containing details about a focus track period. StartDate and EndDate are deprecated and StartDateTime/EndDateTime should be used instead. DDEX advises that StartDate and EndDate may be removed at a future date and therefore recommends against using them.
     *
     * @return \DDEX\MEAD\MEAD_110\PeriodWithTimeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MEAD\MEAD_110\TextWithoutTerritoryType $comment
     */
    public function addToComment(\DDEX\MEAD\MEAD_110\TextWithoutTerritoryType $comment)
    {
