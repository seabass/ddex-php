...
/**
 * Class representing IntensityValueType
 *
 * A Composite containing details of an intensity.
 * XSD Type: IntensityValue
 */
class IntensityValueType
{
    /**
     * @var string $__value
     */
    ...
    /**
     * The Namespace of the intensity. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the intensity. This is represented in an XML schema as an XML Attribute.
     *
