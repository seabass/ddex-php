...
class VenueType
{
     ...
     *
     * @var \DDEX\MEAD\MEAD_110\AllTerritoryCodeType $territoryCode
     */
     ...
     * A Territory of the VenueAddress. The use of ISO TerritoryCodes is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
     * @return \DDEX\MEAD\MEAD_110\AllTerritoryCodeType
     */
     ...
     * A Territory of the VenueAddress. The use of ISO TerritoryCodes is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
     * @param \DDEX\MEAD\MEAD_110\AllTerritoryCodeType $territoryCode
     * @return self
     */
    public function setTerritoryCode(?\DDEX\MEAD\MEAD_110\AllTerritoryCodeType $territoryCode = null)
    {
