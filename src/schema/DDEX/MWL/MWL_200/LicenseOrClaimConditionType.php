...
class LicenseOrClaimConditionType
{
     ...
     *
     * @var \DDEX\MWL\MWL_200\RoyaltyRateType[] $royaltyRate
     */
    private $royaltyRate = [
     ...
     *
     * @var \DDEX\MWL\MWL_200\PercentageRateType[] $percentageRate
     */
     ...
     *
     * @var \DDEX\MWL\MWL_200\ControlledCompositionClauseType $controlledCompositionClause
     */
     ...
     *
     * @var \DDEX\MWL\MWL_200\RateValidityType $rateValidity
     */
     ...
     *
     * @var \DDEX\MWL\MWL_200\LicenseOrClaimConditionReferenceListType $licenseOrClaimConditionReferenceList
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\RoyaltyRateType $royaltyRate
     */
    public function addToRoyaltyRate(\DDEX\MWL\MWL_200\RoyaltyRateType $royaltyRate)
    {
     ...
     * A ddex:Composite containing details of a ddex:RoyaltyRate.
     *
     * @return \DDEX\MWL\MWL_200\RoyaltyRateType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\PercentageRateType $percentageRate
     */
    public function addToPercentageRate(\DDEX\MWL\MWL_200\PercentageRateType $percentageRate)
    {
     ...
     * A ddex:Composite containing details of a ddex:PercentageRate.
     *
     * @return \DDEX\MWL\MWL_200\PercentageRateType[]
     */
     ...
     * A ddex:Composite containing details of a controlled composition clause.
     *
     * @return \DDEX\MWL\MWL_200\ControlledCompositionClauseType
     */
     ...
     * A ddex:Composite containing details of a controlled composition clause.
     *
     * @param \DDEX\MWL\MWL_200\ControlledCompositionClauseType $controlledCompositionClause
     * @return self
     */
    public function setControlledCompositionClause(?\DDEX\MWL\MWL_200\ControlledCompositionClauseType $controlledCompositionClause = null)
    {
     ...
     * A ddex:Composite containing details of the context (such as ddex:Dates, number of uses) in which the ddex:Rate is valid. The default is that the ddex:Rate applies indefinitely from the xs:date of issue of the Licence.
     *
     * @return \DDEX\MWL\MWL_200\RateValidityType
     */
     ...
     * A ddex:Composite containing details of the context (such as ddex:Dates, number of uses) in which the ddex:Rate is valid. The default is that the ddex:Rate applies indefinitely from the xs:date of issue of the Licence.
     *
     * @param \DDEX\MWL\MWL_200\RateValidityType $rateValidity
     * @return self
     */
    public function setRateValidity(?\DDEX\MWL\MWL_200\RateValidityType $rateValidity = null)
    {
     ...
     * A ddex:Composite containing details of one or more ddex:References contained in the mwl:LicenseOrClaimCondition. The condition only applies when the ddex:Work is used in the context of the ddex:Releases or ddex:Resources referenced in this element.
     *
     * @return \DDEX\MWL\MWL_200\LicenseOrClaimConditionReferenceListType
     */
     ...
     * A ddex:Composite containing details of one or more ddex:References contained in the mwl:LicenseOrClaimCondition. The condition only applies when the ddex:Work is used in the context of the ddex:Releases or ddex:Resources referenced in this element.
     *
     * @param \DDEX\MWL\MWL_200\LicenseOrClaimConditionReferenceListType $licenseOrClaimConditionReferenceList
     * @return self
     */
    public function setLicenseOrClaimConditionReferenceList(?\DDEX\MWL\MWL_200\LicenseOrClaimConditionReferenceListType $licenseOrClaimConditionReferenceList = null)
    {
