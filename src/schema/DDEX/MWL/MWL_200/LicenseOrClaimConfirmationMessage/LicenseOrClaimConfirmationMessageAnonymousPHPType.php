...
namespace DDEX\MWL\MWL_200\LicenseOrClaimConfirmationMessage;
...
class LicenseOrClaimConfirmationMessageAnonymousPHPType
{
    ...
    /**
     * The ddex:Language and script for the ddex:Elements of the mwl:LicenseOrClaimConfirmationMessage as defined in IETF RfC 4646. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
    ...
    /**
     * The MessageHeader for the mwl:LicenseOrClaimConfirmationMessage.
     *
    ...
    /**
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are confirmed.
     *
     * @var \DDEX\MWL\MWL_200\LicenseOrClaimType[] $confirmedLicenseOrClaimList
     */
    private $confirmedLicenseOrClaimList = null;

    /**
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are pending.
     *
     * @var \DDEX\MWL\MWL_200\LicenseOrClaimType[] $pendingLicenseOrClaimList
     */
    private $pendingLicenseOrClaimList = null;

    /**
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are rejected.
     *
     * @var \DDEX\MWL\MWL_200\RejectedLicenseOrClaimListType $rejectedLicenseOrClaimList
     */
    private $rejectedLicenseOrClaimList = null;

    /**
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are pending because the ddex:Licensee wishes to negotiate T&Cs.
     *
     * @var \DDEX\MWL\MWL_200\RejectedLicenseOrClaimListType $licenseOrClaimForNegotiationList
     */
    private $licenseOrClaimForNegotiationList = null;

    /**
     * A ddex:Composite containing details of one or more ddex:Works being part of the Release(s) for which a ddex:License or ddex:Claim is rejected.
     *
    ...
    /**
     * A ddex:Composite containing details of one or more ddex:Resources being part of the Release(s) for which a ddex:License or ddex:Claim is rejected.
     *
    ...
    /**
     * A ddex:Composite containing details of one or more ddex:Releases for which a ddex:License or ddex:Claim is rejected.
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:RightShares for which a ddex:License or ddex:Claim is rejected.
     *
    ...
    /**
     * A ddex:Composite containing details of conditions and/or limitations for Usages for which a ddex:License or ddex:Claim is rejected.
     *
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\LicenseOrClaimType $licenseOrClaim
     */
    public function addToConfirmedLicenseOrClaimList(\DDEX\MWL\MWL_200\LicenseOrClaimType $licenseOrClaim)
    {
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are confirmed.
     *
     * @return \DDEX\MWL\MWL_200\LicenseOrClaimType[]
     */
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are confirmed.
     *
     * @param \DDEX\MWL\MWL_200\LicenseOrClaimType[] $confirmedLicenseOrClaimList
     * @return self
     */
     ...
     * @param \DDEX\MWL\MWL_200\LicenseOrClaimType $licenseOrClaim
     */
    public function addToPendingLicenseOrClaimList(\DDEX\MWL\MWL_200\LicenseOrClaimType $licenseOrClaim)
    {
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are pending.
     *
     * @param \DDEX\MWL\MWL_200\LicenseOrClaimType[] $pendingLicenseOrClaimList
     * @return self
     */
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are rejected.
     *
     * @return \DDEX\MWL\MWL_200\RejectedLicenseOrClaimListType
     */
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are rejected.
     *
     * @param \DDEX\MWL\MWL_200\RejectedLicenseOrClaimListType $rejectedLicenseOrClaimList
     * @return self
     */
    public function setRejectedLicenseOrClaimList(?\DDEX\MWL\MWL_200\RejectedLicenseOrClaimListType $rejectedLicenseOrClaimList = null)
    {
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are pending because the ddex:Licensee wishes to negotiate T&Cs.
     *
     * @param \DDEX\MWL\MWL_200\RejectedLicenseOrClaimListType $licenseOrClaimForNegotiationList
     * @return self
     */
    public function setLicenseOrClaimForNegotiationList(?\DDEX\MWL\MWL_200\RejectedLicenseOrClaimListType $licenseOrClaimForNegotiationList = null)
    {
