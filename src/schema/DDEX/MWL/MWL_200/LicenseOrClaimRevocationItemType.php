 ...
 *
 * A ddex:Composite containing details of a ddex:License or ddex:Claim that is revoked.
 * XSD Type: LicenseOrClaimRevocationItem
 */
class LicenseOrClaimRevocationItemType
{
    /**
     * A ddex:Composite containing details of an ddex:Identifier of the ddex:License or ddex:Claim that is being revoked.
     *
    ...
    /**
     * The ddex:DateTime at which the ddex:License is revoked (in ISO 8601:2004 format: YYYY-MM-DDThh:mm:ssZ).
     *
    ...
    /**
     * A ddex:Composite containing details of the reason for the revocation.
     *
