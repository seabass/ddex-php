 ...
 *
 * A ddex:Composite containing details of a request for licensing information to be provided to augment any information previously communicated.
 * XSD Type: LicensingInformationRequestItem
 */
class LicensingInformationRequestItemType
{
    /**
     * The ddex:Language and script for the ddex:Elements of the LicensingInformationRequestItem as defined in IETF RfC 4646. The default is the same as indicated for the containing composite. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
    ...
    /**
     * A ddex:Composite containing details of an ddex:Identifier of the LicensingInformationRequestItem.
     *
    ...
    /**
     * A ddex:Composite containing details of an ddex:Identifier of the ddex:License or ddex:Claim request for which additional information is requested.
     *
    ...
    /**
     * A ddex:Composite containing details of an ddex:Identifier of a ddex:RightShare for which additional information is requested.
     *
    ...
    /**
     * A ddex:Composite containing details of a ddex:MusicalWorkId of a ddex:MusicalWork for which additional information is requested.
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:ResourceIds of a ddex:Resource for which additional information is requested.
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:ReleaseIds of a ddex:Release for which additional information is requested. If available, a ddex:GRid should always to be used. If the ddex:Release contains only one ddex:SoundRecording, the ddex:ISRC of the ddex:SoundRecording may be used instead. If the ddex:Release is an abstraction of a complete ddex:PhysicalProduct (such as a CD ddex:Album), the ddex:ICPN of the ddex:PhysicalProduct may be used instead.
     *
    ...
    /**
     * A ddex:Composite containing a description of the nature of the additional information requested.
     *
    ...
    /**
     * A ddex:Composite containing a description of the reason for the additional information requested.
     *
