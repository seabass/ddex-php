...
{
    /**
     * The ddex:Flag indicating whether the ddex:MusicalWork ddex:Element was updated (=True) or not (=False). The ddex:Flag may only be used when the ddex:UpdateIndicator is set to ddex:UpdateMessage. When this ddex:Boolean ddex:Flag is set to true, the ddex:MessageRecipient is expected to replace any previously provided ddex:MusicalWork data with the now provided data.
     *
     * @var bool $isUpdated
     */
    ...
    /**
     * The ddex:Language and script for the ddex:Elements of the ddex:MusicalWork as defined in IETF RfC 4646. The default is the same as indicated for the containing composite. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
    ...
    /**
     * A ddex:Composite containing details of a ddex:MusicalWorkId of the ddex:MusicalWork.
     *
    ...
    /**
     * The ddex:Identifier (specific to the ddex:Message) of the ddex:MusicalWork within the ddex:Release which contains it. This is a ddex:LocalMusicalWorkAnchor starting with the letter W.
     *
    ...
    /**
     * A ddex:Composite containing details of a ddex:ReferenceTitle of the ddex:MusicalWork.
     *
    ...
    /**
     * The ddex:Flag indicating whether the mwl:MusicalWork is a ddex:Medley (=True) or not (=False).
     *
     * @var bool $isMedley
     */
    ...
    /**
     * A ddex:Flag indicating whether some rights in the mwl:MusicalWork are in dispute as to ownership and/or share percentage (=True) or not (=False). Absence of this element should not be interpreted as there being no dispute.
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:Identifiers of a ddex:License or a ddex:Claim for the ddex:MusicalWork.
     *
    ...
    /**
     * A ddex:Composite containing details of one or more ddex:RightShares contained in the ddex:MusicalWork.
     *
    ...
    /**
     * A ddex:Composite containing details of the ddex:Type of the ddex:MusicalWork.
     *
    ...
    /**
     * A ddex:Type of the ddex:RightsClaim related to the ddex:MusicalWork.
     *
    ...
    /**
     * A ddex:Composite containing details of ddex:Descriptors and other attributes of the ddex:MusicalWork which may vary according to ddex:Territory of release.
     *
