...
{
    /**
     * The ddex:Language and script for the ddex:Elements of the mwl:ResourceList as defined in IETF RfC 4646. The default is the same as indicated for the containing composite. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
     ...
     *
     * @var \DDEX\MWL\MWL_200\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DDEX\MWL\MWL_200\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *
     * @var \DDEX\MWL\MWL_200\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DDEX\MWL\MWL_200\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DDEX\MWL\MWL_200\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DDEX\MWL\MWL_200\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DDEX\MWL\MWL_200\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @var \DDEX\MWL\MWL_200\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\MWL\MWL_200\SoundRecordingType $soundRecording)
    {
     ...
     * A ddex:Composite containing details of a ddex:SoundRecording.
     *
     * @return \DDEX\MWL\MWL_200\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\MIDIType $mIDI
     */
    public function addToMIDI(\DDEX\MWL\MWL_200\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:MIDI.
     *
     * @return \DDEX\MWL\MWL_200\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\VideoType $video
     */
    public function addToVideo(\DDEX\MWL\MWL_200\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Video.
     *
     * @return \DDEX\MWL\MWL_200\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\ImageType $image
     */
    public function addToImage(\DDEX\MWL\MWL_200\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A ddex:Composite containing details of an ddex:Image.
     *
     * @return \DDEX\MWL\MWL_200\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\TextType $text
     */
    public function addToText(\DDEX\MWL\MWL_200\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A ddex:Composite containing details of a ddex:Text.
     *
     * @return \DDEX\MWL\MWL_200\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\MWL\MWL_200\SheetMusicType $sheetMusic)
    {
     ...
     * A ddex:Composite containing details of a ddex:SheetMusic.
     *
     * @return \DDEX\MWL\MWL_200\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\SoftwareType $software
     */
    public function addToSoftware(\DDEX\MWL\MWL_200\SoftwareType $software)
    {
     ...
     * A ddex:Composite containing details of an item of ddex:Software.
     *
     * @return \DDEX\MWL\MWL_200\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_200\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DDEX\MWL\MWL_200\UserDefinedResourceType $userDefinedResource)
    {
     ...
     * A ddex:Composite containing details of a ddex:UserDefinedResource.
     *
     * @return \DDEX\MWL\MWL_200\UserDefinedResourceType[]
     */
