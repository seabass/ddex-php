...
class InvoiceSupportInformationListType
{
     ...
     *
     * @var \DDEX\MWL\MWL_211\InvoiceSupportInformationType[] $invoiceSupportInformation
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\InvoiceSupportInformationType $invoiceSupportInformation
     */
    public function addToInvoiceSupportInformation(\DDEX\MWL\MWL_211\InvoiceSupportInformationType $invoiceSupportInformation)
    {
     ...
     * A ddex:Composite containing details to support invoicing.
     *
     * @return \DDEX\MWL\MWL_211\InvoiceSupportInformationType[]
     */
