...
namespace DDEX\MWL\MWL_211\LicenseOrClaimConfirmationMessage;
...
class LicenseOrClaimConfirmationMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\MWL\MWL_211\LicenseOrClaimType[] $confirmedLicenseOrClaimList
     */
     ...
     *
     * @var \DDEX\MWL\MWL_211\LicenseOrClaimType[] $pendingLicenseOrClaimList
     */
     ...
     *
     * @var \DDEX\MWL\MWL_211\RejectedLicenseOrClaimListType $rejectedLicenseOrClaimList
     */
     ...
     *
     * @var \DDEX\MWL\MWL_211\RejectedLicenseOrClaimListType $licenseOrClaimForNegotiationList
     */
     ...
     */
    public function addToConfirmedLicenseOrClaimList(\DDEX\MWL\MWL_211\LicenseOrClaimType $licenseOrClaim)
    {
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are confirmed.
     *
     * @param \DDEX\MWL\MWL_211\LicenseOrClaimType[] $confirmedLicenseOrClaimList
     * @return self
     */
     ...
     * @param \DDEX\MWL\MWL_211\LicenseOrClaimType $licenseOrClaim
     */
    public function addToPendingLicenseOrClaimList(\DDEX\MWL\MWL_211\LicenseOrClaimType $licenseOrClaim)
    {
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are pending.
     *
     * @param \DDEX\MWL\MWL_211\LicenseOrClaimType[] $pendingLicenseOrClaimList
     * @return self
     */
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are rejected.
     *
     * @return \DDEX\MWL\MWL_211\RejectedLicenseOrClaimListType
     */
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are rejected.
     *
     * @param \DDEX\MWL\MWL_211\RejectedLicenseOrClaimListType $rejectedLicenseOrClaimList
     * @return self
     */
    public function setRejectedLicenseOrClaimList(?\DDEX\MWL\MWL_211\RejectedLicenseOrClaimListType $rejectedLicenseOrClaimList = null)
    {
     ...
     * A ddex:Composite containing details of the ddex:Licenses or ddex:Claims that are pending because the ddex:Licensee wishes to negotiate T&Cs.
     *
     * @param \DDEX\MWL\MWL_211\RejectedLicenseOrClaimListType $licenseOrClaimForNegotiationList
     * @return self
     */
    public function setLicenseOrClaimForNegotiationList(?\DDEX\MWL\MWL_211\RejectedLicenseOrClaimListType $licenseOrClaimForNegotiationList = null)
    {
