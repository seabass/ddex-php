...
namespace DDEX\MWL\MWL_211\LicenseOrClaimRequestMessage;
...
class LicenseOrClaimRequestMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\MWL\MWL_211\LicenseOrClaimRequestType[] $licenseOrClaimRequestList
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\LicenseOrClaimRequestType $licenseOrClaimRequest
     */
    public function addToLicenseOrClaimRequestList(\DDEX\MWL\MWL_211\LicenseOrClaimRequestType $licenseOrClaimRequest)
    {
     ...
     * A ddex:Composite containing details of requests for a ddex:License or ddex:Claim.
     *
     * @return \DDEX\MWL\MWL_211\LicenseOrClaimRequestType[]
     */
     ...
     * A ddex:Composite containing details of requests for a ddex:License or ddex:Claim.
     *
     * @param \DDEX\MWL\MWL_211\LicenseOrClaimRequestType[] $licenseOrClaimRequestList
     * @return self
     */
