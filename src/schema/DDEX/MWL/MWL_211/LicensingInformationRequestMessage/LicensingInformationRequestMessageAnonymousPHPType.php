...
namespace DDEX\MWL\MWL_211\LicensingInformationRequestMessage;
...
class LicensingInformationRequestMessageAnonymousPHPType
{
    ...
    /**
     * The ddex:Language and script for the ddex:Elements of the mwl:LicensingInformationRequestMessage as defined in IETF RfC 4646. ddex:Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML ddex:Attribute.
     *
    ...
    /**
     * The MessageHeader for the mwl:LicensingInformationRequestMessage.
     *
    ...
    /**
     * A ddex:Composite containing details of a request for additional information not previously contained in a mwl:LicenseOrClaimRequestMessage.
     *
     * @var \DDEX\MWL\MWL_211\LicensingInformationRequestItemType[] $licensingInformationRequestItem
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\LicensingInformationRequestItemType $licensingInformationRequestItem
     */
    public function addToLicensingInformationRequestItem(\DDEX\MWL\MWL_211\LicensingInformationRequestItemType $licensingInformationRequestItem)
    {
     ...
     * A ddex:Composite containing details of a request for additional information not previously contained in a mwl:LicenseOrClaimRequestMessage.
     *
     * @return \DDEX\MWL\MWL_211\LicensingInformationRequestItemType[]
     */
