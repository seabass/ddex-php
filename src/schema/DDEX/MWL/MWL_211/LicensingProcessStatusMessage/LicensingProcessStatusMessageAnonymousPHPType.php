...
namespace DDEX\MWL\MWL_211\LicensingProcessStatusMessage;
...
class LicensingProcessStatusMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\MWL\MWL_211\LicensingProcessStatusItemType[] $licensingProcessStatusItem
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_211\LicensingProcessStatusItemType $licensingProcessStatusItem
     */
    public function addToLicensingProcessStatusItem(\DDEX\MWL\MWL_211\LicensingProcessStatusItemType $licensingProcessStatusItem)
    {
     ...
     * A ddex:Composite containing details of the process status of a ddex:License or ddex:Claim request.
     *
     * @return \DDEX\MWL\MWL_211\LicensingProcessStatusItemType[]
     */
