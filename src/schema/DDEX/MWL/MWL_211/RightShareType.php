...
class RightShareType
{
    ...
    /**
     * The ddex:Flag indicating whether the ddex:RightShare ddex:Element was updated (=True) or not (=False). The ddex:Flag may only be used when the ddex:UpdateIndicator is set to ddex:UpdateMessage. When this ddex:Boolean ddex:Flag is set to true, the ddex:MessageRecipient is expected to replace any previously provided ddex:RightShare data with the now provided data.
     *
     * @var bool $isUpdated
     */
    ...
    /**
     * A ddex:Flag indicating whether the ddex:MessageSender assumes that the ddex:Work is in the ddex:PublicDomain (=Yes) or not (=No) for the specified ddex:Territory.
     *
    ...
    /**
     * The Date at which the the ddex:MessageSender assumes that the ddex:Work will be in the ddex:PublicDomain (in ISO 8601:2004 format: YYYY-MM-DD).
     *
    ...
    /**
     * A ddex:Flag indicating whether the ddex:RightShare description is provided as best knowledge by ddex:MessageSender (=Yes) or not (=No) in order to help the ddex:MessageRecipient in its licensing activities.
     *
    ...
    /**
     * A ddex:Flag indicating whether some rights in a ddex:Creation are in dispute as to ownership and/or share percentage (=True) or not (=False).
     *
