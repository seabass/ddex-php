...
{
    /**
     * A ddex:Composite containing details of the ddex:Type of the ddex:RoyaltyRate. Either this ddex:Element or ddex:RoyaltyAmount shall be present, but not both.
     *
    ...
    /**
     * A ddex:Composite containing details of a ddex:RoyaltyAmount. Either this ddex:Element or ddex:RoyaltyCode shall be present, but not both.
     *
    ...
    /**
     * A ddex:Type of ddex:RoyaltyRateCalculation according to the ddex:License or ddex:Claim conditions.
     *
    ...
    /**
     * A ddex:Type of ddex:RoyaltyRate according to the ddex:License or ddex:Claim conditions.
     *
