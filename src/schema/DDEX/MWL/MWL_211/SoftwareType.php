...
class SoftwareType
{
    ...
    /**
     * The ddex:Flag indicating whether the mwl:Software ddex:Element was updated (=True) or not (=False). The ddex:Flag may only be used when the ddex:UpdateIndicator is set to ddex:UpdateMessage. When this ddex:Boolean ddex:Flag is set to true, the ddex:MessageRecipient is expected to replace any previously provided mwl:Software data with the now provided data.
     *
     * @var bool $isUpdated
     */
