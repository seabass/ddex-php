 ...
 *
 * A ddex:Composite containing a list of details to
 *  support invoicing.
...
class InvoiceSupportInformationListType
{
     ...
     *  ddex:Elements of the mwl:InvoiceSupportInformationList as defined in IETF RfC 4646.
     *  The default is the same as indicated for the containing composite. ddex:Language and
    ...
    /**
     * A ddex:Composite containing details to
     *  support invoicing.
     *
     * @var \DDEX\MWL\MWL_212\InvoiceSupportInformationType[] $invoiceSupportInformation
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\InvoiceSupportInformationType $invoiceSupportInformation
     */
    public function addToInvoiceSupportInformation(\DDEX\MWL\MWL_212\InvoiceSupportInformationType $invoiceSupportInformation)
    {
     ...
     *  support invoicing.
     *
     * @return \DDEX\MWL\MWL_212\InvoiceSupportInformationType[]
     */
