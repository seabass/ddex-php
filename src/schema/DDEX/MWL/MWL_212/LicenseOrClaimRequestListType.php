 ...
 *  more requests for a ddex:License or ddex:Claim.
...
class LicenseOrClaimRequestListType
{
     ...
     *  request for a ddex:License or ddex:Claim.
     *
     * @var \DDEX\MWL\MWL_212\LicenseOrClaimRequestType[] $licenseOrClaimRequest
     */
     ...
     */
    public function addToLicenseOrClaimRequest(\DDEX\MWL\MWL_212\LicenseOrClaimRequestType $licenseOrClaimRequest)
    {
