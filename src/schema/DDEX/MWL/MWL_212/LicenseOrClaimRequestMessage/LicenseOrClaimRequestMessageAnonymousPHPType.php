...
namespace DDEX\MWL\MWL_212\LicenseOrClaimRequestMessage;
...
class LicenseOrClaimRequestMessageAnonymousPHPType
{
     ...
     *  ddex:Elements of the mwl:LicenseOrClaimRequestMessage as defined in IETF RfC 4646.
     ...
     *  requests for a ddex:License or ddex:Claim.
     *
     * @var \DDEX\MWL\MWL_212\LicenseOrClaimRequestType[] $licenseOrClaimRequestList
     */
     ...
     *  ddex:License or ddex:Claim is requested.
     *
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\LicenseOrClaimRequestType $licenseOrClaimRequest
     */
    public function addToLicenseOrClaimRequestList(\DDEX\MWL\MWL_212\LicenseOrClaimRequestType $licenseOrClaimRequest)
    {
     ...
     *  requests for a ddex:License or ddex:Claim.
     *
     * @return \DDEX\MWL\MWL_212\LicenseOrClaimRequestType[]
     */
     ...
     *  requests for a ddex:License or ddex:Claim.
     *
     * @param \DDEX\MWL\MWL_212\LicenseOrClaimRequestType[] $licenseOrClaimRequestList
     * @return self
     */
