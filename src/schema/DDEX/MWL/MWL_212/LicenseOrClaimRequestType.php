 ...
 *  for a ddex:License or ddex:Claim.
...
class LicenseOrClaimRequestType
{
     ...
     *  ddex:Identifier of mwl:LicenseOrClaimRequest.
     *
     ...
     *  Identifier of a LicenseOrClaimRequest that is replaced or updated by the present
     *  LicenseOrClaimRequest.
     *
     * @var \DDEX\ddexC\RelatedLicenseOrClaimRequestIdType[] $relatedLicenseOrClaimRequestId
     */
    private $relatedLicenseOrClaimRequestId = [
     ...
     *  LicenseOrClaimCondition (specific to this ddex:Message). This is a
    ...
    /**
     * A Date by which the requestor suggests the
     *  ddex:Licensor provides Licenses or ddex:Claims (in ISO 8601:2004 format:
     *  YYYY-MM-DD).
     *
    ...
    /**
     * A ddex:Composite containing details of an
     *  ddex:Identifier of a ddex:License or ddex:Claim that has previously been granted
     *  and that may be relevant in the current licensing context.
     *
    ...
    /**
     * Adds as relatedLicenseOrClaimRequestId
     *
     * A Composite containing details of an
     *  Identifier of a LicenseOrClaimRequest that is replaced or updated by the present
     *  LicenseOrClaimRequest.
     *
     * @return self
     * @param \DDEX\ddexC\RelatedLicenseOrClaimRequestIdType $relatedLicenseOrClaimRequestId
     */
    public function addToRelatedLicenseOrClaimRequestId(\DDEX\ddexC\RelatedLicenseOrClaimRequestIdType $relatedLicenseOrClaimRequestId)
    {
        $this->relatedLicenseOrClaimRequestId[] = $relatedLicenseOrClaimRequestId;
        return $this;
    }

    /**
     * isset relatedLicenseOrClaimRequestId
     *
     * A Composite containing details of an
     *  Identifier of a LicenseOrClaimRequest that is replaced or updated by the present
     *  LicenseOrClaimRequest.
     ...
     * @return bool
     */
    public function issetRelatedLicenseOrClaimRequestId($index)
    {
        return isset($this->relatedLicenseOrClaimRequestId[$index]);
    }

    /**
     * unset relatedLicenseOrClaimRequestId
     *
     * A Composite containing details of an
     *  Identifier of a LicenseOrClaimRequest that is replaced or updated by the present
     *  LicenseOrClaimRequest.
     ...
     * @return void
     */
    public function unsetRelatedLicenseOrClaimRequestId($index)
    {
        unset($this->relatedLicenseOrClaimRequestId[$index]);
    }

    /**
     * Gets as relatedLicenseOrClaimRequestId
     *
     * A Composite containing details of an
     *  Identifier of a LicenseOrClaimRequest that is replaced or updated by the present
     *  LicenseOrClaimRequest.
     *
     * @return \DDEX\ddexC\RelatedLicenseOrClaimRequestIdType[]
     */
    public function getRelatedLicenseOrClaimRequestId()
    {
        return $this->relatedLicenseOrClaimRequestId;
    }

    /**
     * Sets a new relatedLicenseOrClaimRequestId
     *
     * A Composite containing details of an
     *  Identifier of a LicenseOrClaimRequest that is replaced or updated by the present
     *  LicenseOrClaimRequest.
     ...
     * @return self
     */
    public function setRelatedLicenseOrClaimRequestId(array $relatedLicenseOrClaimRequestId = null)
    {
        $this->relatedLicenseOrClaimRequestId = $relatedLicenseOrClaimRequestId;
        return $this;
    }
