...
namespace DDEX\MWL\MWL_212\LicensingProcessStatusMessage;
...
class LicensingProcessStatusMessageAnonymousPHPType
{
     ...
     *  ddex:Elements of the mwl:LicensingProcessStatusMessage as defined in IETF RfC
     ...
     *  mwl:LicensingProcessStatusMessage.
     *
     ...
     *  the process status of a ddex:License or ddex:Claim request.
     *
     * @var \DDEX\MWL\MWL_212\LicensingProcessStatusItemType[] $licensingProcessStatusItem
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\LicensingProcessStatusItemType $licensingProcessStatusItem
     */
    public function addToLicensingProcessStatusItem(\DDEX\MWL\MWL_212\LicensingProcessStatusItemType $licensingProcessStatusItem)
    {
     ...
     *  the process status of a ddex:License or ddex:Claim request.
     *
     * @return \DDEX\MWL\MWL_212\LicensingProcessStatusItemType[]
     */
