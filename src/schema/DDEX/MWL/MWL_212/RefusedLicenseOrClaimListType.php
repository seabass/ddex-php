 ...
 *  ddex:Licenses or ddex:Claims that are refused.
...
class RefusedLicenseOrClaimListType
{
     ...
     *  ddex:License or ddex:Claim that is refused.
     *
     * @var \DDEX\MWL\MWL_212\RefusedLicenseOrClaimType[] $refusedLicenseOrClaim
     */
     ...
     */
    public function addToRefusedLicenseOrClaim(\DDEX\MWL\MWL_212\RefusedLicenseOrClaimType $refusedLicenseOrClaim)
    {
