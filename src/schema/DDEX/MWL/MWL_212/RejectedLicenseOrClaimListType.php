 ...
 *  ddex:Licenses or ddex:Claims that are rejected.
...
class RejectedLicenseOrClaimListType
{
     ...
     *  ddex:Elements of the RejectedLicenseOrClaimList as defined in IETF RfC 4646.
     ...
     *
     * @var \DDEX\MWL\MWL_212\RejectedLicenseOrClaimType[] $rejectedLicenseOrClaim
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\RejectedLicenseOrClaimType $rejectedLicenseOrClaim
     */
    public function addToRejectedLicenseOrClaim(\DDEX\MWL\MWL_212\RejectedLicenseOrClaimType $rejectedLicenseOrClaim)
    {
     ...
     *  ddex:License or ddex:Claim that is rejected.
     *
     * @return \DDEX\MWL\MWL_212\RejectedLicenseOrClaimType[]
     */
