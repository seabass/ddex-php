 ...
 *  more ddex:Resources. ResourceList provides a simple means of aggregating ddex:Resources
 *  without any explicit sequencing or grouping: if it is needed, that is provided by the
 *  ddex:ResourceGroup ddex:Composite.
...
class ResourceListType
{
     ...
     *  ddex:Elements of the mwl:ResourceList as defined in IETF RfC 4646. The default is the
     ...
     *  ddex:SoundRecording.
     *
     * @var \DDEX\MWL\MWL_212\SoundRecordingType[] $soundRecording
     */
     ...
     *  ddex:MIDI.
     *
     * @var \DDEX\MWL\MWL_212\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *  ddex:Video.
     *
     * @var \DDEX\MWL\MWL_212\VideoType[] $video
     */
    private $video = [
     ...
     *  ddex:Image.
     *
     * @var \DDEX\MWL\MWL_212\ImageType[] $image
     */
    private $image = [
     ...
     *  ddex:Text.
     *
     * @var \DDEX\MWL\MWL_212\TextType[] $text
     */
    private $text = [
     ...
     *  ddex:SheetMusic.
     *
     * @var \DDEX\MWL\MWL_212\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
    ...
    /**
     * A ddex:Composite containing details of an
     *  item of ddex:Software.
     *
     * @var \DDEX\MWL\MWL_212\SoftwareType[] $software
     */
    private $software = [
    ...
    /**
     * A ddex:Composite containing details of a
     *  ddex:UserDefinedResource.
     *
     * @var \DDEX\MWL\MWL_212\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\MWL\MWL_212\SoundRecordingType $soundRecording)
    {
     ...
     *  ddex:SoundRecording.
     *
     * @return \DDEX\MWL\MWL_212\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\MIDIType $mIDI
     */
    public function addToMIDI(\DDEX\MWL\MWL_212\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     *  ddex:MIDI.
     *
     * @return \DDEX\MWL\MWL_212\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\VideoType $video
     */
    public function addToVideo(\DDEX\MWL\MWL_212\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     *  ddex:Video.
     *
     * @return \DDEX\MWL\MWL_212\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\ImageType $image
     */
    public function addToImage(\DDEX\MWL\MWL_212\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     *  ddex:Image.
     *
     * @return \DDEX\MWL\MWL_212\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\TextType $text
     */
    public function addToText(\DDEX\MWL\MWL_212\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     *  ddex:Text.
     *
     * @return \DDEX\MWL\MWL_212\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\MWL\MWL_212\SheetMusicType $sheetMusic)
    {
     ...
     *  ddex:SheetMusic.
     *
     * @return \DDEX\MWL\MWL_212\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\SoftwareType $software
     */
    public function addToSoftware(\DDEX\MWL\MWL_212\SoftwareType $software)
    {
     ...
     *  item of ddex:Software.
     *
     * @return \DDEX\MWL\MWL_212\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWL\MWL_212\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DDEX\MWL\MWL_212\UserDefinedResourceType $userDefinedResource)
    {
     ...
     *  ddex:UserDefinedResource.
     *
     * @return \DDEX\MWL\MWL_212\UserDefinedResourceType[]
     */
