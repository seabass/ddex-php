...
class VideoType
{
     ...
     *  ddex:Elements of the mwl:Video as defined in IETF RfC 4646. The default is the same
     *  as indicated for the containing composite. ddex:Language and Script are provided as
     ...
     *  mwl:Video ddex:Element was updated (=True) or not (=False). The ddex:Flag may only be
     *  used when the ddex:UpdateIndicator is set to ddex:UpdateMessage. When this
     *  ddex:Boolean ddex:Flag is set to true, the ddex:MessageRecipient is expected to
     *  replace any previously provided mwl:Video data with the now provided
     *  data.
     *
     * @var bool $isUpdated
     */
    ...
    /**
     * The ddex:Flag indicating whether the
     *  mwl:Video is related to an ddex:Artist (=True) or not (=False).
     *
     ...
     *  ddex:Identifier of the mwl:Video.
     *
    ...
    /**
     * A ddex:Composite containing details of a
     *  ddex:MusicalWorkId of a ddex:MusicalWork used in the mwl:Video.
     *
     ...
     *  ddex:Message) of the mwl:Video within the ddex:Release which contains it. This is
     *  a ddex:LocalResourceAnchor starting with the letter A.
     *
    ...
    /**
     * @var string[] $videoCueSheetReferenceList
     */
    private $videoCueSheetReferenceList = null;

    /**
     * A ddex:Composite containing details of the
     *  ddex:ReferenceTitle of the mwl:Video.
     *
     ...
     *  ddex:Work used in the ddex:Video is a ddex:Medley (=True) or not
     *  (=False).
     *
     * @var bool $isMedley
     */
    ...
    /**
     * The ddex:Flag indicating whether the
     *  mwl:Video is a ddex:Potpourri (=True) or not (=False).
     *
    ...
    /**
     * The ddex:Flag indicating whether the
     *  mwl:Video is instrumental (=True) or not (=False).
     *
    ...
    /**
     * The ddex:Flag indicating whether the
     *  mwl:Video is used as background to other audio or audiovisual material (=True) or
     *  not (=False).
     *
    ...
    /**
     * The ddex:Flag indicating whether the
     *  mwl:Video is hidden in some way from the ddex:Consumer (=True) or not
     *  (=False).
     *
    ...
    /**
     * The ddex:Flag indicating whether the
     *  mwl:Video is additional to those on the original ddex:Release of which this is a
     *  ddex:Version (=True) or not (=False).
     *
     ...
     *  recorded in the mwl:Video (represented by an ISO 639-2
    ...
    /**
     * The ddex:Duration of the mwl:Video (using
     ...
     *  the MusicalWork(s) used in the mwl:Video.
     *
     ...
     *  ddex:CollectionType ddex:VideoChapter.
     *
    ...
    /**
     * A ddex:Composite containing details of one
     *  or more ddex:MusicalWorks contained in the mwl:Video.
     *
     ...
     *  contained in the current mwl:Video.
     *
    ...
    /**
     * A ddex:Composite containing details of the
     *  Date and ddex:Place of the ddex:Event in which the mwl:Video was
     *  created.
     *
    ...
    /**
     * A ddex:Composite containing details of the
     *  Date and ddex:Place of the ddex:Event in which the mwl:Video was originally
     *  mastered (either in analogue or digital form).
     *
    ...
    /**
     * A ddex:Composite containing details of
     *  ddex:Descriptors and other attributes of the mwl:Video which may vary according to
     *  ddex:Territory of release.
     *
     ...
     */
    public function addToVideoCueSheetReferenceList($videoCueSheetReference)
    {
        $this->videoCueSheetReferenceList[] = $videoCueSheetReference;
        return $this;
    }

    /**
     * isset videoCueSheetReferenceList
     *
     * @param int|string $index
     * @return bool
     */
    public function issetVideoCueSheetReferenceList($index)
    {
        return isset($this->videoCueSheetReferenceList[$index]);
    }

    /**
     * unset videoCueSheetReferenceList
     *
     * @param int|string $index
     * @return void
     */
    public function unsetVideoCueSheetReferenceList($index)
    {
        unset($this->videoCueSheetReferenceList[$index]);
    }

    /**
     * Gets as videoCueSheetReferenceList
     *
     * @return string[]
     */
    public function getVideoCueSheetReferenceList()
    {
        return $this->videoCueSheetReferenceList;
    }

    /**
     * Sets a new videoCueSheetReferenceList
     *
     * @param string $videoCueSheetReferenceList
     * @return self
     */
    public function setVideoCueSheetReferenceList(array $videoCueSheetReferenceList = null)
    {
        $this->videoCueSheetReferenceList = $videoCueSheetReferenceList;
        return $this;
    }
