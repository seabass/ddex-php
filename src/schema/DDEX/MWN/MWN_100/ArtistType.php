...
class ArtistType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\ArtistRoleType[] $artistRole
     */
    private $artistRole = [
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\ArtistRoleType $artistRole
     */
    public function addToArtistRole(\DDEX\MWN\MWN_100\ArtistRoleType $artistRole)
    {
     ...
     * A Composite containing details of a role played by the Artist in relation to other Artists.
     *
     * @return \DDEX\MWN\MWN_100\ArtistRoleType[]
     */
