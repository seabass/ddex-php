...
class HashSumType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\HashSumAlgorithmTypeType $hashSumAlgorithmType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @return \DDEX\MWN\MWN_100\HashSumAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @param \DDEX\MWN\MWN_100\HashSumAlgorithmTypeType $hashSumAlgorithmType
     * @return self
     */
    public function setHashSumAlgorithmType(\DDEX\MWN\MWN_100\HashSumAlgorithmTypeType $hashSumAlgorithmType)
    {
