...
class ImageType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\ResourceProprietaryIdType[] $resourceProprietaryId
     */
    private $resourceProprietaryId = [
     ...
     *
     * @var \DDEX\MWN\MWN_100\ResourceDetailsByTerritoryType[] $imageDetailsByTerritory
     */
    ...
    /**
     * Adds as resourceProprietaryId
     *
     * A Composite containing details of Identifiers of the Image.
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\ResourceProprietaryIdType $resourceProprietaryId
     */
    public function addToResourceProprietaryId(\DDEX\MWN\MWN_100\ResourceProprietaryIdType $resourceProprietaryId)
    {
        $this->resourceProprietaryId[] = $resourceProprietaryId;
        return $this;
    }

    /**
     * isset resourceProprietaryId
     *
     * A Composite containing details of Identifiers of the Image.
     *
     ...
     * @return bool
     */
    public function issetResourceProprietaryId($index)
    {
        return isset($this->resourceProprietaryId[$index]);
    }

    /**
     * unset resourceProprietaryId
     *
     * A Composite containing details of Identifiers of the Image.
     *
     * @param int|string $index
     * @return void
     */
    public function unsetResourceProprietaryId($index)
    {
        unset($this->resourceProprietaryId[$index]);
    }

    /**
     * Gets as resourceProprietaryId
     *
     * A Composite containing details of Identifiers of the Image.
     *
     * @return \DDEX\MWN\MWN_100\ResourceProprietaryIdType[]
     */
    public function getResourceProprietaryId()
    {
        return $this->resourceProprietaryId;
    }

    /**
     * Sets a new resourceProprietaryId
     *
     * A Composite containing details of Identifiers of the Image.
     *
     * @param \DDEX\MWN\MWN_100\ResourceProprietaryIdType[] $resourceProprietaryId
     * @return self
     */
    public function setResourceProprietaryId(array $resourceProprietaryId)
    {
        $this->resourceProprietaryId = $resourceProprietaryId;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\ResourceDetailsByTerritoryType $imageDetailsByTerritory
     */
    public function addToImageDetailsByTerritory(\DDEX\MWN\MWN_100\ResourceDetailsByTerritoryType $imageDetailsByTerritory)
    {
     ...
     * @return self
     */
    public function setImageDetailsByTerritory(array $imageDetailsByTerritory = null)
    {
        $this->imageDetailsByTerritory = $imageDetailsByTerritory;
        return $this;
    }
