...
class MessageAuditTrailType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\MessageAuditTrailEventType[] $messageAuditTrailEvent
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrailEvent(\DDEX\MWN\MWN_100\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing details of a Party handling the Message and the Time at which the handling took place.
     *
     * @return \DDEX\MWN\MWN_100\MessageAuditTrailEventType[]
     */
