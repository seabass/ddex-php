...
class RelatedReleaseType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\ReleaseSummaryDetailsByTerritoryType[] $releaseSummaryDetailsByTerritory
     */
     ...
     *
     * @var \DDEX\MWN\MWN_100\ReleaseRelationshipTypeType $releaseRelationshipType
     */
     ...
     *
     * @var \DDEX\MWN\MWN_100\EventDateType $releaseDate
     */
     ...
     *
     * @var \DDEX\MWN\MWN_100\EventDateType $originalReleaseDate
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory
     */
    public function addToReleaseSummaryDetailsByTerritory(\DDEX\MWN\MWN_100\ReleaseSummaryDetailsByTerritoryType $releaseSummaryDetailsByTerritory)
    {
     ...
     * A Composite containing summary details of Descriptors and other attributes of the Release which may vary according to Territory of Release. Territory of Release may be the world.
     *
     * @return \DDEX\MWN\MWN_100\ReleaseSummaryDetailsByTerritoryType[]
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @return \DDEX\MWN\MWN_100\ReleaseRelationshipTypeType
     */
     ...
     * A Composite containing details of the Type of the relationship between the two Releases.
     *
     * @param \DDEX\MWN\MWN_100\ReleaseRelationshipTypeType $releaseRelationshipType
     * @return self
     */
    public function setReleaseRelationshipType(\DDEX\MWN\MWN_100\ReleaseRelationshipTypeType $releaseRelationshipType)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the related Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @return \DDEX\MWN\MWN_100\EventDateType
     */
     ...
     * A Composite containing details of the Date and Place of the Event in which the related Release was or will be first made available for Usage in its current form, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DDEX\MWN\MWN_100\EventDateType $releaseDate
     * @return self
     */
    public function setReleaseDate(?\DDEX\MWN\MWN_100\EventDateType $releaseDate = null)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the collection of tracks for the Release (e.g. the equivalent physical album on vinyl) was or will be first made available for Usage, whether for physical or electronic/online distribution (in ISO 8601:2004 format: YYYY-MM-DD).
     *
     * @param \DDEX\MWN\MWN_100\EventDateType $originalReleaseDate
     * @return self
     */
    public function setOriginalReleaseDate(?\DDEX\MWN\MWN_100\EventDateType $originalReleaseDate = null)
    {
