...
class ReleaseCollectionReferenceListType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\ReleaseCollectionReferenceType[] $releaseCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\ReleaseCollectionReferenceType $releaseCollectionReference
     */
    public function addToReleaseCollectionReference(\DDEX\MWN\MWN_100\ReleaseCollectionReferenceType $releaseCollectionReference)
    {
     ...
     * A Composite containing a ReleaseCollectionReference for a Collection (specific to this Message). The referenced Collection has to be of CollectionType Series, Season or Episode.
     *
     * @return \DDEX\MWN\MWN_100\ReleaseCollectionReferenceType[]
     */
