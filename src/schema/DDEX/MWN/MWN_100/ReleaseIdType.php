...
class ReleaseIdType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\ICPNType $iCPN
     */
    private $iCPN = null;
     ...
     *
     * @var \DDEX\MWN\MWN_100\CatalogNumberType $catalogNumber
     */
     ...
     * A Composite containing details of the ICPN used as proxy for identification of the Release. Only applicable when the Release is an abstraction of a complete PhysicalProduct. An ICPN comprises 12 or 13 digits, depending whether it is an EAN (13) or a UPC (12). DDEX will enforce the syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @return \DDEX\MWN\MWN_100\ICPNType
     */
     ...
     * A Composite containing details of the ICPN used as proxy for identification of the Release. Only applicable when the Release is an abstraction of a complete PhysicalProduct. An ICPN comprises 12 or 13 digits, depending whether it is an EAN (13) or a UPC (12). DDEX will enforce the syntax [0-9]{12,13} using XML Schema in the future.
     *
     * @param \DDEX\MWN\MWN_100\ICPNType $iCPN
     * @return self
     */
    public function setICPN(?\DDEX\MWN\MWN_100\ICPNType $iCPN = null)
    {
        $this->iCPN = $iCPN;
        return $this;
    }
     ...
     * A Composite containing details of the CatalogNumber of the Release.
     *
     * @return \DDEX\MWN\MWN_100\CatalogNumberType
     */
     ...
     * A Composite containing details of the CatalogNumber of the Release.
     *
     * @param \DDEX\MWN\MWN_100\CatalogNumberType $catalogNumber
     * @return self
     */
    public function setCatalogNumber(?\DDEX\MWN\MWN_100\CatalogNumberType $catalogNumber = null)
    {
     ...
     */
    public function addToProprietaryId(\DDEX\MWN\MWN_100\ProprietaryIdType $proprietaryId)
    {
