...
class ReleaseListType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\ReleaseType[] $release
     */
    private $release = [
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\ReleaseType $release
     */
    public function addToRelease(\DDEX\MWN\MWN_100\ReleaseType $release)
    {
     ...
     * A Composite containing details of a DDEX Release.
     *
     * @return \DDEX\MWN\MWN_100\ReleaseType[]
     */
