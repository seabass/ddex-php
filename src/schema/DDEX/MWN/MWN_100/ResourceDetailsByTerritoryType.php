...
/**
 * Class representing ResourceDetailsByTerritoryType
 *
 * A Composite containing details of Descriptors and other attributes of a Resource which may vary according to Territory of release.
 * XSD Type: ResourceDetailsByTerritory
 */
class ResourceDetailsByTerritoryType
{
    /**
     * The Language and script for the Elements of the ResourceDetailsByTerritory as defined in IETF RfC 5646. The default is the same as indicated for the containing composite. Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A Territory to which the Resource details apply. Either this Element or ExcludedTerritory shall be present, but not both. The use of ISO TerritoryCodes (or the term 'Worldwide”) is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
    ...
    /**
     * A Territory to which the Resource details do not apply. Either this Element or Territory shall be present, but not both. The use of ISO TerritoryCodes (or the term 'Worldwide”) is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
    ...
    /**
     * A Composite containing details of a Contributor to the Resource.
     *
     * @var \DDEX\MWN\MWN_100\ResourceContributorType[] $resourceContributor
     */
    ...
    /**
     * A Composite containing details of the PLine for the Resource.
     *
    ...
    /**
     * A Composite containing details of the CLine for the Resource.
     *
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\ResourceContributorType $resourceContributor
     */
    public function addToResourceContributor(\DDEX\MWN\MWN_100\ResourceContributorType $resourceContributor)
    {
     ...
     * A Composite containing details of a Contributor to the Resource.
     *
     * @return \DDEX\MWN\MWN_100\ResourceContributorType[]
     */
     ...
     * @return self
     */
    public function setDisplayArtistName(?\DDEX\MWN\MWN_100\NameType $displayArtistName = null)
    {
