...
class ResourceListType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DDEX\MWN\MWN_100\MIDIType[] $mIDI
     */
    private $mIDI = [
     ...
     *
     * @var \DDEX\MWN\MWN_100\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @var \DDEX\MWN\MWN_100\ImageType[] $image
     */
    private $image = [
     ...
     *
     * @var \DDEX\MWN\MWN_100\TextType[] $text
     */
    private $text = [
     ...
     *
     * @var \DDEX\MWN\MWN_100\SheetMusicType[] $sheetMusic
     */
    private $sheetMusic = [
     ...
     *
     * @var \DDEX\MWN\MWN_100\SoftwareType[] $software
     */
    private $software = [
     ...
     *
     * @var \DDEX\MWN\MWN_100\UserDefinedResourceType[] $userDefinedResource
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\MWN\MWN_100\SoundRecordingType $soundRecording)
    {
     ...
     * A Composite containing details of a SoundRecording.
     *
     * @return \DDEX\MWN\MWN_100\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\MIDIType $mIDI
     */
    public function addToMIDI(\DDEX\MWN\MWN_100\MIDIType $mIDI)
    {
        $this->mIDI[] = $mIDI;
        return $this;
    }
     ...
     * A Composite containing details of a MIDI.
     *
     * @return \DDEX\MWN\MWN_100\MIDIType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\VideoType $video
     */
    public function addToVideo(\DDEX\MWN\MWN_100\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A Composite containing details of a Video.
     *
     * @return \DDEX\MWN\MWN_100\VideoType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\ImageType $image
     */
    public function addToImage(\DDEX\MWN\MWN_100\ImageType $image)
    {
        $this->image[] = $image;
        return $this;
    }
     ...
     * A Composite containing details of an Image.
     *
     * @return \DDEX\MWN\MWN_100\ImageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\TextType $text
     */
    public function addToText(\DDEX\MWN\MWN_100\TextType $text)
    {
        $this->text[] = $text;
        return $this;
    }
     ...
     * A Composite containing details of a Text.
     *
     * @return \DDEX\MWN\MWN_100\TextType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\SheetMusicType $sheetMusic
     */
    public function addToSheetMusic(\DDEX\MWN\MWN_100\SheetMusicType $sheetMusic)
    {
     ...
     * A Composite containing details of a SheetMusic.
     *
     * @return \DDEX\MWN\MWN_100\SheetMusicType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\SoftwareType $software
     */
    public function addToSoftware(\DDEX\MWN\MWN_100\SoftwareType $software)
    {
     ...
     * A Composite containing details of an item of Software.
     *
     * @return \DDEX\MWN\MWN_100\SoftwareType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\UserDefinedResourceType $userDefinedResource
     */
    public function addToUserDefinedResource(\DDEX\MWN\MWN_100\UserDefinedResourceType $userDefinedResource)
    {
     ...
     * A Composite containing details of a UserDefinedResource.
     *
     * @return \DDEX\MWN\MWN_100\UserDefinedResourceType[]
     */
