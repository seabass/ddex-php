...
class TitleType
{
     ...
     *
     * @var \DDEX\MWN\MWN_100\TitleTextType $titleText
     */
     ...
     *
     * @var \DDEX\MWN\MWN_100\TypedSubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     * A Composite containing the text of the Title.
     *
     * @return \DDEX\MWN\MWN_100\TitleTextType
     */
     ...
     * A Composite containing the text of the Title.
     *
     * @param \DDEX\MWN\MWN_100\TitleTextType $titleText
     * @return self
     */
    public function setTitleText(\DDEX\MWN\MWN_100\TitleTextType $titleText)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_100\TypedSubTitleType $subTitle
     */
    public function addToSubTitle(\DDEX\MWN\MWN_100\TypedSubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DDEX\MWN\MWN_100\TypedSubTitleType[]
     */
