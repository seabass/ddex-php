...
class AtomWriterType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\DetailedPartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\DetailedPartyIdType $partyId
     */
    public function addToPartyId(\DDEX\MWN\MWN_US_LIC_100\DetailedPartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\DetailedPartyIdType[]
     */
     ...
     */
    public function addToPartyName(\DDEX\MWN\MWN_US_LIC_100\PartyNameType $partyName)
    {
