...
/**
 * Class representing CLineWithTerritoryType
 *
 * A Composite containing details of a CLine.
 * Explanatory Note: This Composite is named CLineWithTerritory to disambiguate it from the basic CLine Composite.
 * XSD Type: CLineWithTerritory
 */
class CLineWithTerritoryType
{
    /**
