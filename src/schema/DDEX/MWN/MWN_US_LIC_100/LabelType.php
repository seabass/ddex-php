 ...
 *
 * A Composite containing details of a Label.
 * XSD Type: Label
 */
class LabelType
{
    ...
    /**
     * The Namespace of the LabelName. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the LabelName. This is represented in an XML schema as an XML Attribute.
     *
