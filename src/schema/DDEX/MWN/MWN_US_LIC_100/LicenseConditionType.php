...
class LicenseConditionType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\UsageType[] $usage
     */
    private $usage = [
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\RoyaltyRateType[] $royaltyRate
     */
    private $royaltyRate = [
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\RoyaltyAmountType $advanceAmount
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\GuaranteedAmountType $guaranteedAmount
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\SupplementalDocumentType[] $supplementalDocument
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\RateValidityType $rateValidity
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\TariffReferenceType $tariffReference
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\PriceInformationType $priceInformation
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\TechnicalInstantiationType $technicalInstantiation
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\UsageType $usage
     */
    public function addToUsage(\DDEX\MWN\MWN_US_LIC_100\UsageType $usage)
    {
        $this->usage[] = $usage;
        return $this;
    }
     ...
     * A Composite containing Types and number of Usages of the Release.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\UsageType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\RoyaltyRateType $royaltyRate
     */
    public function addToRoyaltyRate(\DDEX\MWN\MWN_US_LIC_100\RoyaltyRateType $royaltyRate)
    {
     ...
     * A Composite containing details of a RoyaltyRate.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\RoyaltyRateType[]
     */
     ...
     * An Amount which is paid in advance.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\RoyaltyAmountType $advanceAmount
     * @return self
     */
    public function setAdvanceAmount(?\DDEX\MWN\MWN_US_LIC_100\RoyaltyAmountType $advanceAmount = null)
    {
     ...
     * An Amount which is guaranteed,
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\GuaranteedAmountType
     */
     ...
     * An Amount which is guaranteed,
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\GuaranteedAmountType $guaranteedAmount
     * @return self
     */
    public function setGuaranteedAmount(?\DDEX\MWN\MWN_US_LIC_100\GuaranteedAmountType $guaranteedAmount = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\SupplementalDocumentType $supplementalDocument
     */
    public function addToSupplementalDocument(\DDEX\MWN\MWN_US_LIC_100\SupplementalDocumentType $supplementalDocument)
    {
     ...
     * A Composite containing details of a document that contains information to support the LicenseRequest.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\SupplementalDocumentType[]
     */
     ...
     * A Composite containing details of the context (such as Dates, number of uses) in which the Rate is valid. The default is that the Rate applies indefinitely from the xs:date of issue of the Licence.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\RateValidityType
     */
     ...
     * A Composite containing details of the context (such as Dates, number of uses) in which the Rate is valid. The default is that the Rate applies indefinitely from the xs:date of issue of the Licence.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\RateValidityType $rateValidity
     * @return self
     */
    public function setRateValidity(?\DDEX\MWN\MWN_US_LIC_100\RateValidityType $rateValidity = null)
    {
     ...
     * A Composite containing details of a Reference to a TextDocument containing details of a Tariff (in the form of an Identifier, Name or Description) regarding the Usage.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\TariffReferenceType
     */
     ...
     * A Composite containing details of a Reference to a TextDocument containing details of a Tariff (in the form of an Identifier, Name or Description) regarding the Usage.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\TariffReferenceType $tariffReference
     * @return self
     */
    public function setTariffReference(?\DDEX\MWN\MWN_US_LIC_100\TariffReferenceType $tariffReference = null)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\PriceInformationType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/deals-and-commercial-aspects/price-information
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\PriceInformationType $priceInformation
     * @return self
     */
    public function setPriceInformation(?\DDEX\MWN\MWN_US_LIC_100\PriceInformationType $priceInformation = null)
    {
     ...
     * A Composite containing technical details of the Release.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\TechnicalInstantiationType
     */
     ...
     * A Composite containing technical details of the Release.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\TechnicalInstantiationType $technicalInstantiation
     * @return self
     */
    public function setTechnicalInstantiation(?\DDEX\MWN\MWN_US_LIC_100\TechnicalInstantiationType $technicalInstantiation = null)
    {
