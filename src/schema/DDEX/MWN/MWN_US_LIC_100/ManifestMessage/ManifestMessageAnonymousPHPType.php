...
namespace DDEX\MWN\MWN_US_LIC_100\ManifestMessage;
...
class ManifestMessageAnonymousPHPType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\FtpMessageHeaderType $messageHeader
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\MessageNotificationPeriodType $messageNotificationPeriod
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\MessageInBatchType[] $messageInBatch
     */
     ...
     * The MessageHeader for the ManifestMessage.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\FtpMessageHeaderType
     */
     ...
     * The MessageHeader for the ManifestMessage.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\FtpMessageHeaderType $messageHeader
     * @return self
     */
    public function setMessageHeader(\DDEX\MWN\MWN_US_LIC_100\FtpMessageHeaderType $messageHeader)
    {
     ...
     * A Composite containing details of a reporting Period covered by the Messages. It must contain at least one out of StartDate or EndDate. The StartDate must be earlier than the EndDate if both are provided.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\MessageNotificationPeriodType
     */
     ...
     * A Composite containing details of a reporting Period covered by the Messages. It must contain at least one out of StartDate or EndDate. The StartDate must be earlier than the EndDate if both are provided.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\MessageNotificationPeriodType $messageNotificationPeriod
     * @return self
     */
    public function setMessageNotificationPeriod(\DDEX\MWN\MWN_US_LIC_100\MessageNotificationPeriodType $messageNotificationPeriod)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\MessageInBatchType $messageInBatch
     */
    public function addToMessageInBatch(\DDEX\MWN\MWN_US_LIC_100\MessageInBatchType $messageInBatch)
    {
     ...
     * A Composite containing details of a Message in the Batch.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\MessageInBatchType[]
     */
