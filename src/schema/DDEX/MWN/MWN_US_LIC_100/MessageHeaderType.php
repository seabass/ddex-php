...
class MessageHeaderType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType $messageSender
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType $sentOnBehalfOf
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType[] $messageRecipient
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\MessageAuditTrailEventType[] $messageAuditTrail
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType $messageSender
     * @return self
     */
    public function setMessageSender(\DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType $messageSender)
    {
     ...
     * A Composite containing details of the Party on whose behalf the Message is sent.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType $sentOnBehalfOf
     * @return self
     */
    public function setSentOnBehalfOf(?\DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType $sentOnBehalfOf = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType $messageRecipient
     */
    public function addToMessageRecipient(\DDEX\MWN\MWN_US_LIC_100\MessagingPartyWithoutCodeType $messageRecipient)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrail(\DDEX\MWN\MWN_US_LIC_100\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\MessageAuditTrailEventType[]
     */
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\MessageAuditTrailEventType[] $messageAuditTrail
     * @return self
     */
