...
/**
 * Class representing PartyIdForNotificationType
 *
 * A Composite containing details of a PartyId.
 * Explanatory Note: This Composite is named PartyIdForNotification to disambiguate it from the basic PartyId Composite. The name indicates that it is specific for Musical Work and Right Share Notification Choreography.
 * XSD Type: PartyIdForNotification
 */
class PartyIdForNotificationType
{
    /**
