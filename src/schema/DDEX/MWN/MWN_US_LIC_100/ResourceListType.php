...
class ResourceListType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\SoundRecordingType[] $soundRecording
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\VideoType[] $video
     */
    private $video = [
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\SoundRecordingType $soundRecording
     */
    public function addToSoundRecording(\DDEX\MWN\MWN_US_LIC_100\SoundRecordingType $soundRecording)
    {
     ...
     * A Composite containing details of a SoundRecording.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\SoundRecordingType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\VideoType $video
     */
    public function addToVideo(\DDEX\MWN\MWN_US_LIC_100\VideoType $video)
    {
        $this->video[] = $video;
        return $this;
    }
     ...
     * A Composite containing details of a Video.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\VideoType[]
     */
