...
class VideoType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\VideoTypeType $videoType
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\VideoIdType $videoId
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\ResourceMusicalWorkReferenceType[] $resourceMusicalWorkReferenceList
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\PLineWithTerritoryType $pLine
     */
    private $pLine = null;
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_100\CLineWithTerritoryType $cLine
     */
    private $cLine = null;
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\VideoTypeType
     */
     ...
     * A Composite containing details of the Type of the Video.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\VideoTypeType $videoType
     * @return self
     */
    public function setVideoType(?\DDEX\MWN\MWN_US_LIC_100\VideoTypeType $videoType = null)
    {
     ...
     * A Composite containing details of an Identifier of the Video.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\VideoIdType
     */
     ...
     * A Composite containing details of an Identifier of the Video.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\VideoIdType $videoId
     * @return self
     */
    public function setVideoId(\DDEX\MWN\MWN_US_LIC_100\VideoIdType $videoId)
    {
     ...
     * @return self
     */
    public function setDisplayArtistName(?\DDEX\MWN\MWN_US_LIC_100\DisplayArtistNameType $displayArtistName = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_100\ResourceMusicalWorkReferenceType $resourceMusicalWorkReference
     */
    public function addToResourceMusicalWorkReferenceList(\DDEX\MWN\MWN_US_LIC_100\ResourceMusicalWorkReferenceType $resourceMusicalWorkReference)
    {
     ...
     * A Composite containing details of one or more MusicalWorks contained in the Video.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\ResourceMusicalWorkReferenceType[]
     */
     ...
     * A Composite containing details of one or more MusicalWorks contained in the Video.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\ResourceMusicalWorkReferenceType[] $resourceMusicalWorkReferenceList
     * @return self
     */
     ...
     * A Composite containing details of the PLine for the Video.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\PLineWithTerritoryType
     */
     ...
     * A Composite containing details of the PLine for the Video.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\PLineWithTerritoryType $pLine
     * @return self
     */
    public function setPLine(?\DDEX\MWN\MWN_US_LIC_100\PLineWithTerritoryType $pLine = null)
    {
        $this->pLine = $pLine;
        return $this;
    }
     ...
     * A Composite containing details of the CLine for the Video.
     *
     * @return \DDEX\MWN\MWN_US_LIC_100\CLineWithTerritoryType
     */
     ...
     * A Composite containing details of the CLine for the Video.
     *
     * @param \DDEX\MWN\MWN_US_LIC_100\CLineWithTerritoryType $cLine
     * @return self
     */
    public function setCLine(?\DDEX\MWN\MWN_US_LIC_100\CLineWithTerritoryType $cLine = null)
    {
        $this->cLine = $cLine;
        return $this;
    }
