...
class HashSumType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\HashSumAlgorithmTypeType $hashSumAlgorithmType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\HashSumAlgorithmTypeType
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\HashSumAlgorithmTypeType $hashSumAlgorithmType
     * @return self
     */
    public function setHashSumAlgorithmType(\DDEX\MWN\MWN_US_LIC_101\HashSumAlgorithmTypeType $hashSumAlgorithmType)
    {
