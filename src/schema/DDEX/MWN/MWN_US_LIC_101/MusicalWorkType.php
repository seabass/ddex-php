...
class MusicalWorkType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\WriterType[] $writer
     */
    private $writer = [
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\StatusType[] $status
     */
    private $status = [
     ...
     * @return self
     */
    public function setMusicalWorkId(\DDEX\MWN\MWN_US_LIC_101\MusicalWorkIdType $musicalWorkId)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\WriterType $writer
     */
    public function addToWriter(\DDEX\MWN\MWN_US_LIC_101\WriterType $writer)
    {
        $this->writer[] = $writer;
        return $this;
    }
     ...
     * A Composite containing details a MusicalWorkContributor to the MusicalWork.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\WriterType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\StatusType $status
     */
    public function addToStatus(\DDEX\MWN\MWN_US_LIC_101\StatusType $status)
    {
        $this->status[] = $status;
        return $this;
    }
     ...
     * A Status of the MusicalWork.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\StatusType[]
     */
