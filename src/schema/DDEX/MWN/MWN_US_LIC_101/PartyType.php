...
class PartyType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\PartyIdForNotificationType $partyId
     */
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\PartyNameForNotificationType[] $partyName
     */
    private $partyName = [
     ...
     *
     * @var \DDEX\MWN\MWN_US_LIC_101\SocietyAffiliationType[] $societyAffiliation
     */
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\PartyIdForNotificationType
     */
     ...
     * A Composite containing details of the PartyId for the Party. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @param \DDEX\MWN\MWN_US_LIC_101\PartyIdForNotificationType $partyId
     * @return self
     */
    public function setPartyId(\DDEX\MWN\MWN_US_LIC_101\PartyIdForNotificationType $partyId)
    {
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\PartyNameForNotificationType $partyName
     */
    public function addToPartyName(\DDEX\MWN\MWN_US_LIC_101\PartyNameForNotificationType $partyName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\PartyNameForNotificationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LIC_101\SocietyAffiliationType $societyAffiliation
     */
    public function addToSocietyAffiliation(\DDEX\MWN\MWN_US_LIC_101\SocietyAffiliationType $societyAffiliation)
    {
     ...
     * A Composite containing details of a society affiliation for the Party.
     *
     * @return \DDEX\MWN\MWN_US_LIC_101\SocietyAffiliationType[]
     */
