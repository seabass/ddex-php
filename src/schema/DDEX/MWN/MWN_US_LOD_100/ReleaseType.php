...
class ReleaseType
{
     ...
     * @return self
     */
    public function setReleaseType(\DDEX\MWN\MWN_US_LOD_100\ReleaseTypeType $releaseType)
    {
     ...
     * @return self
     */
    public function setDisplayArtistName(\DDEX\MWN\MWN_US_LOD_100\DisplayArtistNameType $displayArtistName)
    {
