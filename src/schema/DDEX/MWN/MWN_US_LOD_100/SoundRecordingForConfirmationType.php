...
/**
 * Class representing SoundRecordingForConfirmationType
 *
 * A Composite containing details of a SoundRecording reported when confirming CatalogTransfer.
 * Explanatory Note: This Composite is named SoundRecordingForConfirmation to disambiguate it from the basic SoundRecording Composite. The name indicates that it is specific for the LoD Confirmation Message.
 * XSD Type: SoundRecordingForConfirmation
 */
class SoundRecordingForConfirmationType
{
    /**
     ...
     *
     * @var \DDEX\MWN\MWN_US_LOD_100\SoundRecordingIdType $soundRecordingId
     */
     ...
     * A Composite containing details of SoundRecordingIds.
     *
     * @return \DDEX\MWN\MWN_US_LOD_100\SoundRecordingIdType
     */
     ...
     * A Composite containing details of SoundRecordingIds.
     *
     * @param \DDEX\MWN\MWN_US_LOD_100\SoundRecordingIdType $soundRecordingId
     * @return self
     */
    public function setSoundRecordingId(\DDEX\MWN\MWN_US_LOD_100\SoundRecordingIdType $soundRecordingId)
    {
