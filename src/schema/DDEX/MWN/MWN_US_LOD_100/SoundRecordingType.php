...
class SoundRecordingType
{
     ...
     *
     * @var \DDEX\MWN\MWN_US_LOD_100\LabelType[] $label
     */
    private $label = [
     ...
     * @return self
     */
    public function setTitle(\DDEX\MWN\MWN_US_LOD_100\ReferenceTitleType $title)
    {
        $this->title = $title;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\MWN\MWN_US_LOD_100\LabelType $label
     */
    public function addToLabel(\DDEX\MWN\MWN_US_LOD_100\LabelType $label)
    {
        $this->label[] = $label;
        return $this;
    }
     ...
     * A Composite containing a Label under which the Release is to be marketed.
     *
     * @return \DDEX\MWN\MWN_US_LOD_100\LabelType[]
     */
