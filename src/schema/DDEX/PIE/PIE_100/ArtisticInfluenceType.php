...
class ArtisticInfluenceType
{
     ...
     *
     * @var \DDEX\PIE\PIE_100\PartyDescriptorWithPronunciationType[] $party
     */
    private $party = [
     ...
     *
     * @var \DDEX\PIE\PIE_100\WorkType[] $work
     */
    private $work = [
     ...
     *
     * @var \DDEX\PIE\PIE_100\ResourceType[] $resource
     */
    private $resource = [
     ...
     *
     * @var \DDEX\PIE\PIE_100\ReleaseType[] $release
     */
    private $release = [
     ...
     *
     * @var \DDEX\PIE\PIE_100\TextWithFormatType[] $description
     */
    private $description = [
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\PartyDescriptorWithPronunciationType $party
     */
    public function addToParty(\DDEX\PIE\PIE_100\PartyDescriptorWithPronunciationType $party)
    {
        $this->party[] = $party;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\WorkType $work
     */
    public function addToWork(\DDEX\PIE\PIE_100\WorkType $work)
    {
        $this->work[] = $work;
        return $this;
    }
     ...
     * A Composite containing details of a Work.
     *
     * @return \DDEX\PIE\PIE_100\WorkType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\ResourceType $resource
     */
    public function addToResource(\DDEX\PIE\PIE_100\ResourceType $resource)
    {
     ...
     * A Composite containing details of a Resource.
     *
     * @return \DDEX\PIE\PIE_100\ResourceType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\ReleaseType $release
     */
    public function addToRelease(\DDEX\PIE\PIE_100\ReleaseType $release)
    {
     ...
     * A Composite containing details of a Release.
     *
     * @return \DDEX\PIE\PIE_100\ReleaseType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\TextWithFormatType $description
     */
    public function addToDescription(\DDEX\PIE\PIE_100\TextWithFormatType $description)
    {
