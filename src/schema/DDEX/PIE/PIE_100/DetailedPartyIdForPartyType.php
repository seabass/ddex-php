...
/**
 * Class representing DetailedPartyIdForPartyType
 *
 * A Composite containing details of a PartyId.
 * Explanatory Note: This Composite is named DetailedPartyIdForParty to disambiguate it from the basic PartyId Composite.
 * XSD Type: DetailedPartyIdForParty
 */
class DetailedPartyIdForPartyType
{
    /**
