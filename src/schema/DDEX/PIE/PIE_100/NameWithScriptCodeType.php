...
/**
 * Class representing NameWithScriptCodeType
 *
 * A Composite containing details of a Name and its pronunciation.
 * Explanatory Note: This Composite is named NameWithScriptCode to disambiguate it from the basic Name Composite.
 * XSD Type: NameWithScriptCode
 */
class NameWithScriptCodeType
{
    /**
     * The Name string.
     ...
     *
     * @var \DDEX\PIE\PIE_100\NameType $name
     */
    private $name = null;
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @param \DDEX\PIE\PIE_100\NameType $name
     * @return self
     */
    public function setName(\DDEX\PIE\PIE_100\NameType $name)
    {
        $this->name = $name;
        return $this;
    }
