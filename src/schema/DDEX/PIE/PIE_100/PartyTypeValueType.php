...
/**
 * Class representing PartyTypeValueType
 *
 * A Composite containing details of a PartyType.
 * XSD Type: PartyTypeValue
 */
class PartyTypeValueType
{
    /**
     * @var string $__value
     */
    ...
    /**
     * The Namespace of the PartyType. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the PartyType. This is represented in an XML schema as an XML Attribute.
     *
