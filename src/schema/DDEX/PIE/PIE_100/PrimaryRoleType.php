...
/**
 * Class representing PrimaryRoleType
 *
 * A Composite containing details of a PrimaryRole.
 * XSD Type: PrimaryRole
 */
class PrimaryRoleType
{
    /**
    ...
    /**
     * The value of the PrimaryRole.
     *
     * @var \DDEX\PIE\PIE_100\ContributorRoleType $value
     */
    private $value = null;
     ...
     * The value of the PrimaryRole.
     *
     * @param \DDEX\PIE\PIE_100\ContributorRoleType $value
     * @return self
     */
    public function setValue(\DDEX\PIE\PIE_100\ContributorRoleType $value)
    {
        $this->value = $value;
        return $this;
    }
