...
/**
 * Class representing PronunciationForPartyType
 *
 * A Composite containing details of a pronunciation of a Name.
 * Explanatory Note: This Composite is named PronunciationForParty to disambiguate it from the basic Pronunciation Composite.
 * XSD Type: PronunciationForParty
 */
class PronunciationForPartyType
{
    /**
     * @var string $__value
     */
    ...
    /**
     * A Flag indicating whether the pronunciation is wrong (=true) or not (=false).
     *
     * @var bool $isMispronounced
     */
    private $isMispronounced = null;
    ...
    /**
     * Gets as isMispronounced
     *
     * A Flag indicating whether the pronunciation is wrong (=true) or not (=false).
     *
     * @return bool
     */
    public function getIsMispronounced()
    {
        return $this->isMispronounced;
    }

    /**
     * Sets a new isMispronounced
     *
     * A Flag indicating whether the pronunciation is wrong (=true) or not (=false).
     *
     * @param bool $isMispronounced
     * @return self
     */
    public function setIsMispronounced($isMispronounced)
    {
        $this->isMispronounced = $isMispronounced;
        return $this;
    }
