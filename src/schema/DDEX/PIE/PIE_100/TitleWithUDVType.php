...
class TitleWithUDVType
{
     ...
     *
     * @var \DDEX\PIE\PIE_100\SubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     *
     * @return self
     * @param \DDEX\PIE\PIE_100\SubTitleType $subTitle
     */
    public function addToSubTitle(\DDEX\PIE\PIE_100\SubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DDEX\PIE\PIE_100\SubTitleType[]
     */
