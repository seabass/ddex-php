...
class MessagingPartyType
{
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_100\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_100\PartyNameType $partyName
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @var \DDEX\RDR_C\RDR_C_100\NameType $tradingName
     */
     ...
     *
     * @return self
     * @param \DDEX\RDR_C\RDR_C_100\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\RDR_C\RDR_C_100\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party handling the Message. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\RDR_C\RDR_C_100\PartyIdType[]
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @return \DDEX\RDR_C\RDR_C_100\PartyNameType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @param \DDEX\RDR_C\RDR_C_100\PartyNameType $partyName
     * @return self
     */
    public function setPartyName(?\DDEX\RDR_C\RDR_C_100\PartyNameType $partyName = null)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @param \DDEX\RDR_C\RDR_C_100\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\RDR_C\RDR_C_100\NameType $tradingName = null)
    {
