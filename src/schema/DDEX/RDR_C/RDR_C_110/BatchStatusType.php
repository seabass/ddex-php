...
class BatchStatusType
{
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\StatusType $status
     */
    private $status = null;
     ...
     * A Composite containing details of the status of the Batch.
     *
     * @return \DDEX\RDR_C\RDR_C_110\StatusType
     */
     ...
     * A Composite containing details of the status of the Batch.
     *
     * @param \DDEX\RDR_C\RDR_C_110\StatusType $status
     * @return self
     */
    public function setStatus(\DDEX\RDR_C\RDR_C_110\StatusType $status)
    {
        $this->status = $status;
        return $this;
    }
