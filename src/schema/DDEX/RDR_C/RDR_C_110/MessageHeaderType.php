...
class MessageHeaderType
{
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $messageSender
     */
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $sentOnBehalfOf
     */
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType[] $messageRecipient
     */
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $sentAsRequestedBy
     */
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\MessageAuditTrailEventType[] $messageAuditTrail
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @return \DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType
     */
     ...
     * A Composite containing details of the MessageSender.
     *
     * @param \DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $messageSender
     * @return self
     */
    public function setMessageSender(\DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $messageSender)
    {
     ...
     * A Composite containing details of the Party on whose behalf the Message is sent.
     *
     * @param \DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $sentOnBehalfOf
     * @return self
     */
    public function setSentOnBehalfOf(?\DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $sentOnBehalfOf = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $messageRecipient
     */
    public function addToMessageRecipient(\DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $messageRecipient)
    {
     ...
     * A Composite containing details of the Party on whose request the Message is sent.
     *
     * @param \DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $sentAsRequestedBy
     * @return self
     */
    public function setSentAsRequestedBy(?\DDEX\RDR_C\RDR_C_110\MessagingPartyWithoutCodeType $sentAsRequestedBy = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RDR_C\RDR_C_110\MessageAuditTrailEventType $messageAuditTrailEvent
     */
    public function addToMessageAuditTrail(\DDEX\RDR_C\RDR_C_110\MessageAuditTrailEventType $messageAuditTrailEvent)
    {
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @return \DDEX\RDR_C\RDR_C_110\MessageAuditTrailEventType[]
     */
     ...
     * A Composite containing information about Parties in between the original MessageSender and ultimate MessageRecipient.
     *
     * @param \DDEX\RDR_C\RDR_C_110\MessageAuditTrailEventType[] $messageAuditTrail
     * @return self
     */
