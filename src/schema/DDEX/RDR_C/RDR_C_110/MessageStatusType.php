...
class MessageStatusType
{
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\FileStatusType $status
     */
    private $status = null;
     ...
     * A Composite containing details of the status of the Message.
     *
     * @return \DDEX\RDR_C\RDR_C_110\FileStatusType
     */
     ...
     * A Composite containing details of the status of the Message.
     *
     * @param \DDEX\RDR_C\RDR_C_110\FileStatusType $status
     * @return self
     */
    public function setStatus(\DDEX\RDR_C\RDR_C_110\FileStatusType $status)
    {
        $this->status = $status;
        return $this;
    }
