...
class MessagingPartyType
{
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\RDR_C\RDR_C_110\PartyNameType $partyName
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @var \DDEX\RDR_C\RDR_C_110\NameType $tradingName
     */
     ...
     *
     * @return self
     * @param \DDEX\RDR_C\RDR_C_110\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\RDR_C\RDR_C_110\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party handling the Message. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\RDR_C\RDR_C_110\PartyIdType[]
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @return \DDEX\RDR_C\RDR_C_110\PartyNameType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @param \DDEX\RDR_C\RDR_C_110\PartyNameType $partyName
     * @return self
     */
    public function setPartyName(?\DDEX\RDR_C\RDR_C_110\PartyNameType $partyName = null)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/general-guidance-on-messages/field-length-and-precision
     *
     * @param \DDEX\RDR_C\RDR_C_110\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\RDR_C\RDR_C_110\NameType $tradingName = null)
    {
