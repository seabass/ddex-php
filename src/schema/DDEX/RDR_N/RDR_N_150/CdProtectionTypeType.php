...
class CdProtectionTypeType
{
    ...
    /**
     * The Namespace of the CdProtectionType. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the CdProtectionType. This is represented in an XML schema as an XML Attribute.
     *
