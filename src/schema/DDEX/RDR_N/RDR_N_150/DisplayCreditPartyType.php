...
/**
 * Class representing DisplayCreditPartyType
 *
 * A Composite containing details of a Party for display credits. A Party may be described through Name and Identifier.
 * XSD Type: DisplayCreditParty
 */
class DisplayCreditPartyType
{
    /**
    ...
    /**
     * A Territory of the Party. The use of ISO TerritoryCodes (or the term 'Worldwide') is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
