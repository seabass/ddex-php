...
/**
 * Class representing EventDateNoWorldwideType
 *
 * A Composite containing details of the Date and Place of an Event.
 * XSD Type: EventDateNoWorldwide
 */
class EventDateNoWorldwideType
{
    /**
     * @var string $__value
     */
    ...
    /**
     * The Territory in which the Event occurred. This is represented in an XML schema as an XML Attribute. The use of ISO TerritoryCodes is strongly encouraged; TIS TerritoryCodes should only be used if both MessageSender and MessageRecipient are familiar with this standard.
     *
