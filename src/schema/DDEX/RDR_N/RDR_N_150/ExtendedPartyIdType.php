...
/**
 * Class representing ExtendedPartyIdType
 *
 * A Composite containing details of a PartyId.
 * Explanatory Note: This Composite is named ExtendedPartyId to disambiguate it from the basic PartyId Composite.
 * XSD Type: ExtendedPartyId
 */
class ExtendedPartyIdType
{
    /**
