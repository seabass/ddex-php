...
/**
 * Class representing PerformingContributorType
 *
 * A Composite containing details of the Name, Identifier and role(s) of a Contributor. This Composite is used for Parties that are performing Contributors.
 * XSD Type: PerformingContributor
 */
class PerformingContributorType
{
    /**
     ...
     *
     * @var \DDEX\RDR_N\RDR_N_150\ContributionWithInstrumentType[] $contribution
     */
     ...
     *
     * @return self
     * @param \DDEX\RDR_N\RDR_N_150\ContributionWithInstrumentType $contribution
     */
    public function addToContribution(\DDEX\RDR_N\RDR_N_150\ContributionWithInstrumentType $contribution)
    {
     ...
     * A Composite containing details of a contribution. Each contribution must have one role in one country with one set of flags and with 0-n instruments. If multiple roles or set of flags need to be communicated, multiple contribution composites need to be used.
     *
     * @return \DDEX\RDR_N\RDR_N_150\ContributionWithInstrumentType[]
     */
