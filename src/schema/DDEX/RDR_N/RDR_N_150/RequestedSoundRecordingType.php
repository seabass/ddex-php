...
/**
 * Class representing RequestedSoundRecordingType
 *
 * A Composite containing details of a requested SoundRecording.
 * XSD Type: RequestedSoundRecording
 */
class RequestedSoundRecordingType
{
    /**
    ...
    /**
     * An integer value that allows signaling to the sender of a claim how much the SoundRecording that is subject to the claim has been used. This is a value between 0 and 10, where 10 means 'a lot' and 0 means 'nothing' and 1 means 'just a little' by the judgement of the sender of the request Message.
     *
     * @var int $weight
     */
    private $weight = null;
     ...
     * @return self
     */
    public function setSoundRecordingId(?\DDEX\RDR_N\RDR_N_150\SoundRecordingIdType $soundRecordingId = null)
    {
     ...
     * @return self
     */
    public function setReferenceTitle(?\DDEX\RDR_N\RDR_N_150\ReferenceTitleType $referenceTitle = null)
    {
