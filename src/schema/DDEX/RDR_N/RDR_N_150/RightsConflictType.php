...
/**
 * Class representing RightsConflictType
 *
 * A Composite containing details of a Rights Conflict.
 * XSD Type: RightsConflict
 */
class RightsConflictType
{
    /**
    ...
    /**
     * A Flag indicating whether the Conflict is internal only (=true) or not (=false).
     *
     * @var bool $isInternalConflictOnly
     */
    private $isInternalConflictOnly = null;
    ...
    /**
     * Gets as isInternalConflictOnly
     *
     * A Flag indicating whether the Conflict is internal only (=true) or not (=false).
     *
     * @return bool
     */
    public function getIsInternalConflictOnly()
    {
        return $this->isInternalConflictOnly;
    }

    /**
     * Sets a new isInternalConflictOnly
     *
     * A Flag indicating whether the Conflict is internal only (=true) or not (=false).
     *
     * @param bool $isInternalConflictOnly
     * @return self
     */
    public function setIsInternalConflictOnly($isInternalConflictOnly)
    {
        $this->isInternalConflictOnly = $isInternalConflictOnly;
        return $this;
    }
}
