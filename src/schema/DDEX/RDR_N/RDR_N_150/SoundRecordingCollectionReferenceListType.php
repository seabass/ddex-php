...
class SoundRecordingCollectionReferenceListType
{
     ...
     *
     * @var \DDEX\RDR_N\RDR_N_150\SoundRecordingCollectionReferenceType[] $soundRecordingCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\RDR_N\RDR_N_150\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference
     */
    public function addToSoundRecordingCollectionReference(\DDEX\RDR_N\RDR_N_150\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference)
    {
     ...
     * A Composite containing a SoundRecordingCollectionReference for a Collection (specific to this Message).
     *
     * @return \DDEX\RDR_N\RDR_N_150\SoundRecordingCollectionReferenceType[]
     */
