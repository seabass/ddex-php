...
{
    /**
     * The Language and script for the Elements of the DataCarrierList as defined in IETF RfC 5646. The default is the same as indicated for the containing composite. Language and Script are provided as lang[-scipt][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
     ...
     *
     * @var \DDEX\RIN\RIN10F\DataCarrierType[] $dataCarrier
     */
    private $dataCarrier = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\DataCarrierType $dataCarrier
     */
    public function addToDataCarrier(\DDEX\RIN\RIN10F\DataCarrierType $dataCarrier)
    {
     ...
     * A Composite containing details of a DataCarrier.
     *
     * @return \DDEX\RIN\RIN10F\DataCarrierType[]
     */
