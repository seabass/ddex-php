...
class PartyType
{
     ...
     *
     * @var \DDEX\RIN\RIN10F\AffiliationType[] $publisher
     */
    private $publisher = [
     ...
     *
     * @var \DDEX\RIN\RIN10F\AffiliationType[] $authorsSociety
     */
     ...
     *
     * @var \DDEX\RIN\RIN10F\AffiliationType[] $label
     */
    private $label = [
     ...
     *
     * @var \DDEX\RIN\RIN10F\AffiliationType[] $musicLicensingCompany
     */
     ...
     *
     * @var \DDEX\RIN\RIN10F\AllTerritoryCodeType $territoryOfResidency
     */
     ...
     *
     * @var \DDEX\RIN\RIN10F\GoverningAgreementTypeType $governingAgreementType
     */
     ...
     *
     * @var \DDEX\RIN\RIN10F\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     */
     ...
     *
     * @var \DDEX\RIN\RIN10F\PostalAddressType[] $postalAddress
     */
     ...
     *
     * @var \DDEX\RIN\RIN10F\PhoneNumberType[] $phoneNumber
     */
    private $phoneNumber = [
     ...
     *
     * @var \DDEX\RIN\RIN10F\EmailAddressType[] $emailAddress
     */
     ...
     *
     * @var \DDEX\RIN\RIN10F\CurrentTerritoryCodeType[] $nationality
     */
    private $nationality = [
     ...
     *
     * @var \DDEX\RIN\RIN10F\EventDateType $dateAndPlaceOfBirth
     */
     ...
     *
     * @var \DDEX\RIN\RIN10F\EventDateType $dateAndPlaceOfDeath
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\AffiliationType $publisher
     */
    public function addToPublisher(\DDEX\RIN\RIN10F\AffiliationType $publisher)
    {
     ...
     * A Composite containing details of the MusicPublisher the Party is signed to.
     *
     * @return \DDEX\RIN\RIN10F\AffiliationType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\AffiliationType $authorsSociety
     */
    public function addToAuthorsSociety(\DDEX\RIN\RIN10F\AffiliationType $authorsSociety)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\AffiliationType $label
     */
    public function addToLabel(\DDEX\RIN\RIN10F\AffiliationType $label)
    {
        $this->label[] = $label;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\AffiliationType $musicLicensingCompany
     */
    public function addToMusicLicensingCompany(\DDEX\RIN\RIN10F\AffiliationType $musicLicensingCompany)
    {
     ...
     * The country of main residency of the Party.
     *
     * @param \DDEX\RIN\RIN10F\AllTerritoryCodeType $territoryOfResidency
     * @return self
     */
    public function setTerritoryOfResidency(?\DDEX\RIN\RIN10F\AllTerritoryCodeType $territoryOfResidency = null)
    {
     ...
     * A Composite containing details of a Type of an agreement that covers the Party's participation in making a SoundRecording.
     *
     * @return \DDEX\RIN\RIN10F\GoverningAgreementTypeType
     */
     ...
     * A Composite containing details of a Type of an agreement that covers the Party's participation in making a SoundRecording.
     *
     * @param \DDEX\RIN\RIN10F\GoverningAgreementTypeType $governingAgreementType
     * @return self
     */
    public function setGoverningAgreementType(?\DDEX\RIN\RIN10F\GoverningAgreementTypeType $governingAgreementType = null)
    {
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated by the Party.
     *
     * @return \DDEX\RIN\RIN10F\ArtistDelegatedUsageRightsType
     */
     ...
     * A Composite containing details of the kinds of usage for which rights have been delegated by the Party.
     *
     * @param \DDEX\RIN\RIN10F\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights
     * @return self
     */
    public function setArtistDelegatedUsageRights(?\DDEX\RIN\RIN10F\ArtistDelegatedUsageRightsType $artistDelegatedUsageRights = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\PostalAddressType $postalAddress
     */
    public function addToPostalAddress(\DDEX\RIN\RIN10F\PostalAddressType $postalAddress)
    {
     ...
     * A Composite containing details of a PostalAddress of the Party.
     *
     * @return \DDEX\RIN\RIN10F\PostalAddressType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\PhoneNumberType $phoneNumber
     */
    public function addToPhoneNumber(\DDEX\RIN\RIN10F\PhoneNumberType $phoneNumber)
    {
     ...
     * A Composite containing details of a PhoneNumber of the Party.
     *
     * @return \DDEX\RIN\RIN10F\PhoneNumberType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\EmailAddressType $emailAddress
     */
    public function addToEmailAddress(\DDEX\RIN\RIN10F\EmailAddressType $emailAddress)
    {
     ...
     * A Composite containing details of an EmailAddress of the Party.
     *
     * @return \DDEX\RIN\RIN10F\EmailAddressType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\CurrentTerritoryCodeType $nationality
     */
    public function addToNationality(\DDEX\RIN\RIN10F\CurrentTerritoryCodeType $nationality)
    {
     ...
     * A Composite containing details of the Date and Place of birth. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN10F\EventDateType $dateAndPlaceOfBirth
     * @return self
     */
    public function setDateAndPlaceOfBirth(?\DDEX\RIN\RIN10F\EventDateType $dateAndPlaceOfBirth = null)
    {
     ...
     * A Composite containing details of the Date and Place of death. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN10F\EventDateType $dateAndPlaceOfDeath
     * @return self
     */
    public function setDateAndPlaceOfDeath(?\DDEX\RIN\RIN10F\EventDateType $dateAndPlaceOfDeath = null)
    {
