...
class SessionContributorReferenceType
{
     ...
     *
     * @var \DDEX\RIN\RIN10F\StudioRoleType[] $role
     */
    private $role = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\StudioRoleType $role
     */
    public function addToRole(\DDEX\RIN\RIN10F\StudioRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * A Composite containing details of a role played by the Contributor during the Session.
     *
     * @return \DDEX\RIN\RIN10F\StudioRoleType[]
     */
