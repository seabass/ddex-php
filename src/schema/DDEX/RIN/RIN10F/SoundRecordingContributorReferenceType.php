 ...
 *
 * A Composite containing details of a Contributor to a SoundRecording.
...
class SoundRecordingContributorReferenceType
{
     ...
     *
     * @var string $soundRecordingContributorReference
     */
    private $soundRecordingContributorReference = null;

    /**
     * A Composite containing details of a role played by the Contributor in relation to the Resource.
     *
     * @var \DDEX\RIN\RIN10F\ContributorRoleType[] $role
     */
    private $role = [
     ...
     *
     * @var \DDEX\RIN\RIN10F\InstrumentTypeType[] $instrumentType
     */
    ...
    /**
     * Gets as soundRecordingContributorReference
     *
     * A Reference for a Contributor (specific to this Message). This is a LocalPartyAnchorReference starting with the letter P.
     *
     * @return string
     */
    public function getSoundRecordingContributorReference()
    {
        return $this->soundRecordingContributorReference;
    }

    /**
     * Sets a new soundRecordingContributorReference
     *
     * A Reference for a Contributor (specific to this Message). This is a LocalPartyAnchorReference starting with the letter P.
     *
     * @param string $soundRecordingContributorReference
     * @return self
     */
    public function setSoundRecordingContributorReference($soundRecordingContributorReference)
    {
        $this->soundRecordingContributorReference = $soundRecordingContributorReference;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\ContributorRoleType $role
     */
    public function addToRole(\DDEX\RIN\RIN10F\ContributorRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * A Composite containing details of a role played by the Contributor in relation to the Resource.
     *
     * @return \DDEX\RIN\RIN10F\ContributorRoleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\InstrumentTypeType $instrumentType
     */
    public function addToInstrumentType(\DDEX\RIN\RIN10F\InstrumentTypeType $instrumentType)
    {
     ...
     * A Composite containing details of an Instrument played by the Contributor in relation to the Resource.
     *
     * @return \DDEX\RIN\RIN10F\InstrumentTypeType[]
     */
