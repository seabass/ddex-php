...
class TitleType
{
     ...
     *
     * @var \DDEX\RIN\RIN10F\SubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN10F\SubTitleType $subTitle
     */
    public function addToSubTitle(\DDEX\RIN\RIN10F\SubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DDEX\RIN\RIN10F\SubTitleType[]
     */
