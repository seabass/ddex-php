...
class ContributorRoleType
{
    ...
    /**
     * The Namespace of the ern:ContributorRole. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the ern:ContributorRole. This is represented in an XML schema as an XML Attribute.
     *
