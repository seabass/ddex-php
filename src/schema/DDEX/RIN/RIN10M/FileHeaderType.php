...
class FileHeaderType
{
     ...
     *
     * @var \DDEX\RIN\RIN10M\PartyDescriptorType $fileCreator
     */
     ...
     *
     * @var \DDEX\RIN\RIN10M\PartyDescriptorType $createdOnBehalfOf
     */
     ...
     *
     * @var \DDEX\RIN\RIN10M\DdexDigitalSignatureType $signature
     */
     ...
     * A Composite containing details of the Party operating the application that created or updated the RIN File.
     *
     * @return \DDEX\RIN\RIN10M\PartyDescriptorType
     */
     ...
     * A Composite containing details of the Party operating the application that created or updated the RIN File.
     *
     * @param \DDEX\RIN\RIN10M\PartyDescriptorType $fileCreator
     * @return self
     */
    public function setFileCreator(?\DDEX\RIN\RIN10M\PartyDescriptorType $fileCreator = null)
    {
     ...
     * A Composite containing details of the Party on whose behalf the RIN File was created.
     *
     * @param \DDEX\RIN\RIN10M\PartyDescriptorType $createdOnBehalfOf
     * @return self
     */
    public function setCreatedOnBehalfOf(?\DDEX\RIN\RIN10M\PartyDescriptorType $createdOnBehalfOf = null)
    {
     ...
     * A digital signature in accordance with DDEX-DSIG.
     *
     * @return \DDEX\RIN\RIN10M\DdexDigitalSignatureType
     */
     ...
     * A digital signature in accordance with DDEX-DSIG.
     *
     * @param \DDEX\RIN\RIN10M\DdexDigitalSignatureType $signature
     * @return self
     */
    public function setSignature(?\DDEX\RIN\RIN10M\DdexDigitalSignatureType $signature = null)
    {
