...
class DataCarrierType
{
     ...
     *
     * @var \DDEX\RIN\RIN11F\ProprietaryIdType[] $dataCarrierId
     */
     ...
     *
     * @var \DDEX\RIN\RIN11F\DataCarrierContentItemType[] $dataCarrierContent
     */
     ...
     */
    public function addToDataCarrierId(\DDEX\RIN\RIN11F\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of an Identifier of the DataCarrier.
     *
     * @param \DDEX\RIN\RIN11F\ProprietaryIdType[] $dataCarrierId
     * @return self
     */
     ...
     */
    public function addToDataCarrierContent(\DDEX\RIN\RIN11F\DataCarrierContentItemType $dataCarrierContentItem)
    {
     ...
     * A Composite containing details of items located on the DataCarrier.
     *
     * @param \DDEX\RIN\RIN11F\DataCarrierContentItemType[] $dataCarrierContent
     * @return self
     */
