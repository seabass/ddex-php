...
class ProjectListType
{
     ...
     *
     * @var \DDEX\RIN\RIN11F\ProjectType[] $project
     */
    private $project = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11F\ProjectType $project
     */
    public function addToProject(\DDEX\RIN\RIN11F\ProjectType $project)
    {
     ...
     * A Composite containing details of a Project.
     *
     * @return \DDEX\RIN\RIN11F\ProjectType[]
     */
