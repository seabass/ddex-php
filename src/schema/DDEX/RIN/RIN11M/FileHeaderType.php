...
class FileHeaderType
{
     ...
     *
     * @var \DDEX\RIN\RIN11M\PartyDescriptorType[] $fileCreator
     */
    private $fileCreator = [
     ...
     *
     * @var \DDEX\RIN\RIN11M\PartyDescriptorType $createdOnBehalfOf
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\DdexDigitalSignatureType[] $signature
     */
    private $signature = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\PartyDescriptorType $fileCreator
     */
    public function addToFileCreator(\DDEX\RIN\RIN11M\PartyDescriptorType $fileCreator)
    {
     ...
     * A Composite containing details of the Party operating the application that created or updated the RIN File.
     *
     * @return \DDEX\RIN\RIN11M\PartyDescriptorType[]
     */
     ...
     * A Composite containing details of the Party on whose behalf the RIN File was created.
     *
     * @param \DDEX\RIN\RIN11M\PartyDescriptorType $createdOnBehalfOf
     * @return self
     */
    public function setCreatedOnBehalfOf(?\DDEX\RIN\RIN11M\PartyDescriptorType $createdOnBehalfOf = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\DdexDigitalSignatureType $signature
     */
    public function addToSignature(\DDEX\RIN\RIN11M\DdexDigitalSignatureType $signature)
    {
     ...
     * A digital signature in accordance with DDEX-DSIG.
     *
     * @return \DDEX\RIN\RIN11M\DdexDigitalSignatureType[]
     */
