...
class SessionContributorReferenceType
{
     ...
     *
     * @var \DDEX\RIN\RIN11M\ResourceContributorRoleType[] $role
     */
    private $role = [
     ...
     *
     * @var \DDEX\RIN\RIN11M\InstrumentTypeType[] $instrumentType
     */
     ...
     *
     * @var \DDEX\RIN\RIN11M\DisplayCreditsType[] $displayCredits
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\ResourceContributorRoleType $role
     */
    public function addToRole(\DDEX\RIN\RIN11M\ResourceContributorRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * A Composite containing details of a role played by the Contributor during the Session.
     *
     * @return \DDEX\RIN\RIN11M\ResourceContributorRoleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\InstrumentTypeType $instrumentType
     */
    public function addToInstrumentType(\DDEX\RIN\RIN11M\InstrumentTypeType $instrumentType)
    {
     ...
     * A Composite containing details of an Instrument played by the Contributor in relation to the Resource.
     *
     * @return \DDEX\RIN\RIN11M\InstrumentTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\DisplayCreditsType $displayCredits
     */
    public function addToDisplayCredits(\DDEX\RIN\RIN11M\DisplayCreditsType $displayCredits)
    {
     ...
     * A Role and instrumentation for which a Party is credited.
     *
     * @return \DDEX\RIN\RIN11M\DisplayCreditsType[]
     */
