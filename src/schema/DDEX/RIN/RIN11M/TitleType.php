...
class TitleType
{
     ...
     *
     * @var \DDEX\RIN\RIN11M\SubTitleType[] $subTitle
     */
    private $subTitle = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN11M\SubTitleType $subTitle
     */
    public function addToSubTitle(\DDEX\RIN\RIN11M\SubTitleType $subTitle)
    {
     ...
     * A Composite containing details of a SubTitle of the Title, including Titles of Versions used to differentiate different versions of the same Title, as required by the GRid and ISRC ReferenceDescriptiveMetadataSets.
     *
     * @return \DDEX\RIN\RIN11M\SubTitleType[]
     */
