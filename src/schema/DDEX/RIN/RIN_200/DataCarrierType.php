...
class DataCarrierType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\ProprietaryIdType[] $dataCarrierId
     */
     ...
     *
     * @var \DDEX\RIN\RIN_200\DataCarrierContentItemType[] $dataCarrierContent
     */
     ...
     */
    public function addToDataCarrierId(\DDEX\RIN\RIN_200\ProprietaryIdType $proprietaryId)
    {
     ...
     * A Composite containing details of an Identifier of the DataCarrier.
     *
     * @param \DDEX\RIN\RIN_200\ProprietaryIdType[] $dataCarrierId
     * @return self
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\DataCarrierContentItemType $dataCarrierContentItem
     */
    public function addToDataCarrierContent(\DDEX\RIN\RIN_200\DataCarrierContentItemType $dataCarrierContentItem)
    {
     ...
     * A Composite containing details of items located on the DataCarrier.
     *
     * @return \DDEX\RIN\RIN_200\DataCarrierContentItemType[]
     */
     ...
     * A Composite containing details of items located on the DataCarrier.
     *
     * @param \DDEX\RIN\RIN_200\DataCarrierContentItemType[] $dataCarrierContent
     * @return self
     */
