...
class DetailedHashSumType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\HashSumAlgorithmTypeType $algorithm
     */
     ...
     * A Composite containing details of the Type of HashSumAlgorithm governing the HashSum.
     *
     * @param \DDEX\RIN\RIN_200\HashSumAlgorithmTypeType $algorithm
     * @return self
     */
    public function setAlgorithm(\DDEX\RIN\RIN_200\HashSumAlgorithmTypeType $algorithm)
    {
