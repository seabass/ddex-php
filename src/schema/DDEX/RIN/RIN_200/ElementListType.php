...
class ElementListType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\ElementType[] $element
     */
    private $element = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\ElementType $element
     */
    public function addToElement(\DDEX\RIN\RIN_200\ElementType $element)
    {
     ...
     * A Composite containing details of an Element.
     *
     * @return \DDEX\RIN\RIN_200\ElementType[]
     */
