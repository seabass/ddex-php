...
class GenreCategoryType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\GenreCategoryValueType $value
     */
    private $value = null;
     ...
     *
     * @var \DDEX\RIN\RIN_200\TextWithoutTerritoryType[] $description
     */
    private $description = [
     ...
     * A Composite containing details of a Genre Category value.
     *
     * @return \DDEX\RIN\RIN_200\GenreCategoryValueType
     */
     ...
     * A Composite containing details of a Genre Category value.
     *
     * @param \DDEX\RIN\RIN_200\GenreCategoryValueType $value
     * @return self
     */
    public function setValue(\DDEX\RIN\RIN_200\GenreCategoryValueType $value)
    {
        $this->value = $value;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\TextWithoutTerritoryType $description
     */
    public function addToDescription(\DDEX\RIN\RIN_200\TextWithoutTerritoryType $description)
    {
     ...
     * A Composite containing a Description of the Genre Category.
     *
     * @return \DDEX\RIN\RIN_200\TextWithoutTerritoryType[]
     */
