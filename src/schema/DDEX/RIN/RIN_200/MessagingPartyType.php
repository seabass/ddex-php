...
class MessagingPartyType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\PartyIdType[] $partyId
     */
    private $partyId = [
     ...
     *
     * @var \DDEX\RIN\RIN_200\PartyNameType $partyName
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @var \DDEX\RIN\RIN_200\NameType $tradingName
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\PartyIdType $partyId
     */
    public function addToPartyId(\DDEX\RIN\RIN_200\PartyIdType $partyId)
    {
     ...
     * A Composite containing details of the PartyId for the Party handling the Message. If no Namespace is given, the Identifier is a DdexPartyId (DPID). Note that DPIDs are not normally used to identify Artists, producers or other Creators.
     *
     * @return \DDEX\RIN\RIN_200\PartyIdType[]
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @return \DDEX\RIN\RIN_200\PartyNameType
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers
     *
     * @param \DDEX\RIN\RIN_200\PartyNameType $partyName
     * @return self
     */
    public function setPartyName(?\DDEX\RIN\RIN_200\PartyNameType $partyName = null)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/lengths-of-artist-names
     *
     * @param \DDEX\RIN\RIN_200\NameType $tradingName
     * @return self
     */
    public function setTradingName(?\DDEX\RIN\RIN_200\NameType $tradingName = null)
    {
