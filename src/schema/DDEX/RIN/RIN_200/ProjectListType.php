...
class ProjectListType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\ProjectType[] $project
     */
    private $project = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\ProjectType $project
     */
    public function addToProject(\DDEX\RIN\RIN_200\ProjectType $project)
    {
     ...
     * A Composite containing details of a Project.
     *
     * @return \DDEX\RIN\RIN_200\ProjectType[]
     */
