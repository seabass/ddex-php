...
class SessionContributorReferenceType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\ResourceContributorRoleType[] $role
     */
    private $role = [
     ...
     *
     * @var \DDEX\RIN\RIN_200\InstrumentTypeType[] $instrumentType
     */
     ...
     *
     * @var \DDEX\RIN\RIN_200\EquipmentReferenceType[] $contributorEquipmentReference
     */
     ...
     *
     * @var \DDEX\RIN\RIN_200\DisplayCreditsType[] $displayCredits
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\ResourceContributorRoleType $role
     */
    public function addToRole(\DDEX\RIN\RIN_200\ResourceContributorRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors%2C-artists-and-writers/one-artist-with-two-roles
     *
     * @return \DDEX\RIN\RIN_200\ResourceContributorRoleType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\InstrumentTypeType $instrumentType
     */
    public function addToInstrumentType(\DDEX\RIN\RIN_200\InstrumentTypeType $instrumentType)
    {
     ...
     * A Composite containing details of an Instrument played by the Contributor in relation to the Resource.
     *
     * @return \DDEX\RIN\RIN_200\InstrumentTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\EquipmentReferenceType $contributorEquipmentReference
     */
    public function addToContributorEquipmentReference(\DDEX\RIN\RIN_200\EquipmentReferenceType $contributorEquipmentReference)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\DisplayCreditsType $displayCredits
     */
    public function addToDisplayCredits(\DDEX\RIN\RIN_200\DisplayCreditsType $displayCredits)
    {
     ...
     * A Role and instrumentation for which a Party is credited.
     *
     * @return \DDEX\RIN\RIN_200\DisplayCreditsType[]
     */
