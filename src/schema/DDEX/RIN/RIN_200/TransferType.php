...
class TransferType
{
     ...
     *
     * @var \DDEX\RIN\RIN_200\ProprietaryIdType[] $transferId
     */
    private $transferId = [
     ...
     *
     * @var \DDEX\RIN\RIN_200\TransferSourceType[] $transferSource
     */
     ...
     *
     * @var \DDEX\RIN\RIN_200\TransferDestinationType[] $transferDestination
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\ProprietaryIdType $transferId
     */
    public function addToTransferId(\DDEX\RIN\RIN_200\ProprietaryIdType $transferId)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\TransferSourceType $transferSource
     */
    public function addToTransferSource(\DDEX\RIN\RIN_200\TransferSourceType $transferSource)
    {
     ...
     * A Composite containing details of a source of the Transfer.
     *
     * @return \DDEX\RIN\RIN_200\TransferSourceType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_200\TransferDestinationType $transferDestination
     */
    public function addToTransferDestination(\DDEX\RIN\RIN_200\TransferDestinationType $transferDestination)
    {
     ...
     * A Composite containing details of a destination of the Transfer.
     *
     * @return \DDEX\RIN\RIN_200\TransferDestinationType[]
     */
