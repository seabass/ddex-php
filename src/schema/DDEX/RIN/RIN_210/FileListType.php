...
class FileListType
{
     ...
     *
     * @var \DDEX\RIN\RIN_210\FileType[] $file
     */
    private $file = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\FileType $file
     */
    public function addToFile(\DDEX\RIN\RIN_210\FileType $file)
    {
        $this->file[] = $file;
        return $this;
    }
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors,-artists-and-writers/contributors,-artists-and-writers/
     *
     * @return \DDEX\RIN\RIN_210\FileType[]
     */
