...
/**
 * Class representing FileStatusType
 *
 * A Composite containing details of a File Status.
 * XSD Type: FileStatus
 */
class FileStatusType
{
    ...
    /**
     * The Namespace of the File Status. This is represented in an XML schema as an XML Attribute.
     *
    ...
    /**
     * A UserDefined value of the File Status. This is represented in an XML schema as an XML Attribute.
     *
