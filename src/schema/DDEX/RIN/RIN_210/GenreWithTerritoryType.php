...
class GenreWithTerritoryType
{
     ...
     *
     * @var \DDEX\RIN\RIN_210\GenreCategoryType[] $genreCategory
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\SubGenreCategoryValueType[] $subGenreCategory
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\GenreCategoryType $genreCategory
     */
    public function addToGenreCategory(\DDEX\RIN\RIN_210\GenreCategoryType $genreCategory)
    {
     ...
     * A Composite containing details of a Genre Category to which the Release belongs.
     *
     * @return \DDEX\RIN\RIN_210\GenreCategoryType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\SubGenreCategoryValueType $value
     */
    public function addToSubGenreCategory(\DDEX\RIN\RIN_210\SubGenreCategoryValueType $value)
    {
     ...
     * A Composite containing details of a sub-genre of the Release.
     *
     * @return \DDEX\RIN\RIN_210\SubGenreCategoryValueType[]
     */
     ...
     * A Composite containing details of a sub-genre of the Release.
     *
     * @param \DDEX\RIN\RIN_210\SubGenreCategoryValueType[] $subGenreCategory
     * @return self
     */
