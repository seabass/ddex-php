...
{
    /**
     * The Language and script for the Elements of the MusicalWorkList as defined in IETF RfC 5646. The default is the same as indicated for the containing composite. Language and Script are provided as lang[-script][-region][-variant]. This is represented in an XML schema as an XML Attribute.
     *
     ...
     *
     * @var \DDEX\RIN\RIN_210\MusicalWorkType[] $musicalWork
     */
    private $musicalWork = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\MusicalWorkType $musicalWork
     */
    public function addToMusicalWork(\DDEX\RIN\RIN_210\MusicalWorkType $musicalWork)
    {
     ...
     * A Composite containing details of a MusicalWork.
     *
     * @return \DDEX\RIN\RIN_210\MusicalWorkType[]
     */
