...
class SessionListType
{
     ...
     *
     * @var \DDEX\RIN\RIN_210\SessionType[] $session
     */
    private $session = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\SessionType $session
     */
    public function addToSession(\DDEX\RIN\RIN_210\SessionType $session)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors,-artists-and-writers/contributors,-artists-and-writers/
     *
     * @return \DDEX\RIN\RIN_210\SessionType[]
     */
