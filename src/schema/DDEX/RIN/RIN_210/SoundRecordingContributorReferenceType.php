...
class SoundRecordingContributorReferenceType
{
     ...
     *
     * @var \DDEX\RIN\RIN_210\ContributorRoleType[] $role
     */
    private $role = [
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\ContributorRoleType $role
     */
    public function addToRole(\DDEX\RIN\RIN_210\ContributorRoleType $role)
    {
        $this->role[] = $role;
        return $this;
    }
