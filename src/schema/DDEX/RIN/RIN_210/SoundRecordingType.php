...
class SoundRecordingType
{
     ...
     *
     * @var \DDEX\RIN\RIN_210\SoundRecordingTypeType $type
     */
    private $type = null;
     ...
     *
     * @var \DDEX\RIN\RIN_210\DisplayArtistNameWithDefaultType[] $displayArtistName
     */
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors,-artists-and-writers/contributors,-artists-and-writers/
     *
     * @var \DDEX\RIN\RIN_210\SoundRecordingIdType[] $soundRecordingId
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\VersionTypeType[] $versionType
     */
    private $versionType = [
     ...
     *
     * @var \DDEX\RIN\RIN_210\RightsControllerType[] $rightsController
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\PLineWithDefaultType $pLine
     */
    private $pLine = null;
     ...
     *
     * @var \DDEX\RIN\RIN_210\ParentalWarningTypeWithTerritoryType $parentalWarningType
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\GenreWithTerritoryType[] $genre
     */
    private $genre = [
     ...
     *
     * @var \DDEX\RIN\RIN_210\StatusType $status
     */
    private $status = null;
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors,-artists-and-writers/contributors,-artists-and-writers/
     *
     * @var \DDEX\RIN\RIN_210\SoundRecordingContributorReferenceType[] $contributor
     */
    private $contributor = [
     ...
     *
     * @var \DDEX\RIN\RIN_210\SampledSoundRecordingType[] $sampledSoundRecording
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\EventDateType $masteredDate
     */
     ...
     *
     * @var \DDEX\RIN\RIN_210\FirstPublicationDateType[] $firstPublicationDate
     */
     ...
     * A Composite containing details of the Type of the SoundRecording.
     *
     * @return \DDEX\RIN\RIN_210\SoundRecordingTypeType
     */
     ...
     * A Composite containing details of the Type of the SoundRecording.
     *
     * @param \DDEX\RIN\RIN_210\SoundRecordingTypeType $type
     * @return self
     */
    public function setType(?\DDEX\RIN\RIN_210\SoundRecordingTypeType $type = null)
    {
        $this->type = $type;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\DisplayArtistNameWithDefaultType $displayArtistName
     */
    public function addToDisplayArtistName(\DDEX\RIN\RIN_210\DisplayArtistNameWithDefaultType $displayArtistName)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors,-artists-and-writers/contributors,-artists-and-writers/
     *
     * @return \DDEX\RIN\RIN_210\DisplayArtistNameWithDefaultType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\SoundRecordingIdType $soundRecordingId
     */
    public function addToSoundRecordingId(\DDEX\RIN\RIN_210\SoundRecordingIdType $soundRecordingId)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors,-artists-and-writers/contributors,-artists-and-writers/
     *
     * @return \DDEX\RIN\RIN_210\SoundRecordingIdType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\VersionTypeType $versionType
     */
    public function addToVersionType(\DDEX\RIN\RIN_210\VersionTypeType $versionType)
    {
     ...
     * A Composite containing details of a Type of Version given by the releasing party to characterise and differentiate one SoundRecording from another with identical or similar Title metadata. VersionTypes may be used for disambiguating a SoundRecording that has been derived from another SoundRecording by using the value EditedVersion. EditedVersion value is often combined with another VersionType such as RadioVersion.
     *
     * @return \DDEX\RIN\RIN_210\VersionTypeType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\RightsControllerType $rightsController
     */
    public function addToRightsController(\DDEX\RIN\RIN_210\RightsControllerType $rightsController)
    {
     ...
     * A Composite containing details of RightsController of Rights in the SoundRecording.
     *
     * @return \DDEX\RIN\RIN_210\RightsControllerType[]
     */
     ...
     * A Composite containing details of the PLine for the SoundRecording.
     *
     * @return \DDEX\RIN\RIN_210\PLineWithDefaultType
     */
     ...
     * A Composite containing details of the PLine for the SoundRecording.
     *
     * @param \DDEX\RIN\RIN_210\PLineWithDefaultType $pLine
     * @return self
     */
    public function setPLine(?\DDEX\RIN\RIN_210\PLineWithDefaultType $pLine = null)
    {
        $this->pLine = $pLine;
        return $this;
    }
     ...
     * A Composite containing details of the classification of the SoundRecording according to advice which it carries about the level of explicitness or offensiveness of its content.
     *
     * @return \DDEX\RIN\RIN_210\ParentalWarningTypeWithTerritoryType
     */
     ...
     * A Composite containing details of the classification of the SoundRecording according to advice which it carries about the level of explicitness or offensiveness of its content.
     *
     * @param \DDEX\RIN\RIN_210\ParentalWarningTypeWithTerritoryType $parentalWarningType
     * @return self
     */
    public function setParentalWarningType(?\DDEX\RIN\RIN_210\ParentalWarningTypeWithTerritoryType $parentalWarningType = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\GenreWithTerritoryType $genre
     */
    public function addToGenre(\DDEX\RIN\RIN_210\GenreWithTerritoryType $genre)
    {
        $this->genre[] = $genre;
        return $this;
    }
     ...
     * A Composite containing details of a Genre to which the SoundRecording belongs.
     *
     * @return \DDEX\RIN\RIN_210\GenreWithTerritoryType[]
     */
     ...
     * The Status of the SoundRecording.
     *
     * @return \DDEX\RIN\RIN_210\StatusType
     */
     ...
     * The Status of the SoundRecording.
     *
     * @param \DDEX\RIN\RIN_210\StatusType $status
     * @return self
     */
    public function setStatus(?\DDEX\RIN\RIN_210\StatusType $status = null)
    {
        $this->status = $status;
        return $this;
    }
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\SoundRecordingContributorReferenceType $contributor
     */
    public function addToContributor(\DDEX\RIN\RIN_210\SoundRecordingContributorReferenceType $contributor)
    {
     ...
     * Further Reading: https://kb.ddex.net/implementing-each-standard/best-practices-for-all-ddex-standards/guidance-on-contributors,-artists-and-writers/contributors,-artists-and-writers/
     *
     * @return \DDEX\RIN\RIN_210\SoundRecordingContributorReferenceType[]
     */
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\SampledSoundRecordingType $sampledSoundRecording
     */
    public function addToSampledSoundRecording(\DDEX\RIN\RIN_210\SampledSoundRecordingType $sampledSoundRecording)
    {
     ...
     * A Composite containing details of a sampled SoundRecording.
     *
     * @return \DDEX\RIN\RIN_210\SampledSoundRecordingType[]
     */
     ...
     * A Composite containing details of the Date and Place at which the SoundRecording was mastered. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @param \DDEX\RIN\RIN_210\EventDateType $masteredDate
     * @return self
     */
    public function setMasteredDate(?\DDEX\RIN\RIN_210\EventDateType $masteredDate = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\RIN\RIN_210\FirstPublicationDateType $firstPublicationDate
     */
    public function addToFirstPublicationDate(\DDEX\RIN\RIN_210\FirstPublicationDateType $firstPublicationDate)
    {
     ...
     * A Composite containing details of the Date and Place of the Event in which the SoundRecording was first published, whether for physical or electronic/online distribution. This is a string with the syntax YYYY[-MM[-DD]].
     *
     * @return \DDEX\RIN\RIN_210\FirstPublicationDateType[]
     */
