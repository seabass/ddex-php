...
class ExternalResourceLinkType
{
     ...
     *
     * @var \DDEX\ddexC\ExternallyLinkedResourceTypeType[] $externallyLinkedResourceType
     */
     ...
     * @return self
     */
    public function setValidityPeriod(?\DDEX\ddexC\PeriodType $validityPeriod = null)
    {
     ...
     *
     * @return self
     * @param \DDEX\ddexC\ExternallyLinkedResourceTypeType $externallyLinkedResourceType
     */
    public function addToExternallyLinkedResourceType(\DDEX\ddexC\ExternallyLinkedResourceTypeType $externallyLinkedResourceType)
    {
     ...
     * A ddex:Composite containing details of the ddex:Type of a ddex:Resource pointed to by the ddexC:ExternalResourceLink.
     *
     * @return \DDEX\ddexC\ExternallyLinkedResourceTypeType[]
     */
