...
class FingerprintType
{
     ...
     *
     * @var \DDEX\ddexC\FingerprintAlgorithmTypeType $fingerprintAlgorithmType
     */
     ...
     * A ddex:Composite containing details of the ddex:Type of FingerprintAlgorithm governing the ddexC:Fingerprint.
     *
     * @return \DDEX\ddexC\FingerprintAlgorithmTypeType
     */
     ...
     * A ddex:Composite containing details of the ddex:Type of FingerprintAlgorithm governing the ddexC:Fingerprint.
     *
     * @param \DDEX\ddexC\FingerprintAlgorithmTypeType $fingerprintAlgorithmType
     * @return self
     */
    public function setFingerprintAlgorithmType(\DDEX\ddexC\FingerprintAlgorithmTypeType $fingerprintAlgorithmType)
    {
