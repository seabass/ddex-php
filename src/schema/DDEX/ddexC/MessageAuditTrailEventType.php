...
class MessageAuditTrailEventType
{
     ...
     *
     * @var \DDEX\ddexC\MessagingPartyType $messagingPartyDescriptor
     */
     ...
     * A ddex:Composite containing details of a ddex:MessagingParty.
     *
     * @param \DDEX\ddexC\MessagingPartyType $messagingPartyDescriptor
     * @return self
     */
    public function setMessagingPartyDescriptor(\DDEX\ddexC\MessagingPartyType $messagingPartyDescriptor)
    {
