...
class MusicalWorkType
{
     ...
     *
     * @var \DDEX\ddexC\RightShareType[] $rightShare
     */
    private $rightShare = [
     ...
     */
    public function addToReferenceTitle(\DDEX\ddexC\ReferenceTitleType $referenceTitle)
    {
     ...
     *
     * @return self
     * @param \DDEX\ddexC\RightShareType $rightShare
     */
    public function addToRightShare(\DDEX\ddexC\RightShareType $rightShare)
    {
     ...
     * A ddex:Composite containing details of a ddex:RightShare for the ddexC:MusicalWork.
     *
     * @return \DDEX\ddexC\RightShareType[]
     */
