...
class ResourceContainedResourceReferenceType
{
     ...
     *
     * @var \DDEX\ddexC\PurposeType $purpose
     */
     ...
     * A ddex:Composite containing details of the ddex:Purpose of the usage.
     *
     * @param \DDEX\ddexC\PurposeType $purpose
     * @return self
     */
    public function setPurpose(?\DDEX\ddexC\PurposeType $purpose = null)
    {
