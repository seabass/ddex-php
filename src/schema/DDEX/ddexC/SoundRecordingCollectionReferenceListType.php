...
class SoundRecordingCollectionReferenceListType
{
     ...
     *
     * @var \DDEX\ddexC\SoundRecordingCollectionReferenceType[] $soundRecordingCollectionReference
     */
     ...
     *
     * @return self
     * @param \DDEX\ddexC\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference
     */
    public function addToSoundRecordingCollectionReference(\DDEX\ddexC\SoundRecordingCollectionReferenceType $soundRecordingCollectionReference)
    {
     ...
     * A ddex:Composite containing a ddex:SoundRecordingCollectionReference for a ddex:Collection (specific to this ddex:Message).
     *
     * @return \DDEX\ddexC\SoundRecordingCollectionReferenceType[]
     */
