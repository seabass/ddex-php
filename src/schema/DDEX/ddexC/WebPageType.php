...
class WebPageType
{
     ...
     *
     * @var \DDEX\ddexC\NameType $pageName
     */
     ...
     */
    public function addToPartyId(\DDEX\ddexC\PartyIdType $partyId)
    {
     ...
     * A ddex:Composite containing the ddex:Name of the ddex:WebPage.
     *
     * @param \DDEX\ddexC\NameType $pageName
     * @return self
     */
    public function setPageName(?\DDEX\ddexC\NameType $pageName = null)
    {
